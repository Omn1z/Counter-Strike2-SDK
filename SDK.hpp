...
class CAnimComponentStateTransition;
...
class CAnimNodePath;
class CAnimNodeState;
class CAnimNodeStateTransition;
...
class CBindPoseAnimNode;
class CBindPoseUpdateNode;
class CBlend2DAnimNode;
...
class CCSPlayer_ObserverServices;
class CCSPlayer_ParachuteServices;
...
class CCredits;
class CCurrentRotationVelocityMetric;
class CCurrentRotationVelocityMetricEvaluator;
class CCurrentVelocityMetric;
class CCurrentVelocityMetricEvaluator;
class CCycleBase;
class CCycleCondition;
class CCycleControlAnimNode;
class CCycleControlClipAnimNode;
...
class CDistanceRemainingMetric;
...
class CFuncWater;
class CFuncWaterAnalog;
class CFuseProgram;
class CFuseSymbolTable;
class CFutureFacingMetric;
class CFutureFacingMetricEvaluator;
class CFutureVelocityMetric;
...
class CGlowSprite;
class CGradientFog;
class CGraphMotionItem;
class CGrassBurn;
class CGrenadeTracer;
class CGroupAnimNode;
class CGroupInputAnimNode;
class CGroupOutputAnimNode;
class CGunTarget;
class CHEGrenade;
...
class CInfoGasCanisterLaunchPoint;
...
class CJiggleBoneAnimNode;
class CJiggleBoneItem;
class CJiggleBoneUpdateNode;
class CJumpHelperAnimNode;
...
class CPhysPropMapPlacedLongUseEntity;
...
class CPhysPropWeaponUpgradeArmor;
class CPhysPropWeaponUpgradeArmorHelmet;
class CPhysPropWeaponUpgradeContractKill;
class CPhysPropWeaponUpgradeExoJump;
class CPhysPropWeaponUpgradeHelmet;
class CPhysPropWeaponUpgradeParachute;
class CPhysPropWeaponUpgradeTablet;
class CPhysPropWeaponUpgradeTabletDroneIntel;
class CPhysPropWeaponUpgradeTabletHighres;
class CPhysPropWeaponUpgradeTabletZoneIntel;
class CPhysPulley;
...
class CPhysicsWire;
class CPlantedC4;
class CPlantedC4Survival;
class CPlatTrigger;
class CPlayerControllerComponent;
class CPlayerInputAnimMotor;
...
class CPointDZParachuteSpawn;
class CPointDZParadropDenialRegion;
class CPointDZWeaponSpawn;
class CPointDZWeaponSpawnGroup;
class CPointEntity;
class CPointEntityFinder;
class CPointGamestatsCounter;
class CPointGiveAmmo;
class CPointHMDAnchor;
class CPointHMDAnchorOverride;
class CPointHintUi;
class CPointHurt;
...
class CPulseCell_Step_BaseCallMethod;
class CPulseCell_Step_CallExternalMethod;
class CPulseCell_Step_CallMethod;
...
class CPulseCell_Value_Expression;
...
class CSequenceBlend2DItem;
class CSequenceFinishedAnimTag;
class CSequenceGroupData;
class CSequenceMotionItem;
...
class CSlowDownOnSlopesAnimNode;
...
class C_BreachChargeProjectile;
class C_Breakable;
...
class C_CSPropExplodingBarrel;
class C_CSPropExplodingBarrelTop;
class C_CSTeam;
class C_Chicken;
...
class C_OP_ScreenForceFromPlayerView;
...
class C_PhysBox;
class C_PhysMagnet;
class C_PhysPropAmmoBox;
class C_PhysPropClientside;
class C_PhysPropLootCrate;
class C_PhysPropRadarJammer;
class C_PhysPropWeaponUpgrade;
class C_PhysicsProp;
class C_PhysicsPropMultiplayer;
class C_PickUpModelSlerper;
class C_PlantedC4;
class C_PlantedC4Survival;
class C_PlayerPing;
...
class C_PointEntity;
class C_PointHMDAnchor;
class C_PointHMDAnchorOverride;
class C_PointHintUIArrowHighlightModel;
class C_PointHintUIButtonHighlightModel;
...
class C_TripWireFireProjectile;
...
class PulseRuntimeLandingPadIndex_t;
