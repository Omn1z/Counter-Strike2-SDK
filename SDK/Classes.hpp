...
public:
   ...
   std::int32_t m_iCurrentThinkContext; // 0x230 - 0x234
   GameTick_t m_nLastThinkTick; // 0x234 - 0x238
   CBitVec< 64 > m_isSteadyState; // 0x240 - 0x248
   std::float_t m_lastNetworkChange; // 0x248 - 0x24C
   CUtlVector< ResponseContext_t > m_ResponseContexts; // 0x258 - 0x270
   CUtlSymbolLarge m_iszResponseContext; // 0x270 - 0x278
   std::int32_t m_iHealth; // 0x298 - 0x29C
   std::int32_t m_iMaxHealth; // 0x29C - 0x2A0
   std::uint8_t m_lifeState; // 0x2A0 - 0x2A1
   std::float_t m_flDamageAccumulator; // 0x2A4 - 0x2A8
   ...
   std::uint8_t m_nWaterTouch; // 0x2B3 - 0x2B4
   std::uint8_t m_nSlimeTouch; // 0x2B4 - 0x2B5
   bool m_bRestoreInHierarchy; // 0x2B5 - 0x2B6
   CUtlSymbolLarge m_target; // 0x2B8 - 0x2C0
   std::float_t m_flMoveDoneTime; // 0x2C0 - 0x2C4
   ...
   std::uint32_t m_fEffects; // 0x3B0 - 0x3B4
   CHandle< CBaseEntity > m_hGroundEntity; // 0x3B4 - 0x3B8
   std::float_t m_flFriction; // 0x3B8 - 0x3BC
   std::float_t m_flElasticity; // 0x3BC - 0x3C0
   std::float_t m_flGravityScale; // 0x3C0 - 0x3C4
   std::float_t m_flTimeScale; // 0x3C4 - 0x3C8
   std::float_t m_flWaterLevel; // 0x3C8 - 0x3CC
   bool m_bSimulatedEveryTick; // 0x3CC - 0x3CD
   bool m_bAnimatedEveryTick; // 0x3CD - 0x3CE
   std::uint8_t m_nMinCPULevel; // 0x3CE - 0x3CF
   std::uint8_t m_nMaxCPULevel; // 0x3CF - 0x3D0
   std::uint8_t m_nMinGPULevel; // 0x3D0 - 0x3D1
   std::uint8_t m_nMaxGPULevel; // 0x3D1 - 0x3D2
   bool m_bDisableLowViolence; // 0x3D2 - 0x3D3
   std::uint8_t m_nWaterType; // 0x3D3 - 0x3D4
   std::int32_t m_iEFlags; // 0x3D4 - 0x3D8
   ...
   std::int32_t m_iInitialTeamNum; // 0x478 - 0x47C
   ...
   std::float_t m_flOverriddenFriction; // 0x490 - 0x494
   CHandle< CBaseEntity > m_pBlocker; // 0x494 - 0x498
   std::float_t m_flLocalTime; // 0x498 - 0x49C
   std::float_t m_flVPhysicsUpdateLocalTime; // 0x49C - 0x4A0
...
public:
   ...
   std::float_t m_flGlowBackfaceMult; // 0x668 - 0x66C
   std::float_t m_fadeMinDist; // 0x66C - 0x670
   std::float_t m_fadeMaxDist; // 0x670 - 0x674
   std::float_t m_flFadeScale; // 0x674 - 0x678
   std::float_t m_flShadowStrength; // 0x678 - 0x67C
   std::uint8_t m_nObjectCulling; // 0x67C - 0x67D
   std::int32_t m_nAddDecal; // 0x680 - 0x684
   Vector m_vDecalPosition; // 0x684 - 0x690
   Vector m_vDecalForwardAxis; // 0x690 - 0x69C
   std::float_t m_flDecalHealBloodRate; // 0x69C - 0x6A0
   std::float_t m_flDecalHealHeightRate; // 0x6A0 - 0x6A4
...
public:
   ...
   std::int32_t m_iMaxHealth; // 0x318 - 0x31C
   std::int32_t m_iHealth; // 0x31C - 0x320
   std::uint8_t m_lifeState; // 0x320 - 0x321
   bool m_bTakesDamage; // 0x321 - 0x322
   TakeDamageFlags_t m_nTakeDamageFlags; // 0x324 - 0x328
   std::uint8_t m_ubInterpolationFrame; // 0x328 - 0x329
   CHandle< C_BaseEntity > m_hSceneObjectController; // 0x32C - 0x330
   std::int32_t m_nNoInterpolationTick; // 0x330 - 0x334
   std::int32_t m_nVisibilityNoInterpolationTick; // 0x334 - 0x338
   std::float_t m_flProxyRandomValue; // 0x338 - 0x33C
   std::int32_t m_iEFlags; // 0x33C - 0x340
   std::uint8_t m_nWaterType; // 0x340 - 0x341
   ...
   std::int32_t m_nSimulationTick; // 0x358 - 0x35C
   std::int32_t m_iCurrentThinkContext; // 0x35C - 0x360
   CUtlVector< thinkfunc_t > m_aThinkFunctions; // 0x360 - 0x378
   std::float_t m_flAnimTime; // 0x378 - 0x37C
   std::float_t m_flSimulationTime; // 0x37C - 0x380
   std::uint8_t m_nSceneObjectOverrideFlags; // 0x380 - 0x381
   ...
   std::float_t m_flSpeed; // 0x3A8 - 0x3AC
   std::uint16_t m_EntClientFlags; // 0x3AC - 0x3AE
   bool m_bClientSideRagdoll; // 0x3AE - 0x3AF
   std::uint8_t m_iTeamNum; // 0x3AF - 0x3B0
   std::uint32_t m_spawnflags; // 0x3B0 - 0x3B4
   GameTick_t m_nNextThinkTick; // 0x3B4 - 0x3B8
   std::uint32_t m_fFlags; // 0x3B8 - 0x3BC
   ...
   std::float_t m_flWaterLevel; // 0x410 - 0x414
   std::uint32_t m_fEffects; // 0x414 - 0x418
   CHandle< C_BaseEntity > m_hGroundEntity; // 0x418 - 0x41C
   std::float_t m_flFriction; // 0x41C - 0x420
   std::float_t m_flElasticity; // 0x420 - 0x424
   std::float_t m_flGravityScale; // 0x424 - 0x428
   std::float_t m_flTimeScale; // 0x428 - 0x42C
   bool m_bSimulatedEveryTick; // 0x42C - 0x42D
   bool m_bAnimatedEveryTick; // 0x42D - 0x42E
   std::uint8_t m_nMinCPULevel; // 0x42E - 0x42F
   std::uint8_t m_nMaxCPULevel; // 0x42F - 0x430
   std::uint8_t m_nMinGPULevel; // 0x430 - 0x431
   std::uint8_t m_nMaxGPULevel; // 0x431 - 0x432
   GameTime_t m_flNavIgnoreUntilTime; // 0x434 - 0x438
   std::uint16_t m_hThink; // 0x438 - 0x43A
   std::uint8_t m_fBBoxVisFlags; // 0x448 - 0x449
   ...
   std::int32_t m_nFirstPredictableCommand; // 0x450 - 0x454
   std::int32_t m_nLastPredictableCommand; // 0x454 - 0x458
   ...
   std::int32_t m_nNextScriptVarRecordID; // 0x4D0 - 0x4D4
   QAngle m_vecAngVelocity; // 0x4E0 - 0x4EC
   std::int32_t m_DataChangeEventRef; // 0x4EC - 0x4F0
   CUtlVector< CEntityHandle > m_dependencies; // 0x4F0 - 0x508
   std::int32_t m_nCreationTick; // 0x508 - 0x50C
...
public:
   ...
   std::float_t m_flOpStartFadeInTime; // 0x144 - 0x148
   std::float_t m_flOpEndFadeInTime; // 0x148 - 0x14C
   std::float_t m_flOpStartFadeOutTime; // 0x14C - 0x150
   std::float_t m_flOpEndFadeOutTime; // 0x150 - 0x154
   std::float_t m_flOpFadeOscillatePeriod; // 0x154 - 0x158
   bool m_bNormalizeToStopTime; // 0x158 - 0x159
   std::float_t m_flOpTimeOffsetMin; // 0x15C - 0x160
   std::float_t m_flOpTimeOffsetMax; // 0x160 - 0x164
   std::int32_t m_nOpTimeOffsetSeed; // 0x164 - 0x168
   std::int32_t m_nOpTimeScaleSeed; // 0x168 - 0x16C
   std::float_t m_flOpTimeScaleMin; // 0x16C - 0x170
   std::float_t m_flOpTimeScaleMax; // 0x170 - 0x174
...
public:
   ...
   std::int32_t m_nLastAddDecal; // 0x5DC - 0x5E0
   std::int32_t m_nDecalsAdded; // 0x5E0 - 0x5E4
   std::int32_t m_iOldHealth; // 0x5E4 - 0x5E8
   ...
   std::float_t m_flGlowBackfaceMult; // 0x768 - 0x76C
   std::float_t m_fadeMinDist; // 0x76C - 0x770
   std::float_t m_fadeMaxDist; // 0x770 - 0x774
   std::float_t m_flFadeScale; // 0x774 - 0x778
   std::float_t m_flShadowStrength; // 0x778 - 0x77C
   std::uint8_t m_nObjectCulling; // 0x77C - 0x77D
   std::int32_t m_nAddDecal; // 0x780 - 0x784
   Vector m_vDecalPosition; // 0x784 - 0x790
   Vector m_vDecalForwardAxis; // 0x790 - 0x79C
   std::float_t m_flDecalHealBloodRate; // 0x79C - 0x7A0
   std::float_t m_flDecalHealHeightRate; // 0x7A0 - 0x7A4
...
public:
   ...
   std::int32_t m_nForceBone; // 0x718 - 0x71C
   ...
   std::float_t m_flMaxSlopeDistance; // 0x720 - 0x724
...
public:
   ...
   std::int32_t m_nForceBone; // 0x860 - 0x864
   ...
   std::float_t m_flMaxSlopeDistance; // 0x868 - 0x86C
...
public:
   ...
   public:
      ...
      std::float_t m_flAmount; // 0x18 - 0x1C
   ...
   std::int32_t m_nLastFlexUpdateFrameCount; // 0xA30 - 0xA34
   Vector m_CachedViewTarget; // 0xA34 - 0xA40
   std::uint32_t m_nNextSceneEventId; // 0xA40 - 0xA44
   std::int32_t m_iBlink; // 0xA44 - 0xA48
   std::float_t m_blinktime; // 0xA48 - 0xA4C
   bool m_prevblinktoggle; // 0xA4C - 0xA4D
   std::int32_t m_iJawOpen; // 0xA50 - 0xA54
   std::float_t m_flJawOpenAmount; // 0xA54 - 0xA58
   std::float_t m_flBlinkAmount; // 0xA58 - 0xA5C
   ...
   std::int32_t m_nEyeOcclusionRendererBone; // 0xA78 - 0xA7C
...
public:
   ...
   std::uint32_t m_nNextSceneEventId; // 0x8A0 - 0x8A4
...
public:
   ...
   public:
      ...
      std::int32_t m_iModelDisplayFlags; // 0x0 - 0x4

   }; // size - 0x4

   std::float_t m_flFlexDelayTime; // 0xB38 - 0xB3C
   ...
   std::uint32_t m_OriginalOwnerXuidLow; // 0xFF8 - 0xFFC
   std::uint32_t m_OriginalOwnerXuidHigh; // 0xFFC - 0x1000
   std::int32_t m_nFallbackPaintKit; // 0x1000 - 0x1004
   std::int32_t m_nFallbackSeed; // 0x1004 - 0x1008
   std::float_t m_flFallbackWear; // 0x1008 - 0x100C
   std::int32_t m_nFallbackStatTrak; // 0x100C - 0x1010
   ...
   std::int32_t m_iOldTeam; // 0x1034 - 0x1038
   bool m_bAttachmentDirty; // 0x1038 - 0x1039
   std::int32_t m_nUnloadedModelIndex; // 0x103C - 0x1040
   std::int32_t m_iNumOwnerValidationRetries; // 0x1040 - 0x1044
...
public:
   ...
   std::uint32_t m_OriginalOwnerXuidLow; // 0xB88 - 0xB8C
   std::uint32_t m_OriginalOwnerXuidHigh; // 0xB8C - 0xB90
   std::int32_t m_nFallbackPaintKit; // 0xB90 - 0xB94
   std::int32_t m_nFallbackSeed; // 0xB94 - 0xB98
   std::float_t m_flFallbackWear; // 0xB98 - 0xB9C
   std::int32_t m_nFallbackStatTrak; // 0xB9C - 0xBA0
   CHandle< CBaseEntity > m_hOldProvidee; // 0xBA0 - 0xBA4
   std::int32_t m_iOldOwnerClass; // 0xBA4 - 0xBA8
...
public:
   ...
   std::int32_t m_nAssociatedEmitterIndex; // 0x1E8 - 0x1EC
...
public:
   ...
   std::int32_t m_iShapeType; // 0x824 - 0x828
...
public:
   ...
   std::float_t m_flMoveDistance; // 0x6F4 - 0x6F8
   std::float_t m_flWait; // 0x6F8 - 0x6FC
   std::float_t m_flLip; // 0x6FC - 0x700
...
public:
   ...
   std::float_t m_flNextPrimaryAttackTickRatio; // 0xBB4 - 0xBB8
   GameTick_t m_nNextSecondaryAttackTick; // 0xBB8 - 0xBBC
   std::float_t m_flNextSecondaryAttackTickRatio; // 0xBBC - 0xBC0
   std::int32_t m_iClip1; // 0xBC0 - 0xBC4
   std::int32_t m_iClip2; // 0xBC4 - 0xBC8
...
public:
   ...
   std::float_t m_flNextPrimaryAttackTickRatio; // 0x1080 - 0x1084
   GameTick_t m_nNextSecondaryAttackTick; // 0x1084 - 0x1088
   std::float_t m_flNextSecondaryAttackTickRatio; // 0x1088 - 0x108C
   std::int32_t m_iClip1; // 0x108C - 0x1090
   std::int32_t m_iClip2; // 0x1090 - 0x1094
...
public:
   ...
   std::float_t m_impactEnergyScale; // 0x8E8 - 0x8EC
   std::int32_t m_iMinHealthDmg; // 0x8EC - 0x8F0
   QAngle m_preferredCarryAngles; // 0x8F0 - 0x8FC
   std::float_t m_flPressureDelay; // 0x8FC - 0x900
   CHandle< CBaseEntity > m_hBreaker; // 0x900 - 0x904
   PerformanceMode_t m_PerformanceMode; // 0x904 - 0x908
   std::float_t m_flDmgModBullet; // 0x908 - 0x90C
   std::float_t m_flDmgModClub; // 0x90C - 0x910
   std::float_t m_flDmgModExplosive; // 0x910 - 0x914
   std::float_t m_flDmgModFire; // 0x914 - 0x918
   CUtlSymbolLarge m_iszPhysicsDamageTableName; // 0x918 - 0x920
   CUtlSymbolLarge m_iszBasePropData; // 0x920 - 0x928
   std::int32_t m_iInteractions; // 0x928 - 0x92C
   GameTime_t m_flPreventDamageBeforeTime; // 0x92C - 0x930
   bool m_bHasBreakPiecesOrCommands; // 0x930 - 0x931
   std::float_t m_explodeDamage; // 0x934 - 0x938
   std::float_t m_explodeRadius; // 0x938 - 0x93C
   std::float_t m_explosionDelay; // 0x940 - 0x944
   ...
   std::float_t m_flDefaultFadeScale; // 0x974 - 0x978
...
public:
   ...
   std::float_t m_flFireSequenceStartTime; // 0xC20 - 0xC24
   std::int32_t m_nFireSequenceStartTimeChange; // 0xC24 - 0xC28
   std::int32_t m_nFireSequenceStartTimeAck; // 0xC28 - 0xC2C
   ...
   std::uint32_t m_nViewModelIndex; // 0xC54 - 0xC58
   ...
   std::float_t m_flTurningInaccuracyDelta; // 0xC94 - 0xC98
   Vector m_vecTurningInaccuracyEyeDirLast; // 0xC98 - 0xCA4
   std::float_t m_flTurningInaccuracy; // 0xCA4 - 0xCA8
   std::float_t m_fAccuracyPenalty; // 0xCA8 - 0xCAC
   GameTime_t m_flLastAccuracyUpdateTime; // 0xCAC - 0xCB0
   std::float_t m_fAccuracySmoothedForZoom; // 0xCB0 - 0xCB4
   GameTime_t m_fScopeZoomEndTime; // 0xCB4 - 0xCB8
   std::int32_t m_iRecoilIndex; // 0xCB8 - 0xCBC
   std::float_t m_flRecoilIndex; // 0xCBC - 0xCC0
   ...
   std::int32_t m_iOriginalTeamNumber; // 0xCD8 - 0xCDC
   std::float_t m_flNextAttackRenderTimeOffset; // 0xCDC - 0xCE0
   ...
   std::int32_t m_numRemoveUnownedWeaponThink; // 0xD20 - 0xD24
   CIronSightController m_IronSightController; // 0xD28 - 0xD40
   std::int32_t m_iIronSightMode; // 0xD40 - 0xD44
   GameTime_t m_flLastLOSTraceFailureTime; // 0xD44 - 0xD48
   std::int32_t m_iNumEmptyAttacks; // 0xD48 - 0xD4C
...
public:
   ...
   std::float_t m_flFireSequenceStartTime; // 0x10D8 - 0x10DC
   std::int32_t m_nFireSequenceStartTimeChange; // 0x10DC - 0x10E0
   std::int32_t m_nFireSequenceStartTimeAck; // 0x10E0 - 0x10E4
   ...
   std::float_t m_flCrosshairDistance; // 0x1108 - 0x110C
   std::int32_t m_iAmmoLastCheck; // 0x110C - 0x1110
   std::int32_t m_iAlpha; // 0x1110 - 0x1114
   std::int32_t m_iScopeTextureID; // 0x1114 - 0x1118
   std::int32_t m_iCrosshairTextureID; // 0x1118 - 0x111C
   std::float_t m_flGunAccuracyPosition; // 0x111C - 0x1120
   std::uint32_t m_nViewModelIndex; // 0x1120 - 0x1124
   ...
   std::float_t m_flTurningInaccuracyDelta; // 0x115C - 0x1160
   Vector m_vecTurningInaccuracyEyeDirLast; // 0x1160 - 0x116C
   std::float_t m_flTurningInaccuracy; // 0x116C - 0x1170
   std::float_t m_fAccuracyPenalty; // 0x1170 - 0x1174
   GameTime_t m_flLastAccuracyUpdateTime; // 0x1174 - 0x1178
   std::float_t m_fAccuracySmoothedForZoom; // 0x1178 - 0x117C
   GameTime_t m_fScopeZoomEndTime; // 0x117C - 0x1180
   std::int32_t m_iRecoilIndex; // 0x1180 - 0x1184
   std::float_t m_flRecoilIndex; // 0x1184 - 0x1188
   ...
   std::int32_t m_iOriginalTeamNumber; // 0x11A0 - 0x11A4
   std::float_t m_flNextAttackRenderTimeOffset; // 0x11A4 - 0x11A8
   ...
   std::float_t m_gunHeat; // 0x1288 - 0x128C
   std::uint32_t m_smokeAttachments; // 0x128C - 0x1290
   GameTime_t m_lastSmokeTime; // 0x1290 - 0x1294
   std::float_t m_flLastClientFireBulletTime; // 0x1294 - 0x1298
   C_IronSightController m_IronSightController; // 0x12F0 - 0x13A0
   std::int32_t m_iIronSightMode; // 0x13A0 - 0x13A4
   GameTime_t m_flLastLOSTraceFailureTime; // 0x13B0 - 0x13B4
   std::int32_t m_iNumEmptyAttacks; // 0x13B4 - 0x13B8
...
public:
   ...
   std::float_t m_massScale; // 0xAB8 - 0xABC
   std::float_t m_inertiaScale; // 0xABC - 0xAC0
   std::int32_t m_damageType; // 0xAC0 - 0xAC4
   std::int32_t m_damageToEnableMotion; // 0xAC4 - 0xAC8
   std::float_t m_flForceToEnableMotion; // 0xAC8 - 0xACC
   ...
   std::int32_t m_iExploitableByPlayer; // 0xAD0 - 0xAD4
   ...
   std::int32_t m_iInitialGlowState; // 0xADC - 0xAE0
   std::int32_t m_nGlowRange; // 0xAE0 - 0xAE4
   std::int32_t m_nGlowRangeMin; // 0xAE4 - 0xAE8
   ...
   std::int32_t m_nCollisionGroupOverride; // 0xAFC - 0xB00
...
public:
   ...
   std::int32_t m_iShapeType; // 0x99C - 0x9A0
...
public:
   ...
   std::int32_t m_zoomLevel; // 0xD50 - 0xD54
   std::int32_t m_iBurstShotsRemaining; // 0xD54 - 0xD58
   std::int32_t m_silencedModelIndex; // 0xD60 - 0xD64
...
public:
   ...
   std::int32_t m_zoomLevel; // 0x13D0 - 0x13D4
   std::int32_t m_iBurstShotsRemaining; // 0x13D4 - 0x13D8
   std::int32_t m_iSilencerBodygroup; // 0x13D8 - 0x13DC
   std::int32_t m_silencedModelIndex; // 0x13E8 - 0x13EC
...
public:
   ...
   std::float_t m_impactEnergyScale; // 0xA58 - 0xA5C
   std::int32_t m_iMinHealthDmg; // 0xA5C - 0xA60
   std::float_t m_flPressureDelay; // 0xA60 - 0xA64
   CHandle< C_BaseEntity > m_hBreaker; // 0xA64 - 0xA68
   PerformanceMode_t m_PerformanceMode; // 0xA68 - 0xA6C
   std::float_t m_flDmgModBullet; // 0xA6C - 0xA70
   std::float_t m_flDmgModClub; // 0xA70 - 0xA74
   std::float_t m_flDmgModExplosive; // 0xA74 - 0xA78
   std::float_t m_flDmgModFire; // 0xA78 - 0xA7C
   CUtlSymbolLarge m_iszPhysicsDamageTableName; // 0xA80 - 0xA88
   CUtlSymbolLarge m_iszBasePropData; // 0xA88 - 0xA90
   std::int32_t m_iInteractions; // 0xA90 - 0xA94
   GameTime_t m_flPreventDamageBeforeTime; // 0xA94 - 0xA98
   bool m_bHasBreakPiecesOrCommands; // 0xA98 - 0xA99
   std::float_t m_explodeDamage; // 0xA9C - 0xAA0
   std::float_t m_explodeRadius; // 0xAA0 - 0xAA4
   std::float_t m_explosionDelay; // 0xAA8 - 0xAAC
   ...
   std::float_t m_flDefaultFadeScale; // 0xAD8 - 0xADC
...
public:
   ...
   std::int32_t m_bloodColor; // 0xB40 - 0xB44
   ...
   std::float_t m_flWaterWorldZ; // 0xB4C - 0xB50
   std::float_t m_flWaterNextTraceTime; // 0xB50 - 0xB54
   std::float_t m_flFieldOfView; // 0xB54 - 0xB58
...
public:
   ...
   std::int32_t m_nEventPriority; // 0xB28 - 0xB2C
...
public:
   ...
   std::float_t m_DmgRadius; // 0x90C - 0x910
   GameTime_t m_flDetonateTime; // 0x910 - 0x914
   std::float_t m_flWarnAITime; // 0x914 - 0x918
   std::float_t m_flDamage; // 0x918 - 0x91C
...
public:
   ...
   std::int32_t m_iInitialGlowState; // 0xA84 - 0xA88
   std::int32_t m_nGlowRange; // 0xA88 - 0xA8C
   std::int32_t m_nGlowRangeMin; // 0xA8C - 0xA90
   Color m_glowColor; // 0xA90 - 0xA94
   std::int32_t m_nGlowTeam; // 0xA94 - 0xA98
...
public:
   ...
   std::float_t m_flWeight; // 0x20 - 0x24
...
public:
   ...
   std::float_t m_flWeight; // 0x48 - 0x4C
   std::int32_t m_nDimensionStartIndex; // 0x4C - 0x50
...
public:
   ...
   std::float_t m_forceLimit; // 0x4C0 - 0x4C4
   std::float_t m_torqueLimit; // 0x4C4 - 0x4C8
   std::uint32_t m_teleportTick; // 0x4C8 - 0x4CC
   std::float_t m_minTeleportDistance; // 0x4CC - 0x4D0
...
public:
   ...
   std::float_t m_flFieldOfView; // 0x8D0 - 0x8D4
   std::float_t m_impactEnergyScale; // 0x8D4 - 0x8D8
   HitGroup_t m_LastHitGroup; // 0x8D8 - 0x8DC
   bool m_bApplyStressDamage; // 0x8DC - 0x8DD
   std::int32_t m_bloodColor; // 0x8E0 - 0x8E4
   std::int32_t m_registeredNavTeam; // 0x940 - 0x944
   std::int32_t m_navMeshID; // 0x944 - 0x948
   std::int32_t m_iDamageCount; // 0x948 - 0x94C
   ...
   std::uint32_t m_nNavHullIdx; // 0x964 - 0x968
...
public:
   ...
   std::uint32_t m_iHideHUD; // 0xC14 - 0xC18
   ...
   std::float_t m_flFOVSensitivityAdjust; // 0xCBC - 0xCC0
   std::float_t m_flMouseSensitivity; // 0xCC0 - 0xCC4
   Vector m_vOldOrigin; // 0xCC4 - 0xCD0
   std::float_t m_flOldSimulationTime; // 0xCD0 - 0xCD4
   std::int32_t m_nLastExecutedCommandNumber; // 0xCD4 - 0xCD8
   std::int32_t m_nLastExecutedCommandTick; // 0xCD8 - 0xCDC
...
public:
   ...
   std::int32_t m_nPriority; // 0x30 - 0x34
   AnimNodeNetworkMode m_networkMode; // 0x34 - 0x38
...
public:
   ...
   std::float_t m_DmgRadius; // 0xB2C - 0xB30
   GameTime_t m_flDetonateTime; // 0xB30 - 0xB34
   std::float_t m_flWarnAITime; // 0xB34 - 0xB38
   std::float_t m_flDamage; // 0xB38 - 0xB3C
...
public:
   ...
   std::int32_t m_nOrdinal; // 0x538 - 0x53C
   CUtlString m_sWeaponName; // 0x540 - 0x548
   std::uint64_t m_xuid; // 0x548 - 0x550
...
public:
   ...
   std::float_t m_flThrowStrength; // 0xD7C - 0xD80
   std::float_t m_flThrowStrengthApproach; // 0xD80 - 0xD84
...
public:
   ...
   std::float_t m_flThrowStrength; // 0x13FC - 0x1400
   std::float_t m_flThrowStrengthApproach; // 0x1400 - 0x1404
...
public:
   ...
   std::float_t m_volume; // 0x788 - 0x78C
   std::float_t m_flTWidth; // 0x78C - 0x790
   std::float_t m_flTLength; // 0x790 - 0x794
...
public:
   ...
   std::int32_t m_nOrdinal; // 0x4A0 - 0x4A4
   CUtlString m_sWeaponName; // 0x4A8 - 0x4B0
   std::uint64_t m_xuid; // 0x4B0 - 0x4B8
...
public:
   ...
   std::int32_t m_nLastClipPlaneSetupFrame; // 0xD28 - 0xD2C
   ...
   std::float_t m_flLastCollisionCeiling; // 0xD54 - 0xD58
   std::float_t m_flLastCollisionCeilingChangeTime; // 0xD58 - 0xD5C
   bool m_bInLanding; // 0xDB8 - 0xDB9
   std::float_t m_flLandingTime; // 0xDBC - 0xDC0
   ...
   std::float_t m_flSlopeDropOffset; // 0xE50 - 0xE54
   std::float_t m_flSlopeDropHeight; // 0xE60 - 0xE64
   ...
   std::int32_t m_iGunGameProgressiveWeaponIndex; // 0xEAC - 0xEB0
   std::int32_t m_iNumGunGameTRKillPoints; // 0xEB0 - 0xEB4
   std::int32_t m_iNumGunGameKillsWithCurrentWeapon; // 0xEB4 - 0xEB8
   std::uint32_t m_unTotalRoundDamageDealt; // 0xEB8 - 0xEBC
   std::float_t m_fMolotovUseTime; // 0xEBC - 0xEC0
   std::float_t m_fMolotovDamageTime; // 0xEC0 - 0xEC4
   bool m_bInBombZone; // 0xEC4 - 0xEC5
   std::int32_t m_nWhichBombZone; // 0xEC8 - 0xECC
   bool m_bInBuyZone; // 0xECC - 0xECD
   bool m_bInNoDefuseArea; // 0xECD - 0xECE
   std::int32_t m_iThrowGrenadeCounter; // 0xED0 - 0xED4
   bool m_bWaitForNoAttack; // 0xED4 - 0xED5
   bool m_bIsRespawningForDMBonus; // 0xED5 - 0xED6
   std::float_t m_flGuardianTooFarDistFrac; // 0xED8 - 0xEDC
   GameTime_t m_flDetectedByEnemySensorTime; // 0xEDC - 0xEE0
   std::float_t m_flNextGuardianTooFarWarning; // 0xEE0 - 0xEE4
   bool m_bSuppressGuardianTooFarWarningAudio; // 0xEE4 - 0xEE5
   bool m_bKilledByTaser; // 0xEE5 - 0xEE6
   std::int32_t m_iMoveState; // 0xEE8 - 0xEEC
   ...
   std::float_t m_flLowerBodyYawTarget; // 0xEF0 - 0xEF4
   bool m_bStrafing; // 0xEF4 - 0xEF5
   char m_szLastPlaceName[18]; // 0xEF5 - 0xF07
   std::float_t m_flLastExoJumpTime; // 0xF08 - 0xF0C
   GameTime_t m_flLastSpawnTimeIndex; // 0xF18 - 0xF1C
   std::int32_t m_iAddonBits; // 0xF1C - 0xF20
   std::int32_t m_iPrimaryAddon; // 0xF20 - 0xF24
   std::int32_t m_iSecondaryAddon; // 0xF24 - 0xF28
   std::int32_t m_iProgressBarDuration; // 0xF28 - 0xF2C
   std::float_t m_flProgressBarStartTime; // 0xF2C - 0xF30
   std::float_t m_flStamina; // 0xF30 - 0xF34
   std::int32_t m_iDirection; // 0xF34 - 0xF38
   std::int32_t m_iShotsFired; // 0xF38 - 0xF3C
   bool m_bNightVisionOn; // 0xF3C - 0xF3D
   bool m_bHasNightVision; // 0xF3D - 0xF3E
   std::float_t m_flVelocityModifier; // 0xF40 - 0xF44
   std::float_t m_flGroundAccelLinearFracLastTime; // 0xF44 - 0xF48
   std::int32_t m_iStartAccount; // 0xF48 - 0xF4C
   bool m_bIsSpawnRappelling; // 0xF4C - 0xF4D
   Vector m_vecSpawnRappellingRopeOrigin; // 0xF50 - 0xF5C
   std::float_t m_flSpawnRappellingFadeOutForClientViewOffset; // 0xF5C - 0xF60
   std::int32_t m_nSurvivalTeam; // 0xF60 - 0xF64
   CHandle< C_CSPlayerPawnBase > m_hSurvivalAssassinationTarget; // 0xF64 - 0xF68
   std::float_t m_flHealthShotBoostExpirationTime; // 0xF68 - 0xF6C
   std::float_t m_flLastKnownParachuteScreenEffectAmount; // 0xF6C - 0xF70
   Vector m_vecIntroStartEyePosition; // 0xF70 - 0xF7C
   Vector m_vecIntroStartPlayerForward; // 0xF7C - 0xF88
   std::float_t m_flClientDeathTime; // 0xF88 - 0xF8C
   std::float_t m_flNightVisionAlpha; // 0xF94 - 0xF98
   bool m_bScreenTearFrameCaptured; // 0xF98 - 0xF99
   std::float_t m_flFlashBangTime; // 0xF9C - 0xFA0
   std::float_t m_flFlashScreenshotAlpha; // 0xFA0 - 0xFA4
   std::float_t m_flFlashOverlayAlpha; // 0xFA4 - 0xFA8
   ...
   std::float_t m_flFlashMaxAlpha; // 0xFAC - 0xFB0
   std::float_t m_flFlashDuration; // 0xFB0 - 0xFB4
   std::float_t m_flLastFiredWeaponTime; // 0xFB4 - 0xFB8
   ...
   std::int32_t m_iHealthBarRenderMaskIndex; // 0xFE0 - 0xFE4
   std::float_t m_flHealthFadeValue; // 0xFE4 - 0xFE8
   std::float_t m_flHealthFadeAlpha; // 0xFE8 - 0xFEC
   std::int32_t m_nMyCollisionGroup; // 0xFEC - 0xFF0
   std::float_t m_ignoreLadderJumpTime; // 0xFF0 - 0xFF4
   ...
   std::float_t m_flDeathCCWeight; // 0x1030 - 0x1034
   bool m_bOldIsScoped; // 0x1034 - 0x1035
   std::float_t m_flPrevRoundEndTime; // 0x1038 - 0x103C
   std::float_t m_flPrevMatchEndTime; // 0x103C - 0x1040
   std::uint16_t m_unCurrentEquipmentValue; // 0x1040 - 0x1042
   std::uint16_t m_unRoundStartEquipmentValue; // 0x1042 - 0x1044
   std::uint16_t m_unFreezetimeEndEquipmentValue; // 0x1044 - 0x1046
   bool m_passiveItems[4]; // 0x1046 - 0x104A
   Vector m_vecThirdPersonViewPositionOverride; // 0x104C - 0x1058
   std::int32_t m_nHeavyAssaultSuitCooldownRemaining; // 0x1058 - 0x105C
   std::int32_t m_ArmorValue; // 0x105C - 0x1060
   QAngle m_angEyeAngles; // 0x1060 - 0x106C
   bool m_bInHostageRescueZone; // 0x1078 - 0x1079
   std::float_t m_fNextThinkPushAway; // 0x107C - 0x1080
   ...
   std::int32_t m_nLastConcurrentKilled; // 0x1088 - 0x108C
   std::int32_t m_nDeathCamMusic; // 0x108C - 0x1090
   ...
   std::float_t m_flCurrentMusicStartTime; // 0x111C - 0x1120
   std::float_t m_flMusicRoundStartTime; // 0x1120 - 0x1124
   std::int32_t m_cycleLatch; // 0x1124 - 0x1128
   std::float_t m_serverIntendedCycle; // 0x1128 - 0x112C
   ...
   std::float_t m_nextTaserShakeTime; // 0x1144 - 0x1148
   std::float_t m_firstTaserShakeTime; // 0x1148 - 0x114C
   std::float_t m_flLastSmokeOverlayAlpha; // 0x114C - 0x1150
   Vector m_vLastSmokeOverlayColor; // 0x1150 - 0x115C
   ParticleIndex_t m_nPlayerSmokedFx; // 0x115C - 0x1160
   std::float_t m_flLastKnownAccumulatedWeaponEncumbrance; // 0x1160 - 0x1164
   std::float_t m_flLastTimeComputedAccumulatedWeaponEncumbrance; // 0x1164 - 0x1168
   std::float_t m_flNextMagDropTime; // 0x1168 - 0x116C
   std::int32_t m_nLastMagDropAttachmentIndex; // 0x116C - 0x1170
   ...
   std::float_t m_flLastNearbyItemHighlightCheck; // 0x11AC - 0x11B0
   ...
   std::float_t m_flTimeOfLastInjury; // 0x1200 - 0x1204
   RelativeDamagedDirection_t m_nRelativeDirectionOfLastInjury; // 0x1204 - 0x1208
   std::int32_t m_nSurvivalTeamNumber; // 0x1208 - 0x120C
   std::float_t m_flNextSprayDecalTime; // 0x120C - 0x1210
   bool m_bPreviouslyInBuyZone; // 0x1210 - 0x1211
   std::uint32_t m_unPreviousWeaponHash; // 0x1214 - 0x1218
   std::uint32_t m_unWeaponHash; // 0x1218 - 0x121C
   bool m_bPrevDefuser; // 0x121C - 0x121D
   bool m_bPrevHelmet; // 0x121D - 0x121E
   std::int32_t m_nPrevArmorVal; // 0x1220 - 0x1224
   ...
   std::int32_t m_aimPunchTickBase; // 0x1240 - 0x1244
   std::float_t m_aimPunchTickFraction; // 0x1244 - 0x1248
   CUtlVector< QAngle > m_aimPunchCache; // 0x1248 - 0x1260
   std::float_t m_flOldFallVelocity; // 0x1268 - 0x126C
   bool m_bHasDeathInfo; // 0x126C - 0x126D
   std::float_t m_flDeathInfoTime; // 0x1270 - 0x1274
   ...
   std::float_t m_flLandseconds; // 0x1298 - 0x129C
...
public:
   ...
   std::int32_t m_iPriority; // 0x4A0 - 0x4A4
   bool m_bEnabled; // 0x4A4 - 0x4A5
   std::int32_t m_nType; // 0x4A8 - 0x4AC
...
public:
   ...
   std::int32_t m_iOpvarIndex; // 0x530 - 0x534
...
public:
   ...
   std::float_t m_flZFar; // 0x538 - 0x53C
   std::float_t m_flZNear; // 0x53C - 0x540
   bool m_bLoop; // 0x540 - 0x541
   bool m_bVerticalFOV; // 0x541 - 0x542
   bool m_bConstantSpeed; // 0x542 - 0x543
   std::float_t m_flDuration; // 0x544 - 0x548
   std::float_t m_flPathLength; // 0x588 - 0x58C
   std::float_t m_flPathDuration; // 0x58C - 0x590
...
public:
   ...
   std::int32_t m_iOpvarIndex; // 0x550 - 0x554
...
public:
   ...
   std::float_t m_flRadius; // 0x4C8 - 0x4CC
   ...
   std::int32_t m_soundscapeIndex; // 0x4E4 - 0x4E8
   std::int32_t m_soundscapeEntityListId; // 0x4E8 - 0x4EC
   std::uint32_t m_soundEventHash; // 0x4EC - 0x4F0
...
public:
   ...
   std::int32_t m_nQuestPhase; // 0x88 - 0x8C
...
public:
   ...
   std::int32_t m_nInputMin; // 0x1F4 - 0x1F8
   std::int32_t m_nInputMax; // 0x1F8 - 0x1FC
   std::int32_t m_nScaleControlPoint; // 0x1FC - 0x200
   std::int32_t m_nScaleControlPointField; // 0x200 - 0x204
   std::float_t m_flOutputMin; // 0x204 - 0x208
   std::float_t m_flOutputMax; // 0x208 - 0x20C
   ...
   std::float_t m_flRemapBias; // 0x214 - 0x218
...
public:
   ...
   std::int32_t m_iInitialGlowState; // 0xBCC - 0xBD0
   std::int32_t m_nGlowRange; // 0xBD0 - 0xBD4
   std::int32_t m_nGlowRangeMin; // 0xBD4 - 0xBD8
   Color m_glowColor; // 0xBD8 - 0xBDC
   std::int32_t m_nGlowTeam; // 0xBDC - 0xBE0
   std::int32_t m_iCachedFrameCount; // 0xBE0 - 0xBE4
...
public:
   ...
   std::float_t m_flAutoReturnDelay; // 0xAA8 - 0xAAC
   CUtlVector< CHandle< CBasePropDoor > > m_hDoorList; // 0xAB0 - 0xAC8
   std::int32_t m_nHardwareType; // 0xAC8 - 0xACC
   ...
   std::uint32_t m_sndParamAngularSpeed; // 0xB34 - 0xB38
   ...
   std::int32_t m_numCloseAttempts; // 0xB80 - 0xB84
...
public:
   ...
   std::float_t m_flBumpStrength; // 0xE28 - 0xE2C
   ...
   std::float_t m_flAnimationRate; // 0xE48 - 0xE4C
   ...
   std::int32_t m_nLightingControlPoint; // 0x10C8 - 0x10CC
   ...
   std::int32_t m_nHSVShiftControlPoint; // 0x1480 - 0x1484
   ...
   std::int32_t m_nRefractBlurRadius; // 0x1980 - 0x1984
   ...
   std::float_t m_flDepthBias; // 0x1E40 - 0x1E44
...
public:
   ...
   std::uint32_t m_iHideHUD; // 0x9D4 - 0x9D8
   ...
   std::float_t m_fHltvReplayDelay; // 0xA90 - 0xA94
   std::float_t m_fHltvReplayEnd; // 0xA94 - 0xA98
...
public:
   ...
   std::int32_t m_nEmitterIndex; // 0x1E8 - 0x1EC
...
public:
   ...
   std::float_t m_flSpriteFramerate; // 0x700 - 0x704
   std::float_t m_flFrame; // 0x704 - 0x708
   GameTime_t m_flDieTime; // 0x708 - 0x70C
   std::uint32_t m_nBrightness; // 0x718 - 0x71C
   std::float_t m_flBrightnessDuration; // 0x71C - 0x720
   std::float_t m_flSpriteScale; // 0x720 - 0x724
   std::float_t m_flScaleDuration; // 0x724 - 0x728
   bool m_bWorldSpaceScale; // 0x728 - 0x729
   std::float_t m_flGlowProxySize; // 0x72C - 0x730
   std::float_t m_flHDRColorScale; // 0x730 - 0x734
   GameTime_t m_flLastTime; // 0x734 - 0x738
   std::float_t m_flMaxFrame; // 0x738 - 0x73C
   std::float_t m_flStartScale; // 0x73C - 0x740
   std::float_t m_flDestScale; // 0x740 - 0x744
   GameTime_t m_flScaleTimeStart; // 0x744 - 0x748
   std::int32_t m_nStartBrightness; // 0x748 - 0x74C
   std::int32_t m_nDestBrightness; // 0x74C - 0x750
   GameTime_t m_flBrightnessTimeStart; // 0x750 - 0x754
   std::int32_t m_nSpriteWidth; // 0x754 - 0x758
   std::int32_t m_nSpriteHeight; // 0x758 - 0x75C
...
public:
   ...
   std::float_t m_flTrajectoryTrailEffectCreationTime; // 0xBF8 - 0xBFC
...
public:
   ...
   std::float_t m_flDofNearBlurry; // 0x59C - 0x5A0
   std::float_t m_flDofNearCrisp; // 0x5A0 - 0x5A4
   std::float_t m_flDofFarCrisp; // 0x5A4 - 0x5A8
   std::float_t m_flDofFarBlurry; // 0x5A8 - 0x5AC
   std::float_t m_flDofTiltToGround; // 0x5AC - 0x5B0
...
public:
   ...
   std::int32_t m_iRetakesOffering; // 0x1388 - 0x138C
   std::int32_t m_iRetakesOfferingCard; // 0x138C - 0x1390
   bool m_bRetakesHasDefuseKit; // 0x1390 - 0x1391
   bool m_bRetakesMVPLastRound; // 0x1391 - 0x1392
   std::int32_t m_iRetakesMVPBoostItem; // 0x1394 - 0x1398
   ...
   std::int32_t m_nRagdollDamageBone; // 0x17FC - 0x1800
...
public:
   ...
   std::uint32_t m_nCollisionAttributeIndex; // 0x0 - 0x4
   std::uint32_t m_nSurfacePropertyIndex; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_nState; // 0x890 - 0x894
...
public:
   ...
   std::float_t m_flDistanceMin; // 0x5CC - 0x5D0
   std::float_t m_flDistanceMax; // 0x5D0 - 0x5D4
   std::float_t m_flDistanceMapMin; // 0x5D4 - 0x5D8
   std::float_t m_flDistanceMapMax; // 0x5D8 - 0x5DC
   std::float_t m_flOcclusionRadius; // 0x5DC - 0x5E0
   std::float_t m_flOcclusionMin; // 0x5E0 - 0x5E4
   std::float_t m_flOcclusionMax; // 0x5E4 - 0x5E8
   std::float_t m_flValSetOnDisable; // 0x5E8 - 0x5EC
   bool m_bSetValueOnDisable; // 0x5EC - 0x5ED
   std::int32_t m_nSimulationMode; // 0x5F0 - 0x5F4
   std::int32_t m_nVisibilitySamples; // 0x5F4 - 0x5F8
   Vector m_vDynamicProxyPoint; // 0x5F8 - 0x604
   std::float_t m_flDynamicMaximumOcclusion; // 0x604 - 0x608
   CEntityHandle m_hDynamicEntity; // 0x608 - 0x60C
   CUtlSymbolLarge m_iszDynamicEntityName; // 0x610 - 0x618
   std::float_t m_flPathingDistanceNormFactor; // 0x618 - 0x61C
...
public:
   ...
   std::float_t m_flTimingBlend; // 0x7C - 0x80
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F0 - 0x1F4
   std::float_t m_flDegrees; // 0x1F4 - 0x1F8
   std::float_t m_flDegreesMin; // 0x1F8 - 0x1FC
   std::float_t m_flDegreesMax; // 0x1FC - 0x200
   std::float_t m_flRotationRandExponent; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_skyObstructionScale; // 0x28 - 0x2C
   CGlowSprite m_Sprites[4]; // 0x30 - 0xB0
   std::int32_t m_nSprites; // 0xB0 - 0xB4
   std::float_t m_flProxyRadius; // 0xB4 - 0xB8
   std::float_t m_flHDRColorScale; // 0xB8 - 0xBC
   std::float_t m_flGlowObstructionScale; // 0xBC - 0xC0
   bool m_bCacheGlowObstruction; // 0xC0 - 0xC1
   bool m_bCacheSkyObstruction; // 0xC1 - 0xC2
   std::int16_t m_bActivated; // 0xC2 - 0xC4
   std::uint16_t m_ListIndex; // 0xC4 - 0xC6
   std::int32_t m_queryHandle; // 0xC8 - 0xCC
...
public:
   ...
   std::float_t m_flLiteralValue; // 0x8 - 0xC
   CKV3MemberNameWithStorage m_NamedValue; // 0x10 - 0x48
   std::int32_t m_nControlPoint; // 0x48 - 0x4C
   ParticleAttributeIndex_t m_nScalarAttribute; // 0x4C - 0x50
   ParticleAttributeIndex_t m_nVectorAttribute; // 0x50 - 0x54
   std::int32_t m_nVectorComponent; // 0x54 - 0x58
   std::float_t m_flRandomMin; // 0x58 - 0x5C
   std::float_t m_flRandomMax; // 0x5C - 0x60
   bool m_bHasRandomSignFlip; // 0x60 - 0x61
   ParticleFloatRandomMode_t m_nRandomMode; // 0x64 - 0x68
   std::float_t m_flLOD0; // 0x6C - 0x70
   std::float_t m_flLOD1; // 0x70 - 0x74
   std::float_t m_flLOD2; // 0x74 - 0x78
   std::float_t m_flLOD3; // 0x78 - 0x7C
   ParticleAttributeIndex_t m_nNoiseInputVectorAttribute; // 0x7C - 0x80
   std::float_t m_flNoiseOutputMin; // 0x80 - 0x84
   std::float_t m_flNoiseOutputMax; // 0x84 - 0x88
   std::float_t m_flNoiseScale; // 0x88 - 0x8C
   Vector m_vecNoiseOffsetRate; // 0x8C - 0x98
   std::float_t m_flNoiseOffset; // 0x98 - 0x9C
   std::int32_t m_nNoiseOctaves; // 0x9C - 0xA0
   ...
   std::float_t m_flNoiseTurbulenceScale; // 0xAC - 0xB0
   std::float_t m_flNoiseTurbulenceMix; // 0xB0 - 0xB4
   std::float_t m_flNoiseImgPreviewScale; // 0xB4 - 0xB8
   bool m_bNoiseImgPreviewLive; // 0xB8 - 0xB9
   ParticleFloatInputMode_t m_nInputMode; // 0xC0 - 0xC4
   std::float_t m_flMultFactor; // 0xC4 - 0xC8
   std::float_t m_flInput0; // 0xC8 - 0xCC
   std::float_t m_flInput1; // 0xCC - 0xD0
   std::float_t m_flOutput0; // 0xD0 - 0xD4
   std::float_t m_flOutput1; // 0xD4 - 0xD8
   std::float_t m_flNotchedRangeMin; // 0xD8 - 0xDC
   std::float_t m_flNotchedRangeMax; // 0xDC - 0xE0
   std::float_t m_flNotchedOutputOutside; // 0xE0 - 0xE4
   std::float_t m_flNotchedOutputInside; // 0xE4 - 0xE8
   ParticleFloatBiasType_t m_nBiasType; // 0xE8 - 0xEC
   std::float_t m_flBiasParameter; // 0xEC - 0xF0
...
public:
   ...
   std::float_t m_flDampingOriginalSpeed; // 0xB48 - 0xB4C
   std::float_t m_flDampingOriginalRot; // 0xB4C - 0xB50
...
public:
   ...
   std::int32_t m_Score; // 0x6F8 - 0x6FC
...
public:
   ...
   std::float_t m_flSavedElapsedTime; // 0x4A8 - 0x4AC
   CUtlSymbolLarge m_iszSourceEntityName; // 0x4B0 - 0x4B8
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldInput; // 0x244 - 0x248
   ParticleAttributeIndex_t m_nFieldOutput; // 0x248 - 0x24C
   std::float_t m_flRemapTime; // 0x24C - 0x250
...
public:
   ...
   std::float_t m_flWidth; // 0xA4C - 0xA50
   std::float_t m_flHeight; // 0xA50 - 0xA54
   std::float_t m_flDPI; // 0xA54 - 0xA58
   std::float_t m_flInteractDistance; // 0xA58 - 0xA5C
   std::float_t m_flDepthOffset; // 0xA5C - 0xA60
   std::uint32_t m_unOwnerContext; // 0xA60 - 0xA64
   std::uint32_t m_unHorizontalAlign; // 0xA64 - 0xA68
   std::uint32_t m_unVerticalAlign; // 0xA68 - 0xA6C
   std::uint32_t m_unOrientation; // 0xA6C - 0xA70
   ...
   std::int32_t m_nExplicitImageLayout; // 0xA98 - 0xA9C
...
public:
   ...
   std::float_t m_flSpriteFramerate; // 0x860 - 0x864
   std::float_t m_flFrame; // 0x864 - 0x868
   GameTime_t m_flDieTime; // 0x868 - 0x86C
   std::uint32_t m_nBrightness; // 0x878 - 0x87C
   std::float_t m_flBrightnessDuration; // 0x87C - 0x880
   std::float_t m_flSpriteScale; // 0x880 - 0x884
   std::float_t m_flScaleDuration; // 0x884 - 0x888
   bool m_bWorldSpaceScale; // 0x888 - 0x889
   std::float_t m_flGlowProxySize; // 0x88C - 0x890
   std::float_t m_flHDRColorScale; // 0x890 - 0x894
   GameTime_t m_flLastTime; // 0x894 - 0x898
   std::float_t m_flMaxFrame; // 0x898 - 0x89C
   std::float_t m_flStartScale; // 0x89C - 0x8A0
   std::float_t m_flDestScale; // 0x8A0 - 0x8A4
   GameTime_t m_flScaleTimeStart; // 0x8A4 - 0x8A8
   std::int32_t m_nStartBrightness; // 0x8A8 - 0x8AC
   std::int32_t m_nDestBrightness; // 0x8AC - 0x8B0
   GameTime_t m_flBrightnessTimeStart; // 0x8B0 - 0x8B4
   CWeakHandle< InfoForResourceTypeIMaterial2 > m_hOldSpriteMaterial; // 0x8B8 - 0x8C0
   std::int32_t m_nSpriteWidth; // 0x960 - 0x964
   std::int32_t m_nSpriteHeight; // 0x964 - 0x968
...
public:
   ...
   std::int32_t m_voicePitch; // 0x44 - 0x48
   ...
   std::int32_t m_nLastSpokenPriority; // 0x50 - 0x54
...
public:
   ...
   std::uint32_t m_nViewModelIndex; // 0x834 - 0x838
   std::uint32_t m_nAnimationParity; // 0x838 - 0x83C
   std::float_t m_flAnimationStartTime; // 0x83C - 0x840
   ...
   std::int32_t m_oldLayer; // 0x85C - 0x860
   std::float_t m_oldLayerStartTime; // 0x860 - 0x864
...
public:
   ...
   std::float_t m_flDistanceMax; // 0x730 - 0x734
   bool m_bDisabled; // 0x734 - 0x735
   std::int32_t m_nMinCountAll; // 0x738 - 0x73C
   std::int32_t m_nMaxCountAll; // 0x73C - 0x740
   std::int32_t m_nMinFactorAll; // 0x740 - 0x744
   std::int32_t m_nMaxFactorAll; // 0x744 - 0x748
   CUtlSymbolLarge m_iszNPCClassname_1; // 0x750 - 0x758
   std::int32_t m_nNPCState_1; // 0x758 - 0x75C
   bool m_bInvertState_1; // 0x75C - 0x75D
   std::int32_t m_nMinCount_1; // 0x760 - 0x764
   std::int32_t m_nMaxCount_1; // 0x764 - 0x768
   std::int32_t m_nMinFactor_1; // 0x768 - 0x76C
   std::int32_t m_nMaxFactor_1; // 0x76C - 0x770
   std::float_t m_flDefaultDist_1; // 0x774 - 0x778
   CUtlSymbolLarge m_iszNPCClassname_2; // 0x778 - 0x780
   std::int32_t m_nNPCState_2; // 0x780 - 0x784
   bool m_bInvertState_2; // 0x784 - 0x785
   std::int32_t m_nMinCount_2; // 0x788 - 0x78C
   std::int32_t m_nMaxCount_2; // 0x78C - 0x790
   std::int32_t m_nMinFactor_2; // 0x790 - 0x794
   std::int32_t m_nMaxFactor_2; // 0x794 - 0x798
   std::float_t m_flDefaultDist_2; // 0x79C - 0x7A0
   CUtlSymbolLarge m_iszNPCClassname_3; // 0x7A0 - 0x7A8
   std::int32_t m_nNPCState_3; // 0x7A8 - 0x7AC
   bool m_bInvertState_3; // 0x7AC - 0x7AD
   std::int32_t m_nMinCount_3; // 0x7B0 - 0x7B4
   std::int32_t m_nMaxCount_3; // 0x7B4 - 0x7B8
   std::int32_t m_nMinFactor_3; // 0x7B8 - 0x7BC
   std::int32_t m_nMaxFactor_3; // 0x7BC - 0x7C0
   std::float_t m_flDefaultDist_3; // 0x7C4 - 0x7C8
...
public:
   ...
   std::int32_t m_nImpulse; // 0x40 - 0x44
   CInButtonState m_nButtons; // 0x48 - 0x68
   std::uint64_t m_nQueuedButtonDownMask; // 0x68 - 0x70
   std::uint64_t m_nQueuedButtonChangeMask; // 0x70 - 0x78
   std::uint64_t m_nButtonDoublePressed; // 0x78 - 0x80
   uint32 m_pButtonPressedCmdNumber[64]; // 0x80 - 0x180
   std::uint32_t m_nLastCommandNumberProcessed; // 0x180 - 0x184
   std::uint64_t m_nToggleButtonDownMask; // 0x188 - 0x190
   std::float_t m_flMaxspeed; // 0x190 - 0x194
   std::float_t m_flForceSubtickMoveWhen; // 0x194 - 0x198
   std::float_t m_flForwardMove; // 0x198 - 0x19C
   std::float_t m_flLeftMove; // 0x19C - 0x1A0
   std::float_t m_flUpMove; // 0x1A0 - 0x1A4
...
public:
   ...
   std::float_t m_flDistance; // 0xD34 - 0xD38
   ...
   std::float_t m_flAjarAngle; // 0xD44 - 0xD48
...
public:
   ...
   std::uint32_t m_nViewModelIndex; // 0x9AC - 0x9B0
   std::uint32_t m_nAnimationParity; // 0x9B0 - 0x9B4
   std::float_t m_flAnimationStartTime; // 0x9B4 - 0x9B8
   ...
   std::float_t m_previousElapsedDuration; // 0x9E4 - 0x9E8
   std::float_t m_previousCycle; // 0x9E8 - 0x9EC
   std::int32_t m_nOldAnimationParity; // 0x9EC - 0x9F0
   HSequence m_hOldLayerSequence; // 0x9F0 - 0x9F4
   std::int32_t m_oldLayer; // 0x9F4 - 0x9F8
   std::float_t m_oldLayerStartTime; // 0x9F8 - 0x9FC
...
public:
   ...
   std::uint32_t m_nSceneObjectIndex; // 0x0 - 0x4
...
public:
   ...
   bool m_bEnabled; // 0x6F0 - 0x6F1
   std::int32_t m_nColorMode; // 0x6F4 - 0x6F8
   Color m_Color; // 0x6F8 - 0x6FC
   std::float_t m_flColorTemperature; // 0x6FC - 0x700
   std::float_t m_flBrightness; // 0x700 - 0x704
   std::float_t m_flBrightnessScale; // 0x704 - 0x708
   std::int32_t m_nDirectLight; // 0x708 - 0x70C
   std::int32_t m_nBakedShadowIndex; // 0x70C - 0x710
   std::int32_t m_nLuminaireShape; // 0x710 - 0x714
   std::float_t m_flLuminaireSize; // 0x714 - 0x718
   std::float_t m_flLuminaireAnisotropy; // 0x718 - 0x71C
   ...
   std::float_t m_flShape; // 0x850 - 0x854
   std::float_t m_flSoftX; // 0x854 - 0x858
   std::float_t m_flSoftY; // 0x858 - 0x85C
   std::float_t m_flSkirt; // 0x85C - 0x860
   std::float_t m_flSkirtNear; // 0x860 - 0x864
   Vector m_vSizeParams; // 0x864 - 0x870
   std::float_t m_flRange; // 0x870 - 0x874
   Vector m_vShear; // 0x874 - 0x880
   std::int32_t m_nBakeSpecularToCubemaps; // 0x880 - 0x884
   Vector m_vBakeSpecularToCubemapsSize; // 0x884 - 0x890
   std::int32_t m_nCastShadows; // 0x890 - 0x894
   std::int32_t m_nShadowMapSize; // 0x894 - 0x898
   std::int32_t m_nShadowPriority; // 0x898 - 0x89C
   bool m_bContactShadow; // 0x89C - 0x89D
   std::int32_t m_nBounceLight; // 0x8A0 - 0x8A4
   std::float_t m_flBounceScale; // 0x8A4 - 0x8A8
   std::float_t m_flMinRoughness; // 0x8A8 - 0x8AC
   std::int32_t m_nFog; // 0x8AC - 0x8B0
   std::float_t m_flFogStrength; // 0x8B0 - 0x8B4
   std::int32_t m_nFogShadows; // 0x8B4 - 0x8B8
   std::float_t m_flFogScale; // 0x8B8 - 0x8BC
   std::float_t m_flFadeSizeStart; // 0x8BC - 0x8C0
   std::float_t m_flFadeSizeEnd; // 0x8C0 - 0x8C4
   std::float_t m_flShadowFadeSizeStart; // 0x8C4 - 0x8C8
   std::float_t m_flShadowFadeSizeEnd; // 0x8C8 - 0x8CC
...
public:
   ...
   std::float_t m_flBlockDamage; // 0x7C0 - 0x7C4
...
public:
   ...
   std::float_t m_flFrameRate; // 0x6F0 - 0x6F4
   std::float_t m_flHDRColorScale; // 0x6F4 - 0x6F8
   GameTime_t m_flFireTime; // 0x6F8 - 0x6FC
   std::float_t m_flDamage; // 0x6FC - 0x700
   std::uint8_t m_nNumBeamEnts; // 0x700 - 0x701
   ...
   std::uint32_t m_nBeamFlags; // 0x71C - 0x720
   CHandle< CBaseEntity > m_hAttachEntity[10]; // 0x720 - 0x748
   AttachmentHandle_t m_nAttachIndex[10]; // 0x748 - 0x752
   std::float_t m_fWidth; // 0x754 - 0x758
   std::float_t m_fEndWidth; // 0x758 - 0x75C
   std::float_t m_fFadeLength; // 0x75C - 0x760
   std::float_t m_fHaloScale; // 0x760 - 0x764
   std::float_t m_fAmplitude; // 0x764 - 0x768
   std::float_t m_fStartFrame; // 0x768 - 0x76C
   std::float_t m_fSpeed; // 0x76C - 0x770
   std::float_t m_flFrame; // 0x770 - 0x774
   ...
   std::int32_t m_nDissolveType; // 0x78C - 0x790
...
public:
   ...
   std::float_t m_flCustomDuration; // 0x2C - 0x30
...
public:
   ...
   std::float_t m_flPressureDelay; // 0x718 - 0x71C
   std::int32_t m_iMinHealthDmg; // 0x71C - 0x720
   CUtlSymbolLarge m_iszPropData; // 0x720 - 0x728
   std::float_t m_impactEnergyScale; // 0x728 - 0x72C
   ...
   std::float_t m_flDmgModBullet; // 0x780 - 0x784
   std::float_t m_flDmgModClub; // 0x784 - 0x788
   std::float_t m_flDmgModExplosive; // 0x788 - 0x78C
   std::float_t m_flDmgModFire; // 0x78C - 0x790
   CUtlSymbolLarge m_iszPhysicsDamageTableName; // 0x790 - 0x798
   CUtlSymbolLarge m_iszBasePropData; // 0x798 - 0x7A0
   std::int32_t m_iInteractions; // 0x7A0 - 0x7A4
...
public:
   ...
   std::uint32_t m_iDisplayHistoryBits; // 0xAE0 - 0xAE4
   std::float_t m_flLastAttackedTeammate; // 0xAE4 - 0xAE8
   ...
   std::int32_t m_nSpotRules; // 0xB10 - 0xB14
   std::float_t m_flTimeOfLastInjury; // 0xB14 - 0xB18
   ...
   std::float_t m_flLastDistanceTraveledNotice; // 0xC04 - 0xC08
   std::float_t m_flAccumulatedDistanceTraveled; // 0xC08 - 0xC0C
   std::float_t m_flLastFriendlyFireDamageReductionRatio; // 0xC0C - 0xC10
   bool m_bRespawning; // 0xC10 - 0xC11
   std::int32_t m_iNumGunGameTRBombTotalPoints; // 0xC14 - 0xC18
   bool m_bShouldProgressGunGameTRBombModeWeapon; // 0xC18 - 0xC19
   std::int32_t m_nLastPickupPriority; // 0xC1C - 0xC20
   std::float_t m_flLastPickupPriorityTime; // 0xC20 - 0xC24
   ...
   std::int32_t m_iGunGameProgressiveWeaponIndex; // 0xC3C - 0xC40
   std::int32_t m_iNumGunGameTRKillPoints; // 0xC40 - 0xC44
   std::int32_t m_iNumGunGameKillsWithCurrentWeapon; // 0xC44 - 0xC48
   std::uint32_t m_unTotalRoundDamageDealt; // 0xC48 - 0xC4C
   std::float_t m_fMolotovDamageTime; // 0xC4C - 0xC50
   ...
   std::float_t m_flGuardianTooFarDistFrac; // 0xC54 - 0xC58
   std::float_t m_flNextGuardianTooFarHurtTime; // 0xC58 - 0xC5C
   ...
   std::int32_t m_nSurvivalTeam; // 0xC70 - 0xC74
   CHandle< CCSPlayerPawnBase > m_hSurvivalAssassinationTarget; // 0xC74 - 0xC78
   std::int32_t m_nCompletedSurvivalAssassinations; // 0xC78 - 0xC7C
   std::float_t m_flDealtDamageToEnemyMostRecentTimestamp; // 0xC7C - 0xC80
   std::float_t m_flHealthShotBoostExpirationTime; // 0xC80 - 0xC84
   GameTime_t m_flLastEquippedHelmetTime; // 0xC84 - 0xC88
   GameTime_t m_flLastEquippedArmorTime; // 0xC88 - 0xC8C
   std::int32_t m_nHeavyAssaultSuitCooldownRemaining; // 0xC8C - 0xC90
   bool m_bResetArmorNextSpawn; // 0xC90 - 0xC91
   std::float_t m_flLastExoJumpTime; // 0xC94 - 0xC98
   GameTime_t m_flLastBumpMineBumpTime; // 0xC98 - 0xC9C
   bool m_bEscaped; // 0xCA8 - 0xCA9
   bool m_bIsVIP; // 0xCA9 - 0xCAA
   std::int32_t m_iNumSpawns; // 0xCAC - 0xCB0
   std::int32_t m_iShouldHaveCash; // 0xCB0 - 0xCB4
   bool m_bJustKilledTeammate; // 0xCB4 - 0xCB5
   bool m_bPunishedForTK; // 0xCB5 - 0xCB6
   bool m_bInvalidSteamLogonDelayed; // 0xCB6 - 0xCB7
   std::int32_t m_iTeamKills; // 0xCB8 - 0xCBC
   GameTime_t m_flLastAction; // 0xCBC - 0xCC0
   float32 m_flNameChangeHistory[5]; // 0xCC0 - 0xCD4
   std::float_t m_fLastGivenDefuserTime; // 0xCD4 - 0xCD8
   std::float_t m_fLastGivenBombTime; // 0xCD8 - 0xCDC
   bool m_bHasNightVision; // 0xCDC - 0xCDD
   bool m_bNightVisionOn; // 0xCDD - 0xCDE
   std::float_t m_fNextRadarUpdateTime; // 0xCE0 - 0xCE4
   std::float_t m_flLastMoneyUpdateTime; // 0xCE4 - 0xCE8
   char m_MenuStringBuffer[1024]; // 0xCE8 - 0x10E8
   CHandle< CBaseEntity > m_pIntroCamera; // 0x10E8 - 0x10EC
   std::float_t m_fIntroCamTime; // 0x10EC - 0x10F0
   std::int32_t m_nMyCollisionGroup; // 0x10F0 - 0x10F4
   ...
   std::int32_t m_iMoveState; // 0x10F8 - 0x10FC
   ...
   std::uint16_t m_nCharacterDefIndex; // 0x117C - 0x117E
   bool m_bDiedAirborne; // 0x117E - 0x117F
   CEntityIndex m_iBombSiteIndex; // 0x1180 - 0x1184
   std::int32_t m_nWhichBombZone; // 0x1184 - 0x1188
   ...
   std::float_t m_flStamina; // 0x1190 - 0x1194
   std::int32_t m_iDirection; // 0x1194 - 0x1198
   std::int32_t m_iShotsFired; // 0x1198 - 0x119C
   std::int32_t m_ArmorValue; // 0x119C - 0x11A0
   std::float_t m_flFlinchStack; // 0x11A0 - 0x11A4
   std::float_t m_flVelocityModifier; // 0x11A4 - 0x11A8
   std::float_t m_flGroundAccelLinearFracLastTime; // 0x11A8 - 0x11AC
   std::int32_t m_iHostagesKilled; // 0x11AC - 0x11B0
   Vector m_vecTotalBulletForce; // 0x11B0 - 0x11BC
   std::float_t m_flFlashDuration; // 0x11BC - 0x11C0
   std::float_t m_flFlashMaxAlpha; // 0x11C0 - 0x11C4
   std::float_t m_flProgressBarStartTime; // 0x11C4 - 0x11C8
   std::int32_t m_iProgressBarDuration; // 0x11C8 - 0x11CC
   bool m_bWaitForNoAttack; // 0x11CC - 0x11CD
   bool m_bIsRespawningForDMBonus; // 0x11CD - 0x11CE
   std::float_t m_flLowerBodyYawTarget; // 0x11D0 - 0x11D4
   bool m_bStrafing; // 0x11D4 - 0x11D5
   Vector m_lastStandingPos; // 0x11D8 - 0x11E4
   std::float_t m_ignoreLadderJumpTime; // 0x11E4 - 0x11E8
   ...
   std::float_t m_flSlopeDropOffset; // 0x1224 - 0x1228
   std::float_t m_flSlopeDropHeight; // 0x1228 - 0x122C
   Vector m_vHeadConstraintOffset; // 0x122C - 0x1238
   std::int32_t m_iLastWeaponFireUsercmd; // 0x1240 - 0x1244
   ...
   std::int32_t m_nNumDangerZoneDamageHits; // 0x1270 - 0x1274
   ...
   std::int32_t m_nLastConcurrentKilled; // 0x127C - 0x1280
   std::int32_t m_nDeathCamMusic; // 0x1280 - 0x1284
   std::int32_t m_iAddonBits; // 0x1284 - 0x1288
   std::int32_t m_iPrimaryAddon; // 0x1288 - 0x128C
   std::int32_t m_iSecondaryAddon; // 0x128C - 0x1290
   std::int32_t m_nTeamDamageGivenForMatch; // 0x1290 - 0x1294
   bool m_bTDGaveProtectionWarning; // 0x1294 - 0x1295
   bool m_bTDGaveProtectionWarningThisRound; // 0x1295 - 0x1296
   std::float_t m_applyDeafnessTime; // 0x1298 - 0x129C
   std::float_t m_flLastTHWarningTime; // 0x129C - 0x12A0
   ...
   std::int32_t m_NumEnemiesKilledThisSpawn; // 0x12C0 - 0x12C4
   std::int32_t m_maxNumEnemiesKillStreak; // 0x12C4 - 0x12C8
   std::int32_t m_NumEnemiesKilledThisRound; // 0x12C8 - 0x12CC
   std::int32_t m_NumEnemiesAtRoundStart; // 0x12CC - 0x12D0
   std::int32_t m_iRoundsWon; // 0x12D0 - 0x12D4
   bool m_bHasUsedDMBonusRespawn; // 0x12D4 - 0x12D5
   std::int32_t m_lastRoundResult; // 0x12D8 - 0x12DC
   bool m_wasNotKilledNaturally; // 0x12DC - 0x12DD
   uint32 m_vecPlayerPatchEconIndices[5]; // 0x12E0 - 0x12F4
   std::int32_t m_iDeathFlags; // 0x12F4 - 0x12F8
   CHandle< CChicken > m_hPet; // 0x12F8 - 0x12FC
   std::float_t m_flLastKnownAccumulatedWeaponEncumbrance; // 0x12FC - 0x1300
   std::float_t m_flLastTimeComputedAccumulatedWeaponEncumbrance; // 0x1300 - 0x1304
   std::uint16_t m_unCurrentEquipmentValue; // 0x14D0 - 0x14D2
   std::uint16_t m_unRoundStartEquipmentValue; // 0x14D2 - 0x14D4
   std::uint16_t m_unFreezetimeEndEquipmentValue; // 0x14D4 - 0x14D6
   char m_szLastPlaceName[18]; // 0x14D6 - 0x14E8
   std::int32_t m_nSuicides; // 0x14E8 - 0x14EC
   std::int32_t m_nSurvivalTeamNumber; // 0x14EC - 0x14F0
   QAngle m_aimPunchAngle; // 0x14F0 - 0x14FC
   QAngle m_aimPunchAngleVel; // 0x14FC - 0x1508
   std::int32_t m_aimPunchTickBase; // 0x1508 - 0x150C
   std::float_t m_aimPunchTickFraction; // 0x150C - 0x1510
   CUtlVector< QAngle > m_aimPunchCache; // 0x1510 - 0x1528
   bool m_bHasDeathInfo; // 0x1528 - 0x1529
   std::float_t m_flDeathInfoTime; // 0x152C - 0x1530
   Vector m_vecDeathInfoOrigin; // 0x1530 - 0x153C
   bool m_bKilledByHeadshot; // 0x153C - 0x153D
   std::int32_t m_LastHitBox; // 0x1540 - 0x1544
   std::int32_t m_LastHealth; // 0x1544 - 0x1548
   std::float_t m_flLastCollisionCeiling; // 0x1548 - 0x154C
   std::float_t m_flLastCollisionCeilingChangeTime; // 0x154C - 0x1550
   CUtlString m_strVOPrefix; // 0x1550 - 0x1558
   std::float_t m_flLandseconds; // 0x1558 - 0x155C
...
public:
   ...
   std::int32_t m_iDisabled; // 0x6F4 - 0x6F8
...
public:
   ...
   std::float_t m_flBlockDamage; // 0x7A8 - 0x7AC
   std::float_t m_flStartPosition; // 0x7AC - 0x7B0
   std::float_t m_flMoveDistance; // 0x7B0 - 0x7B4
...
public:
   ...
   std::int32_t m_nSpinRateDegrees; // 0x1F0 - 0x1F4
   std::int32_t m_nSpinRateMinDegrees; // 0x1F4 - 0x1F8
   std::float_t m_fSpinRateStopTime; // 0x1FC - 0x200
...
public:
   ...
   std::int32_t m_nControlPoint; // 0x64 - 0x68
   ...
   std::float_t m_flInterpInput0; // 0x570 - 0x574
   std::float_t m_flInterpInput1; // 0x574 - 0x578
...
public:
   ...
   std::float_t m_force; // 0x4B0 - 0x4B4
   std::float_t m_forceTime; // 0x4B4 - 0x4B8
...
public:
   ...
   std::float_t m_flWidth; // 0x8A4 - 0x8A8
   std::float_t m_flHeight; // 0x8A8 - 0x8AC
   std::float_t m_flDPI; // 0x8AC - 0x8B0
   std::float_t m_flInteractDistance; // 0x8B0 - 0x8B4
   std::float_t m_flDepthOffset; // 0x8B4 - 0x8B8
   std::uint32_t m_unOwnerContext; // 0x8B8 - 0x8BC
   std::uint32_t m_unHorizontalAlign; // 0x8BC - 0x8C0
   std::uint32_t m_unVerticalAlign; // 0x8C0 - 0x8C4
   std::uint32_t m_unOrientation; // 0x8C4 - 0x8C8
   ...
   std::int32_t m_nExplicitImageLayout; // 0x8F0 - 0x8F4
...
public:
   ...
   std::uint32_t m_lastUpdateTickCount; // 0x89C - 0x8A0
   ...
   std::float_t m_flBlendWeight; // 0x8EC - 0x8F0
   std::float_t m_flDefaultFadeScale; // 0x8F0 - 0x8F4
...
public:
   ...
   std::int32_t m_nLayerIndex; // 0x18 - 0x1C
   std::uint64_t m_nLayerId; // 0x20 - 0x28
...
public:
   ...
   std::float_t m_flForceClientTime; // 0x51C - 0x520
   std::float_t m_flCurrentTime; // 0x520 - 0x524
   std::float_t m_flFrameTime; // 0x524 - 0x528
   bool m_bCancelAtNextInterrupt; // 0x528 - 0x529
   std::float_t m_fPitch; // 0x52C - 0x530
   bool m_bAutomated; // 0x530 - 0x531
   std::int32_t m_nAutomatedAction; // 0x534 - 0x538
   std::float_t m_flAutomationDelay; // 0x538 - 0x53C
   std::float_t m_flAutomationTime; // 0x53C - 0x540
   ...
   std::int32_t m_nSceneFlushCounter; // 0x590 - 0x594
   std::uint16_t m_nSceneStringIndex; // 0x594 - 0x596
   ...
   std::int32_t m_nInterruptCount; // 0x974 - 0x978
   ...
   std::int32_t m_BusyActor; // 0x9EC - 0x9F0
...
public:
   ...
   std::float_t m_flOriginalDamage; // 0x898 - 0x89C
   std::float_t m_flDamage; // 0x89C - 0x8A0
   std::float_t m_flDamageCap; // 0x8A0 - 0x8A4
   GameTime_t m_flLastDmgTime; // 0x8A4 - 0x8A8
   std::float_t m_flForgivenessDelay; // 0x8A8 - 0x8AC
   std::int32_t m_bitsDamageInflict; // 0x8AC - 0x8B0
   std::int32_t m_damageModel; // 0x8B0 - 0x8B4
   bool m_bNoDmgForce; // 0x8B4 - 0x8B5
   Vector m_vDamageForce; // 0x8B8 - 0x8C4
   bool m_thinkAlways; // 0x8C4 - 0x8C5
   std::float_t m_hurtThinkPeriod; // 0x8C8 - 0x8CC
...
public:
   ...
   std::int32_t m_nColorMode; // 0x83C - 0x840
   Color m_Color; // 0x840 - 0x844
   std::float_t m_flColorTemperature; // 0x844 - 0x848
   std::float_t m_flBrightness; // 0x848 - 0x84C
   std::float_t m_flBrightnessScale; // 0x84C - 0x850
   std::int32_t m_nDirectLight; // 0x850 - 0x854
   std::int32_t m_nBakedShadowIndex; // 0x854 - 0x858
   std::int32_t m_nLuminaireShape; // 0x858 - 0x85C
   std::float_t m_flLuminaireSize; // 0x85C - 0x860
   std::float_t m_flLuminaireAnisotropy; // 0x860 - 0x864
   ...
   std::float_t m_flShape; // 0x968 - 0x96C
   std::float_t m_flSoftX; // 0x96C - 0x970
   std::float_t m_flSoftY; // 0x970 - 0x974
   std::float_t m_flSkirt; // 0x974 - 0x978
   std::float_t m_flSkirtNear; // 0x978 - 0x97C
   Vector m_vSizeParams; // 0x97C - 0x988
   std::float_t m_flRange; // 0x988 - 0x98C
   Vector m_vShear; // 0x98C - 0x998
   std::int32_t m_nBakeSpecularToCubemaps; // 0x998 - 0x99C
   Vector m_vBakeSpecularToCubemapsSize; // 0x99C - 0x9A8
   std::int32_t m_nCastShadows; // 0x9A8 - 0x9AC
   std::int32_t m_nShadowMapSize; // 0x9AC - 0x9B0
   std::int32_t m_nShadowPriority; // 0x9B0 - 0x9B4
   bool m_bContactShadow; // 0x9B4 - 0x9B5
   std::int32_t m_nBounceLight; // 0x9B8 - 0x9BC
   std::float_t m_flBounceScale; // 0x9BC - 0x9C0
   std::float_t m_flMinRoughness; // 0x9C0 - 0x9C4
   std::int32_t m_nFog; // 0x9C4 - 0x9C8
   std::float_t m_flFogStrength; // 0x9C8 - 0x9CC
   std::int32_t m_nFogShadows; // 0x9CC - 0x9D0
   std::float_t m_flFogScale; // 0x9D0 - 0x9D4
   std::float_t m_flFadeSizeStart; // 0x9D4 - 0x9D8
   std::float_t m_flFadeSizeEnd; // 0x9D8 - 0x9DC
   std::float_t m_flShadowFadeSizeStart; // 0x9DC - 0x9E0
   std::float_t m_flShadowFadeSizeEnd; // 0x9E0 - 0x9E4
...
public:
   ...
   std::float_t m_flInitialModelScale; // 0x19B8 - 0x19BC
...
public:
   ...
   std::int32_t m_nCP0; // 0x1F0 - 0x1F4
   std::int32_t m_nCP1; // 0x1F4 - 0x1F8
   std::float_t m_flMinInputValue; // 0x1F8 - 0x1FC
   std::float_t m_flMaxInputValue; // 0x1FC - 0x200
...
public:
   ...
   std::float_t m_flFreezeTransitionDuration; // 0xA3C - 0xA40
   std::int32_t m_nStopType; // 0xA40 - 0xA44
   ...
   std::float_t m_flPreSimTime; // 0xA54 - 0xA58
   ...
   std::int32_t m_nDataCP; // 0xD98 - 0xD9C
   Vector m_vecDataCPValue; // 0xD9C - 0xDA8
   std::int32_t m_nTintCP; // 0xDA8 - 0xDAC
...
public:
   ...
   std::int32_t m_nCurrentTick; // 0x30 - 0x34
   std::int32_t m_nCurrentTickThisFrame; // 0x34 - 0x38
   std::int32_t m_nTotalTicksThisFrame; // 0x38 - 0x3C
   std::int32_t m_nTotalTicks; // 0x3C - 0x40
...
public:
   ...
   std::int32_t m_nMaxCarry; // 0x10 - 0x14
   CRangeInt m_nSplashSize; // 0x1C - 0x24
   AmmoFlags_t m_nFlags; // 0x24 - 0x28
   std::float_t m_flMass; // 0x28 - 0x2C
...
public:
   ...
   std::float_t m_flRealTime; // 0x0 - 0x4
...
public:
   ...
   public:
      ...
      std::float_t flIn; // 0x0 - 0x4
      CUtlSymbolLarge iAttribHook; // 0x8 - 0x10
      std::float_t flOut; // 0x10 - 0x14
   ...
   std::int32_t m_iReapplyProvisionParity; // 0x20 - 0x24
...
public:
   ...
   std::float_t m_flScale; // 0x4A0 - 0x4A4
   std::float_t m_flStartScale; // 0x4A4 - 0x4A8
   std::float_t m_flScaleTime; // 0x4A8 - 0x4AC
   std::uint32_t m_nFlags; // 0x4AC - 0x4B0
...
public:
   ...
   std::int32_t m_nFinalPredictedTick; // 0x540 - 0x544
   C_CommandContext m_CommandContext; // 0x548 - 0x5C8
   std::uint64_t m_nInButtonsWhichAreToggles; // 0x5C8 - 0x5D0
   std::uint32_t m_nTickBase; // 0x5D0 - 0x5D4
   ...
   std::uint64_t m_steamID; // 0x690 - 0x698
   bool m_bIsLocalPlayerController; // 0x698 - 0x699
   std::uint32_t m_iDesiredFOV; // 0x69C - 0x6A0
...
public:
   ...
   std::uint64_t m_nInButtonsWhichAreToggles; // 0x4A8 - 0x4B0
   std::uint32_t m_nTickBase; // 0x4B0 - 0x4B4
   ...
   std::float_t m_fLerpTime; // 0x598 - 0x59C
   ...
   std::int32_t m_nHighestCommandNumberReceived; // 0x618 - 0x61C
   std::int64_t m_nUsecTimestampLastUserCmdReceived; // 0x620 - 0x628
   ChatIgnoreType_t m_iIgnoreGlobalChat; // 0x638 - 0x63C
   std::float_t m_flLastPlayerTalkTime; // 0x63C - 0x640
   std::float_t m_flLastEntitySteadyState; // 0x640 - 0x644
   std::int32_t m_nAvailableEntitySteadyState; // 0x644 - 0x648
   bool m_bHasAnySteadyStateEnts; // 0x648 - 0x649
   std::uint64_t m_steamID; // 0x658 - 0x660
   std::uint32_t m_iDesiredFOV; // 0x660 - 0x664
...
public:
   ...
   std::int32_t m_nNumBullets; // 0x10C - 0x110
   ...
   std::int32_t m_iMaxClip1; // 0x2DC - 0x2E0
   std::int32_t m_iMaxClip2; // 0x2E0 - 0x2E4
   std::int32_t m_iDefaultClip1; // 0x2E4 - 0x2E8
   std::int32_t m_iDefaultClip2; // 0x2E8 - 0x2EC
   std::int32_t m_iWeight; // 0x2EC - 0x2F0
   ...
   std::int32_t m_iSlot; // 0x318 - 0x31C
   std::int32_t m_iPosition; // 0x31C - 0x320
...
public:
   ...
   std::int32_t m_nOrientationControlPoint; // 0x2054 - 0x2058
   std::float_t m_flMinSize; // 0x2058 - 0x205C
   std::float_t m_flMaxSize; // 0x205C - 0x2060
...
public:
   ...
   std::uint32_t m_id; // 0x1C - 0x20
   bool m_isRunning; // 0x90 - 0x91
   bool m_isCrouching; // 0x91 - 0x92
   std::float_t m_forwardSpeed; // 0x94 - 0x98
   std::float_t m_leftSpeed; // 0x98 - 0x9C
   std::float_t m_verticalSpeed; // 0x9C - 0xA0
   std::uint64_t m_buttonFlags; // 0xA0 - 0xA8
   std::float_t m_jumpTimestamp; // 0xA8 - 0xAC
   Vector m_viewForward; // 0xAC - 0xB8
   std::int32_t m_postureStackIndex; // 0xC8 - 0xCC
...
public:
   ...
   std::float_t m_flInfluenceRadius; // 0x59C - 0x5A0
   ...
   std::int32_t m_nHandshake; // 0x5C4 - 0x5C8
   std::int32_t m_nEnvCubeMapArrayIndex; // 0x5C8 - 0x5CC
   std::int32_t m_nPriority; // 0x5CC - 0x5D0
   std::float_t m_flEdgeFadeDist; // 0x5D0 - 0x5D4
   Vector m_vEdgeFadeDists; // 0x5D4 - 0x5E0
   std::float_t m_flDiffuseScale; // 0x5E0 - 0x5E4
...
public:
   ...
   std::float_t m_flAutoRideSpeed; // 0x73C - 0x740
...
public:
   ...
   std::int32_t m_nBlockedTeamNumber; // 0x6F4 - 0x6F8
...
public:
   ...
   std::int32_t m_targetState; // 0x7EC - 0x7F0
   std::int32_t m_use; // 0x7F0 - 0x7F4
...
public:
   ...
   std::float_t m_length; // 0x6F4 - 0x6F8
   Vector m_controlMins; // 0x6F8 - 0x704
   Vector m_controlMaxs; // 0x704 - 0x710
   Vector m_lastBlockPos; // 0x710 - 0x71C
   std::int32_t m_lastBlockTick; // 0x71C - 0x720
   std::float_t m_flVolume; // 0x720 - 0x724
   std::float_t m_flBank; // 0x724 - 0x728
   std::float_t m_oldSpeed; // 0x728 - 0x72C
   std::float_t m_flBlockDamage; // 0x72C - 0x730
   std::float_t m_height; // 0x730 - 0x734
   std::float_t m_maxSpeed; // 0x734 - 0x738
   std::float_t m_dir; // 0x738 - 0x73C
   ...
   std::float_t m_flMoveSoundMinDuration; // 0x768 - 0x76C
   std::float_t m_flMoveSoundMaxDuration; // 0x76C - 0x770
   GameTime_t m_flNextMoveSoundTime; // 0x770 - 0x774
   std::float_t m_flMoveSoundMinPitch; // 0x774 - 0x778
   std::float_t m_flMoveSoundMaxPitch; // 0x778 - 0x77C
   ...
   std::float_t m_flDesiredSpeed; // 0x80C - 0x810
   GameTime_t m_flSpeedChangeTime; // 0x810 - 0x814
   std::float_t m_flAccelSpeed; // 0x814 - 0x818
   std::float_t m_flDecelSpeed; // 0x818 - 0x81C
   bool m_bAccelToSpeed; // 0x81C - 0x81D
   std::float_t m_flTimeScale; // 0x820 - 0x824
...
public:
   ...
   std::int32_t m_nState; // 0x6F0 - 0x6F4
...
public:
   ...
   std::float_t m_flScale; // 0xC4 - 0xC8
   Vector m_vecAbsOrigin; // 0xC8 - 0xD4
   QAngle m_angAbsRotation; // 0xD4 - 0xE0
   std::float_t m_flAbsScale; // 0xE0 - 0xE4
   std::int16_t m_nParentAttachmentOrBone; // 0xE4 - 0xE6
   ...
   std::uint8_t m_nHierarchicalDepth; // 0xEB - 0xEC
   std::uint8_t m_nHierarchyType; // 0xEC - 0xED
   std::uint8_t m_nDoNotSetAnimTimeInInvalidatePhysicsCount; // 0xED - 0xEE
   CUtlStringToken m_name; // 0xF0 - 0xF4
   CUtlStringToken m_hierarchyAttachName; // 0x130 - 0x134
   std::float_t m_flZOffset; // 0x134 - 0x138
...
public:
   ...
   std::int32_t m_nSpotRules; // 0xA38 - 0xA3C
   std::uint32_t m_uiHostageSpawnExclusionGroupMask; // 0xA3C - 0xA40
   std::uint32_t m_nHostageSpawnRandomFactor; // 0xA40 - 0xA44
   bool m_bRemove; // 0xA44 - 0xA45
   Vector m_vel; // 0xA48 - 0xA54
   bool m_isRescued; // 0xA54 - 0xA55
   bool m_jumpedThisFrame; // 0xA55 - 0xA56
   std::int32_t m_nHostageState; // 0xA58 - 0xA5C
   ...
   std::float_t m_flGrabbingLength; // 0x2BB0 - 0x2BB4
   ...
   std::int32_t m_nApproachRewardPayouts; // 0x2BD8 - 0x2BDC
   std::int32_t m_nPickupEventCount; // 0x2BDC - 0x2BE0
...
public:
   ...
   std::int32_t m_fireCount; // 0x1040 - 0x1044
   std::int32_t m_nInfernoType; // 0x1044 - 0x1048
   std::int32_t m_nFireEffectTickBegin; // 0x1048 - 0x104C
   std::float_t m_nFireLifetime; // 0x104C - 0x1050
   bool m_bInPostEffectTime; // 0x1050 - 0x1051
   std::int32_t m_nFiresExtinguishCount; // 0x1054 - 0x1058
   ...
   std::int32_t m_fireSpawnOffset; // 0x12E8 - 0x12EC
   std::int32_t m_nMaxFlames; // 0x12EC - 0x12F0
   CountdownTimer m_BookkeepingTimer; // 0x12F0 - 0x1308
   CountdownTimer m_NextSpreadTimer; // 0x1308 - 0x1320
   std::uint16_t m_nSourceItemDefIndex; // 0x1320 - 0x1322
...
public:
   ...
   bool m_bDisabled; // 0x4A0 - 0x4A1
   std::float_t m_flRange; // 0x4A4 - 0x4A8
   std::int32_t m_nImportance; // 0x4A8 - 0x4AC
   std::int32_t m_nLightChoice; // 0x4AC - 0x4B0
...
public:
   ...
   bool m_bDisabled; // 0x538 - 0x539
   std::float_t m_flRange; // 0x53C - 0x540
   std::int32_t m_nImportance; // 0x540 - 0x544
   std::int32_t m_nLightChoice; // 0x544 - 0x548
...
public:
   ...
   std::int32_t m_nSpotRules; // 0x910 - 0x914
...
public:
   ...
   std::int32_t m_minHitPoints; // 0x4A4 - 0x4A8
   std::int32_t m_minHitPointsToCommit; // 0x4A8 - 0x4AC
...
public:
   ...
   std::float_t m_flRefDot; // 0x740 - 0x744
...
public:
   ...
   std::int32_t m_nParameterCount; // 0x48 - 0x4C
   std::int32_t m_nConfigStartIndex; // 0x4C - 0x50
   std::int32_t m_nConfigCount; // 0x50 - 0x54
...
public:
   ...
   std::float_t m_flRadius; // 0x7C - 0x80
...
public:
   ...
   std::float_t m_flFreezeTransitionDuration; // 0x8F4 - 0x8F8
   std::int32_t m_nStopType; // 0x8F8 - 0x8FC
   ...
   std::float_t m_flPreSimTime; // 0x90C - 0x910
   ...
   std::int32_t m_nDataCP; // 0xC50 - 0xC54
   Vector m_vecDataCPValue; // 0xC54 - 0xC60
   std::int32_t m_nTintCP; // 0xC60 - 0xC64
...
public:
   ...
   std::float_t m_flWait; // 0x4A0 - 0x4A4
   std::float_t m_flRadius; // 0x4A4 - 0x4A8
   CEntityIOOutput m_OnPass; // 0x4A8 - 0x4D0
...
public:
   ...
   std::float_t m_flMaxSimulationTime; // 0x4A4 - 0x4A8
   CUtlSymbolLarge m_iszEffectName; // 0x4A8 - 0x4B0
   CUtlVector< CUtlSymbolLarge > m_PathNodes_Name; // 0x4B0 - 0x4C8
   std::float_t m_flParticleSpacing; // 0x4C8 - 0x4CC
   std::float_t m_flSlack; // 0x4CC - 0x4D0
   std::float_t m_flRadius; // 0x4D0 - 0x4D4
   Color m_ColorTint; // 0x4D4 - 0x4D8
   std::int32_t m_nEffectState; // 0x4D8 - 0x4DC
...
public:
   ...
   std::float_t m_hingeFriction; // 0x61C - 0x620
   std::float_t m_systemLoadScale; // 0x620 - 0x624
   bool m_bIsAxisLocal; // 0x624 - 0x625
   std::float_t m_flMinRotation; // 0x628 - 0x62C
   std::float_t m_flMaxRotation; // 0x62C - 0x630
   std::float_t m_flInitialRotation; // 0x630 - 0x634
   std::float_t m_flMotorFrequency; // 0x634 - 0x638
   std::float_t m_flMotorDampingRatio; // 0x638 - 0x63C
   std::float_t m_flAngleSpeed; // 0x63C - 0x640
   std::float_t m_flAngleSpeedThreshold; // 0x640 - 0x644
...
public:
   ...
   std::int32_t m_nBombSite; // 0x828 - 0x82C
   std::int32_t m_nSourceSoundscapeHash; // 0x82C - 0x830
   ...
   std::int32_t m_iProgressBarTime; // 0x8F8 - 0x8FC
...
public:
   ...
   std::uint32_t m_iFOV; // 0x40 - 0x44
   std::uint32_t m_iFOVStart; // 0x44 - 0x48
   GameTime_t m_flFOVTime; // 0x48 - 0x4C
   std::float_t m_flFOVRate; // 0x4C - 0x50
   ...
   std::float_t m_flOldPlayerZ; // 0x170 - 0x174
   std::float_t m_flOldPlayerViewOffsetZ; // 0x174 - 0x178
...
public:
   ...
   std::float_t m_flOldPlayerZ; // 0x150 - 0x154
   std::float_t m_flOldPlayerViewOffsetZ; // 0x154 - 0x158
...
public:
   ...
   std::float_t m_flStepSoundTime; // 0x1B8 - 0x1BC
   std::float_t m_flFallVelocity; // 0x1BC - 0x1C0
   bool m_bInCrouch; // 0x1C0 - 0x1C1
   std::uint32_t m_nCrouchState; // 0x1C4 - 0x1C8
   ...
   std::float_t m_flSurfaceFriction; // 0x1DC - 0x1E0
   CUtlStringToken m_surfaceProps; // 0x1E0 - 0x1E4
   std::int32_t m_nStepside; // 0x1F0 - 0x1F4
   std::int32_t m_iTargetVolume; // 0x1F4 - 0x1F8
...
public:
   ...
   std::uint8_t m_iObserverMode; // 0x40 - 0x41
...
public:
   ...
   ObserverMode_t m_iObserverLastMode; // 0x48 - 0x4C
   bool m_bForcedObserverMode; // 0x4C - 0x4D
   std::float_t m_flObserverChaseDistance; // 0x50 - 0x54
...
public:
   ...
   std::float_t m_FOV; // 0x4A0 - 0x4A4
   std::float_t m_Resolution; // 0x4A4 - 0x4A8
   bool m_bFogEnable; // 0x4A8 - 0x4A9
   Color m_FogColor; // 0x4A9 - 0x4AD
   std::float_t m_flFogStart; // 0x4B0 - 0x4B4
   std::float_t m_flFogEnd; // 0x4B4 - 0x4B8
   std::float_t m_flFogMaxDensity; // 0x4B8 - 0x4BC
   bool m_bActive; // 0x4BC - 0x4BD
   bool m_bUseScreenAspectRatio; // 0x4BD - 0x4BE
   std::float_t m_flAspectRatio; // 0x4C0 - 0x4C4
   bool m_bNoSky; // 0x4C4 - 0x4C5
   std::float_t m_fBrightness; // 0x4C8 - 0x4CC
   std::float_t m_flZFar; // 0x4CC - 0x4D0
   std::float_t m_flZNear; // 0x4D0 - 0x4D4
   bool m_bDofEnabled; // 0x4D4 - 0x4D5
   std::float_t m_flDofNearBlurry; // 0x4D8 - 0x4DC
   std::float_t m_flDofNearCrisp; // 0x4DC - 0x4E0
   std::float_t m_flDofFarCrisp; // 0x4E0 - 0x4E4
   std::float_t m_flDofFarBlurry; // 0x4E4 - 0x4E8
   std::float_t m_flDofTiltToGround; // 0x4E8 - 0x4EC
   std::float_t m_TargetFOV; // 0x4EC - 0x4F0
   std::float_t m_DegreesPerSecond; // 0x4F0 - 0x4F4
...
public:
   ...
   std::float_t m_flRadius; // 0x4A0 - 0x4A4
...
public:
   ...
   std::int32_t m_nPlayerIndex; // 0x4A8 - 0x4AC
...
public:
   ...
   std::int32_t m_currentDamageState; // 0xDBC - 0xDC0
...
public:
   ...
   std::uint16_t m_RopeFlags; // 0x6F8 - 0x6FA
   CUtlSymbolLarge m_iNextLinkName; // 0x700 - 0x708
   std::int16_t m_Slack; // 0x708 - 0x70A
   std::float_t m_Width; // 0x70C - 0x710
   std::float_t m_TextureScale; // 0x710 - 0x714
   std::uint8_t m_nSegments; // 0x714 - 0x715
   ...
   std::uint8_t m_Subdiv; // 0x728 - 0x729
   std::uint8_t m_nChangeCount; // 0x729 - 0x72A
   std::int16_t m_RopeLength; // 0x72A - 0x72C
   std::uint8_t m_fLockedPoints; // 0x72C - 0x72D
   bool m_bCreatedFromMapFile; // 0x72D - 0x72E
   std::float_t m_flScrollSpeed; // 0x730 - 0x734
...
public:
   ...
   std::int32_t m_numChickensKilled; // 0x0 - 0x4
   std::int32_t m_killsWhileBlind; // 0x4 - 0x8
   std::int32_t m_bombCarrierkills; // 0x8 - 0xC
   std::int32_t m_iBurnDamageInflicted; // 0xC - 0x10
   std::int32_t m_iDinks; // 0x10 - 0x14
...
public:
   ...
   std::int32_t m_iKills; // 0x30 - 0x34
   std::int32_t m_iDeaths; // 0x34 - 0x38
   std::int32_t m_iAssists; // 0x38 - 0x3C
   std::int32_t m_iDamage; // 0x3C - 0x40
   std::int32_t m_iEquipmentValue; // 0x40 - 0x44
   std::int32_t m_iMoneySaved; // 0x44 - 0x48
   std::int32_t m_iKillReward; // 0x48 - 0x4C
   std::int32_t m_iLiveTime; // 0x4C - 0x50
   std::int32_t m_iHeadShotKills; // 0x50 - 0x54
   std::int32_t m_iObjective; // 0x54 - 0x58
   std::int32_t m_iCashEarned; // 0x58 - 0x5C
   std::int32_t m_iUtilityDamage; // 0x5C - 0x60
   std::int32_t m_iEnemiesFlashed; // 0x60 - 0x64
...
public:
   ...
   std::float_t m_playbackSpeed; // 0xA0 - 0xA4
...
public:
   ...
   std::float_t m_playbackSpeed; // 0x98 - 0x9C
   std::float_t m_duration; // 0x9C - 0xA0
   bool m_bLoop; // 0xA0 - 0xA1
...
public:
   ...
   std::int32_t m_nAABBDirection; // 0x668 - 0x66C
...
public:
   ...
   std::int32_t m_nBoneCount; // 0x28 - 0x2C
   std::int32_t m_nMorphCount; // 0x2C - 0x30
...
public:
   ...
   std::int32_t m_iScore; // 0x4D0 - 0x4D4
...
public:
   ...
   std::float_t m_flAutoExposureMin; // 0x4A0 - 0x4A4
   std::float_t m_flAutoExposureMax; // 0x4A4 - 0x4A8
   std::float_t m_flTonemapPercentTarget; // 0x4A8 - 0x4AC
   std::float_t m_flTonemapPercentBrightPixels; // 0x4AC - 0x4B0
   std::float_t m_flTonemapMinAvgLum; // 0x4B0 - 0x4B4
   std::float_t m_flExposureAdaptationSpeedUp; // 0x4B4 - 0x4B8
   std::float_t m_flExposureAdaptationSpeedDown; // 0x4B8 - 0x4BC
   std::float_t m_flTonemapEVSmoothingRange; // 0x4BC - 0x4C0
...
public:
   ...
   std::float_t m_flAlternateTicksFix; // 0x8B4 - 0x8B8
   std::float_t m_flPushSpeed; // 0x8B8 - 0x8BC
...
public:
   ...
   std::float_t m_flScale; // 0x538 - 0x53C
   std::float_t m_flStartScale; // 0x53C - 0x540
   std::float_t m_flScaleTime; // 0x540 - 0x544
   std::uint32_t m_nFlags; // 0x544 - 0x548
...
public:
   ...
   std::float_t m_flInitialModelScale; // 0xB44 - 0xB48
...
public:
   ...
   std::float_t m_flInfluenceRadius; // 0x634 - 0x638
   ...
   std::int32_t m_nHandshake; // 0x65C - 0x660
   std::int32_t m_nEnvCubeMapArrayIndex; // 0x660 - 0x664
   std::int32_t m_nPriority; // 0x664 - 0x668
   std::float_t m_flEdgeFadeDist; // 0x668 - 0x66C
   Vector m_vEdgeFadeDists; // 0x66C - 0x678
   std::float_t m_flDiffuseScale; // 0x678 - 0x67C
...
public:
   ...
   std::int32_t m_fireCount; // 0x11BC - 0x11C0
   std::int32_t m_nInfernoType; // 0x11C0 - 0x11C4
   std::float_t m_nFireLifetime; // 0x11C4 - 0x11C8
   bool m_bInPostEffectTime; // 0x11C8 - 0x11C9
   std::int32_t m_lastFireCount; // 0x11CC - 0x11D0
   std::int32_t m_nFireEffectTickBegin; // 0x11D0 - 0x11D4
   std::int32_t m_drawableCount; // 0x7DE0 - 0x7DE4
   bool m_blosCheck; // 0x7DE4 - 0x7DE5
   std::int32_t m_nlosperiod; // 0x7DE8 - 0x7DEC
   std::float_t m_maxFireHalfWidth; // 0x7DEC - 0x7DF0
   std::float_t m_maxFireHeight; // 0x7DF0 - 0x7DF4
   Vector m_minBounds; // 0x7DF4 - 0x7E00
   Vector m_maxBounds; // 0x7E00 - 0x7E0C
   std::float_t m_flLastGrassBurnThink; // 0x7E0C - 0x7E10
...
public:
   ...
   std::float_t m_flMaxSimulationTime; // 0x53C - 0x540
   CUtlSymbolLarge m_iszEffectName; // 0x540 - 0x548
   CUtlVector< CUtlSymbolLarge > m_PathNodes_Name; // 0x548 - 0x560
   std::float_t m_flParticleSpacing; // 0x560 - 0x564
   std::float_t m_flSlack; // 0x564 - 0x568
   std::float_t m_flRadius; // 0x568 - 0x56C
   Color m_ColorTint; // 0x56C - 0x570
   std::int32_t m_nEffectState; // 0x570 - 0x574
...
public:
   ...
   std::int32_t m_nBombSite; // 0x99C - 0x9A0
   std::int32_t m_nSourceSoundscapeHash; // 0x9A0 - 0x9A4
   ...
   std::float_t m_flTimerLength; // 0x9CC - 0x9D0
   std::float_t m_bTenSecWarning; // 0x9D0 - 0x9D4
   std::float_t m_bTriggerWarning; // 0x9D4 - 0x9D8
   std::float_t m_bExplodeWarning; // 0x9D8 - 0x9DC
   bool m_bLocalBRMusicPlayed; // 0x9DC - 0x9DD
   std::float_t m_flDefuseLength; // 0x9E0 - 0x9E4
...
public:
   ...
   std::float_t m_FOV; // 0x538 - 0x53C
   std::float_t m_Resolution; // 0x53C - 0x540
   bool m_bFogEnable; // 0x540 - 0x541
   Color m_FogColor; // 0x541 - 0x545
   std::float_t m_flFogStart; // 0x548 - 0x54C
   std::float_t m_flFogEnd; // 0x54C - 0x550
   std::float_t m_flFogMaxDensity; // 0x550 - 0x554
   bool m_bActive; // 0x554 - 0x555
   bool m_bUseScreenAspectRatio; // 0x555 - 0x556
   std::float_t m_flAspectRatio; // 0x558 - 0x55C
   bool m_bNoSky; // 0x55C - 0x55D
   std::float_t m_fBrightness; // 0x560 - 0x564
   std::float_t m_flZFar; // 0x564 - 0x568
   std::float_t m_flZNear; // 0x568 - 0x56C
   bool m_bDofEnabled; // 0x56C - 0x56D
   std::float_t m_flDofNearBlurry; // 0x570 - 0x574
   std::float_t m_flDofNearCrisp; // 0x574 - 0x578
   std::float_t m_flDofFarCrisp; // 0x578 - 0x57C
   std::float_t m_flDofFarBlurry; // 0x57C - 0x580
   std::float_t m_flDofTiltToGround; // 0x580 - 0x584
   std::float_t m_TargetFOV; // 0x584 - 0x588
   std::float_t m_DegreesPerSecond; // 0x588 - 0x58C
...
public:
   ...
   std::int32_t m_nPlayerIndex; // 0x540 - 0x544
   std::int32_t m_nLastSimulateFrame; // 0x544 - 0x548
...
public:
   ...
   std::int32_t m_iScore; // 0x568 - 0x56C
...
public:
   ...
   std::float_t m_flAutoExposureMin; // 0x538 - 0x53C
   std::float_t m_flAutoExposureMax; // 0x53C - 0x540
   std::float_t m_flTonemapPercentTarget; // 0x540 - 0x544
   std::float_t m_flTonemapPercentBrightPixels; // 0x544 - 0x548
   std::float_t m_flTonemapMinAvgLum; // 0x548 - 0x54C
   std::float_t m_flExposureAdaptationSpeedUp; // 0x54C - 0x550
   std::float_t m_flExposureAdaptationSpeedDown; // 0x550 - 0x554
   std::float_t m_flTonemapEVSmoothingRange; // 0x554 - 0x558
...
public:
   ...
   std::uint16_t nNode; // 0x20 - 0x22
   std::uint16_t nCollisionMask; // 0x22 - 0x24
   Vector vSize; // 0x24 - 0x30
   std::float_t flStickiness; // 0x30 - 0x34
   std::uint16_t nVertexMapIndex; // 0x34 - 0x36
   std::uint16_t nFlags; // 0x36 - 0x38
...
public:
   ...
   std::float_t flStickiness; // 0x10 - 0x14
   std::uint16_t nNode; // 0x14 - 0x16
   std::uint16_t nCollisionMask; // 0x16 - 0x18
   std::uint16_t nVertexMapIndex; // 0x18 - 0x1A
   std::uint16_t nFlags; // 0x1A - 0x1C
...
public:
   ...
   std::float_t flStickiness; // 0x20 - 0x24
   std::uint16_t nNode; // 0x24 - 0x26
   std::uint16_t nCollisionMask; // 0x26 - 0x28
   std::uint16_t nVertexMapIndex; // 0x28 - 0x2A
   std::uint16_t nFlags; // 0x2A - 0x2C
...
public:
   ...
   std::int32_t m_nControlPoint; // 0x0 - 0x4
...
public:
   ...
   std::int32_t preset; // 0x0 - 0x4
   std::int32_t pitchrun; // 0x4 - 0x8
   std::int32_t pitchstart; // 0x8 - 0xC
   std::int32_t spinup; // 0xC - 0x10
   std::int32_t spindown; // 0x10 - 0x14
   std::int32_t volrun; // 0x14 - 0x18
   std::int32_t volstart; // 0x18 - 0x1C
   std::int32_t fadein; // 0x1C - 0x20
   std::int32_t fadeout; // 0x20 - 0x24
   std::int32_t lfotype; // 0x24 - 0x28
   std::int32_t lforate; // 0x28 - 0x2C
   std::int32_t lfomodpitch; // 0x2C - 0x30
   std::int32_t lfomodvol; // 0x30 - 0x34
   std::int32_t cspinup; // 0x34 - 0x38
   std::int32_t cspincount; // 0x38 - 0x3C
   std::int32_t pitch; // 0x3C - 0x40
   std::int32_t spinupsav; // 0x40 - 0x44
   std::int32_t spindownsav; // 0x44 - 0x48
   std::int32_t pitchfrac; // 0x48 - 0x4C
   std::int32_t vol; // 0x4C - 0x50
   std::int32_t fadeinsav; // 0x50 - 0x54
   std::int32_t fadeoutsav; // 0x54 - 0x58
   std::int32_t volfrac; // 0x58 - 0x5C
   std::int32_t lfofrac; // 0x5C - 0x60
   std::int32_t lfomult; // 0x60 - 0x64
...
public:
   ...
   std::uint32_t m_nVisClusterMemberOffset; // 0x0 - 0x4
   std::uint8_t m_nVisClusterMemberCount; // 0x4 - 0x5
   bool m_bHasTransform; // 0x5 - 0x6
   std::int16_t m_nDrawCallIndex; // 0x6 - 0x8
   Color m_vTintColor; // 0x8 - 0xC
   std::uint8_t m_nLODGroupMask; // 0xC - 0xD
   ObjectTypeFlags_t m_objectFlags; // 0x10 - 0x14
   Vector m_vLODOrigin; // 0x14 - 0x20
   std::float_t m_fLODStartDrawDistance; // 0x20 - 0x24
   std::float_t m_fLODEndDrawDistance; // 0x24 - 0x28
   std::float_t m_fMaxObjectScale; // 0x28 - 0x2C
   std::int32_t m_nLightProbeVolumePrecomputedHandshake; // 0x2C - 0x30
...
public:
   ...
   std::float_t m_fAngleIncrement; // 0xBC - 0xC0
   std::int32_t m_nSequenceMaxFrame; // 0xC0 - 0xC4
   std::int32_t m_nBoneMaskIndex; // 0xC4 - 0xC8
...
public:
   ...
   std::int32_t m_nEntityIndex; // 0x0 - 0x4
...
public:
   ...
   std::int32_t m_nEntIndex; // 0x110 - 0x114
...
public:
   ...
   std::uint32_t m_nLightmapVersionNumber; // 0x0 - 0x4
   std::uint32_t m_nLightmapGameVersionNumber; // 0x4 - 0x8
...
public:
   ...
   std::float_t m_flDuration; // 0x34 - 0x38
...
public:
   ...
   std::int32_t m_iSoundType; // 0x4A0 - 0x4A4
   std::int32_t m_iSoundContext; // 0x4A4 - 0x4A8
   std::int32_t m_iVolume; // 0x4A8 - 0x4AC
   std::int32_t m_iSoundIndex; // 0x4AC - 0x4B0
   std::float_t m_flDuration; // 0x4B0 - 0x4B4
...
public:
   ...
   std::float_t m_flTimingBlend; // 0x4C - 0x50
...
public:
   ...
   std::uint32_t m_nUpType; // 0x80 - 0x84
...
public:
   ...
   std::float_t m_fAngleIncrement; // 0x50 - 0x54
...
public:
   ...
   std::float_t m_radius; // 0x4A0 - 0x4A4
   std::float_t m_flMaxRadius; // 0x4A4 - 0x4A8
...
public:
   ...
   std::int32_t m_nActivity; // 0x10 - 0x14
   std::int32_t m_nFlags; // 0x14 - 0x18
   std::int32_t m_nWeight; // 0x18 - 0x1C
...
public:
   ...
   std::int32_t m_nFrame; // 0x0 - 0x4
   std::float_t m_flCycle; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_nMaxUniqueFrameIndex; // 0x50 - 0x54
...
public:
   ...
   std::int32_t m_nFlags; // 0x20 - 0x24
   std::int32_t m_nType; // 0x24 - 0x28
...
public:
   ...
   std::int32_t m_nVersion; // 0x10 - 0x14
   std::int32_t m_nType; // 0x14 - 0x18
...
public:
   ...
   std::float_t framestalltime; // 0x158 - 0x15C
...
public:
   ...
   std::int32_t m_nFrames; // 0x10 - 0x14
   std::int32_t m_nFramesPerBlock; // 0x14 - 0x18
...
public:
   ...
   std::int32_t m_ankleBoneIndex; // 0x20 - 0x24
   std::int32_t m_toeBoneIndex; // 0x24 - 0x28
...
public:
   ...
   std::int32_t m_nStartFrame; // 0x0 - 0x4
   std::int32_t m_nEndFrame; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_nUniqueFrameIndex; // 0x0 - 0x4
   std::uint32_t m_nLocalElementMasks; // 0x4 - 0x8
   std::int32_t m_nLocalChannel; // 0x8 - 0xC
...
public:
   ...
   std::int32_t m_startIndex; // 0x60 - 0x64
   std::int32_t m_writeIndex; // 0x64 - 0x68
   std::int32_t m_frameCount; // 0x68 - 0x6C
...
public:
   ...
   std::int32_t m_nBoolVariablesCount; // 0x188 - 0x18C
   std::int32_t m_nOwnerOnlyBoolVariablesCount; // 0x18C - 0x190
   std::int32_t m_nRandomSeedOffset; // 0x190 - 0x194
   std::float_t m_flLastTeleportTime; // 0x194 - 0x198
...
public:
   ...
   std::int32_t m_nOwnerOnlyBoolVariablesCount; // 0x18C - 0x190
   std::int32_t m_nRandomSeedOffset; // 0x190 - 0x194
   std::float_t m_flLastTeleportTime; // 0x1120 - 0x1124
...
public:
   ...
   std::float_t m_fSpeedScale; // 0xC - 0x10
...
public:
   ...
   std::int32_t m_nChannelElements; // 0x58 - 0x5C
...
public:
   ...
   std::int32_t m_nStartFrame; // 0x20 - 0x24
   std::int32_t m_nPeakFrame; // 0x24 - 0x28
   std::int32_t m_nTailFrame; // 0x28 - 0x2C
   std::int32_t m_nEndFrame; // 0x2C - 0x30
...
public:
   ...
   std::int32_t endframe; // 0x0 - 0x4
   std::int32_t motionflags; // 0x4 - 0x8
   std::float_t v0; // 0x8 - 0xC
   std::float_t v1; // 0xC - 0x10
   std::float_t angle; // 0x10 - 0x14
...
public:
   ...
   std::int32_t m_nCount; // 0x2C - 0x30
...
public:
   ...
   std::float_t m_flStartCycle; // 0x3C - 0x40
   std::float_t m_flEndCycle; // 0x40 - 0x44
...
public:
   ...
   std::float_t m_flCycle; // 0x1C - 0x20
...
public:
   ...
   std::float_t m_timeStamp; // 0x80 - 0x84
...
public:
   ...
   std::float_t m_flFadeInTime; // 0x0 - 0x4
   std::float_t m_flFadeOutTime; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_startStateIndex; // 0x50 - 0x54
...
public:
   ...
   std::float_t m_fStartCycle; // 0x24 - 0x28
   std::float_t m_fDuration; // 0x28 - 0x2C
...
public:
   ...
   std::int32_t m_nodeIndex; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_flAxisSize; // 0x30 - 0x34
...
public:
   ...
   std::float_t m_flRadius; // 0x20 - 0x24
...
public:
   ...
   std::uint32_t m_nFlags; // 0x10 - 0x14
...
public:
   ...
   std::uint8_t m_nInfluences; // 0x83 - 0x84
...
public:
   ...
   std::float_t m_flVolume; // 0x50 - 0x54
...
public:
   ...
   std::float_t m_flRadius; // 0x850 - 0x854
...
public:
   ...
   std::float_t m_flLastEventCycle; // 0x1184 - 0x1188
   std::float_t m_flLastEventAnimTime; // 0x1188 - 0x118C
   CNetworkedQuantizedFloat m_flPlaybackRate; // 0x118C - 0x1194
   std::float_t m_flPrevAnimTime; // 0x1194 - 0x1198
   bool m_bClientSideAnimation; // 0x1198 - 0x1199
   bool m_bNetworkedAnimationInputsChanged; // 0x1199 - 0x119A
   std::uint8_t m_nPrevNewSequenceParity; // 0x119A - 0x119B
   std::uint8_t m_nPrevResetEventsParity; // 0x119B - 0x119C
   std::int32_t m_nNewSequenceParity; // 0x119C - 0x11A0
   std::int32_t m_nResetEventsParity; // 0x11A0 - 0x11A4
...
public:
   ...
   std::float_t m_flLastEventCycle; // 0x1F4 - 0x1F8
   std::float_t m_flLastEventAnimTime; // 0x1F8 - 0x1FC
   CNetworkedQuantizedFloat m_flPlaybackRate; // 0x1FC - 0x204
   std::float_t m_flPrevAnimTime; // 0x204 - 0x208
   bool m_bClientSideAnimation; // 0x208 - 0x209
   bool m_bNetworkedAnimationInputsChanged; // 0x209 - 0x20A
   std::int32_t m_nNewSequenceParity; // 0x20C - 0x210
   std::int32_t m_nResetEventsParity; // 0x210 - 0x214
...
public:
   ...
   std::int32_t m_iNumYesVotes; // 0x164 - 0x168
   std::int32_t m_iNumNoVotes; // 0x168 - 0x16C
   std::int32_t m_iNumPotentialVotes; // 0x16C - 0x170
...
public:
   ...
   std::int32_t m_iPositionInterpolator; // 0x500 - 0x504
   std::int32_t m_iRotationInterpolator; // 0x504 - 0x508
   std::float_t m_flAnimStartTime; // 0x508 - 0x50C
   std::float_t m_flAnimEndTime; // 0x50C - 0x510
   std::float_t m_flAverageSpeedAcrossFrame; // 0x510 - 0x514
   ...
   std::float_t m_flTimeIntoFrame; // 0x538 - 0x53C
   std::int32_t m_iDirection; // 0x53C - 0x540
...
public:
   ...
   std::float_t m_flHoldBreathTime; // 0x158 - 0x15C
   std::float_t m_flDrowningDamageInterval; // 0x15C - 0x160
   std::int32_t m_nDrowningDamageInitial; // 0x160 - 0x164
   std::int32_t m_nDrowningDamageMax; // 0x164 - 0x168
   std::int32_t m_nWaterSpeed; // 0x168 - 0x16C
   std::float_t m_flUseRange; // 0x16C - 0x170
   std::float_t m_flUseAngleTolerance; // 0x170 - 0x174
   std::float_t m_flCrouchTime; // 0x174 - 0x178
...
public:
   ...
   std::float_t m_playbackSpeed; // 0xAC - 0xB0
...
public:
   ...
   std::float_t m_playbackSpeed; // 0xE4 - 0xE8
...
public:
   ...
   std::float_t m_flControlPoint1; // 0x0 - 0x4
   std::float_t m_flControlPoint2; // 0x4 - 0x8
...
public:
   ...
   CUtlString m_name; // 0x10 - 0x18
   std::float_t m_blendValue; // 0x18 - 0x1C
...
public:
   ...
   std::float_t m_flAmount; // 0x4B8 - 0x4BC
   std::int32_t m_Color; // 0x4BC - 0x4C0
...
public:
   ...
   std::int32_t m_nPriority; // 0x40 - 0x44
...
public:
   ...
   std::int32_t m_nBodyGroupOption; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_flTimingBlend; // 0x64 - 0x68
   std::float_t m_flRootMotionBlend; // 0x68 - 0x6C
...
public:
   ...
   std::int32_t m_nWeightListIndex; // 0x8C - 0x90
   std::float_t m_flRootMotionBlend; // 0x90 - 0x94
...
public:
   ...
   std::int32_t m_nBoneIndex; // 0x50 - 0x54
...
public:
   ...
   std::int32_t m_nParentBoneIndex; // 0x960 - 0x964
...
public:
   ...
   std::float_t m_flZoomCooldownTimestamp; // 0x88 - 0x8C
   bool m_bDoneAiming; // 0x8C - 0x8D
   std::float_t m_flLerpStartTime; // 0x90 - 0x94
   std::float_t m_flNextLookTargetLerpTime; // 0x94 - 0x98
   std::float_t m_flPenaltyReductionRatio; // 0x98 - 0x9C
...
public:
   ...
   std::float_t m_flDamagingAreasPenaltyCost; // 0x88 - 0x8C
   ...
   std::float_t m_flArrivalEpsilon; // 0xD8 - 0xDC
   std::float_t m_flAdditionalArrivalEpsilon2D; // 0xDC - 0xE0
   std::float_t m_flHidingSpotCheckDistanceThreshold; // 0xE0 - 0xE4
   std::float_t m_flNearestAreaDistanceThreshold; // 0xE4 - 0xE8
...
public:
   ...
   std::float_t m_flRoundStartThresholdSeconds; // 0x78 - 0x7C
   std::float_t m_flSensorInactivityThresholdSeconds; // 0x7C - 0x80
...
public:
   ...
   std::int32_t m_density; // 0x6F0 - 0x6F4
   std::int32_t m_frequency; // 0x6F4 - 0x6F8
   std::int32_t m_state; // 0x6F8 - 0x6FC
...
public:
   ...
   bool m_bShouldExplode; // 0x958 - 0x959
   std::int32_t m_nParentBoneIndex; // 0x95C - 0x960
...
public:
   ...
   std::float_t m_flFluidDensity; // 0x18 - 0x1C
...
public:
   ...
   std::int32_t m_LegacyTeamNum; // 0x898 - 0x89C
...
public:
   ...
   std::int32_t m_nSpotRules; // 0xD90 - 0xD94
...
public:
   ...
   std::float_t m_followTimestamp; // 0x188 - 0x18C
   std::float_t m_allowAutoFollowTime; // 0x18C - 0x190
   ...
   std::float_t m_stateTimestamp; // 0x4D8 - 0x4DC
   ...
   std::float_t m_avoidTimestamp; // 0x508 - 0x50C
   ...
   std::int32_t m_pathIndex; // 0x6618 - 0x661C
   ...
   std::float_t m_pathLadderEnd; // 0x669C - 0x66A0
   ...
   std::uint8_t m_travelDistancePhase; // 0x6830 - 0x6831
   std::uint8_t m_hostageEscortCount; // 0x69C8 - 0x69C9
   std::float_t m_hostageEscortCountTimestamp; // 0x69CC - 0x69D0
   std::int32_t m_desiredTeam; // 0x69D0 - 0x69D4
   ...
   std::float_t m_noiseTravelDistance; // 0x6A14 - 0x6A18
   std::float_t m_noiseTimestamp; // 0x6A18 - 0x6A1C
   ...
   std::float_t m_lookAroundStateTimestamp; // 0x6A60 - 0x6A64
   std::float_t m_lookAheadAngle; // 0x6A64 - 0x6A68
   std::float_t m_forwardAngle; // 0x6A68 - 0x6A6C
   std::float_t m_inhibitLookAroundTimestamp; // 0x6A6C - 0x6A70
   Vector m_lookAtSpot; // 0x6A74 - 0x6A80
   std::float_t m_lookAtSpotDuration; // 0x6A84 - 0x6A88
   std::float_t m_lookAtSpotTimestamp; // 0x6A88 - 0x6A8C
   std::float_t m_lookAtSpotAngleTolerance; // 0x6A8C - 0x6A90
   bool m_lookAtSpotClearIfClose; // 0x6A90 - 0x6A91
   bool m_lookAtSpotAttack; // 0x6A91 - 0x6A92
   char* m_lookAtDesc; // 0x6A98 - 0x6AA0
   std::float_t m_peripheralTimestamp; // 0x6AA0 - 0x6AA4
   std::uint8_t m_approachPointCount; // 0x6C28 - 0x6C29
   ...
   std::float_t m_spotCheckTimestamp; // 0x6C90 - 0x6C94
   std::int32_t m_checkedHidingSpotCount; // 0x7098 - 0x709C
   std::float_t m_lookPitch; // 0x709C - 0x70A0
   std::float_t m_lookPitchVel; // 0x70A0 - 0x70A4
   std::float_t m_lookYaw; // 0x70A4 - 0x70A8
   std::float_t m_lookYawVel; // 0x70A8 - 0x70AC
   ...
   std::float_t m_aimFocus; // 0x70EC - 0x70F0
   std::float_t m_aimFocusInterval; // 0x70F0 - 0x70F4
   ...
   std::uint8_t m_visibleEnemyParts; // 0x711D - 0x711E
   Vector m_lastEnemyPosition; // 0x7120 - 0x712C
   std::float_t m_lastSawEnemyTimestamp; // 0x712C - 0x7130
   std::float_t m_firstSawEnemyTimestamp; // 0x7130 - 0x7134
   std::float_t m_currentEnemyAcquireTimestamp; // 0x7134 - 0x7138
   std::float_t m_enemyDeathTimestamp; // 0x7138 - 0x713C
   std::float_t m_friendDeathTimestamp; // 0x713C - 0x7140
   bool m_isLastEnemyDead; // 0x7140 - 0x7141
   std::int32_t m_nearbyEnemyCount; // 0x7144 - 0x7148
   CHandle< CCSPlayerPawnBase > m_bomber; // 0x7350 - 0x7354
   std::int32_t m_nearbyFriendCount; // 0x7354 - 0x7358
   ...
   std::float_t m_attackedTimestamp; // 0x7374 - 0x7378
   IntervalTimer m_burnedByFlamesTimer; // 0x7378 - 0x7388
   std::int32_t m_lastVictimID; // 0x7388 - 0x738C
   ...
   std::uint8_t m_enemyQueueIndex; // 0x7498 - 0x7499
   std::uint8_t m_enemyQueueCount; // 0x7499 - 0x749A
   std::uint8_t m_enemyQueueAttendIndex; // 0x749A - 0x749B
   ...
   std::int32_t m_avgVelIndex; // 0x750C - 0x7510
   std::int32_t m_avgVelCount; // 0x7510 - 0x7514
   Vector m_lastOrigin; // 0x7514 - 0x7520
   std::float_t m_lastRadioRecievedTimestamp; // 0x7524 - 0x7528
   std::float_t m_lastRadioSentTimestamp; // 0x7528 - 0x752C
   CHandle< CCSPlayerPawnBase > m_radioSubject; // 0x752C - 0x7530
   Vector m_radioPosition; // 0x7530 - 0x753C
   std::float_t m_voiceEndTimestamp; // 0x753C - 0x7540
   std::int32_t m_lastValidReactionQueueFrame; // 0x7548 - 0x754C
...
public:
   ...
   std::int32_t m_iMinBurstSize; // 0x4A0 - 0x4A4
   std::int32_t m_iMaxBurstSize; // 0x4A4 - 0x4A8
   std::float_t m_flMinBurstDelay; // 0x4A8 - 0x4AC
   std::float_t m_flMaxBurstDelay; // 0x4AC - 0x4B0
   std::float_t m_flRateOfFire; // 0x4B0 - 0x4B4
   ...
   std::int32_t m_iShotsRemaining; // 0x4D4 - 0x4D8
   std::int32_t m_iSpread; // 0x4D8 - 0x4DC
   Vector m_vecSpread; // 0x4DC - 0x4E8
   Vector m_vecTargetPosition; // 0x4E8 - 0x4F4
   std::float_t m_flTargetDist; // 0x4F4 - 0x4F8
   std::float_t m_flBias; // 0x4F8 - 0x4FC
   ...
   std::float_t m_flDamageScaleValue; // 0x508 - 0x50C
   std::float_t m_flAdditionalSpread; // 0x50C - 0x510
...
public:
   ...
   std::uint32_t m_nWeaponParity; // 0x86C - 0x870
   std::uint32_t m_nOldWeaponParity; // 0x870 - 0x874
...
public:
   ...
   std::float_t m_flTerroristTimeOutRemaining; // 0xD4 - 0xD8
   std::float_t m_flCTTimeOutRemaining; // 0xD8 - 0xDC
   std::int32_t m_nTerroristTimeOuts; // 0xDC - 0xE0
   std::int32_t m_nCTTimeOuts; // 0xE0 - 0xE4
   bool m_bTechnicalTimeOut; // 0xE4 - 0xE5
   bool m_bMatchWaitingForResume; // 0xE5 - 0xE6
   std::int32_t m_iRoundTime; // 0xE8 - 0xEC
   std::float_t m_fMatchStartTime; // 0xEC - 0xF0
   GameTime_t m_fRoundStartTime; // 0xF0 - 0xF4
   GameTime_t m_flRestartRoundTime; // 0xF4 - 0xF8
   bool m_bGameRestart; // 0xF8 - 0xF9
   std::float_t m_flGameStartTime; // 0xFC - 0x100
   std::float_t m_timeUntilNextPhaseStarts; // 0x100 - 0x104
   std::int32_t m_gamePhase; // 0x104 - 0x108
   std::int32_t m_totalRoundsPlayed; // 0x108 - 0x10C
   std::int32_t m_nRoundsPlayedThisPhase; // 0x10C - 0x110
   std::int32_t m_nOvertimePlaying; // 0x110 - 0x114
   std::int32_t m_iHostagesRemaining; // 0x114 - 0x118
   ...
   std::int32_t m_nQueuedMatchmakingMode; // 0x120 - 0x124
   bool m_bIsValveDS; // 0x124 - 0x125
   bool m_bLogoMap; // 0x125 - 0x126
   bool m_bPlayAllStepSoundsOnServer; // 0x126 - 0x127
   std::int32_t m_iNumGunGameProgressiveWeaponsCT; // 0x128 - 0x12C
   std::int32_t m_iNumGunGameProgressiveWeaponsT; // 0x12C - 0x130
   std::int32_t m_iSpectatorSlotCount; // 0x130 - 0x134
   ...
   std::int32_t m_MatchDevice; // 0x4F4 - 0x4F8
   bool m_bHasMatchStarted; // 0x4F8 - 0x4F9
   std::float_t m_flDMBonusStartTime; // 0x4FC - 0x500
   std::float_t m_flDMBonusTimeLength; // 0x500 - 0x504
   std::uint16_t m_unDMBonusWeaponLoadoutSlot; // 0x504 - 0x506
   bool m_bDMBonusActive; // 0x506 - 0x507
   std::int32_t m_nNextMapInMapgroup; // 0x508 - 0x50C
   ...
   std::int32_t m_nTournamentPredictionsPct; // 0xD0C - 0xD10
   ...
   std::int32_t m_nGuardianModeWaveNumber; // 0xD1C - 0xD20
   std::int32_t m_nGuardianModeSpecialKillsRemaining; // 0xD20 - 0xD24
   std::int32_t m_nGuardianModeSpecialWeaponNeeded; // 0xD24 - 0xD28
   std::int32_t m_nGuardianGrenadesToGiveBots; // 0xD28 - 0xD2C
   std::int32_t m_nNumHeaviesToSpawn; // 0xD2C - 0xD30
   std::uint32_t m_numGlobalGiftsGiven; // 0xD30 - 0xD34
   std::uint32_t m_numGlobalGifters; // 0xD34 - 0xD38
   std::uint32_t m_numGlobalGiftsPeriodSeconds; // 0xD38 - 0xD3C
   ...
   std::int32_t m_numBestOfMaps; // 0xE34 - 0xE38
   std::int32_t m_nHalloweenMaskListSeed; // 0xE38 - 0xE3C
   bool m_bBombDropped; // 0xE3C - 0xE3D
   bool m_bBombPlanted; // 0xE3D - 0xE3E
   std::int32_t m_iRoundWinStatus; // 0xE40 - 0xE44
   std::int32_t m_eRoundWinReason; // 0xE44 - 0xE48
   ...
   std::int32_t m_nServerQuestID; // 0x10B8 - 0x10BC
   ...
   std::int32_t m_nEndMatchMapVoteWinner; // 0x1110 - 0x1114
   std::int32_t m_iNumConsecutiveCTLoses; // 0x1114 - 0x1118
   std::int32_t m_iNumConsecutiveTerroristLoses; // 0x1118 - 0x111C
   ...
   std::int32_t m_iTotalRoundsPlayed; // 0x1148 - 0x114C
   std::int32_t m_iUnBalancedRounds; // 0x114C - 0x1150
   bool m_endMatchOnRoundReset; // 0x1150 - 0x1151
   bool m_endMatchOnThink; // 0x1151 - 0x1152
   std::int32_t m_iFreezeTime; // 0x1154 - 0x1158
   std::int32_t m_iNumTerrorist; // 0x1158 - 0x115C
   std::int32_t m_iNumCT; // 0x115C - 0x1160
   std::int32_t m_iNumSpawnableTerrorist; // 0x1160 - 0x1164
   std::int32_t m_iNumSpawnableCT; // 0x1164 - 0x1168
   ...
   std::uint32_t m_numQueuedMatchmakingAccounts; // 0x11B0 - 0x11B4
   char* m_pQueuedMatchmakingReservationString; // 0x11B8 - 0x11C0
   std::uint32_t m_numTotalTournamentDrops; // 0x11C0 - 0x11C4
   std::uint32_t m_numSpectatorsCountMax; // 0x11C4 - 0x11C8
   std::uint32_t m_numSpectatorsCountMaxTV; // 0x11C8 - 0x11CC
   std::uint32_t m_numSpectatorsCountMaxLnk; // 0x11CC - 0x11D0
   bool m_bForceTeamChangeSilent; // 0x11D8 - 0x11D9
   bool m_bLoadingRoundBackupData; // 0x11D9 - 0x11DA
   std::int32_t m_nMatchInfoShowType; // 0x1210 - 0x1214
   std::float_t m_flMatchInfoDecidedTime; // 0x1214 - 0x1218
   std::float_t m_flCoopRespawnAndHealTime; // 0x1230 - 0x1234
   std::int32_t m_coopBonusCoinsFound; // 0x1234 - 0x1238
   ...
   std::int32_t mTeamDMLastWinningTeamNumber; // 0x123C - 0x1240
   std::float_t mTeamDMLastThinkTime; // 0x1240 - 0x1244
   std::float_t m_flTeamDMLastAnnouncementTime; // 0x1244 - 0x1248
   std::int32_t m_iAccountTerrorist; // 0x1248 - 0x124C
   std::int32_t m_iAccountCT; // 0x124C - 0x1250
   std::int32_t m_iSpawnPointCount_Terrorist; // 0x1250 - 0x1254
   std::int32_t m_iSpawnPointCount_CT; // 0x1254 - 0x1258
   std::int32_t m_iMaxNumTerrorists; // 0x1258 - 0x125C
   std::int32_t m_iMaxNumCTs; // 0x125C - 0x1260
   std::int32_t m_iLoserBonus; // 0x1260 - 0x1264
   std::int32_t m_iLoserBonusMostRecentTeam; // 0x1264 - 0x1268
   std::float_t m_tmNextPeriodicThink; // 0x1268 - 0x126C
   bool m_bVoiceWonMatchBragFired; // 0x126C - 0x126D
   std::float_t m_fWarmupNextChatNoticeTime; // 0x1270 - 0x1274
   std::int32_t m_iHostagesRescued; // 0x1278 - 0x127C
   std::int32_t m_iHostagesTouched; // 0x127C - 0x1280
   std::float_t m_flNextHostageAnnouncement; // 0x1280 - 0x1284
   ...
   std::float_t m_firstKillTime; // 0x128C - 0x1290
   std::float_t m_firstBloodTime; // 0x1294 - 0x1298
   ...
   std::float_t m_flVoteCheckThrottle; // 0x12C4 - 0x12C8
   bool m_bBuyTimeEnded; // 0x12C8 - 0x12C9
   std::int32_t m_nLastFreezeEndBeep; // 0x12CC - 0x12D0
   std::int32_t m_iHaveEscaped; // 0x12D0 - 0x12D4
   bool m_bMapHasEscapeZone; // 0x12D4 - 0x12D5
   std::int32_t m_iNumEscapers; // 0x12D8 - 0x12DC
   std::int32_t m_iNumEscapeRounds; // 0x12DC - 0x12E0
   ...
   std::float_t m_fGunGameBombRespawnTimer; // 0x12E4 - 0x12E8
   ...
   std::int32_t m_iNextCTSpawnPoint; // 0x1340 - 0x1344
   std::int32_t m_iNextTerroristSpawnPoint; // 0x1344 - 0x1348
   ...
   std::float_t m_fAutobalanceDisplayTime; // 0x137C - 0x1380
   ...
   std::float_t m_fNextUpdateTeamClanNamesTime; // 0x15F0 - 0x15F4
   GameTime_t m_flLastThinkTime; // 0x15F4 - 0x15F8
   std::float_t m_fAccumulatedRoundOffDamage; // 0x15F8 - 0x15FC
   std::int32_t m_nShorthandedBonusLastEvalRound; // 0x15FC - 0x1600
   ...
   std::int32_t m_iMaxGunGameProgressiveWeaponIndex; // 0x1864 - 0x1868
   ...
   std::int32_t m_GuardianBotSkillLevelMax; // 0x376C - 0x3770
   std::int32_t m_GuardianBotSkillLevelMin; // 0x3770 - 0x3774
   ...
   std::uint8_t m_nMatchEndCount; // 0x3800 - 0x3801
...
public:
   ...
   std::int32_t m_iCoachingTeam; // 0x6F0 - 0x6F4
   std::uint64_t m_nPlayerDominated; // 0x6F8 - 0x700
   std::uint64_t m_nPlayerDominatingMe; // 0x700 - 0x708
   std::int32_t m_iCompetitiveRanking; // 0x708 - 0x70C
   std::int32_t m_iCompetitiveWins; // 0x70C - 0x710
   std::int8_t m_iCompetitiveRankType; // 0x710 - 0x711
   std::int32_t m_nEndMatchNextMapVote; // 0x714 - 0x718
   std::uint16_t m_unActiveQuestId; // 0x718 - 0x71A
   QuestProgress::Reason m_nQuestProgressReason; // 0x71C - 0x720
   std::uint32_t m_unPlayerTvControlFlags; // 0x720 - 0x724
   std::int32_t m_iDraftIndex; // 0x790 - 0x794
   std::uint32_t m_msQueuedModeDisconnectionTimestamp; // 0x794 - 0x798
   std::uint32_t m_uiAbandonRecordedReason; // 0x798 - 0x79C
   ...
   std::int32_t m_nDisconnectionTick; // 0x7A0 - 0x7A4
   ...
   std::int32_t m_nBotsControlledThisRound; // 0x7B4 - 0x7B8
   ...
   std::int32_t m_DesiredObserverMode; // 0x7C4 - 0x7C8
   CEntityHandle m_hDesiredObserverTarget; // 0x7C8 - 0x7CC
   bool m_bPawnIsAlive; // 0x7CC - 0x7CD
   std::uint32_t m_iPawnHealth; // 0x7D0 - 0x7D4
   std::int32_t m_iPawnArmor; // 0x7D4 - 0x7D8
   bool m_bPawnHasDefuser; // 0x7D8 - 0x7D9
   bool m_bPawnHasHelmet; // 0x7D9 - 0x7DA
   std::uint16_t m_nPawnCharacterDefIndex; // 0x7DA - 0x7DC
   std::int32_t m_iPawnLifetimeStart; // 0x7DC - 0x7E0
   std::int32_t m_iPawnLifetimeEnd; // 0x7E0 - 0x7E4
   std::int32_t m_iPawnGunGameLevel; // 0x7E4 - 0x7E8
   std::int32_t m_iPawnBotDifficulty; // 0x7E8 - 0x7EC
   CHandle< CCSPlayerController > m_hOriginalControllerOfCurrentPawn; // 0x7EC - 0x7F0
   std::int32_t m_iScore; // 0x7F0 - 0x7F4
   std::int32_t m_iRoundScore; // 0x7F4 - 0x7F8
   CNetworkUtlVectorBase< EKillTypes_t > m_vecKills; // 0x7F8 - 0x810
   std::int32_t m_iMVPs; // 0x810 - 0x814
   std::int32_t m_nUpdateCounter; // 0x814 - 0x818
   IntervalTimer m_lastHeldVoteTimer; // 0xF8B8 - 0xF8C8
   bool m_bShowHints; // 0xF8D0 - 0xF8D1
   std::int32_t m_iNextTimeCheck; // 0xF8D4 - 0xF8D8
...
public:
   ...
   std::int32_t m_iCoachingTeam; // 0x708 - 0x70C
   std::uint64_t m_nPlayerDominated; // 0x710 - 0x718
   std::uint64_t m_nPlayerDominatingMe; // 0x718 - 0x720
   std::int32_t m_iCompetitiveRanking; // 0x720 - 0x724
   std::int32_t m_iCompetitiveWins; // 0x724 - 0x728
   std::int8_t m_iCompetitiveRankType; // 0x728 - 0x729
   std::int32_t m_nEndMatchNextMapVote; // 0x72C - 0x730
   std::uint16_t m_unActiveQuestId; // 0x730 - 0x732
   QuestProgress::Reason m_nQuestProgressReason; // 0x734 - 0x738
   std::uint32_t m_unPlayerTvControlFlags; // 0x738 - 0x73C
   std::int32_t m_iDraftIndex; // 0x7A8 - 0x7AC
   std::uint32_t m_msQueuedModeDisconnectionTimestamp; // 0x7AC - 0x7B0
   std::uint32_t m_uiAbandonRecordedReason; // 0x7B0 - 0x7B4
   ...
   std::int32_t m_nDisconnectionTick; // 0x7B8 - 0x7BC
   ...
   std::int32_t m_nBotsControlledThisRound; // 0x7CC - 0x7D0
   ...
   std::uint32_t m_iPawnHealth; // 0x7E0 - 0x7E4
   std::int32_t m_iPawnArmor; // 0x7E4 - 0x7E8
   bool m_bPawnHasDefuser; // 0x7E8 - 0x7E9
   bool m_bPawnHasHelmet; // 0x7E9 - 0x7EA
   std::uint16_t m_nPawnCharacterDefIndex; // 0x7EA - 0x7EC
   std::int32_t m_iPawnLifetimeStart; // 0x7EC - 0x7F0
   std::int32_t m_iPawnLifetimeEnd; // 0x7F0 - 0x7F4
   std::int32_t m_iPawnGunGameLevel; // 0x7F4 - 0x7F8
   std::int32_t m_iPawnBotDifficulty; // 0x7F8 - 0x7FC
   CHandle< CCSPlayerController > m_hOriginalControllerOfCurrentPawn; // 0x7FC - 0x800
   std::int32_t m_iScore; // 0x800 - 0x804
   C_NetworkUtlVectorBase< EKillTypes_t > m_vecKills; // 0x808 - 0x820
   std::int32_t m_iMVPs; // 0x820 - 0x824
...
public:
   ...
   std::int32_t m_iNumRoundKills; // 0x148 - 0x14C
   std::int32_t m_iNumRoundKillsHeadshots; // 0x14C - 0x150
...
public:
   ...
   std::int32_t m_iNumRoundKills; // 0x108 - 0x10C
   std::int32_t m_iNumRoundKillsHeadshots; // 0x10C - 0x110
...
public:
   ...
   std::int32_t m_nSendUpdate; // 0x40 - 0x44
...
public:
   ...
   std::int32_t m_nSendUpdate; // 0x40 - 0x44
   std::int32_t m_nCachedSendUpdate; // 0x44 - 0x48
...
public:
   ...
   std::int32_t m_iAccount; // 0x40 - 0x44
   std::int32_t m_iStartAccount; // 0x44 - 0x48
   std::int32_t m_iTotalCashSpent; // 0x48 - 0x4C
   std::int32_t m_iCashSpentThisRound; // 0x4C - 0x50
   std::int32_t m_nPreviousAccount; // 0x50 - 0x54
...
public:
   ...
   std::int32_t m_iAccountMoneyEarnedForNextRound; // 0x44 - 0x48
   std::int32_t m_iAccount; // 0x48 - 0x4C
   std::int32_t m_iStartAccount; // 0x4C - 0x50
   std::int32_t m_iTotalCashSpent; // 0x50 - 0x54
   std::int32_t m_iCashSpentThisRound; // 0x54 - 0x58
...
public:
   ...
   std::uint16_t m_unMusicID; // 0x40 - 0x42
   MedalRank_t m_rank[6]; // 0x44 - 0x5C
   std::int32_t m_nPersonaDataPublicLevel; // 0x5C - 0x60
   std::int32_t m_nPersonaDataPublicCommendsLeader; // 0x60 - 0x64
   std::int32_t m_nPersonaDataPublicCommendsTeacher; // 0x64 - 0x68
   std::int32_t m_nPersonaDataPublicCommendsFriendly; // 0x68 - 0x6C
...
public:
   ...
   std::int32_t m_iRetakesOffering; // 0x1670 - 0x1674
   std::int32_t m_iRetakesOfferingCard; // 0x1674 - 0x1678
   bool m_bRetakesHasDefuseKit; // 0x1678 - 0x1679
   bool m_bRetakesMVPLastRound; // 0x1679 - 0x167A
   std::int32_t m_iRetakesMVPBoostItem; // 0x167C - 0x1680
   ...
   std::int32_t m_iPlayerLocked; // 0x1804 - 0x1808
   std::float_t m_flNextSprayDecalTime; // 0x180C - 0x1810
   std::int32_t m_nRagdollDamageBone; // 0x1814 - 0x1818
...
public:
   ...
   std::int32_t m_totalHitsOnServer; // 0x40 - 0x44
...
public:
   ...
   std::float_t m_flNextAutoBuyAmmoTime; // 0x40 - 0x44
...
public:
   ...
   std::float_t m_flLastShotFOV; // 0x248 - 0x24C
   std::float_t m_flDeathCamTilt; // 0x24C - 0x250
...
public:
   ...
   std::float_t m_flMaxFallVelocity; // 0x208 - 0x20C
   Vector m_vecLadderNormal; // 0x20C - 0x218
   std::int32_t m_nLadderSurfacePropIndex; // 0x218 - 0x21C
   bool m_bAllowAutoMovement; // 0x21C - 0x21D
   std::float_t m_flDuckAmount; // 0x220 - 0x224
   std::float_t m_flDuckSpeed; // 0x224 - 0x228
   bool m_bDuckOverride; // 0x228 - 0x229
   std::float_t m_flDuckOffset; // 0x22C - 0x230
   std::uint32_t m_nDuckTimeMsecs; // 0x230 - 0x234
   std::uint32_t m_nDuckJumpTimeMsecs; // 0x234 - 0x238
   std::uint32_t m_nJumpTimeMsecs; // 0x238 - 0x23C
   std::float_t m_flLastDuckTime; // 0x23C - 0x240
   ...
   std::int32_t m_nTraceCount; // 0x1360 - 0x1364
   std::int32_t m_StuckLast; // 0x1364 - 0x1368
   bool m_bSpeedCropped; // 0x1368 - 0x1369
   std::int32_t m_nOldWaterLevel; // 0x136C - 0x1370
   std::float_t m_flWaterEntryTime; // 0x1370 - 0x1374
   ...
   std::int32_t m_iFootsteps; // 0x13A8 - 0x13AC
   std::int32_t m_nRoundFootstepsMade; // 0x13AC - 0x13B0
   bool m_bOldJumpPressed; // 0x13B0 - 0x13B1
   std::float_t m_flJumpUntil; // 0x13B4 - 0x13B8
   std::float_t m_flJumpVel; // 0x13B8 - 0x13BC
...
public:
   ...
   std::float_t m_flMaxFallVelocity; // 0x1F8 - 0x1FC
   Vector m_vecLadderNormal; // 0x1FC - 0x208
   std::int32_t m_nLadderSurfacePropIndex; // 0x208 - 0x20C
   bool m_bAllowAutoMovement; // 0x20C - 0x20D
   std::float_t m_flDuckAmount; // 0x210 - 0x214
   std::float_t m_flDuckSpeed; // 0x214 - 0x218
   bool m_bDuckOverride; // 0x218 - 0x219
   std::float_t m_flDuckOffset; // 0x21C - 0x220
   std::uint32_t m_nDuckTimeMsecs; // 0x220 - 0x224
   std::uint32_t m_nDuckJumpTimeMsecs; // 0x224 - 0x228
   std::uint32_t m_nJumpTimeMsecs; // 0x228 - 0x22C
   std::float_t m_flLastDuckTime; // 0x22C - 0x230
   ...
   std::int32_t m_nTraceCount; // 0x1350 - 0x1354
   std::int32_t m_StuckLast; // 0x1354 - 0x1358
   bool m_bSpeedCropped; // 0x1358 - 0x1359
   std::int32_t m_nOldWaterLevel; // 0x135C - 0x1360
   std::float_t m_flWaterEntryTime; // 0x1360 - 0x1364
   ...
   std::float_t m_flJumpUntil; // 0x1398 - 0x139C
   std::float_t m_flJumpVel; // 0x139C - 0x13A0
...
public:
   ...
   std::float_t m_flObsInterp_PathLength; // 0x74 - 0x78
   ...
   std::int32_t m_nLastKillerDamageTaken; // 0xA8 - 0xAC
   std::int32_t m_nLastKillerHitsTaken; // 0xAC - 0xB0
   std::int32_t m_nLastKillerDamageGiven; // 0xB0 - 0xB4
   std::int32_t m_nLastKillerHitsGiven; // 0xB4 - 0xB8
   std::int32_t m_nLastKillerActualDamageGiven; // 0xB8 - 0xBC
   std::int32_t m_nLastKillerActualDamageTaken; // 0xBC - 0xC0
...
public:
   ...
   std::float_t m_NextDrownDamageTime; // 0x40 - 0x44
   std::int32_t m_nDrownDmgRate; // 0x44 - 0x48
   GameTime_t m_AirFinishedTime; // 0x48 - 0x4C
   std::float_t m_flWaterJumpTime; // 0x4C - 0x50
   Vector m_vecWaterJumpVel; // 0x50 - 0x5C
   std::float_t m_flSwimSoundTime; // 0x5C - 0x60
...
public:
   ...
   std::float_t m_flWaterJumpTime; // 0x40 - 0x44
   Vector m_vecWaterJumpVel; // 0x44 - 0x50
   std::float_t m_flSwimSoundTime; // 0x50 - 0x54
...
public:
   ...
   std::int32_t m_nTimeToMelee; // 0xBC - 0xC0
   std::int32_t m_nTimeToSecondary; // 0xC0 - 0xC4
   std::int32_t m_nTimeToPrimary; // 0xC4 - 0xC8
   std::int32_t m_nTimeToSniperRifle; // 0xC8 - 0xCC
...
public:
   ...
   std::int32_t m_nAccumulatedDamage; // 0xB10 - 0xB14
...
public:
   ...
   std::float_t m_flOverrideAlpha; // 0xB00 - 0xB04
...
public:
   ...
   std::int32_t m_nLastRecievedShorthandedRoundBonus; // 0x558 - 0x55C
   std::int32_t m_nShorthandedRoundBonusStartRound; // 0x55C - 0x560
   bool m_bSurrendered; // 0x560 - 0x561
   char m_szTeamMatchStat[512]; // 0x561 - 0x761
   std::int32_t m_numMapVictories; // 0x764 - 0x768
   std::int32_t m_scoreFirstHalf; // 0x768 - 0x76C
   std::int32_t m_scoreSecondHalf; // 0x76C - 0x770
   std::int32_t m_scoreOvertime; // 0x770 - 0x774
   char m_szClanTeamname[129]; // 0x774 - 0x7F5
   std::uint32_t m_iClanID; // 0x7F8 - 0x7FC
   char m_szTeamFlagImage[8]; // 0x7FC - 0x804
   char m_szTeamLogoImage[8]; // 0x804 - 0x80C
   std::float_t m_flNextResourceTime; // 0x80C - 0x810
   std::int32_t m_iLastUpdateSentAt; // 0x810 - 0x814
   std::float_t m_flLastPlayerSortTime; // 0x814 - 0x818
...
public:
   ...
   std::float_t m_flCycle; // 0x3C - 0x40
...
public:
   ...
   std::uint32_t m_OriginalOwnerXuidLow; // 0xD80 - 0xD84
   std::uint32_t m_OriginalOwnerXuidHigh; // 0xD84 - 0xD88
   ...
   std::float_t m_turnRate; // 0xE00 - 0xE04
   ...
   std::float_t m_flLastJumpTime; // 0xE98 - 0xE9C
   ...
   std::float_t m_flActiveFollowStartTime; // 0x2F7C - 0x2F80
...
public:
   ...
   std::float_t m_blendTime; // 0x60 - 0x64
...
public:
   ...
   CUtlString m_name; // 0x8 - 0x10
   std::float_t m_weight; // 0x10 - 0x14
   std::float_t m_blendTime; // 0x14 - 0x18
...
public:
   ...
   std::float_t m_blendTime; // 0xAC - 0xB0
...
public:
   ...
   std::uint8_t m_nRenderFX; // 0x10 - 0x11
   std::uint8_t m_nRenderMode; // 0x11 - 0x12
   bitfield:1 m_bAlphaOverride; // 0x0 - 0x0
   bitfield:1 m_bShadowAlphaOverride; // 0x0 - 0x0
   bitfield:6 m_nReserved; // 0x0 - 0x0
   std::uint8_t m_nAlpha; // 0x13 - 0x14
   std::uint16_t m_nDesyncOffset; // 0x14 - 0x16
   std::uint16_t m_nReserved2; // 0x16 - 0x18
   std::uint16_t m_nDistFadeStart; // 0x18 - 0x1A
   std::uint16_t m_nDistFadeEnd; // 0x1A - 0x1C
   std::float_t m_flFadeScale; // 0x1C - 0x20
   GameTime_t m_flRenderFxStartTime; // 0x20 - 0x24
   std::float_t m_flRenderFxDuration; // 0x24 - 0x28
...
public:
   ...
   std::float_t m_flStiffness; // 0x40 - 0x44
   std::float_t m_flEaseIn; // 0x44 - 0x48
   std::float_t m_flEaseOut; // 0x48 - 0x4C
...
public:
   ...
   std::uint8_t m_usSolidFlags; // 0x5A - 0x5B
   SolidType_t m_nSolidType; // 0x5B - 0x5C
   std::uint8_t m_triggerBloat; // 0x5C - 0x5D
   SurroundingBoundsType_t m_nSurroundType; // 0x5D - 0x5E
   std::uint8_t m_CollisionGroup; // 0x5E - 0x5F
   std::uint8_t m_nEnablePhysics; // 0x5F - 0x60
   std::float_t m_flBoundingRadius; // 0x60 - 0x64
   ...
   std::float_t m_flCapsuleRadius; // 0xAC - 0xB0
...
public:
   ...
   std::float_t m_flFadeInDuration; // 0x4A0 - 0x4A4
   std::float_t m_flFadeOutDuration; // 0x4A4 - 0x4A8
   std::float_t m_flStartFadeInWeight; // 0x4A8 - 0x4AC
   std::float_t m_flStartFadeOutWeight; // 0x4AC - 0x4B0
   GameTime_t m_flTimeStartFadeIn; // 0x4B0 - 0x4B4
   GameTime_t m_flTimeStartFadeOut; // 0x4B4 - 0x4B8
   std::float_t m_flMaxWeight; // 0x4B8 - 0x4BC
   ...
   std::float_t m_MinFalloff; // 0x4C4 - 0x4C8
   std::float_t m_MaxFalloff; // 0x4C8 - 0x4CC
   std::float_t m_flCurWeight; // 0x4CC - 0x4D0
...
public:
   ...
   std::float_t m_MaxWeight; // 0x89C - 0x8A0
   std::float_t m_FadeDuration; // 0x8A0 - 0x8A4
   bool m_bStartDisabled; // 0x8A4 - 0x8A5
   std::float_t m_Weight; // 0x8A8 - 0x8AC
   char m_lookupFilename[512]; // 0x8AC - 0xAAC
   std::float_t m_LastEnterWeight; // 0xAAC - 0xAB0
   GameTime_t m_LastEnterTime; // 0xAB0 - 0xAB4
   std::float_t m_LastExitWeight; // 0xAB4 - 0xAB8
...
public:
   ...
   std::int32_t m_iTeleportStage; // 0x18 - 0x1C
...
public:
   ...
   std::int32_t m_nVersion; // 0x8 - 0xC
...
public:
   ...
   std::int32_t m_nTotalElementCount; // 0x0 - 0x4
...
public:
   ...
   std::float_t m_massScale; // 0x820 - 0x824
...
public:
   ...
   std::uint32_t m_nBoneHash; // 0x1C - 0x20
   std::float_t m_flWeight; // 0x20 - 0x24
...
public:
   ...
   std::uint32_t m_nBoneHash; // 0x3C - 0x40
   CUtlString m_sName; // 0x40 - 0x48
   std::float_t m_flWeight; // 0x48 - 0x4C
...
public:
   ...
   std::float_t m_flLogoLength; // 0x4CC - 0x4D0
...
public:
   ...
   std::float_t m_comparisonValue; // 0x38 - 0x3C
...
public:
   ...
   std::float_t m_duration; // 0x80 - 0x84
...
public:
   ...
   std::float_t m_flModifier; // 0x8 - 0xC
   std::float_t m_flModifierMin; // 0xC - 0x10
   std::float_t m_flSourceModifier; // 0x10 - 0x14
   std::float_t m_flSourceModifierMin; // 0x14 - 0x18
   std::float_t m_flListenerReverbModifierWhenSourceReverbIsActive; // 0x18 - 0x1C
...
public:
   ...
   std::int32_t m_nPlayDoorOpenSound; // 0xDEC - 0xDF0
...
public:
   ...
   std::uint64_t m_DamagerXuid; // 0x48 - 0x50
   std::uint64_t m_RecipientXuid; // 0x50 - 0x58
   std::int32_t m_iDamage; // 0x58 - 0x5C
   std::int32_t m_iActualHealthRemoved; // 0x5C - 0x60
   std::int32_t m_iNumHits; // 0x60 - 0x64
   std::int32_t m_iLastBulletUpdate; // 0x64 - 0x68
...
public:
   ...
   std::float_t m_flAnticipationTime; // 0x30 - 0x34
   std::float_t m_flMinSpeedScale; // 0x34 - 0x38
   AnimParamID m_anticipationPosParam; // 0x38 - 0x3C
   AnimParamID m_anticipationHeadingParam; // 0x3C - 0x40
   std::float_t m_flSpringConstant; // 0x40 - 0x44
   std::float_t m_flMinSpringTension; // 0x44 - 0x48
   std::float_t m_flMaxSpringTension; // 0x48 - 0x4C
...
public:
   ...
   std::float_t m_flAnticipationTime; // 0x2C - 0x30
   std::float_t m_flMinSpeedScale; // 0x30 - 0x34
   CAnimParamHandle m_hAnticipationPosParam; // 0x34 - 0x36
   CAnimParamHandle m_hAnticipationHeadingParam; // 0x36 - 0x38
   std::float_t m_flSpringConstant; // 0x38 - 0x3C
   std::float_t m_flMinSpringTension; // 0x3C - 0x40
   std::float_t m_flMaxSpringTension; // 0x40 - 0x44
...
public:
   ...
   std::float_t m_flExtraRadius; // 0x4B0 - 0x4B4
   GameTime_t m_flExtraRadiusStartTime; // 0x4B4 - 0x4B8
   std::float_t m_flExtraRadiusTotalLerpTime; // 0x4B8 - 0x4BC
   std::int32_t m_nDropOrder; // 0x4BC - 0x4C0
   std::int32_t m_iWave; // 0x4C0 - 0x4C4
   std::int32_t m_nMyZoneIndex; // 0x4C4 - 0x4C8
...
public:
   ...
   std::float_t m_flFinalExpansionTime; // 0x4C0 - 0x4C4
   ...
   std::float_t m_flLastDangerZoneStatusLogged; // 0x584 - 0x588
   GameTime_t m_flLastDangerZoneDamageTime; // 0x588 - 0x58C
   bool m_bFirstBombWarning; // 0x58C - 0x58D
   std::int32_t m_numWaveRewardsGranted; // 0x590 - 0x594
...
public:
   ...
   std::int32_t m_nNpcEvents; // 0x1F44E0 - 0x1F44E4
...
public:
   ...
   std::float_t m_flAnimationScale; // 0x0 - 0x4
   std::float_t m_flAnimationLifeSpan; // 0x4 - 0x8
   std::float_t m_flPlaceTime; // 0x8 - 0xC
   std::float_t m_flFadeStartTime; // 0xC - 0x10
   std::float_t m_flFadeDuration; // 0x10 - 0x14
   std::int32_t m_nVBSlot; // 0x14 - 0x18
   std::int32_t m_nBoneIndex; // 0x18 - 0x1C
   CDecalInfo* m_pNext; // 0x28 - 0x30
   CDecalInfo* m_pPrev; // 0x30 - 0x38
   std::int32_t m_nDecalMaterialIndex; // 0x90 - 0x94
...
public:
   ...
   std::int32_t m_shotsRemaining; // 0x9A8 - 0x9AC
   GameTime_t m_fExpireTime; // 0x9AC - 0x9B0
   std::uint16_t m_decoyWeaponDefIndex; // 0x9B8 - 0x9BA
...
public:
   ...
   std::float_t m_playbackSpeed; // 0x54 - 0x58
...
public:
   ...
   std::float_t m_flMaxDistance; // 0x28 - 0x2C
   bool m_bFilterFixedMinDistance; // 0x2C - 0x2D
   std::float_t m_flMinDistance; // 0x30 - 0x34
   bool m_bFilterGoalDistance; // 0x34 - 0x35
   std::float_t m_flStartGoalFilterDistance; // 0x38 - 0x3C
   bool m_bFilterGoalOvershoot; // 0x3C - 0x3D
   std::float_t m_flMaxGoalOvershootScale; // 0x40 - 0x44
...
public:
   ...
   std::float_t m_flMaxDistance; // 0x50 - 0x54
   std::float_t m_flMinDistance; // 0x54 - 0x58
   std::float_t m_flStartGoalFilterDistance; // 0x58 - 0x5C
   std::float_t m_flMaxGoalOvershootScale; // 0x5C - 0x60
...
public:
   ...
   std::int8_t m_ConeCutoff; // 0xF - 0x10
...
public:
   ...
   std::float_t m_flLastKnownSpeed; // 0xD14 - 0xD18
   std::float_t m_flMaxSpeed; // 0xD18 - 0xD1C
   Vector m_vecCurrentDestination; // 0xD1C - 0xD28
   std::float_t m_flLastKnownDistanceToDestination; // 0xD28 - 0xD2C
   std::float_t m_flLastKnownWaypointAccuracy; // 0xD2C - 0xD30
   ...
   std::float_t m_flLastKnownGroundHeight; // 0xD90 - 0xD94
   ...
   std::int32_t m_tCargoCollisionGroup; // 0xE40 - 0xE44
   ...
   std::float_t m_flRopeLength; // 0xE74 - 0xE78
   ...
   std::int32_t m_nJammedAmount; // 0xE8C - 0xE90
...
public:
   ...
   std::int32_t m_nPoseParamPitch; // 0x858 - 0x85C
   std::int32_t m_nPoseParamYaw; // 0x85C - 0x860
...
public:
   ...
   std::uint8_t m_ActualFlags; // 0x6F0 - 0x6F1
   std::uint8_t m_Flags; // 0x6F1 - 0x6F2
   std::uint8_t m_LightStyle; // 0x6F2 - 0x6F3
   bool m_On; // 0x6F3 - 0x6F4
   std::float_t m_Radius; // 0x6F4 - 0x6F8
   std::int32_t m_Exponent; // 0x6F8 - 0x6FC
   std::float_t m_InnerAngle; // 0x6FC - 0x700
   std::float_t m_OuterAngle; // 0x700 - 0x704
   std::float_t m_SpotRadius; // 0x704 - 0x708
...
public:
   ...
   std::uint16_t m_iAttributeDefinitionIndex; // 0x30 - 0x32
   std::float_t m_flValue; // 0x34 - 0x38
   std::float_t m_flInitialValue; // 0x38 - 0x3C
   std::int32_t m_nRefundableCurrency; // 0x3C - 0x40
...
public:
   ...
   std::uint16_t m_iItemDefinitionIndex; // 0x38 - 0x3A
   std::int32_t m_iEntityQuality; // 0x3C - 0x40
   std::uint32_t m_iEntityLevel; // 0x40 - 0x44
   std::uint64_t m_iItemID; // 0x48 - 0x50
   std::uint32_t m_iItemIDHigh; // 0x50 - 0x54
   std::uint32_t m_iItemIDLow; // 0x54 - 0x58
   std::uint32_t m_iAccountID; // 0x58 - 0x5C
   std::uint32_t m_iInventoryPosition; // 0x5C - 0x60
...
public:
   ...
   std::int32_t m_nForceSkin; // 0xBA8 - 0xBAC
...
public:
   ...
   std::float_t m_flScale; // 0x40 - 0x44
   std::float_t m_flMagnitude; // 0x44 - 0x48
   std::float_t m_flRadius; // 0x48 - 0x4C
   ...
   std::uint32_t m_nDamageType; // 0x58 - 0x5C
   std::uint8_t m_nPenetrate; // 0x5C - 0x5D
   std::uint16_t m_nMaterial; // 0x5E - 0x60
   std::uint16_t m_nHitBox; // 0x60 - 0x62
   std::uint8_t m_nColor; // 0x62 - 0x63
   std::uint8_t m_fFlags; // 0x63 - 0x64
   AttachmentHandle_t m_nAttachmentIndex; // 0x64 - 0x65
   CUtlStringToken m_nAttachmentName; // 0x68 - 0x6C
   std::uint16_t m_iEffectName; // 0x6C - 0x6E
   std::uint8_t m_nExplosionType; // 0x6E - 0x6F
...
public:
   ...
   std::int32_t m_nTagIndex; // 0x18 - 0x1C
...
public:
   ...
   std::uint32_t m_flags; // 0x8 - 0xC
   EntComponentInfo_t* m_pInfo; // 0x10 - 0x18
   std::int32_t m_nPriority; // 0x18 - 0x1C
...
public:
   ...
   std::float_t m_flFadeInStart; // 0x6F0 - 0x6F4
   std::float_t m_flFadeInLength; // 0x6F4 - 0x6F8
   std::float_t m_flFadeOutModelStart; // 0x6F8 - 0x6FC
   std::float_t m_flFadeOutModelLength; // 0x6FC - 0x700
   std::float_t m_flFadeOutStart; // 0x700 - 0x704
   std::float_t m_flFadeOutLength; // 0x704 - 0x708
   GameTime_t m_flStartTime; // 0x708 - 0x70C
   EntityDisolveType_t m_nDissolveType; // 0x70C - 0x710
   Vector m_vDissolverOrigin; // 0x710 - 0x71C
   std::uint32_t m_nMagnitude; // 0x71C - 0x720
...
public:
   ...
   std::float_t m_flSize; // 0x4A8 - 0x4AC
   bool m_bUseHitboxes; // 0x4AC - 0x4AD
   std::int32_t m_iNumHitboxFires; // 0x4B0 - 0x4B4
   std::float_t m_flHitboxFireScale; // 0x4B4 - 0x4B8
   GameTime_t m_flLifetime; // 0x4B8 - 0x4BC
   CHandle< CBaseEntity > m_hAttacker; // 0x4BC - 0x4C0
   std::int32_t m_iDangerSound; // 0x4C0 - 0x4C4
   std::float_t m_flDirectDamagePerSecond; // 0x4C4 - 0x4C8
   std::int32_t m_iCustomDamageType; // 0x4C8 - 0x4CC
...
public:
   ...
   std::int32_t m_nameStringableIndex; // 0x14 - 0x18
   CUtlSymbolLarge m_name; // 0x18 - 0x20
   CUtlSymbolLarge m_designerName; // 0x20 - 0x28
   std::uint32_t m_flags; // 0x30 - 0x34
   WorldGroupId_t m_worldGroupId; // 0x38 - 0x3C
   std::uint32_t m_fDataObjectTypes; // 0x3C - 0x40
...
public:
   ...
   std::uint8_t m_defaultValue; // 0x80 - 0x81
...
public:
   ...
   std::int32_t m_active; // 0x790 - 0x794
   ...
   std::float_t m_life; // 0x7B0 - 0x7B4
   std::float_t m_boltWidth; // 0x7B4 - 0x7B8
   std::float_t m_noiseAmplitude; // 0x7B8 - 0x7BC
   std::int32_t m_speed; // 0x7BC - 0x7C0
   std::float_t m_restrike; // 0x7C0 - 0x7C4
   CUtlSymbolLarge m_iszSpriteName; // 0x7C8 - 0x7D0
   std::int32_t m_frameStart; // 0x7D0 - 0x7D4
   Vector m_vEndPointWorld; // 0x7D4 - 0x7E0
   Vector m_vEndPointRelative; // 0x7E0 - 0x7EC
   std::float_t m_radius; // 0x7EC - 0x7F0
...
public:
   ...
   std::int32_t m_nBeverageType; // 0x4A4 - 0x4A8
...
public:
   ...
   std::float_t m_flBrightness; // 0x1574 - 0x1578
   ...
   std::int32_t m_nHandshake; // 0x15CC - 0x15D0
   std::int32_t m_nEnvCubeMapArrayIndex; // 0x15D0 - 0x15D4
   std::int32_t m_nPriority; // 0x15D4 - 0x15D8
   bool m_bStartDisabled; // 0x15D8 - 0x15D9
   std::float_t m_flEdgeFadeDist; // 0x15DC - 0x15E0
   Vector m_vEdgeFadeDists; // 0x15E0 - 0x15EC
   std::int32_t m_nLightProbeSizeX; // 0x15EC - 0x15F0
   std::int32_t m_nLightProbeSizeY; // 0x15F0 - 0x15F4
   std::int32_t m_nLightProbeSizeZ; // 0x15F4 - 0x15F8
   std::int32_t m_nLightProbeAtlasX; // 0x15F8 - 0x15FC
   std::int32_t m_nLightProbeAtlasY; // 0x15FC - 0x1600
   std::int32_t m_nLightProbeAtlasZ; // 0x1600 - 0x1604
...
public:
   ...
   std::float_t m_flEndDistance; // 0x4A0 - 0x4A4
   std::float_t m_flStartDistance; // 0x4A4 - 0x4A8
   std::float_t m_flFogFalloffExponent; // 0x4A8 - 0x4AC
   bool m_bHeightFogEnabled; // 0x4AC - 0x4AD
   std::float_t m_flFogHeightWidth; // 0x4B0 - 0x4B4
   std::float_t m_flFogHeightEnd; // 0x4B4 - 0x4B8
   std::float_t m_flFogHeightStart; // 0x4B8 - 0x4BC
   std::float_t m_flFogHeightExponent; // 0x4BC - 0x4C0
   std::float_t m_flLODBias; // 0x4C0 - 0x4C4
   bool m_bActive; // 0x4C4 - 0x4C5
   bool m_bStartDisabled; // 0x4C5 - 0x4C6
   std::float_t m_flFogMaxOpacity; // 0x4C8 - 0x4CC
   std::int32_t m_nCubemapSourceType; // 0x4CC - 0x4D0
...
public:
   ...
   std::float_t m_flWidth; // 0x6F8 - 0x6FC
   std::float_t m_flHeight; // 0x6FC - 0x700
   std::float_t m_flDepth; // 0x700 - 0x704
   std::uint32_t m_nRenderOrder; // 0x704 - 0x708
   bool m_bProjectOnWorld; // 0x708 - 0x709
   bool m_bProjectOnCharacters; // 0x709 - 0x70A
   bool m_bProjectOnWater; // 0x70A - 0x70B
   std::float_t m_flDepthSortBias; // 0x70C - 0x710
...
public:
   ...
   std::float_t m_flFadeStartDist; // 0x4A0 - 0x4A4
   std::float_t m_flFadeEndDist; // 0x4A4 - 0x4A8
...
public:
   ...
   std::float_t m_flLifetime; // 0x4A0 - 0x4A4
...
public:
   ...
   std::float_t m_flPostSpawnDirectionVariance; // 0x4D8 - 0x4DC
   std::float_t m_flPostSpawnSpeed; // 0x4DC - 0x4E0
...
public:
   ...
   std::int32_t m_iMagnitude; // 0x6F0 - 0x6F4
   std::float_t m_flPlayerDamage; // 0x6F4 - 0x6F8
   std::int32_t m_iRadiusOverride; // 0x6F8 - 0x6FC
   std::float_t m_flInnerRadius; // 0x6FC - 0x700
   std::int32_t m_spriteScale; // 0x700 - 0x704
   std::float_t m_flDamageForce; // 0x704 - 0x708
   CHandle< CBaseEntity > m_hInflictor; // 0x708 - 0x70C
   std::int32_t m_iCustomDamageType; // 0x70C - 0x710
...
public:
   ...
   std::float_t m_Duration; // 0x4A4 - 0x4A8
   std::float_t m_HoldDuration; // 0x4A8 - 0x4AC
...
public:
   ...
   std::float_t m_radius; // 0x4A4 - 0x4A8
   std::float_t m_targetLevel; // 0x4A8 - 0x4AC
   std::float_t m_targetTime; // 0x4AC - 0x4B0
   std::float_t m_levelTime; // 0x4B0 - 0x4B4
...
public:
   ...
   bool m_bEnabled; // 0x4A0 - 0x4A1
   std::float_t m_radius; // 0x4A4 - 0x4A8
   std::float_t m_damage; // 0x4A8 - 0x4AC
...
public:
   ...
   std::float_t m_flDamageRadius; // 0x824 - 0x828
   std::float_t m_flDamage; // 0x828 - 0x82C
   ...
   std::float_t m_flFlightTime; // 0x8E4 - 0x8E8
   std::float_t m_flFlightSpeed; // 0x8E8 - 0x8EC
   GameTime_t m_flLaunchTime; // 0x8EC - 0x8F0
   std::float_t m_flInitialZSpeed; // 0x8F0 - 0x8F4
   std::float_t m_flZAcceleration; // 0x8F4 - 0x8F8
   std::float_t m_flHorizSpeed; // 0x8F8 - 0x8FC
   bool m_bLaunchedFromWithinWorld; // 0x8FC - 0x8FD
   Vector m_vecParabolaDirection; // 0x900 - 0x90C
   std::float_t m_flWorldEnterTime; // 0x90C - 0x910
   Vector m_vecSkyboxOrigin; // 0x910 - 0x91C
   std::float_t m_flSkyboxScale; // 0x91C - 0x920
   bool m_bInSkybox; // 0x920 - 0x921
   bool m_bDoImpactEffects; // 0x921 - 0x922
   std::int32_t m_nMyZoneIndex; // 0x924 - 0x928
   CHandle< CBaseEntity > m_hSkyboxCopy; // 0x928 - 0x92C
   std::float_t m_flLaunchHeight; // 0x92C - 0x930
...
public:
   ...
   std::int32_t m_triggermode; // 0x4D0 - 0x4D4
   std::int32_t m_initialstate; // 0x4D4 - 0x4D8
   std::int32_t m_counter; // 0x4D8 - 0x4DC
...
public:
   ...
   std::int32_t m_iTimeout; // 0x4B8 - 0x4BC
   std::int32_t m_iDisplayLimit; // 0x4BC - 0x4C0
   ...
   std::float_t m_fIconOffset; // 0x4E4 - 0x4E8
   std::float_t m_fRange; // 0x4E8 - 0x4EC
   std::uint8_t m_iPulseOption; // 0x4EC - 0x4ED
   std::uint8_t m_iAlphaOption; // 0x4ED - 0x4EE
   std::uint8_t m_iShakeOption; // 0x4EE - 0x4EF
   bool m_bStatic; // 0x4EF - 0x4F0
   bool m_bNoOffscreen; // 0x4F0 - 0x4F1
   bool m_bForceCaption; // 0x4F1 - 0x4F2
   std::int32_t m_iInstanceType; // 0x4F4 - 0x4F8
...
public:
   ...
   std::int32_t m_iTimeout; // 0x4B0 - 0x4B4
   CUtlSymbolLarge m_iszCaption; // 0x4B8 - 0x4C0
   CUtlSymbolLarge m_iszStartSound; // 0x4C0 - 0x4C8
   std::int32_t m_iLayoutFileType; // 0x4C8 - 0x4CC
   CUtlSymbolLarge m_iszCustomLayoutFile; // 0x4D0 - 0x4D8
   std::int32_t m_iAttachType; // 0x4D8 - 0x4DC
   std::float_t m_flHeightOffset; // 0x4DC - 0x4E0
...
public:
   ...
   std::float_t m_flStartFrame; // 0x7B4 - 0x7B8
...
public:
   ...
   std::int32_t m_nHandshake; // 0x14C4 - 0x14C8
   std::int32_t m_nPriority; // 0x14C8 - 0x14CC
   bool m_bStartDisabled; // 0x14CC - 0x14CD
   std::int32_t m_nLightProbeSizeX; // 0x14D0 - 0x14D4
   std::int32_t m_nLightProbeSizeY; // 0x14D4 - 0x14D8
   std::int32_t m_nLightProbeSizeZ; // 0x14D8 - 0x14DC
   std::int32_t m_nLightProbeAtlasX; // 0x14DC - 0x14E0
   std::int32_t m_nLightProbeAtlasY; // 0x14E0 - 0x14E4
   std::int32_t m_nLightProbeAtlasZ; // 0x14E4 - 0x14E8
...
public:
   ...
   std::int32_t m_nSoundMask; // 0x4A8 - 0x4AC
   std::float_t m_flSensitivity; // 0x4AC - 0x4B0
   std::float_t m_flSmoothFactor; // 0x4B0 - 0x4B4
   std::float_t m_flMaxRange; // 0x4B4 - 0x4B8
   CUtlSymbolLarge m_iszSpeakerName; // 0x4B8 - 0x4C0
   CHandle< CBaseEntity > m_hSpeaker; // 0x4C0 - 0x4C4
   bool m_bAvoidFeedback; // 0x4C4 - 0x4C5
   std::int32_t m_iSpeakerDSPPreset; // 0x4C8 - 0x4CC
   ...
   std::int32_t m_iLastRoutedFrame; // 0x658 - 0x65C
...
public:
   ...
   std::float_t m_flAlphaScale; // 0xC68 - 0xC6C
   std::float_t m_flRadiusScale; // 0xC6C - 0xC70
   std::float_t m_flSelfIllumScale; // 0xC70 - 0xC74
...
public:
   ...
   std::float_t m_flLightFOV; // 0x6F8 - 0x6FC
   ...
   std::float_t m_flIntensity; // 0x70C - 0x710
   std::float_t m_flLinearAttenuation; // 0x710 - 0x714
   std::float_t m_flQuadraticAttenuation; // 0x714 - 0x718
   bool m_bVolumetric; // 0x718 - 0x719
   std::float_t m_flNoiseStrength; // 0x71C - 0x720
   std::float_t m_flFlashlightTime; // 0x720 - 0x724
   std::uint32_t m_nNumPlanes; // 0x724 - 0x728
   std::float_t m_flPlaneOffset; // 0x728 - 0x72C
   std::float_t m_flVolumetricIntensity; // 0x72C - 0x730
   std::float_t m_flColorTransitionTime; // 0x730 - 0x734
   std::float_t m_flAmbient; // 0x734 - 0x738
   char m_SpotlightTextureName[512]; // 0x738 - 0x938
   std::int32_t m_nSpotlightTextureFrame; // 0x938 - 0x93C
   std::uint32_t m_nShadowQuality; // 0x93C - 0x940
   std::float_t m_flNearZ; // 0x940 - 0x944
   std::float_t m_flFarZ; // 0x944 - 0x948
   std::float_t m_flProjectionSize; // 0x948 - 0x94C
   std::float_t m_flRotation; // 0x94C - 0x950
...
public:
   ...
   std::int32_t m_iDesiredOverlay; // 0x51C - 0x520
...
public:
   ...
   std::float_t m_Amplitude; // 0x4A8 - 0x4AC
   std::float_t m_Frequency; // 0x4AC - 0x4B0
   std::float_t m_Duration; // 0x4B0 - 0x4B4
   std::float_t m_Radius; // 0x4B4 - 0x4B8
   GameTime_t m_stopTime; // 0x4B8 - 0x4BC
   GameTime_t m_nextShake; // 0x4BC - 0x4C0
   std::float_t m_currentAmp; // 0x4C0 - 0x4C4
...
public:
   ...
   std::float_t m_flBrightnessScale; // 0x700 - 0x704
   std::int32_t m_nFogType; // 0x704 - 0x708
   std::float_t m_flFogMinStart; // 0x708 - 0x70C
   std::float_t m_flFogMinEnd; // 0x70C - 0x710
   std::float_t m_flFogMaxStart; // 0x710 - 0x714
   std::float_t m_flFogMaxEnd; // 0x714 - 0x718
...
public:
   ...
   std::float_t m_flDelay; // 0x4A0 - 0x4A4
   std::int32_t m_nMagnitude; // 0x4A4 - 0x4A8
   std::int32_t m_nTrailLength; // 0x4A8 - 0x4AC
   std::int32_t m_nType; // 0x4AC - 0x4B0
...
public:
   ...
   std::float_t m_Duration; // 0x4A0 - 0x4A4
   std::float_t m_Radius; // 0x4A4 - 0x4A8
   std::float_t m_TiltTime; // 0x4A8 - 0x4AC
...
public:
   ...
   std::float_t m_flDelay; // 0x4AC - 0x4B0
...
public:
   ...
   std::float_t m_flScattering; // 0x4A0 - 0x4A4
   std::float_t m_flAnisotropy; // 0x4A4 - 0x4A8
   std::float_t m_flFadeSpeed; // 0x4A8 - 0x4AC
   std::float_t m_flDrawDistance; // 0x4AC - 0x4B0
   std::float_t m_flFadeInStart; // 0x4B0 - 0x4B4
   std::float_t m_flFadeInEnd; // 0x4B4 - 0x4B8
   std::float_t m_flIndirectStrength; // 0x4B8 - 0x4BC
   std::int32_t m_nIndirectTextureDimX; // 0x4BC - 0x4C0
   std::int32_t m_nIndirectTextureDimY; // 0x4C0 - 0x4C4
   std::int32_t m_nIndirectTextureDimZ; // 0x4C4 - 0x4C8
   ...
   std::float_t m_flStartAnisotropy; // 0x4F0 - 0x4F4
   std::float_t m_flStartScattering; // 0x4F4 - 0x4F8
   std::float_t m_flStartDrawDistance; // 0x4F8 - 0x4FC
   std::float_t m_flDefaultAnisotropy; // 0x4FC - 0x500
   std::float_t m_flDefaultScattering; // 0x500 - 0x504
   std::float_t m_flDefaultDrawDistance; // 0x504 - 0x508
   ...
   std::int32_t m_nForceRefreshCount; // 0x518 - 0x51C
...
public:
   ...
   bool m_bStartDisabled; // 0x4BC - 0x4BD
   std::float_t m_flStrength; // 0x4C0 - 0x4C4
   std::int32_t m_nFalloffShape; // 0x4C4 - 0x4C8
   std::float_t m_flFalloffExponent; // 0x4C8 - 0x4CC
...
public:
   ...
   public:
      ...
      std::float_t m_flStartWindSpeed; // 0x0 - 0x4
      std::float_t m_flAveWindSpeed; // 0x4 - 0x8
   ...
   public:
      ...
      std::float_t m_flWindAngleVariation; // 0x0 - 0x4
      std::float_t m_flWindSpeedVariation; // 0x4 - 0x8

   }; // size - 0x8

   GameTime_t m_flStartTime; // 0x8 - 0xC
   std::uint32_t m_iWindSeed; // 0xC - 0x10
   std::uint16_t m_iMinWind; // 0x10 - 0x12
   std::uint16_t m_iMaxWind; // 0x12 - 0x14
   std::int32_t m_windRadius; // 0x14 - 0x18
   std::uint16_t m_iMinGust; // 0x18 - 0x1A
   std::uint16_t m_iMaxGust; // 0x1A - 0x1C
   std::float_t m_flMinGustDelay; // 0x1C - 0x20
   std::float_t m_flMaxGustDelay; // 0x20 - 0x24
   std::float_t m_flGustDuration; // 0x24 - 0x28
   std::uint16_t m_iGustDirChange; // 0x28 - 0x2A
   Vector m_location; // 0x2C - 0x38
   std::int32_t m_iszGustSound; // 0x38 - 0x3C
   std::int32_t m_iWindDir; // 0x3C - 0x40
   std::float_t m_flWindSpeed; // 0x40 - 0x44
   Vector m_currentWindVector; // 0x44 - 0x50
   Vector m_CurrentSwayVector; // 0x50 - 0x5C
   Vector m_PrevSwayVector; // 0x5C - 0x68
   std::uint16_t m_iInitialWindDir; // 0x68 - 0x6A
   std::float_t m_flInitialWindSpeed; // 0x6C - 0x70
   ...
   std::float_t m_flAveWindSpeed; // 0xD0 - 0xD4
   bool m_bGusting; // 0xD4 - 0xD5
   std::float_t m_flWindAngleVariation; // 0xD8 - 0xDC
   std::float_t m_flWindSpeedVariation; // 0xDC - 0xE0
...
public:
   ...
   std::float_t m_flSpeed; // 0x4A0 - 0x4A4
   std::int32_t m_nFOV; // 0x4A4 - 0x4A8
...
public:
   ...
   std::int32_t m_nExample1; // 0x0 - 0x4
   std::int32_t m_nExample2; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_nDerivedA; // 0x10 - 0x14
...
public:
   ...
   std::int32_t m_nDerivedB; // 0x10 - 0x14
...
public:
   ...
   std::uint32_t m_nNode; // 0x0 - 0x4
   std::uint32_t m_nJiggleParent; // 0x4 - 0x8
...
public:
   ...
   std::uint32_t m_nFlags; // 0x0 - 0x4
   std::float_t m_flLength; // 0x4 - 0x8
   std::float_t m_flTipMass; // 0x8 - 0xC
   std::float_t m_flYawStiffness; // 0xC - 0x10
   std::float_t m_flYawDamping; // 0x10 - 0x14
   std::float_t m_flPitchStiffness; // 0x14 - 0x18
   std::float_t m_flPitchDamping; // 0x18 - 0x1C
   std::float_t m_flAlongStiffness; // 0x1C - 0x20
   std::float_t m_flAlongDamping; // 0x20 - 0x24
   std::float_t m_flAngleLimit; // 0x24 - 0x28
   std::float_t m_flMinYaw; // 0x28 - 0x2C
   std::float_t m_flMaxYaw; // 0x2C - 0x30
   std::float_t m_flYawFriction; // 0x30 - 0x34
   std::float_t m_flYawBounce; // 0x34 - 0x38
   std::float_t m_flMinPitch; // 0x38 - 0x3C
   std::float_t m_flMaxPitch; // 0x3C - 0x40
   std::float_t m_flPitchFriction; // 0x40 - 0x44
   std::float_t m_flPitchBounce; // 0x44 - 0x48
   std::float_t m_flBaseMass; // 0x48 - 0x4C
   std::float_t m_flBaseStiffness; // 0x4C - 0x50
   std::float_t m_flBaseDamping; // 0x50 - 0x54
   std::float_t m_flBaseMinLeft; // 0x54 - 0x58
   std::float_t m_flBaseMaxLeft; // 0x58 - 0x5C
   std::float_t m_flBaseLeftFriction; // 0x5C - 0x60
   std::float_t m_flBaseMinUp; // 0x60 - 0x64
   std::float_t m_flBaseMaxUp; // 0x64 - 0x68
   std::float_t m_flBaseUpFriction; // 0x68 - 0x6C
   std::float_t m_flBaseMinForward; // 0x6C - 0x70
   std::float_t m_flBaseMaxForward; // 0x70 - 0x74
   std::float_t m_flBaseForwardFriction; // 0x74 - 0x78
   std::float_t m_flRadius0; // 0x78 - 0x7C
   std::float_t m_flRadius1; // 0x7C - 0x80
   Vector m_vPoint0; // 0x80 - 0x8C
   Vector m_vPoint1; // 0x8C - 0x98
   std::uint16_t m_nCollisionMask; // 0x98 - 0x9A
...
public:
   ...
   CUtlString m_Name; // 0x0 - 0x8
   std::uint32_t m_nNameHash; // 0x8 - 0xC
...
public:
   ...
   std::uint32_t m_nJiggleParent; // 0x30 - 0x34
...
public:
   ...
   std::float_t m_flRadius; // 0x500 - 0x504
   std::float_t m_flOuterRadius; // 0x504 - 0x508
   std::int32_t m_nMaxSquadmatesPerEnemy; // 0x508 - 0x50C
...
public:
   ...
   std::float_t m_fFilterMass; // 0x4F8 - 0x4FC
...
public:
   ...
   std::int32_t m_nFilterCount; // 0x578 - 0x57C
...
public:
   ...
   std::float_t m_flRadius; // 0x4F8 - 0x4FC
...
public:
   ...
   std::float_t m_flMinAngle; // 0x2C - 0x30
   std::float_t m_flMaxAngle; // 0x30 - 0x34
   std::float_t m_flRadius; // 0x34 - 0x38
...
public:
   ...
   std::float_t m_flSplayMinAngle; // 0x64 - 0x68
   std::float_t m_flSplayMaxAngle; // 0x68 - 0x6C
   std::float_t m_flFingerScaleRatio; // 0x6C - 0x70
...
public:
   ...
   std::float_t m_flFingerWeight; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_nFireType; // 0x6F8 - 0x6FC
   std::float_t m_flFuel; // 0x6FC - 0x700
   GameTime_t m_flDamageTime; // 0x700 - 0x704
   GameTime_t m_lastDamage; // 0x704 - 0x708
   std::float_t m_flFireSize; // 0x708 - 0x70C
   GameTime_t m_flLastNavUpdateTime; // 0x70C - 0x710
   std::float_t m_flHeatLevel; // 0x710 - 0x714
   std::float_t m_flHeatAbsorb; // 0x714 - 0x718
   std::float_t m_flDamageScale; // 0x718 - 0x71C
   std::float_t m_flMaxHeat; // 0x71C - 0x720
   std::float_t m_flLastHeatLevel; // 0x720 - 0x724
   std::float_t m_flAttackTime; // 0x724 - 0x728
...
public:
   ...
   std::float_t m_flScale; // 0x108 - 0x10C
   std::int32_t m_nGUID; // 0x10C - 0x110
...
public:
   ...
   std::int32_t m_nFlameModelIndex; // 0x4B0 - 0x4B4
   std::int32_t m_nFlameFromAboveModelIndex; // 0x4B4 - 0x4B8
...
public:
   ...
   std::uint32_t m_id; // 0x824 - 0x828
   std::float_t m_x; // 0x828 - 0x82C
   std::float_t m_y; // 0x82C - 0x830
   std::float_t m_z; // 0x830 - 0x834
   std::float_t m_angle; // 0x834 - 0x838
   std::float_t m_angleChange; // 0x838 - 0x83C
   Vector m_forward; // 0x83C - 0x848
   Vector m_perp; // 0x848 - 0x854
   Vector m_poolOrigin; // 0x854 - 0x860
   std::float_t m_waterLevel; // 0x860 - 0x864
   std::float_t m_speed; // 0x864 - 0x868
   std::float_t m_desiredSpeed; // 0x868 - 0x86C
   std::float_t m_calmSpeed; // 0x86C - 0x870
   std::float_t m_panicSpeed; // 0x870 - 0x874
   std::float_t m_avoidRange; // 0x874 - 0x878
...
public:
   ...
   std::int32_t m_fishCount; // 0x4B0 - 0x4B4
   std::float_t m_maxRange; // 0x4B4 - 0x4B8
   std::float_t m_swimDepth; // 0x4B8 - 0x4BC
   std::float_t m_waterLevel; // 0x4BC - 0x4C0
...
public:
   ...
   std::float_t m_flTimeToDetonate; // 0x9A0 - 0x9A4
   std::uint8_t m_numOpponentsHit; // 0x9A4 - 0x9A5
   std::uint8_t m_numTeammatesHit; // 0x9A5 - 0x9A6
...
public:
   ...
   std::float_t m_flMuzzleFlashBrightness; // 0x24 - 0x28
   Quaternion m_quatMuzzleFlashOrientation; // 0x30 - 0x40
   Vector m_vecMuzzleFlashOrigin; // 0x40 - 0x4C
   std::float_t m_flFov; // 0x4C - 0x50
   std::float_t m_flFarZ; // 0x50 - 0x54
   std::float_t m_flLinearAtten; // 0x54 - 0x58
   bool m_bCastsShadows; // 0x58 - 0x59
   std::float_t m_flCurrentPullBackDist; // 0x5C - 0x60
...
public:
   ...
   std::float_t min; // 0x10 - 0x14
   std::float_t max; // 0x14 - 0x18
...
public:
   ...
   std::float_t m_fDefaultValue; // 0x78 - 0x7C
   std::float_t m_fMinValue; // 0x7C - 0x80
   std::float_t m_fMaxValue; // 0x80 - 0x84
...
public:
   ...
   std::float_t m_flConstValue; // 0x8 - 0xC
...
public:
   ...
   std::int32_t m_iChangedVariables; // 0x50C - 0x510
...
public:
   ...
   CAnimNodeConnection m_inputConnection; // 0x38 - 0x40
   std::float_t m_flBlendOutTime; // 0x40 - 0x44
   bool m_bBlockNonPathMovement; // 0x44 - 0x45
   bool m_bStopFeetAtGoal; // 0x45 - 0x46
   bool m_bScaleSpeed; // 0x46 - 0x47
   std::float_t m_flScale; // 0x48 - 0x4C
   std::float_t m_flMinAngle; // 0x4C - 0x50
   std::float_t m_flMaxAngle; // 0x50 - 0x54
   std::float_t m_flSpeedScaleBlending; // 0x54 - 0x58
   bool m_bTurnToFace; // 0x58 - 0x59
   AnimValueSource m_facingTarget; // 0x5C - 0x60
   AnimParamID m_param; // 0x60 - 0x64
   std::float_t m_flTurnToFaceOffset; // 0x64 - 0x68
...
public:
   ...
   std::float_t m_flBlendOutTime; // 0x6C - 0x70
   bool m_bBlockNonPathMovement; // 0x70 - 0x71
   bool m_bStopFeetAtGoal; // 0x71 - 0x72
   bool m_bScaleSpeed; // 0x72 - 0x73
   std::float_t m_flScale; // 0x74 - 0x78
   std::float_t m_flMinAngle; // 0x78 - 0x7C
   std::float_t m_flMaxAngle; // 0x7C - 0x80
   std::float_t m_flSpeedScaleBlending; // 0x80 - 0x84
   CAnimInputDamping m_turnDamping; // 0x88 - 0x98
   AnimValueSource m_facingTarget; // 0x98 - 0x9C
   CAnimParamHandle m_hParam; // 0x9C - 0x9E
   std::float_t m_flTurnToFaceOffset; // 0xA0 - 0xA4
...
public:
   ...
   std::float_t m_flTurnTimeMin; // 0x68 - 0x6C
   std::float_t m_flTurnTimeMax; // 0x6C - 0x70
   std::float_t m_flStepHeightMax; // 0x70 - 0x74
   std::float_t m_flStepHeightMaxAngle; // 0x74 - 0x78
...
public:
   ...
   std::float_t m_flTurnTimeMin; // 0x90 - 0x94
   std::float_t m_flTurnTimeMax; // 0x94 - 0x98
   std::float_t m_flStepHeightMax; // 0x98 - 0x9C
   std::float_t m_flStepHeightMaxAngle; // 0x9C - 0xA0
...
public:
   ...
   std::float_t m_flStanceDirectionMS; // 0x18 - 0x1C
...
public:
   ...
   std::float_t m_flFootLength; // 0x30 - 0x34
   std::float_t m_flBindPoseDirectionMS; // 0x34 - 0x38
   std::float_t m_flTraceHeight; // 0x38 - 0x3C
   std::float_t m_flTraceRadius; // 0x3C - 0x40
...
public:
   ...
   std::float_t m_flBlendTime; // 0x60 - 0x64
   ...
   std::float_t m_flMaxLegTwist; // 0x70 - 0x74
   std::float_t m_flStrideCurveScale; // 0x74 - 0x78
   std::float_t m_flStrideCurveLimitScale; // 0x78 - 0x7C
   bool m_bEnableVerticalCurvedPaths; // 0x7C - 0x7D
   bool m_bModulateStepHeight; // 0x7D - 0x7E
   std::float_t m_flStepHeightIncreaseScale; // 0x80 - 0x84
   std::float_t m_flStepHeightDecreaseScale; // 0x84 - 0x88
   bool m_bEnableHipShift; // 0x88 - 0x89
   std::float_t m_flHipShiftScale; // 0x8C - 0x90
   CAnimInputDamping m_hipShiftDamping; // 0x90 - 0xA0
   bool m_bApplyTilt; // 0xA0 - 0xA1
   std::float_t m_flTiltPlanePitchSpringStrength; // 0xA4 - 0xA8
   std::float_t m_flTiltPlaneRollSpringStrength; // 0xA8 - 0xAC
   bool m_bEnableLockBreaking; // 0xAC - 0xAD
   std::float_t m_flLockBreakTolerance; // 0xB0 - 0xB4
   std::float_t m_flLockBreakBlendTime; // 0xB4 - 0xB8
   bool m_bEnableStretching; // 0xB8 - 0xB9
   std::float_t m_flMaxStretchAmount; // 0xBC - 0xC0
   std::float_t m_flStretchExtensionScale; // 0xC0 - 0xC4
   bool m_bEnableGroundTracing; // 0xC4 - 0xC5
   std::float_t m_flTraceAngleBlend; // 0xC8 - 0xCC
   bool m_bApplyHipDrop; // 0xCC - 0xCD
   std::float_t m_flMaxFootHeight; // 0xD0 - 0xD4
   std::float_t m_flExtensionScale; // 0xD4 - 0xD8
   ...
   std::float_t m_flMaxRootHeightOffset; // 0x100 - 0x104
   std::float_t m_flMinRootHeightOffset; // 0x104 - 0x108
...
public:
   ...
   std::float_t m_flMaxRotationLeft; // 0x1C - 0x20
   std::float_t m_flMaxRotationRight; // 0x20 - 0x24
...
public:
   ...
   std::float_t m_flStrideCurveScale; // 0x108 - 0x10C
   std::float_t m_flStrideCurveLimitScale; // 0x10C - 0x110
   std::float_t m_flStepHeightIncreaseScale; // 0x110 - 0x114
   std::float_t m_flStepHeightDecreaseScale; // 0x114 - 0x118
   std::float_t m_flHipShiftScale; // 0x118 - 0x11C
   std::float_t m_flBlendTime; // 0x11C - 0x120
   std::float_t m_flMaxRootHeightOffset; // 0x120 - 0x124
   std::float_t m_flMinRootHeightOffset; // 0x124 - 0x128
   std::float_t m_flTiltPlanePitchSpringStrength; // 0x128 - 0x12C
   std::float_t m_flTiltPlaneRollSpringStrength; // 0x12C - 0x130
...
public:
   ...
   std::float_t m_flBlendTime; // 0x5C - 0x60
   std::float_t m_flLockBreakDistance; // 0x60 - 0x64
   std::float_t m_flMaxLegStraightAmount; // 0x64 - 0x68
   bool m_bApplyFootRotationLimits; // 0x68 - 0x69
   CUtlString m_hipBoneName; // 0x70 - 0x78
   bool m_bApplyLegTwistLimits; // 0x78 - 0x79
   std::float_t m_flMaxLegTwist; // 0x7C - 0x80
...
public:
   ...
   std::float_t m_flMaxRotationLeft; // 0x20 - 0x24
   std::float_t m_flMaxRotationRight; // 0x24 - 0x28
...
public:
   ...
   CAnimNodeConnection m_inputConnection; // 0x38 - 0x40
   std::float_t m_flTolerance; // 0x40 - 0x44
...
public:
   ...
   std::float_t m_flTolerance; // 0x84 - 0x88
...
public:
   ...
   std::float_t m_flRotationOffset; // 0xC - 0x10
   std::float_t m_flProgression; // 0x10 - 0x14
...
public:
   ...
   std::float_t m_flTransitionDurationSeconds; // 0x6F8 - 0x6FC
   QAngle m_angMoveEntitySpace; // 0x6FC - 0x708
   Vector m_vecMoveDirEntitySpace; // 0x708 - 0x714
   std::float_t m_flTargetSpeed; // 0x714 - 0x718
   GameTick_t m_nTransitionStartTick; // 0x718 - 0x71C
   std::int32_t m_nTransitionDurationTicks; // 0x71C - 0x720
   std::float_t m_flTransitionStartSpeed; // 0x720 - 0x724
...
public:
   ...
   std::int32_t m_nResolutionEnum; // 0x718 - 0x71C
...
public:
   ...
   std::float_t m_flFanFriction; // 0x6FC - 0x700
   std::float_t m_flAttenuation; // 0x700 - 0x704
   std::float_t m_flVolume; // 0x704 - 0x708
   std::float_t m_flTargetSpeed; // 0x708 - 0x70C
   std::float_t m_flMaxSpeed; // 0x70C - 0x710
   std::float_t m_flBlockDamage; // 0x710 - 0x714
   std::float_t m_flTimeScale; // 0x714 - 0x718
...
public:
   ...
   std::int32_t m_nNumShardsEverCreated; // 0x7A4 - 0x7A8
   ...
   std::float_t m_flGlassThickness; // 0x7B4 - 0x7B8
   std::float_t m_flSpawnInvulnerability; // 0x7B8 - 0x7BC
   ...
   std::uint8_t m_iInitialDamageType; // 0x7C3 - 0x7C4
   ...
   std::uint8_t m_iSurfaceType; // 0x841 - 0x842
...
public:
   ...
   std::float_t m_flDesiredTimescale; // 0x4A0 - 0x4A4
   std::float_t m_flAcceleration; // 0x4A4 - 0x4A8
   std::float_t m_flMinBlendRate; // 0x4A8 - 0x4AC
   std::float_t m_flBlendDeltaMultiplier; // 0x4AC - 0x4B0
...
public:
   ...
   std::float_t m_flBlockDamage; // 0x7A4 - 0x7A8
...
public:
   ...
   std::int32_t m_nMaxTempVarsUsed; // 0x48 - 0x4C
...
public:
   ...
   std::float_t m_flDistance; // 0x28 - 0x2C
   std::float_t m_flTime; // 0x2C - 0x30
...
public:
   ...
   std::float_t m_flDistance; // 0x50 - 0x54
   std::float_t m_flTime; // 0x54 - 0x58
...
public:
   ...
   std::float_t m_flDistance; // 0x28 - 0x2C
   std::float_t m_flStoppingDistance; // 0x2C - 0x30
   VelocityMetricMode m_eMode; // 0x30 - 0x31
   bool m_bAutoTargetSpeed; // 0x31 - 0x32
   std::float_t m_flManualTargetSpeed; // 0x34 - 0x38
...
public:
   ...
   std::float_t m_flDistance; // 0x50 - 0x54
   std::float_t m_flStoppingDistance; // 0x54 - 0x58
   std::float_t m_flTargetSpeed; // 0x58 - 0x5C
...
public:
   ...
   std::int32_t m_iCurrentMaxPieces; // 0x4C4 - 0x4C8
   std::int32_t m_iMaxPieces; // 0x4C8 - 0x4CC
   std::int32_t m_iLastFrame; // 0x4CC - 0x4D0
...
public:
   ...
   std::float_t m_flAngRate; // 0x3C - 0x40
   std::float_t m_flDuration; // 0x40 - 0x44
...
public:
   ...
   std::int32_t m_iMaxPieces; // 0x4B0 - 0x4B4
   std::float_t m_flAmmoMod; // 0x4B4 - 0x4B8
...
public:
   ...
   std::float_t m_flLinearFrequencyX; // 0x50C - 0x510
   std::float_t m_flLinearFrequencyY; // 0x510 - 0x514
   std::float_t m_flLinearFrequencyZ; // 0x514 - 0x518
   std::float_t m_flLinearDampingRatioX; // 0x518 - 0x51C
   std::float_t m_flLinearDampingRatioY; // 0x51C - 0x520
   std::float_t m_flLinearDampingRatioZ; // 0x520 - 0x524
   std::float_t m_flMaxLinearImpulseX; // 0x524 - 0x528
   std::float_t m_flMaxLinearImpulseY; // 0x528 - 0x52C
   std::float_t m_flMaxLinearImpulseZ; // 0x52C - 0x530
   std::float_t m_flBreakAfterTimeX; // 0x530 - 0x534
   std::float_t m_flBreakAfterTimeY; // 0x534 - 0x538
   std::float_t m_flBreakAfterTimeZ; // 0x538 - 0x53C
   ...
   std::float_t m_flBreakAfterTimeThresholdX; // 0x548 - 0x54C
   std::float_t m_flBreakAfterTimeThresholdY; // 0x54C - 0x550
   std::float_t m_flBreakAfterTimeThresholdZ; // 0x550 - 0x554
   std::float_t m_flNotifyForceX; // 0x554 - 0x558
   std::float_t m_flNotifyForceY; // 0x558 - 0x55C
   std::float_t m_flNotifyForceZ; // 0x55C - 0x560
   std::float_t m_flNotifyForceMinTimeX; // 0x560 - 0x564
   std::float_t m_flNotifyForceMinTimeY; // 0x564 - 0x568
   std::float_t m_flNotifyForceMinTimeZ; // 0x568 - 0x56C
   ...
   std::float_t m_flAngularFrequencyX; // 0x588 - 0x58C
   std::float_t m_flAngularFrequencyY; // 0x58C - 0x590
   std::float_t m_flAngularFrequencyZ; // 0x590 - 0x594
   std::float_t m_flAngularDampingRatioX; // 0x594 - 0x598
   std::float_t m_flAngularDampingRatioY; // 0x598 - 0x59C
   std::float_t m_flAngularDampingRatioZ; // 0x59C - 0x5A0
   std::float_t m_flMaxAngularImpulseX; // 0x5A0 - 0x5A4
   std::float_t m_flMaxAngularImpulseY; // 0x5A4 - 0x5A8
   std::float_t m_flMaxAngularImpulseZ; // 0x5A8 - 0x5AC
...
public:
   ...
   std::float_t m_flSpecularPower; // 0x5C - 0x60
   std::float_t m_flSpecularIndependence; // 0x60 - 0x64
   ...
   std::float_t m_flSunDistance; // 0x7C - 0x80
   std::float_t m_flFOV; // 0x80 - 0x84
   std::float_t m_flNearZ; // 0x84 - 0x88
   std::float_t m_flFarZ; // 0x88 - 0x8C
   bool m_bEnableShadows; // 0x8C - 0x8D
   bool m_bOldEnableShadows; // 0x8D - 0x8E
   bool m_bBackgroundClearNotRequired; // 0x8E - 0x8F
   std::float_t m_flCloudScale; // 0x90 - 0x94
   std::float_t m_flCloud1Speed; // 0x94 - 0x98
   std::float_t m_flCloud1Direction; // 0x98 - 0x9C
   std::float_t m_flCloud2Speed; // 0x9C - 0xA0
   std::float_t m_flCloud2Direction; // 0xA0 - 0xA4
   std::float_t m_flAmbientScale1; // 0xA4 - 0xA8
   std::float_t m_flAmbientScale2; // 0xA8 - 0xAC
   std::float_t m_flGroundScale; // 0xAC - 0xB0
   std::float_t m_flLightScale; // 0xB0 - 0xB4
   std::float_t m_flFoWDarkness; // 0xB4 - 0xB8
   ...
   std::float_t m_flViewFoV; // 0xE0 - 0xE4
...
public:
   ...
   std::int32_t m_iGlowType; // 0x30 - 0x34
   std::int32_t m_iGlowTeam; // 0x34 - 0x38
   std::int32_t m_nGlowRange; // 0x38 - 0x3C
   std::int32_t m_nGlowRangeMin; // 0x3C - 0x40
   Color m_glowColorOverride; // 0x40 - 0x44
   bool m_bFlashing; // 0x44 - 0x45
   std::float_t m_flGlowTime; // 0x48 - 0x4C
   std::float_t m_flGlowStartTime; // 0x4C - 0x50
...
public:
   ...
   std::float_t m_flHorzSize; // 0xC - 0x10
   std::float_t m_flVertSize; // 0x10 - 0x14
...
public:
   ...
   std::float_t m_flFogStartDistance; // 0x4A8 - 0x4AC
   std::float_t m_flFogEndDistance; // 0x4AC - 0x4B0
   bool m_bHeightFogEnabled; // 0x4B0 - 0x4B1
   std::float_t m_flFogStartHeight; // 0x4B4 - 0x4B8
   std::float_t m_flFogEndHeight; // 0x4B8 - 0x4BC
   std::float_t m_flFarZ; // 0x4BC - 0x4C0
   std::float_t m_flFogMaxOpacity; // 0x4C0 - 0x4C4
   std::float_t m_flFogFalloffExponent; // 0x4C4 - 0x4C8
   std::float_t m_flFogVerticalExponent; // 0x4C8 - 0x4CC
   Color m_fogColor; // 0x4CC - 0x4D0
   std::float_t m_flFogStrength; // 0x4D0 - 0x4D4
   std::float_t m_flFadeTime; // 0x4D4 - 0x4D8
...
public:
   ...
   std::float_t m_flGrassBurnClearTime; // 0x4A0 - 0x4A4
...
public:
   ...
   std::float_t m_flTracerDuration; // 0x858 - 0x85C
...
public:
   ...
   std::float_t m_duration; // 0x28 - 0x2C
...
public:
   ...
   std::float_t m_tmMessageEnd; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_flShapeRadius; // 0x50 - 0x54
   std::uint32_t m_nBoneNameHash; // 0x54 - 0x58
   std::int32_t m_nGroupId; // 0x58 - 0x5C
   Color m_cRenderColor; // 0x5C - 0x60
   std::uint16_t m_nHitBoxIndex; // 0x60 - 0x62
   std::uint8_t m_nShapeType; // 0x62 - 0x63
...
public:
   ...
   CAnimNodeConnection m_inputConnection; // 0x38 - 0x40
   std::float_t m_flMinDelayBetweenHits; // 0x40 - 0x44
   ...
   std::float_t m_flHipBoneTranslationScale; // 0x68 - 0x6C
   std::int32_t m_nEffectedBoneCount; // 0x6C - 0x70
   std::float_t m_flMaxImpactForce; // 0x70 - 0x74
   std::float_t m_flMinImpactForce; // 0x74 - 0x78
   std::float_t m_flWhipImpactScale; // 0x78 - 0x7C
   std::float_t m_flCounterRotationScale; // 0x7C - 0x80
   std::float_t m_flDistanceFadeScale; // 0x80 - 0x84
   std::float_t m_flPropagationScale; // 0x84 - 0x88
   std::float_t m_flWhipDelay; // 0x88 - 0x8C
   std::float_t m_flSpringStrength; // 0x8C - 0x90
   std::float_t m_flWhipSpringStrength; // 0x90 - 0x94
   std::float_t m_flHipDipSpringStrength; // 0x94 - 0x98
   std::float_t m_flHipDipImpactScale; // 0x98 - 0x9C
   std::float_t m_flHipDipDelay; // 0x9C - 0xA0
...
public:
   ...
   std::float_t m_flMinDelayBetweenHits; // 0xC0 - 0xC4
...
public:
   ...
   std::float_t m_flRange; // 0x4A8 - 0x4AC
...
public:
   ...
   bool m_bDisabled; // 0x538 - 0x539
   std::int32_t m_nResolutionX; // 0x53C - 0x540
   std::int32_t m_nResolutionY; // 0x540 - 0x544
   ...
   std::int32_t m_nTargetChangeCount; // 0x570 - 0x574
...
public:
   ...
   bool m_bDisabled; // 0x4A0 - 0x4A1
   std::int32_t m_nResolutionX; // 0x4A4 - 0x4A8
   std::int32_t m_nResolutionY; // 0x4A8 - 0x4AC
   ...
   std::int32_t m_nTargetChangeCount; // 0x4D8 - 0x4DC
...
public:
   ...
   std::float_t m_flTimeoutInterval; // 0x560 - 0x564
...
public:
   ...
   std::int32_t m_nMode; // 0x4A4 - 0x4A8
...
public:
   ...
   std::uint32_t m_hLayerSpawnGroup; // 0x574 - 0x578
...
public:
   ...
   std::uint32_t m_hLayerSpawnGroup; // 0x4DC - 0x4E0
...
public:
   ...
   std::float_t m_flPostSpeakDelay; // 0xA08 - 0xA0C
   std::float_t m_flPreDelay; // 0xA0C - 0xA10
...
public:
   ...
   std::int32_t m_defaultValue; // 0x78 - 0x7C
   std::int32_t m_minValue; // 0x7C - 0x80
   std::int32_t m_maxValue; // 0x80 - 0x84
...
public:
   ...
   std::float_t m_flStartTime; // 0x0 - 0x4
   std::float_t m_flEndTime; // 0x4 - 0x8
   std::float_t m_flStartValue; // 0x8 - 0xC
   std::float_t m_flEndValue; // 0xC - 0x10
   std::int32_t m_nInterpType; // 0x10 - 0x14
...
public:
   ...
   std::float_t m_flIronSightAmount; // 0xC - 0x10
   std::float_t m_flIronSightAmountGained; // 0x10 - 0x14
   std::float_t m_flIronSightAmountBiased; // 0x14 - 0x18
...
public:
   ...
   std::int32_t m_nBundleSize; // 0x938 - 0x93C
   std::float_t m_flAllowPickupTime; // 0x940 - 0x944
...
public:
   ...
   std::float_t m_flPickupRadiusSqr; // 0x904 - 0x908
   std::float_t m_flTriggerRadiusSqr; // 0x908 - 0x90C
   ...
   std::float_t m_flPickupRadius; // 0xA48 - 0xA4C
   std::float_t m_flTriggerRadius; // 0xA4C - 0xA50
...
public:
   ...
   CUtlString m_boneName; // 0x0 - 0x8
   std::float_t m_flSpringStrength; // 0x8 - 0xC
   std::float_t m_flSimRateFPS; // 0xC - 0x10
   std::float_t m_flDamping; // 0x10 - 0x14
...
public:
   ...
   std::float_t m_flJumpStartCycle; // 0xB4 - 0xB8
   std::float_t m_flJumpDuration; // 0xB8 - 0xBC
...
public:
   ...
   std::float_t m_flOriginalJumpDuration; // 0xB8 - 0xBC
   std::float_t m_flJumpStartCycle; // 0xBC - 0xC0
   std::float_t m_flJumpEndCycle; // 0xC0 - 0xC4
...
public:
   ...
   std::float_t m_angularLimit; // 0x4D4 - 0x4D8
...
public:
   ...
   std::int32_t m_nServerLOD; // 0x38 - 0x3C
...
public:
   ...
   std::int32_t m_nServerLOD; // 0x30 - 0x34
...
public:
   ...
   std::float_t m_flMaxValue; // 0x48 - 0x4C
...
public:
   ...
   std::float_t m_flMaxValue; // 0xDC - 0xE0
   std::int32_t m_nSequenceMaxFrame; // 0xE0 - 0xE4
...
public:
   ...
   std::float_t m_flBrightness; // 0x90 - 0x94
   std::float_t m_flBrightnessScale; // 0x94 - 0x98
   std::float_t m_flBrightnessMult; // 0x98 - 0x9C
   std::float_t m_flRange; // 0x9C - 0xA0
   std::float_t m_flFalloff; // 0xA0 - 0xA4
   std::float_t m_flAttenuation0; // 0xA4 - 0xA8
   std::float_t m_flAttenuation1; // 0xA8 - 0xAC
   std::float_t m_flAttenuation2; // 0xAC - 0xB0
   std::float_t m_flTheta; // 0xB0 - 0xB4
   std::float_t m_flPhi; // 0xB4 - 0xB8
   CStrongHandle< InfoForResourceTypeCTextureBase > m_hLightCookie; // 0xB8 - 0xC0
   std::int32_t m_nCascades; // 0xC0 - 0xC4
   std::int32_t m_nCastShadows; // 0xC4 - 0xC8
   std::int32_t m_nShadowWidth; // 0xC8 - 0xCC
   std::int32_t m_nShadowHeight; // 0xCC - 0xD0
   bool m_bRenderDiffuse; // 0xD0 - 0xD1
   std::int32_t m_nRenderSpecular; // 0xD4 - 0xD8
   bool m_bRenderTransmissive; // 0xD8 - 0xD9
   std::float_t m_flOrthoLightWidth; // 0xDC - 0xE0
   std::float_t m_flOrthoLightHeight; // 0xE0 - 0xE4
   std::int32_t m_nStyle; // 0xE4 - 0xE8
   CUtlString m_Pattern; // 0xE8 - 0xF0
   std::int32_t m_nCascadeRenderStaticObjects; // 0xF0 - 0xF4
   std::float_t m_flShadowCascadeCrossFade; // 0xF4 - 0xF8
   std::float_t m_flShadowCascadeDistanceFade; // 0xF8 - 0xFC
   std::float_t m_flShadowCascadeDistance0; // 0xFC - 0x100
   std::float_t m_flShadowCascadeDistance1; // 0x100 - 0x104
   std::float_t m_flShadowCascadeDistance2; // 0x104 - 0x108
   std::float_t m_flShadowCascadeDistance3; // 0x108 - 0x10C
   std::int32_t m_nShadowCascadeResolution0; // 0x10C - 0x110
   std::int32_t m_nShadowCascadeResolution1; // 0x110 - 0x114
   std::int32_t m_nShadowCascadeResolution2; // 0x114 - 0x118
   std::int32_t m_nShadowCascadeResolution3; // 0x118 - 0x11C
   bool m_bUsesBakedShadowing; // 0x11C - 0x11D
   std::int32_t m_nShadowPriority; // 0x120 - 0x124
   std::int32_t m_nBakedShadowIndex; // 0x124 - 0x128
   bool m_bRenderToCubemaps; // 0x128 - 0x129
   CUtlSymbolLarge m_LightGroups; // 0x130 - 0x138
   std::int32_t m_nDirectLight; // 0x138 - 0x13C
   std::int32_t m_nIndirectLight; // 0x13C - 0x140
   std::float_t m_flFadeMinDist; // 0x140 - 0x144
   std::float_t m_flFadeMaxDist; // 0x144 - 0x148
   std::float_t m_flShadowFadeMinDist; // 0x148 - 0x14C
   std::float_t m_flShadowFadeMaxDist; // 0x14C - 0x150
   ...
   std::float_t m_flPrecomputedMaxRange; // 0x190 - 0x194
   std::int32_t m_nFogLightingMode; // 0x194 - 0x198
   std::float_t m_flFogContributionStength; // 0x198 - 0x19C
   std::float_t m_flNearClipPlane; // 0x19C - 0x1A0
   Color m_SkyColor; // 0x1A0 - 0x1A4
   std::float_t m_flSkyIntensity; // 0x1A4 - 0x1A8
   ...
   std::float_t m_flCapsuleLength; // 0x1B4 - 0x1B8
   std::float_t m_flMinRoughness; // 0x1B8 - 0x1BC
...
public:
   ...
   std::uint32_t m_nHorizontalSize; // 0x6F0 - 0x6F4
   std::uint32_t m_nVerticalSize; // 0x6F4 - 0x6F8
   std::uint32_t m_nMinDist; // 0x6F8 - 0x6FC
   std::uint32_t m_nMaxDist; // 0x6FC - 0x700
   std::uint32_t m_nOuterMaxDist; // 0x700 - 0x704
   std::float_t m_flGlowProxySize; // 0x704 - 0x708
   std::float_t m_flHDRColorScale; // 0x708 - 0x70C
...
public:
   ...
   std::int32_t m_TriggerHitPoints; // 0x4B0 - 0x4B4
   std::float_t m_flTimeToTrigger; // 0x4B4 - 0x4B8
   GameTime_t m_flStartTime; // 0x4B8 - 0x4BC
   std::float_t m_flDangerousTime; // 0x4BC - 0x4C0
...
public:
   ...
   std::int32_t m_nShuffleCases; // 0x5A0 - 0x5A4
   std::int32_t m_nLastShuffleCase; // 0x5A4 - 0x5A8
...
public:
   ...
   std::float_t m_flInValue; // 0x4A0 - 0x4A4
   std::float_t m_flCompareValue; // 0x4A4 - 0x4A8
...
public:
   ...
   std::float_t m_flZone1Distance; // 0x4B0 - 0x4B4
   std::float_t m_flZone2Distance; // 0x4B4 - 0x4B8
...
public:
   ...
   std::int32_t m_nTeam; // 0x4BC - 0x4C0
...
public:
   ...
   std::float_t m_flScale; // 0x4C8 - 0x4CC
   std::int32_t m_nMeasureType; // 0x4CC - 0x4D0
...
public:
   ...
   std::float_t m_flYawLimit; // 0x64 - 0x68
   std::float_t m_flPitchLimit; // 0x68 - 0x6C
   ...
   std::float_t m_flHysteresisInnerAngle; // 0x70 - 0x74
   std::float_t m_flHysteresisOuterAngle; // 0x74 - 0x78
...
public:
   ...
   std::int32_t m_iBuyingStatus; // 0x4A0 - 0x4A4
   std::float_t m_flBombRadius; // 0x4A4 - 0x4A8
   std::int32_t m_iPetPopulation; // 0x4A8 - 0x4AC
   bool m_bUseNormalSpawnsForDM; // 0x4AC - 0x4AD
   bool m_bDisableAutoGeneratedDMSpawns; // 0x4AD - 0x4AE
   std::float_t m_flBotMaxVisionDistance; // 0x4B0 - 0x4B4
   std::int32_t m_iHostageCount; // 0x4B4 - 0x4B8
...
public:
   ...
   std::int32_t m_nDraftType; // 0x4C0 - 0x4C4
   std::int32_t m_nTeamWinningCoinToss; // 0x4C4 - 0x4C8
   ...
   std::int32_t m_nCurrentPhase; // 0xDE4 - 0xDE8
   std::int32_t m_nPhaseStartTick; // 0xDE8 - 0xDEC
   std::int32_t m_nPhaseDurationTicks; // 0xDEC - 0xDF0
...
public:
   ...
   std::float_t m_flValue; // 0x4C - 0x50
   Color m_Color; // 0x50 - 0x54
...
public:
   ...
   std::int32_t m_nBaseVertex; // 0x4 - 0x8
   std::int32_t m_nVertexCount; // 0x8 - 0xC
   std::int32_t m_nStartIndex; // 0xC - 0x10
   std::int32_t m_nIndexCount; // 0x10 - 0x14
   std::float_t m_flUvDensity; // 0x14 - 0x18
   Vector m_vTintColor; // 0x18 - 0x24
   std::float_t m_flAlpha; // 0x24 - 0x28
   std::uint32_t m_nFirstMeshlet; // 0x2C - 0x30
   std::uint16_t m_nNumMeshlets; // 0x30 - 0x32
...
public:
   ...
   std::float_t m_flInMin; // 0x4A0 - 0x4A4
   std::float_t m_flInMax; // 0x4A4 - 0x4A8
...
public:
   ...
   std::float_t m_flMin; // 0x4A0 - 0x4A4
   std::float_t m_flMax; // 0x4A4 - 0x4A8
...
public:
   ...
   std::float_t m_flInMin; // 0x4A0 - 0x4A4
   std::float_t m_flInMax; // 0x4A4 - 0x4A8
   std::float_t m_flOut1; // 0x4A8 - 0x4AC
   std::float_t m_flOut2; // 0x4AC - 0x4B0
   std::float_t m_flOldInValue; // 0x4B0 - 0x4B4
   bool m_bEnabled; // 0x4B4 - 0x4B5
...
public:
   ...
   CUtlSymbolLarge m_iszMessage; // 0x4A0 - 0x4A8
   std::float_t m_MessageVolume; // 0x4A8 - 0x4AC
   std::int32_t m_MessageAttenuation; // 0x4AC - 0x4B0
   std::float_t m_Radius; // 0x4B0 - 0x4B4
...
public:
   ...
   std::int32_t m_radius; // 0x4A0 - 0x4A4
...
public:
   ...
   std::int32_t m_nChoice; // 0x50 - 0x54
...
public:
   ...
   std::uint64_t m_MeshGroupMask; // 0x180 - 0x188
   std::int8_t m_nIdealMotionType; // 0x222 - 0x223
   std::int8_t m_nForceLOD; // 0x223 - 0x224
   std::int8_t m_nClothUpdateFlags; // 0x224 - 0x225
...
public:
   ...
   std::int32_t m_lastUsed; // 0x980 - 0x984
   QAngle m_start; // 0x984 - 0x990
   QAngle m_end; // 0x990 - 0x99C
   std::float_t m_IdealYaw; // 0x99C - 0x9A0
   CUtlSymbolLarge m_sNoise; // 0x9A0 - 0x9A8
   bool m_bUpdateTarget; // 0x9A8 - 0x9A9
   std::int32_t m_direction; // 0x9AC - 0x9B0
   std::float_t m_returnSpeed; // 0x9B0 - 0x9B4
   std::float_t m_flStartPosition; // 0x9B4 - 0x9B8
...
public:
   ...
   std::float_t m_flULeftSrc; // 0x0 - 0x4
   std::float_t m_flVTopSrc; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_nSlaveChannel; // 0x78 - 0x7C
   std::float_t m_flMin; // 0x7C - 0x80
   std::float_t m_flMax; // 0x80 - 0x84
...
public:
   ...
   std::int16_t m_nXLeftDst; // 0x0 - 0x2
   std::int16_t m_nYTopDst; // 0x2 - 0x4
   std::float_t m_flUWidthSrc; // 0x4 - 0x8
   std::float_t m_flVHeightSrc; // 0x8 - 0xC
...
public:
   ...
   std::int32_t m_nWidth; // 0x10 - 0x14
   std::int32_t m_nHeight; // 0x14 - 0x18
...
public:
   ...
   std::int32_t m_nDimensionCount; // 0x18 - 0x1C
...
public:
   ...
   std::float_t m_flDuration; // 0x10 - 0x14
   MotionIndex m_nMotionIndex; // 0x14 - 0x18
   std::int32_t m_nSampleStart; // 0x18 - 0x1C
   std::int32_t m_nSampleCount; // 0x1C - 0x20
...
public:
   ...
   std::int32_t m_nRandomSeed; // 0x80 - 0x84
   std::float_t m_flSampleRate; // 0x84 - 0x88
   bool m_bSearchEveryTick; // 0x88 - 0x89
   std::float_t m_flSearchInterval; // 0x8C - 0x90
   bool m_bSearchWhenMotionEnds; // 0x90 - 0x91
   bool m_bSearchWhenGoalChanges; // 0x91 - 0x92
   std::float_t m_flBlendTime; // 0x94 - 0x98
   std::float_t m_flSelectionThreshold; // 0x98 - 0x9C
   std::float_t m_flReselectionTimeWindow; // 0x9C - 0xA0
   bool m_bLockSelectionWhenWaning; // 0xA0 - 0xA1
   bool m_bEnableRotationCorrection; // 0xA1 - 0xA2
   bool m_bGoalAssist; // 0xA2 - 0xA3
   std::float_t m_flGoalAssistDistance; // 0xA4 - 0xA8
   std::float_t m_flGoalAssistTolerance; // 0xA8 - 0xAC
   bool m_bEnableDistanceScaling; // 0xAC - 0xAD
   std::float_t m_flDistanceScale_OuterRadius; // 0xB0 - 0xB4
   std::float_t m_flDistanceScale_InnerRadius; // 0xB4 - 0xB8
   std::float_t m_flDistanceScale_MaxScale; // 0xB8 - 0xBC
   std::float_t m_flDistanceScale_MinScale; // 0xBC - 0xC0
...
public:
   ...
   std::float_t m_flSearchInterval; // 0xE4 - 0xE8
   bool m_bSearchWhenClipEnds; // 0xE8 - 0xE9
   bool m_bSearchWhenGoalChanges; // 0xE9 - 0xEA
   CBlendCurve m_blendCurve; // 0xEC - 0xF4
   std::float_t m_flSampleRate; // 0xF4 - 0xF8
   std::float_t m_flBlendTime; // 0xF8 - 0xFC
   bool m_bLockClipWhenWaning; // 0xFC - 0xFD
   std::float_t m_flSelectionThreshold; // 0x100 - 0x104
   std::float_t m_flReselectionTimeWindow; // 0x104 - 0x108
   bool m_bEnableRotationCorrection; // 0x108 - 0x109
   bool m_bGoalAssist; // 0x109 - 0x10A
   std::float_t m_flGoalAssistDistance; // 0x10C - 0x110
   std::float_t m_flGoalAssistTolerance; // 0x110 - 0x114
   CAnimInputDamping m_distanceScale_Damping; // 0x118 - 0x128
   std::float_t m_flDistanceScale_OuterRadius; // 0x128 - 0x12C
   std::float_t m_flDistanceScale_InnerRadius; // 0x12C - 0x130
   std::float_t m_flDistanceScale_MaxScale; // 0x130 - 0x134
   std::float_t m_flDistanceScale_MinScale; // 0x134 - 0x138
...
public:
   ...
   std::int32_t m_nParamIndex; // 0x40 - 0x44
...
public:
   ...
   std::float_t m_flPlaybackSpeed; // 0x44 - 0x48
...
public:
   ...
   std::float_t m_flMinValue; // 0x24 - 0x28
   std::float_t m_flMaxValue; // 0x28 - 0x2C
   std::int32_t m_nSamples; // 0x2C - 0x30
...
public:
   ...
   std::float_t m_speed; // 0x8 - 0xC
   std::float_t m_maxTorque; // 0xC - 0x10
   Vector m_axis; // 0x10 - 0x1C
   std::float_t m_inertiaFactor; // 0x1C - 0x20
...
public:
   ...
   std::int32_t m_nDefaultMotorIndex; // 0x7C - 0x80
...
public:
   ...
   std::float_t m_flTurnToFaceOffset; // 0x60 - 0x64
   std::float_t m_flTurnToFaceLimit; // 0x64 - 0x68
   CAnimInputDamping m_damping; // 0x68 - 0x78
...
public:
   ...
   std::float_t m_flTurnToFaceOffset; // 0x8C - 0x90
   std::float_t m_flTurnToFaceLimit; // 0x90 - 0x94
...
public:
   ...
   std::float_t m_flLightRadiusFilter; // 0x4B0 - 0x4B4
   std::float_t m_flBrightnessDelta; // 0x4B4 - 0x4B8
   bool m_bPerformScreenFade; // 0x4B8 - 0x4B9
   std::float_t m_flTargetBrightnessMultiplier; // 0x4BC - 0x4C0
   std::float_t m_flCurrentBrightnessMultiplier; // 0x4C0 - 0x4C4
...
public:
   ...
   std::int32_t m_iTotal; // 0x5C8 - 0x5CC
...
public:
   ...
   std::uint32_t m_unAlignmentDegrees; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_flWidth; // 0x4A0 - 0x4A4
   ...
   std::int32_t m_nNavLinkIdForward; // 0x4D0 - 0x4D4
   std::int32_t m_nNavLinkIdReverse; // 0x4D4 - 0x4D8
...
public:
   ...
   std::uint32_t m_unRecommendedDistance; // 0x4 - 0x8
...
public:
   ...
   std::float_t m_flPhysicsOverheadBufferDist; // 0x4A4 - 0x4A8
...
public:
   ...
   std::float_t m_flSearchDist; // 0xAC - 0xB0
...
public:
   ...
   std::float_t m_flRadiusInner; // 0x80 - 0x84
...
public:
   ...
   std::uint16_t m_cellX; // 0x10 - 0x12
   std::uint16_t m_cellY; // 0x12 - 0x14
   std::uint16_t m_cellZ; // 0x14 - 0x16
   std::uint16_t m_nOutsideWorld; // 0x16 - 0x18
...
public:
   ...
   std::uint8_t m_nTransmitStateOwnedCounter; // 0x16C - 0x16D
...
public:
   ...
   std::float_t m_flPrevCycle; // 0xC - 0x10
   std::float_t m_flCycle; // 0x10 - 0x14
   CNetworkedQuantizedFloat m_flWeight; // 0x14 - 0x1C
   bool m_bSequenceChangeNetworked; // 0x1C - 0x1D
   bool m_bDiscontinuity; // 0x1D - 0x1E
   std::float_t m_flPrevCycleFromDiscontinuity; // 0x20 - 0x24
   std::float_t m_flPrevCycleForAnimEventDetection; // 0x24 - 0x28
...
public:
   ...
   std::float_t m_flScale; // 0x4C - 0x50
   PARTICLE_EHANDLE__* m_hOwner; // 0x50 - 0x58
   CParticleProperty* m_pOwningParticleProperty; // 0x58 - 0x60
   std::float_t m_flFreezeTransitionStart; // 0x70 - 0x74
   std::float_t m_flFreezeTransitionDuration; // 0x74 - 0x78
   std::float_t m_flFreezeTransitionOverride; // 0x78 - 0x7C
   ...
   std::int32_t m_RefCount; // 0xC0 - 0xC4
...
public:
   ...
   std::float_t m_flInnerAngle; // 0x918 - 0x91C
   std::float_t m_flOuterAngle; // 0x91C - 0x920
...
public:
   ...
   std::float_t m_flLastDistFromDrop; // 0x830 - 0x834
   bool m_bDroppedParadrop; // 0x834 - 0x835
   CSoundPatch* m_pSoundLoop; // 0x838 - 0x840
   std::float_t m_flSpawnTime; // 0x840 - 0x844
   std::float_t m_flFlightTime; // 0x844 - 0x848
...
public:
   ...
   std::int32_t m_nBehaviorVersion; // 0x8 - 0xC
   ...
   std::int32_t m_nFirstMultipleOverride_BackwardCompat; // 0x178 - 0x17C
   std::int32_t m_nInitialParticles; // 0x1F0 - 0x1F4
   std::int32_t m_nMaxParticles; // 0x1F4 - 0x1F8
   std::int32_t m_nGroupID; // 0x1F8 - 0x1FC
   Vector m_BoundingBoxMin; // 0x1FC - 0x208
   Vector m_BoundingBoxMax; // 0x208 - 0x214
   std::float_t m_flDepthSortBias; // 0x214 - 0x218
   std::int32_t m_nSortOverridePositionCP; // 0x218 - 0x21C
   bool m_bInfiniteBounds; // 0x21C - 0x21D
   Color m_ConstantColor; // 0x21D - 0x221
   Vector m_ConstantNormal; // 0x224 - 0x230
   std::float_t m_flConstantRadius; // 0x230 - 0x234
   std::float_t m_flConstantRotation; // 0x234 - 0x238
   std::float_t m_flConstantRotationSpeed; // 0x238 - 0x23C
   std::float_t m_flConstantLifespan; // 0x23C - 0x240
   std::int32_t m_nConstantSequenceNumber; // 0x240 - 0x244
   std::int32_t m_nConstantSequenceNumber1; // 0x244 - 0x248
   std::int32_t m_nSnapshotControlPoint; // 0x248 - 0x24C
   ...
   std::float_t m_flCullRadius; // 0x260 - 0x264
   std::float_t m_flCullFillCost; // 0x264 - 0x268
   std::int32_t m_nCullControlPoint; // 0x268 - 0x26C
   CStrongHandle< InfoForResourceTypeIParticleSystemDefinition > m_hFallback; // 0x270 - 0x278
   std::int32_t m_nFallbackMaxCount; // 0x278 - 0x27C
   ...
   std::float_t m_flPreSimulationTime; // 0x290 - 0x294
   std::float_t m_flStopSimulationAfterTime; // 0x294 - 0x298
   std::float_t m_flMaximumTimeStep; // 0x298 - 0x29C
   std::float_t m_flMaximumSimTime; // 0x29C - 0x2A0
   std::float_t m_flMinimumSimTime; // 0x2A0 - 0x2A4
   std::float_t m_flMinimumTimeStep; // 0x2A4 - 0x2A8
   std::int32_t m_nMinimumFrames; // 0x2A8 - 0x2AC
   std::int32_t m_nMinCPULevel; // 0x2AC - 0x2B0
   std::int32_t m_nMinGPULevel; // 0x2B0 - 0x2B4
   std::float_t m_flNoDrawTimeToGoToSleep; // 0x2B4 - 0x2B8
   std::float_t m_flMaxDrawDistance; // 0x2B8 - 0x2BC
   std::float_t m_flStartFadeDistance; // 0x2BC - 0x2C0
   std::float_t m_flMaxCreationDistance; // 0x2C0 - 0x2C4
   std::int32_t m_nAggregationMinAvailableParticles; // 0x2C4 - 0x2C8
   std::float_t m_flAggregateRadius; // 0x2C8 - 0x2CC
   ...
   std::int32_t m_nSkipRenderControlPoint; // 0x2E0 - 0x2E4
   std::int32_t m_nAllowRenderControlPoint; // 0x2E4 - 0x2E8
...
public:
   ...
   std::int32_t m_nControlPoint; // 0x44 - 0x48
   std::int32_t m_nControlPointRangeMax; // 0x48 - 0x4C
   std::float_t m_flEndCPGrowthTime; // 0x4C - 0x50
...
public:
   ...
   std::float_t m_flCameraBias; // 0x0 - 0x4
   std::int32_t m_nCPin; // 0x4 - 0x8
   std::float_t m_flProxyRadius; // 0x8 - 0xC
   std::float_t m_flInputMin; // 0xC - 0x10
   std::float_t m_flInputMax; // 0x10 - 0x14
   std::float_t m_flNoPixelVisibilityFallback; // 0x14 - 0x18
   std::float_t m_flDistanceInputMin; // 0x18 - 0x1C
   std::float_t m_flDistanceInputMax; // 0x1C - 0x20
   std::float_t m_flDotInputMin; // 0x20 - 0x24
   std::float_t m_flDotInputMax; // 0x24 - 0x28
   bool m_bDotCPAngles; // 0x28 - 0x29
   bool m_bDotCameraAngles; // 0x29 - 0x2A
   std::float_t m_flAlphaScaleMin; // 0x2C - 0x30
   std::float_t m_flAlphaScaleMax; // 0x30 - 0x34
   std::float_t m_flRadiusScaleMin; // 0x34 - 0x38
   std::float_t m_flRadiusScaleMax; // 0x38 - 0x3C
   std::float_t m_flRadiusScaleFOVBase; // 0x3C - 0x40
...
public:
   ...
   CAnimNodeConnection m_inputConnection; // 0x38 - 0x40
   std::float_t m_flStoppingRadius; // 0x40 - 0x44
   std::float_t m_flStoppingSpeedScale; // 0x44 - 0x48
...
public:
   ...
   std::float_t m_flStoppingRadius; // 0x68 - 0x6C
   std::float_t m_flStoppingSpeedScale; // 0x6C - 0x70
...
public:
   ...
   std::float_t m_flMinExtrapolationSpeed; // 0x4C - 0x50
...
public:
   ...
   std::float_t m_flDistance; // 0x68 - 0x6C
   bool m_bExtrapolateMovement; // 0x6C - 0x6D
   std::float_t m_flMinExtrapolationSpeed; // 0x70 - 0x74
...
public:
   ...
   std::int32_t m_nStartControlPointNumber; // 0x0 - 0x4
   std::int32_t m_nEndControlPointNumber; // 0x4 - 0x8
   std::int32_t m_nBulgeControl; // 0x8 - 0xC
   std::float_t m_flBulge; // 0xC - 0x10
   std::float_t m_flMidPoint; // 0x10 - 0x14
...
public:
   ...
   std::float_t m_flRadius; // 0x4B8 - 0x4BC
   std::float_t m_length; // 0x4BC - 0x4C0
   CUtlSymbolLarge m_altName; // 0x4C0 - 0x4C8
   std::int32_t m_nIterVal; // 0x4C8 - 0x4CC
...
public:
   ...
   std::float_t m_flFriction; // 0x4F8 - 0x4FC
   bool m_bEnableSwingLimit; // 0x4FC - 0x4FD
   std::float_t m_flSwingLimit; // 0x500 - 0x504
   bool m_bEnableTwistLimit; // 0x504 - 0x505
   std::float_t m_flMinTwistAngle; // 0x508 - 0x50C
   std::float_t m_flMaxTwistAngle; // 0x50C - 0x510
...
public:
   ...
   std::int32_t m_damageType; // 0x7B0 - 0x7B4
   std::float_t m_massScale; // 0x7B4 - 0x7B8
   std::int32_t m_damageToEnableMotion; // 0x7B8 - 0x7BC
   std::float_t m_flForceToEnableMotion; // 0x7BC - 0x7C0
   QAngle m_angPreferredCarryAngles; // 0x7C0 - 0x7CC
   bool m_bNotSolidToWorld; // 0x7CC - 0x7CD
   bool m_bEnableUseOutput; // 0x7CD - 0x7CE
   std::int32_t m_iExploitableByPlayer; // 0x7D0 - 0x7D4
   std::float_t m_flTouchOutputPerEntityDelay; // 0x7D4 - 0x7D8
...
public:
   ...
   std::float_t m_flMagnitude; // 0x4A4 - 0x4A8
   std::float_t m_flDamage; // 0x4A8 - 0x4AC
   std::float_t m_radius; // 0x4AC - 0x4B0
   CUtlSymbolLarge m_targetEntityName; // 0x4B0 - 0x4B8
   std::float_t m_flInnerRadius; // 0x4B8 - 0x4BC
   std::float_t m_flPushScale; // 0x4BC - 0x4C0
...
public:
   ...
   std::float_t m_flLinearFrequency; // 0x4F8 - 0x4FC
   std::float_t m_flLinearDampingRatio; // 0x4FC - 0x500
   std::float_t m_flAngularFrequency; // 0x500 - 0x504
   std::float_t m_flAngularDampingRatio; // 0x504 - 0x508
...
public:
   ...
   std::float_t m_damage; // 0x4A0 - 0x4A4
   std::float_t m_distance; // 0x4A4 - 0x4A8
...
public:
   ...
   std::float_t m_addLength; // 0x51C - 0x520
   std::float_t m_minLength; // 0x520 - 0x524
   std::float_t m_totalLength; // 0x524 - 0x528
...
public:
   ...
   std::float_t m_massScale; // 0x870 - 0x874
   std::float_t m_forceLimit; // 0x874 - 0x878
   std::float_t m_torqueLimit; // 0x878 - 0x87C
   ...
   std::float_t m_flTotalMass; // 0x89C - 0x8A0
   std::float_t m_flRadius; // 0x8A0 - 0x8A4
   GameTime_t m_flNextSuckTime; // 0x8A4 - 0x8A8
   std::int32_t m_iMaxObjectsAttached; // 0x8A8 - 0x8AC
...
public:
   ...
   std::float_t m_spinUp; // 0x4AC - 0x4B0
   std::float_t m_additionalAcceleration; // 0x4B0 - 0x4B4
   std::float_t m_angularAcceleration; // 0x4B4 - 0x4B8
...
public:
   ...
   std::int32_t m_nUsesRemaining; // 0xB28 - 0xB2C
   GameTime_t m_flTimeLastUsed; // 0xB2C - 0xB30
...
public:
   ...
   std::int32_t m_nPingType; // 0xB38 - 0xB3C
   std::int32_t m_nLongUseActionType; // 0xB3C - 0xB40
   std::float_t m_flLongUseDuration; // 0xB40 - 0xB44
...
public:
   ...
   std::int32_t m_nCurrentCashCount; // 0xB50 - 0xB54
   std::int32_t m_nCashCount; // 0xB54 - 0xB58
...
public:
   ...
   std::int32_t m_nNumThinksAtZeroVerticalVelocity; // 0xB54 - 0xB58
...
public:
   ...
   std::float_t m_addLength; // 0x51C - 0x520
   std::float_t m_gearRatio; // 0x520 - 0x524
...
public:
   ...
   std::float_t m_slideFriction; // 0x50C - 0x510
   std::float_t m_systemLoadScale; // 0x510 - 0x514
   std::float_t m_initialOffset; // 0x514 - 0x518
   bool m_bEnableLinearConstraint; // 0x518 - 0x519
   bool m_bEnableAngularConstraint; // 0x519 - 0x51A
   std::float_t m_flMotorFrequency; // 0x51C - 0x520
   std::float_t m_flMotorDampingRatio; // 0x520 - 0x524
...
public:
   ...
   CUtlString m_name; // 0x0 - 0x8
   std::uint32_t m_nameHash; // 0x8 - 0xC
   std::uint32_t m_baseNameHash; // 0xC - 0x10
...
public:
   ...
   std::float_t m_reflectivity; // 0x0 - 0x4
   std::float_t m_hardnessFactor; // 0x4 - 0x8
   std::float_t m_roughnessFactor; // 0x8 - 0xC
   std::float_t m_roughThreshold; // 0xC - 0x10
   std::float_t m_hardThreshold; // 0x10 - 0x14
   std::float_t m_hardVelocityThreshold; // 0x14 - 0x18
   std::float_t m_flStaticImpactVolume; // 0x18 - 0x1C
   std::float_t m_flOcclusionFactor; // 0x1C - 0x20
...
public:
   ...
   std::float_t m_friction; // 0x0 - 0x4
   std::float_t m_elasticity; // 0x4 - 0x8
   std::float_t m_density; // 0x8 - 0xC
   std::float_t m_thickness; // 0xC - 0x10
   std::float_t m_softContactFrequency; // 0x10 - 0x14
   std::float_t m_softContactDampingRatio; // 0x14 - 0x18
   std::float_t m_wheelDrag; // 0x18 - 0x1C
...
public:
   ...
   std::float_t m_flSuspensionFrequency; // 0x4F8 - 0x4FC
   std::float_t m_flSuspensionDampingRatio; // 0x4FC - 0x500
   std::float_t m_flSuspensionHeightOffset; // 0x500 - 0x504
   bool m_bEnableSuspensionLimit; // 0x504 - 0x505
   std::float_t m_flMinSuspensionOffset; // 0x508 - 0x50C
   std::float_t m_flMaxSuspensionOffset; // 0x50C - 0x510
   bool m_bEnableSteeringLimit; // 0x510 - 0x511
   std::float_t m_flMinSteeringAngle; // 0x514 - 0x518
   std::float_t m_flMaxSteeringAngle; // 0x518 - 0x51C
   std::float_t m_flSteeringAxisFriction; // 0x51C - 0x520
   std::float_t m_flSpinAxisFriction; // 0x520 - 0x524
...
public:
   ...
   std::float_t m_separationDuration; // 0x4B0 - 0x4B4
...
public:
   ...
   std::float_t m_flRespawnDuration; // 0xB30 - 0xB34
...
public:
   ...
   std::float_t m_flFrequency; // 0x4A8 - 0x4AC
   std::float_t m_flDampingRatio; // 0x4AC - 0x4B0
   std::float_t m_flRestLength; // 0x4B0 - 0x4B4
   ...
   std::uint32_t m_teleportTick; // 0x4E0 - 0x4E4
...
public:
   ...
   std::int32_t m_nDensity; // 0x4A0 - 0x4A4
...
public:
   ...
   std::float_t m_flSpringConstant; // 0x44 - 0x48
   std::float_t m_flAnticipationDistance; // 0x48 - 0x4C
...
public:
   ...
   std::float_t m_flSpringConstant; // 0x3C - 0x40
   std::float_t m_flAnticipationDistance; // 0x40 - 0x44
...
public:
   ...
   std::int32_t m_iType; // 0x4B0 - 0x4B4
...
public:
   ...
   std::int32_t m_nUniqueID; // 0x6F0 - 0x6F4
   std::uint32_t m_unAccountID; // 0x6F4 - 0x6F8
   std::uint32_t m_unTraceID; // 0x6F8 - 0x6FC
   std::uint32_t m_rtGcTime; // 0x6FC - 0x700
   Vector m_vecEndPos; // 0x700 - 0x70C
   Vector m_vecStart; // 0x70C - 0x718
   Vector m_vecLeft; // 0x718 - 0x724
   Vector m_vecNormal; // 0x724 - 0x730
   std::int32_t m_nPlayer; // 0x730 - 0x734
   std::int32_t m_nEntity; // 0x734 - 0x738
   std::int32_t m_nHitbox; // 0x738 - 0x73C
   std::float_t m_flCreationTime; // 0x73C - 0x740
   std::int32_t m_nTintID; // 0x740 - 0x744
   std::uint8_t m_nVersion; // 0x744 - 0x745
...
public:
   ...
   std::float_t m_flDuration; // 0x4B8 - 0x4BC
   std::float_t m_flDotTolerance; // 0x4BC - 0x4C0
...
public:
   ...
   std::float_t m_flThreshold; // 0x4A4 - 0x4A8
   std::int32_t m_nLastCompareResult; // 0x4A8 - 0x4AC
   std::int32_t m_nLastFireResult; // 0x4AC - 0x4B0
   GameTime_t m_flFireTime; // 0x4B0 - 0x4B4
   std::float_t m_flFireInterval; // 0x4B4 - 0x4B8
   std::float_t m_flLastAngVelocity; // 0x4B8 - 0x4BC
...
public:
   ...
   std::float_t m_flVerticalFOV; // 0x500 - 0x504
...
public:
   ...
   std::float_t m_flStartTimeInCommentary; // 0x8F0 - 0x8F4
   CUtlSymbolLarge m_iszTitle; // 0x8F8 - 0x900
   CUtlSymbolLarge m_iszSpeakers; // 0x900 - 0x908
   std::int32_t m_iNodeNumber; // 0x908 - 0x90C
   std::int32_t m_iNodeNumberMax; // 0x90C - 0x910
...
public:
   ...
   std::float_t m_flRadius; // 0x4A8 - 0x4AC
...
public:
   ...
   std::int32_t m_nGroupID; // 0x4B0 - 0x4B4
   std::float_t m_flDefaultWeight; // 0x4B4 - 0x4B8
   std::float_t m_flCurrentWeight; // 0x4B8 - 0x4BC
   CHandle< CBaseEntity > m_hItem; // 0x4BC - 0x4C0
   CUtlSymbolLarge m_iszDoorName; // 0x4C0 - 0x4C8
   CHandle< CDZDoor > m_hDoor; // 0x4C8 - 0x4CC
   std::int32_t m_nPrice; // 0x4CC - 0x4D0
...
public:
   ...
   std::int32_t m_nDamage; // 0x4A0 - 0x4A4
   std::int32_t m_bitsDamageType; // 0x4A4 - 0x4A8
   std::float_t m_flRadius; // 0x4A8 - 0x4AC
   std::float_t m_flDelay; // 0x4AC - 0x4B0
...
public:
   ...
   std::float_t m_flSeenTargetTime; // 0xAA4 - 0xAA8
...
public:
   ...
   std::float_t m_flMagnitude; // 0x4A4 - 0x4A8
   std::float_t m_flRadius; // 0x4A8 - 0x4AC
   std::float_t m_flInnerRadius; // 0x4AC - 0x4B0
   std::float_t m_flConeOfInfluence; // 0x4B0 - 0x4B4
...
public:
   ...
   std::float_t m_flTimeoutInterval; // 0x4B8 - 0x4BC
...
public:
   ...
   std::float_t m_flTimeoutInterval; // 0x550 - 0x554
...
public:
   ...
   std::float_t m_flMaximumChangePerSecond; // 0x4C0 - 0x4C4
   std::float_t m_flDisengageDistance; // 0x4C4 - 0x4C8
   std::float_t m_flEngageDistance; // 0x4C8 - 0x4CC
   ...
   std::float_t m_flMomentumModifier; // 0x518 - 0x51C
   std::float_t m_flSnapValue; // 0x51C - 0x520
   std::float_t m_flCurrentMomentum; // 0x520 - 0x524
   ValueRemapperRatchetType_t m_nRatchetType; // 0x524 - 0x528
   std::float_t m_flRatchetOffset; // 0x528 - 0x52C
   std::float_t m_flInputOffset; // 0x52C - 0x530
   bool m_bEngaged; // 0x530 - 0x531
   bool m_bFirstUpdate; // 0x531 - 0x532
   std::float_t m_flPreviousValue; // 0x534 - 0x538
   ...
   std::float_t m_flCustomOutputValue; // 0x54C - 0x550
...
public:
   ...
   std::float_t m_fPrevVelocity; // 0x4B4 - 0x4B8
   std::float_t m_flAvgInterval; // 0x4B8 - 0x4BC
...
public:
   ...
   std::float_t m_flWorldUnitsPerPx; // 0x934 - 0x938
   std::float_t m_flFontSize; // 0x938 - 0x93C
   std::float_t m_flDepthOffset; // 0x93C - 0x940
...
public:
   ...
   std::float_t m_flFadeDuration; // 0x8B0 - 0x8B4
   std::float_t m_flMinLogExposure; // 0x8B4 - 0x8B8
   std::float_t m_flMaxLogExposure; // 0x8B8 - 0x8BC
   std::float_t m_flMinExposure; // 0x8BC - 0x8C0
   std::float_t m_flMaxExposure; // 0x8C0 - 0x8C4
   std::float_t m_flExposureCompensation; // 0x8C4 - 0x8C8
   std::float_t m_flExposureFadeSpeedUp; // 0x8C8 - 0x8CC
   std::float_t m_flExposureFadeSpeedDown; // 0x8CC - 0x8D0
   std::float_t m_flTonemapEVSmoothingRange; // 0x8D0 - 0x8D4
   bool m_bMaster; // 0x8D4 - 0x8D5
   bool m_bExposureControl; // 0x8D5 - 0x8D6
   std::float_t m_flRate; // 0x8D8 - 0x8DC
   std::float_t m_flTonemapPercentTarget; // 0x8DC - 0x8E0
   std::float_t m_flTonemapPercentBrightPixels; // 0x8E0 - 0x8E4
   std::float_t m_flTonemapMinAvgLum; // 0x8E4 - 0x8E8
...
public:
   ...
   std::float_t m_flInnerDistance; // 0x108 - 0x10C
   ParticleAttachment_t m_nAttachType; // 0x10C - 0x110
   bool m_bBatchSameVolumeType; // 0x110 - 0x111
   std::int32_t m_nRTEnvCP; // 0x114 - 0x118
   std::int32_t m_nRTEnvCPComponent; // 0x118 - 0x11C
...
public:
   ...
   std::int32_t m_nDimensions; // 0x18 - 0x1C
...
public:
   ...
   std::int32_t m_nTexture; // 0x4A0 - 0x4A4
   std::float_t m_flDistance; // 0x4A4 - 0x4A8
...
public:
   ...
   std::float_t m_flLightFOV; // 0x14 - 0x18
   ...
   std::float_t m_flBrightnessScale; // 0x20 - 0x24
   Color m_LightColor; // 0x24 - 0x28
   std::float_t m_flIntensity; // 0x28 - 0x2C
   std::float_t m_flLinearAttenuation; // 0x2C - 0x30
   std::float_t m_flQuadraticAttenuation; // 0x30 - 0x34
   bool m_bVolumetric; // 0x34 - 0x35
   std::float_t m_flVolumetricIntensity; // 0x38 - 0x3C
   std::float_t m_flNoiseStrength; // 0x3C - 0x40
   std::float_t m_flFlashlightTime; // 0x40 - 0x44
   std::uint32_t m_nNumPlanes; // 0x44 - 0x48
   std::float_t m_flPlaneOffset; // 0x48 - 0x4C
   std::float_t m_flColorTransitionTime; // 0x4C - 0x50
   std::float_t m_flAmbient; // 0x50 - 0x54
   char m_SpotlightTextureName[512]; // 0x54 - 0x254
   std::int32_t m_nSpotlightTextureFrame; // 0x254 - 0x258
   std::uint32_t m_nShadowQuality; // 0x258 - 0x25C
   std::float_t m_flNearZ; // 0x25C - 0x260
   std::float_t m_flFarZ; // 0x260 - 0x264
   std::float_t m_flProjectionSize; // 0x264 - 0x268
   std::float_t m_flRotation; // 0x268 - 0x26C
...
public:
   ...
   std::float_t m_flDisplayValue; // 0x820 - 0x824
   std::int32_t m_nInitialValue; // 0x824 - 0x828
...
public:
   ...
   std::float_t m_lastUpdate; // 0x64 - 0x68
   bool m_allAsleep; // 0x68 - 0x69
   Vector m_vecLastOrigin; // 0x6C - 0x78
   std::float_t m_flLastOriginChangeTime; // 0x78 - 0x7C
   std::float_t m_flAwakeTime; // 0x7C - 0x80
...
public:
   ...
   std::float_t m_flFrequency; // 0x44 - 0x48
   std::float_t m_flDampingRatio; // 0x48 - 0x4C
   std::float_t m_flDecayDuration; // 0x4C - 0x50
   std::float_t m_flDecayBias; // 0x50 - 0x54
...
public:
   ...
   std::float_t m_flSpringFrequencyMin; // 0x50 - 0x54
   std::float_t m_flSpringFrequencyMax; // 0x54 - 0x58
...
public:
   ...
   std::float_t m_flSpringFrequencyMin; // 0x90 - 0x94
   std::float_t m_flSpringFrequencyMax; // 0x94 - 0x98
...
public:
   ...
   std::float_t m_xmin; // 0x4F8 - 0x4FC
   std::float_t m_xmax; // 0x4FC - 0x500
   std::float_t m_ymin; // 0x500 - 0x504
   std::float_t m_ymax; // 0x504 - 0x508
   std::float_t m_zmin; // 0x508 - 0x50C
   std::float_t m_zmax; // 0x50C - 0x510
   std::float_t m_xfriction; // 0x510 - 0x514
   std::float_t m_yfriction; // 0x514 - 0x518
   std::float_t m_zfriction; // 0x518 - 0x51C
...
public:
   ...
   bool m_bDisabled; // 0x4A0 - 0x4A1
   std::float_t m_radius; // 0x4A4 - 0x4A8
   std::float_t m_force; // 0x4A8 - 0x4AC
...
public:
   ...
   std::int8_t m_iCurrentMaxRagdollCount; // 0x4A0 - 0x4A1
   std::int32_t m_iMaxRagdollCount; // 0x4A4 - 0x4A8
...
public:
   ...
   std::uint32_t m_boneIndexAttached; // 0x9C8 - 0x9CC
   std::uint32_t m_ragdollAttachedObjectIndex; // 0x9CC - 0x9D0
...
public:
   ...
   std::int32_t m_nWeightListIndex; // 0x68 - 0x6C
...
public:
   ...
   std::float_t m_minInterval; // 0x8 - 0xC
   std::float_t m_maxInterval; // 0xC - 0x10
...
public:
   ...
   std::float_t m_minInterval; // 0xC - 0x10
   std::float_t m_maxInterval; // 0x10 - 0x14
...
public:
   ...
   std::uint64_t m_hBuffer; // 0x0 - 0x8
   std::uint32_t m_nBindOffsetBytes; // 0x10 - 0x14
...
public:
   ...
   std::uint32_t m_nSplitscreenFlags; // 0x54 - 0x58
...
public:
   ...
   std::int32_t m_nBoneWeightCount; // 0x48 - 0x4C
...
public:
   ...
   std::int32_t m_nNumPrefixedContexts; // 0x28 - 0x2C
...
public:
   ...
   public:
      ...
      std::float_t m_fDispatchTime; // 0x40 - 0x44
...
public:
   ...
   std::int32_t m_nMatchSeed; // 0xF8 - 0xFC
   bool m_bBlockersPresent; // 0xFC - 0xFD
   bool m_bRoundInProgress; // 0xFD - 0xFE
   std::int32_t m_iFirstSecondHalfRound; // 0x100 - 0x104
   std::int32_t m_iBombSite; // 0x104 - 0x108
...
public:
   ...
   std::float_t m_loadTime; // 0x6F0 - 0x6F4
   std::float_t m_Duration; // 0x6F4 - 0x6F8
   std::float_t m_HoldTime; // 0x6F8 - 0x6FC
...
public:
   ...
   CUtlString m_name; // 0x0 - 0x8
   std::float_t m_flWeight; // 0x8 - 0xC
...
public:
   ...
   std::int32_t m_numRoundsSurvived; // 0x14 - 0x18
   std::int32_t m_maxNumRoundsSurvived; // 0x18 - 0x1C
   std::int32_t m_numRoundsSurvivedTotal; // 0x1C - 0x20
   std::int32_t m_iRoundsWonWithoutPurchase; // 0x20 - 0x24
   std::int32_t m_iRoundsWonWithoutPurchaseTotal; // 0x24 - 0x28
   std::int32_t m_numFirstKills; // 0x28 - 0x2C
   std::int32_t m_numClutchKills; // 0x2C - 0x30
   std::int32_t m_numPistolKills; // 0x30 - 0x34
   std::int32_t m_numSniperKills; // 0x34 - 0x38
...
public:
   ...
   std::int32_t m_iEnemy5Ks; // 0x68 - 0x6C
   std::int32_t m_iEnemy4Ks; // 0x6C - 0x70
   std::int32_t m_iEnemy3Ks; // 0x70 - 0x74
...
public:
   ...
   std::int32_t m_iEnemy4Ks; // 0x6C - 0x70
   std::int32_t m_iEnemy3Ks; // 0x70 - 0x74
   std::int32_t m_iEnemy2Ks; // 0x74 - 0x78
   std::int32_t m_iUtility_Count; // 0x78 - 0x7C
   std::int32_t m_iUtility_Successes; // 0x7C - 0x80
   std::int32_t m_iUtility_Enemies; // 0x80 - 0x84
   std::int32_t m_iFlash_Count; // 0x84 - 0x88
   std::int32_t m_iFlash_Successes; // 0x88 - 0x8C
   std::int32_t m_nHealthPointsRemovedTotal; // 0x8C - 0x90
   std::int32_t m_nHealthPointsDealtTotal; // 0x90 - 0x94
   std::int32_t m_nShotsFiredTotal; // 0x94 - 0x98
   std::int32_t m_nShotsOnTargetTotal; // 0x98 - 0x9C
   std::int32_t m_i1v1Count; // 0x9C - 0xA0
   std::int32_t m_i1v1Wins; // 0xA0 - 0xA4
   std::int32_t m_i1v2Count; // 0xA4 - 0xA8
   std::int32_t m_i1v2Wins; // 0xA8 - 0xAC
   std::int32_t m_iEntryCount; // 0xAC - 0xB0
   std::int32_t m_iEntryWins; // 0xB0 - 0xB4
...
public:
   ...
   std::uint64_t m_nViewId; // 0x0 - 0x8
...
public:
   ...
   CUtlString m_Name; // 0x0 - 0x8
   std::uint64_t m_TextureId; // 0x8 - 0x10
   std::int32_t m_nWidth; // 0x10 - 0x14
   std::int32_t m_nHeight; // 0x14 - 0x18
   std::int32_t m_nRequestedWidth; // 0x18 - 0x1C
   std::int32_t m_nRequestedHeight; // 0x1C - 0x20
   std::int32_t m_nNumMipLevels; // 0x20 - 0x24
   std::int32_t m_nDepth; // 0x24 - 0x28
   std::int32_t m_nMultisampleNumSamples; // 0x28 - 0x2C
   std::int32_t m_nFormat; // 0x2C - 0x30
...
public:
   ...
   std::int32_t m_iLayer; // 0x0 - 0x4
   std::int32_t m_iPriority; // 0x4 - 0x8
   HSequence m_hSequence; // 0x8 - 0xC
   std::float_t m_flWeight; // 0xC - 0x10
   bool m_bIsMoving; // 0x10 - 0x11
   bool m_bHasArrived; // 0x11 - 0x12
   std::float_t m_flInitialYaw; // 0x14 - 0x18
   std::float_t m_flTargetYaw; // 0x18 - 0x1C
   std::float_t m_flFacingYaw; // 0x1C - 0x20
   std::int32_t m_nType; // 0x20 - 0x24
   ...
   std::uint32_t m_nSceneEventId; // 0x58 - 0x5C
...
public:
   ...
   std::int32_t m_nInitialSeed; // 0x9C - 0xA0
...
public:
   ...
   std::float_t m_flRadius; // 0x4EC - 0x4F0
   std::float_t m_flRepeat; // 0x4F0 - 0x4F4
   std::float_t m_flPlayAnimFadeInTime; // 0x4F4 - 0x4F8
   std::float_t m_flMoveInterpTime; // 0x4F8 - 0x4FC
   std::float_t m_flAngRate; // 0x4FC - 0x500
   std::int32_t m_iDelay; // 0x500 - 0x504
   GameTime_t m_startTime; // 0x504 - 0x508
   bool m_bWaitForBeginSequence; // 0x508 - 0x509
   std::int32_t m_saved_effects; // 0x50C - 0x510
   std::int32_t m_savedFlags; // 0x510 - 0x514
   std::int32_t m_savedCollisionGroup; // 0x514 - 0x518
   ...
   std::int32_t m_iPlayerDeathBehavior; // 0x7A4 - 0x7A8
...
public:
   ...
   std::int16_t m_nLocalReference; // 0x0 - 0x2
   std::int16_t m_nLocalPose; // 0x2 - 0x4
   CSeqAutoLayerFlag m_flags; // 0x4 - 0xC
   std::float_t m_start; // 0xC - 0x10
   std::float_t m_peak; // 0x10 - 0x14
   std::float_t m_tail; // 0x14 - 0x18
   std::float_t m_end; // 0x18 - 0x1C
...
public:
   ...
   std::float_t m_flDefaultMorphCtrlWeight; // 0x40 - 0x44
...
public:
   ...
   std::int16_t m_cmd; // 0x0 - 0x2
   std::int16_t m_nLocalReference; // 0x2 - 0x4
   std::int16_t m_nLocalBonemask; // 0x4 - 0x6
   std::int16_t m_nDstResult; // 0x6 - 0x8
   std::int16_t m_nSrcResult; // 0x8 - 0xA
   bool m_bSpline; // 0xA - 0xB
   std::float_t m_flVar1; // 0xC - 0x10
   std::float_t m_flVar2; // 0x10 - 0x14
   std::int16_t m_nLineNumber; // 0x14 - 0x16
...
public:
   ...
   std::int16_t m_nFrameRangeSequence; // 0x24 - 0x26
   std::int16_t m_nFrameCount; // 0x26 - 0x28
   std::float_t m_flFPS; // 0x28 - 0x2C
   std::int16_t m_nSubCycles; // 0x2C - 0x2E
   std::int16_t m_numLocalResults; // 0x2E - 0x30
...
public:
   ...
   std::float_t m_flPosWeight; // 0x0 - 0x4
   std::float_t m_flAngleWeight; // 0x4 - 0x8
   std::int16_t m_nLocalBone; // 0x8 - 0xA
...
public:
   ...
   std::int32_t m_nLocalCyclePoseParameter; // 0x60 - 0x64
...
public:
   ...
   CBufferString m_sName; // 0x0 - 0x10
   std::float_t m_flStart; // 0x10 - 0x14
   std::float_t m_flEnd; // 0x14 - 0x18
   std::float_t m_flLoop; // 0x18 - 0x1C
...
public:
   ...
   std::float_t m_flValue; // 0x30 - 0x34
   bool m_bX; // 0x34 - 0x35
   bool m_bY; // 0x35 - 0x36
   bool m_bZ; // 0x36 - 0x37
   std::int32_t m_eType; // 0x38 - 0x3C
...
public:
   ...
   std::int32_t m_nLocalWeightlist; // 0x88 - 0x8C
...
public:
   ...
   CSeqSeqDescFlag m_flags; // 0x10 - 0x1B
   CSeqTransition m_transition; // 0x1C - 0x24
   std::int16_t m_nLocalBaseReference; // 0x24 - 0x26
   std::int16_t m_nLocalBoneMask; // 0x26 - 0x28
...
public:
   ...
   std::uint32_t m_nFlags; // 0x20 - 0x24
...
public:
   ...
   std::uint32_t m_hShardHandle; // 0x8 - 0xC
   ...
   std::uint32_t m_hParentShard; // 0x40 - 0x44
   ShatterGlassStressType m_ShatterStressType; // 0x44 - 0x45
   Vector m_vecStressVelocity; // 0x48 - 0x54
   bool m_bCreatedModel; // 0x54 - 0x55
   std::float_t m_flLongestEdge; // 0x58 - 0x5C
   std::float_t m_flShortestEdge; // 0x5C - 0x60
   std::float_t m_flLongestAcross; // 0x60 - 0x64
   std::float_t m_flShortestAcross; // 0x64 - 0x68
   std::float_t m_flSumOfAllEdges; // 0x68 - 0x6C
   std::float_t m_flArea; // 0x6C - 0x70
   OnFrame m_nOnFrameEdge; // 0x70 - 0x71
   std::int32_t m_nParentPanelsNthShard; // 0x74 - 0x78
   std::int32_t m_nSubShardGeneration; // 0x78 - 0x7C
...
public:
   ...
   std::uint32_t m_hParentShard; // 0xB04 - 0xB08
...
public:
   ...
   std::float_t m_interval; // 0x8 - 0xC
...
public:
   ...
   std::int32_t m_nFrameIndex; // 0x5C - 0x60
...
public:
   ...
   std::float_t m_flCycle; // 0x78 - 0x7C
...
public:
   ...
   std::uint8_t m_nHitboxSet; // 0x398 - 0x399
...
public:
   ...
   std::float_t m_flPhysicsForceDamage; // 0x10 - 0x14
...
public:
   ...
   std::float_t m_flTraceDistance; // 0x40 - 0x44
...
public:
   ...
   std::float_t m_flTraceDistance; // 0x34 - 0x38
...
public:
   ...
   CAnimNodeConnection m_inputConnection; // 0x38 - 0x40
   std::float_t m_flSlowDownStrength; // 0x40 - 0x44
...
public:
   ...
   std::float_t m_flSlowDownStrength; // 0x68 - 0x6C
...
public:
   ...
   std::int32_t m_nSmokeEffectTickBegin; // 0x9B8 - 0x9BC
   bool m_bDidSmokeEffect; // 0x9BC - 0x9BD
   std::int32_t m_nRandomSeed; // 0x9C0 - 0x9C4
...
public:
   ...
   std::float_t m_flSmoothAmplitude; // 0x8 - 0xC
   std::float_t m_flSmoothBias; // 0xC - 0x10
   std::float_t m_flSmoothDuration; // 0x10 - 0x14
   std::float_t m_flSmoothRemainingTime; // 0x14 - 0x18
   std::int32_t m_nSmoothDir; // 0x18 - 0x1C
...
public:
   ...
   std::float_t m_flDebugNormalizedLength; // 0x44 - 0x48
...
public:
   ...
   std::int32_t m_nMaxCount; // 0x18 - 0x1C
...
public:
   ...
   std::float_t m_flMaxDuration; // 0x18 - 0x1C
...
public:
   ...
   std::float_t m_flEntIndex; // 0x20 - 0x24
   std::float_t m_flOpvar; // 0x24 - 0x28
...
public:
   ...
   std::int32_t m_nBlockMaxCount; // 0x10 - 0x14
...
public:
   ...
   std::int32_t m_iVolume; // 0x8 - 0xC
   std::float_t m_flOcclusionScale; // 0xC - 0x10
   std::int32_t m_iType; // 0x10 - 0x14
   std::int32_t m_iNextAudible; // 0x14 - 0x18
   GameTime_t m_flExpireTime; // 0x18 - 0x1C
   std::int16_t m_iNext; // 0x1C - 0x1E
   bool m_bNoExpirationTime; // 0x1E - 0x1F
   std::int32_t m_ownerChannelIndex; // 0x20 - 0x24
...
public:
   ...
   std::float_t m_flRadius; // 0x4C0 - 0x4C4
...
public:
   ...
   std::int32_t m_iFreeSound; // 0x4A0 - 0x4A4
   std::int32_t m_iActiveSound; // 0x4A4 - 0x4A8
   std::int32_t m_cLastActiveSounds; // 0x4A8 - 0x4AC
...
public:
   ...
   std::float_t m_current; // 0x0 - 0x4
   std::float_t m_target; // 0x4 - 0x8
   std::float_t m_rate; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_flFloatValue; // 0x4B0 - 0x4B4
...
public:
   ...
   std::int32_t m_iCountMax; // 0x550 - 0x554
   std::float_t m_flDistanceMax; // 0x554 - 0x558
   std::float_t m_flDistMaxSqr; // 0x558 - 0x55C
   std::float_t m_flDotProductMax; // 0x55C - 0x560
...
public:
   ...
   std::int32_t m_nOpvarType; // 0x4C0 - 0x4C4
   std::int32_t m_nOpvarIndex; // 0x4C4 - 0x4C8
   std::float_t m_flOpvarValue; // 0x4C8 - 0x4CC
...
public:
   ...
   std::float_t m_flWindMin; // 0x568 - 0x56C
   std::float_t m_flWindMax; // 0x56C - 0x570
   std::float_t m_flWindMapMin; // 0x570 - 0x574
   std::float_t m_flWindMapMax; // 0x574 - 0x578
...
public:
   ...
   std::float_t m_flDistMinSqr; // 0x650 - 0x654
   std::float_t m_flDistMaxSqr; // 0x654 - 0x658
...
public:
   ...
   std::float_t m_shutdownTime; // 0x30 - 0x34
   std::float_t m_flLastTime; // 0x34 - 0x38
   ...
   std::int32_t m_isPlaying; // 0x54 - 0x58
   CCopyRecipientFilter m_Filter; // 0x58 - 0x80
   std::float_t m_flCloseCaptionDuration; // 0x80 - 0x84
...
public:
   ...
   std::float_t m_flLightScale; // 0x6F0 - 0x6F4
   std::float_t m_Radius; // 0x6F4 - 0x6F8
...
public:
   ...
   CUtlString m_sequenceName; // 0x50 - 0x58
   std::int32_t m_nFrameIndex; // 0x58 - 0x5C
...
public:
   ...
   std::float_t m_comparisonFixedValue; // 0x30 - 0x34
...
public:
   ...
   CUtlVector< CUtlString > m_feet; // 0x28 - 0x40
   std::float_t m_flMinStepsRemaining; // 0x40 - 0x44
...
public:
   ...
   CUtlVector< int32 > m_footIndices; // 0x50 - 0x68
   std::float_t m_flMinStepsRemaining; // 0x68 - 0x6C
...
public:
   ...
   CAnimNodeConnection m_inputConnection; // 0x38 - 0x40
   std::float_t m_flOuterRadius; // 0x40 - 0x44
   std::float_t m_flInnerRadius; // 0x44 - 0x48
   std::float_t m_flMaxScale; // 0x48 - 0x4C
   std::float_t m_flMinScale; // 0x4C - 0x50
...
public:
   ...
   std::float_t m_flOuterRadius; // 0x6C - 0x70
   std::float_t m_flInnerRadius; // 0x70 - 0x74
   std::float_t m_flMaxScale; // 0x74 - 0x78
   std::float_t m_flMinScale; // 0x78 - 0x7C
   CAnimInputDamping m_damping; // 0x80 - 0x90
...
public:
   ...
   std::float_t m_interval; // 0xC - 0x10
...
public:
   ...
   std::float_t m_flSize; // 0x714 - 0x718
   std::float_t m_flRotation; // 0x718 - 0x71C
   std::float_t m_flHazeScale; // 0x71C - 0x720
   std::float_t m_flAlphaHaze; // 0x720 - 0x724
   std::float_t m_flAlphaHdr; // 0x724 - 0x728
   std::float_t m_flAlphaScale; // 0x728 - 0x72C
   std::float_t m_flHDRColorScale; // 0x72C - 0x730
   std::float_t m_flFarZScale; // 0x730 - 0x734
...
public:
   ...
   std::float_t m_flSpawnSelectionTimeStartCurrentStage; // 0x204 - 0x208
   std::float_t m_flSpawnSelectionTimeEndCurrentStage; // 0x208 - 0x20C
   std::float_t m_flSpawnSelectionTimeEndLastStage; // 0x20C - 0x210
   SpawnStage_t m_spawnStage; // 0x210 - 0x214
   std::float_t m_flTabletHexOriginX; // 0x214 - 0x218
   std::float_t m_flTabletHexOriginY; // 0x218 - 0x21C
   std::float_t m_flTabletHexSize; // 0x21C - 0x220
   ...
   std::float_t m_flSurvivalStartTime; // 0x6A0 - 0x6A4
   std::float_t m_flLastThinkTime; // 0x6A4 - 0x6A8
   ...
   std::float_t m_flLastWinConditionDetectedTime; // 0x7B0 - 0x7B4
   std::int32_t m_nWinConditionStageProgress; // 0x7B4 - 0x7B8
   std::int32_t m_nEntIndexOfRunnerUpPlayer; // 0x7B8 - 0x7BC
   std::int32_t m_nEntIndexOfKilledPlayerCheckingWinConditions; // 0x7BC - 0x7C0
   std::float_t m_flTimeOfLastParadrop; // 0x7C0 - 0x7C4
   ...
   std::float_t m_flLastDroneSpawnTime; // 0x848 - 0x84C
...
public:
   ...
   std::float_t m_flFlightPathRotationOffset; // 0x82C - 0x830
...
public:
   ...
   std::int32_t m_nContractKillGridIndex; // 0xE14 - 0xE18
   std::int32_t m_nContractKillGridHighResIndex; // 0xE18 - 0xE1C
   bool m_bTabletReceptionIsBlocked; // 0xE1C - 0xE1D
   std::float_t m_flScanProgress; // 0xE20 - 0xE24
   ...
   std::int32_t m_nLastPurchaseIndex; // 0xE7C - 0xE80
   ...
   std::float_t m_flLastClosePoseParamVal; // 0x1060 - 0x1064
...
public:
   ...
   std::float_t m_flDamage; // 0x44 - 0x48
   std::int32_t m_bitsDamageType; // 0x48 - 0x4C
   std::int32_t m_iDamageCustom; // 0x4C - 0x50
   AmmoIndex_t m_iAmmoType; // 0x50 - 0x51
   std::float_t m_flOriginalDamage; // 0x60 - 0x64
   TakeDamageFlags_t m_nDamageFlags; // 0x70 - 0x74
   std::int32_t m_nNumObjectsPenetrated; // 0x74 - 0x78
...
public:
   ...
   std::int32_t m_nHealthLost; // 0x0 - 0x4
   std::int32_t m_nDamageTaken; // 0x4 - 0x8
...
public:
   ...
   CHandle< CBaseEntity > m_hTargetEntity; // 0x4A4 - 0x4A8
   std::int32_t m_soundPlaying; // 0x4A8 - 0x4AC
...
public:
   ...
   std::int32_t m_iLoop; // 0x4A0 - 0x4A4
   std::int32_t m_iBeam; // 0x4A4 - 0x4A8
...
public:
   ...
   std::float_t m_flFPS; // 0x6F4 - 0x6F8
   ...
   std::float_t m_flStartTime; // 0x720 - 0x724
   std::float_t m_flStartFrame; // 0x724 - 0x728
...
public:
   ...
   std::int32_t m_nTargetAxis; // 0x70 - 0x74
   std::int32_t m_nSlaveAxis; // 0x74 - 0x78
...
public:
   ...
   std::float_t m_flMaxTimeRemaining; // 0x2C - 0x30
   bool m_bFilterByTimeRemaining; // 0x30 - 0x31
   std::float_t m_flMinTimeRemaining; // 0x34 - 0x38
...
public:
   ...
   std::float_t m_flMaxTimeRemaining; // 0x54 - 0x58
   bool m_bFilterByTimeRemaining; // 0x58 - 0x59
   std::float_t m_flMinTimeRemaining; // 0x5C - 0x60
...
public:
   ...
   std::int32_t m_nBucketCount; // 0x210 - 0x214
   std::float_t m_flInterval; // 0x214 - 0x218
   std::float_t m_flFinalValue; // 0x218 - 0x21C
...
public:
   ...
   std::int32_t m_iDisabled; // 0x518 - 0x51C
   std::float_t m_flInitialDelay; // 0x51C - 0x520
   std::float_t m_flRefireTime; // 0x520 - 0x524
   bool m_bUpDownState; // 0x524 - 0x525
   std::int32_t m_iUseRandomTime; // 0x528 - 0x52C
   bool m_bPauseAfterFiring; // 0x52C - 0x52D
   std::float_t m_flLowerRandomBound; // 0x530 - 0x534
   std::float_t m_flUpperRandomBound; // 0x534 - 0x538
   std::float_t m_flRemainingTime; // 0x538 - 0x53C
...
public:
   ...
   std::uint8_t m_srcStateIndex; // 0x0 - 0x1
   std::uint8_t m_destStateIndex; // 0x1 - 0x2
...
public:
   ...
   std::int32_t m_iInputFilter; // 0x768 - 0x76C
   std::int32_t m_iDontMessageParent; // 0x76C - 0x770
...
public:
   ...
   std::float_t m_flFluidDensity; // 0x8B8 - 0x8BC
...
public:
   ...
   std::float_t m_flWait; // 0x4B8 - 0x4BC
   GameTime_t m_flReturnTime; // 0x4BC - 0x4C0
   GameTime_t m_flStopTime; // 0x4C0 - 0x4C4
   std::float_t m_moveDistance; // 0x4C4 - 0x4C8
   std::float_t m_targetSpeed; // 0x4C8 - 0x4CC
   std::float_t m_initialSpeed; // 0x4CC - 0x4D0
   std::float_t m_acceleration; // 0x4D0 - 0x4D4
   std::float_t m_deceleration; // 0x4D4 - 0x4D8
   std::int32_t m_state; // 0x4D8 - 0x4DC
   Vector m_vecMoveDir; // 0x4DC - 0x4E8
   std::float_t m_fov; // 0x4E8 - 0x4EC
   std::float_t m_fovSpeed; // 0x4EC - 0x4F0
   ...
   std::uint64_t m_nPlayerButtons; // 0x518 - 0x520
...
public:
   ...
   std::float_t m_flForce; // 0x8BC - 0x8C0
   std::float_t m_flPlayerForce; // 0x8C0 - 0x8C4
   std::float_t m_flRampTime; // 0x8C4 - 0x8C8
...
public:
   ...
   std::float_t m_flMagnitude; // 0x8C0 - 0x8C4
   std::float_t m_flNoise; // 0x8C4 - 0x8C8
   std::float_t m_flViewkick; // 0x8C8 - 0x8CC
...
public:
   ...
   std::float_t m_flLerpDuration; // 0x8B4 - 0x8B8
...
public:
   ...
   std::float_t m_flFieldOfView; // 0x8C4 - 0x8C8
   std::float_t m_flLookTime; // 0x8C8 - 0x8CC
   std::float_t m_flLookTimeTotal; // 0x8CC - 0x8D0
   GameTime_t m_flLookTimeLast; // 0x8D0 - 0x8D4
   std::float_t m_flTimeoutDuration; // 0x8D4 - 0x8D8
...
public:
   ...
   std::float_t m_gravityScale; // 0x8A8 - 0x8AC
   std::float_t m_linearLimit; // 0x8AC - 0x8B0
   std::float_t m_linearDamping; // 0x8B0 - 0x8B4
   std::float_t m_angularLimit; // 0x8B4 - 0x8B8
   std::float_t m_angularDamping; // 0x8B8 - 0x8BC
   std::float_t m_linearForce; // 0x8BC - 0x8C0
   std::float_t m_flFrequency; // 0x8C0 - 0x8C4
   std::float_t m_flDampingRatio; // 0x8C4 - 0x8C8
...
public:
   ...
   std::float_t m_fRadius; // 0x8A8 - 0x8AC
   std::int32_t m_nTouchers; // 0x8AC - 0x8B0
...
public:
   ...
   std::float_t m_fDangerousTimer; // 0x89C - 0x8A0
   std::int32_t m_minHitPoints; // 0x8A0 - 0x8A4
...
public:
   ...
   std::float_t m_flCenterSize; // 0x8BC - 0x8C0
   std::float_t m_flMinVal; // 0x8C0 - 0x8C4
   std::float_t m_flMaxVal; // 0x8C4 - 0x8C8
   std::float_t m_flWait; // 0x8C8 - 0x8CC
   ...
   std::float_t m_flNormCenterSize; // 0xBF8 - 0xBFC
...
public:
   ...
   std::int32_t m_nLastStuckToEntModelIndex; // 0x9E4 - 0x9E8
   CTransform m_xformStuckToEnt; // 0x9F0 - 0xA10
   Vector m_vecTrapSetPosition; // 0xA10 - 0xA1C
   std::int32_t m_nWireSoundsPlayed; // 0xA1C - 0xA20
...
public:
   ...
   std::float_t m_turnStartTime; // 0x44 - 0x48
   std::float_t m_turnDuration; // 0x48 - 0x4C
   bool m_bMatchChildDuration; // 0x4C - 0x4D
   bool m_bUseManualTurnOffset; // 0x4D - 0x4E
   std::float_t m_manualTurnOffset; // 0x50 - 0x54
...
public:
   ...
   std::float_t m_turnStartTimeOffset; // 0x70 - 0x74
   std::float_t m_turnDuration; // 0x74 - 0x78
   bool m_bMatchChildDuration; // 0x78 - 0x79
   std::float_t m_manualTurnOffset; // 0x7C - 0x80
...
public:
   ...
   std::float_t m_flMaxTwist; // 0x80 - 0x84
...
public:
   ...
   std::int32_t m_nCentroids; // 0x18 - 0x1C
   std::int32_t m_nDimensions; // 0x1C - 0x20
...
public:
   ...
   std::int32_t m_iActiveIssueIndex; // 0x4A0 - 0x4A4
   std::int32_t m_iOnlyTeamToVote; // 0x4A4 - 0x4A8
   int32 m_nVoteOptionCount[5]; // 0x4A8 - 0x4BC
   std::int32_t m_nPotentialVotes; // 0x4BC - 0x4C0
   ...
   std::int32_t m_nHighestCountIndex; // 0x62C - 0x630
...
public:
   ...
   std::uint32_t m_nBaseClusterCount; // 0x40 - 0x44
   std::uint32_t m_nPVSBytesPerCluster; // 0x44 - 0x48
   Vector m_vMinBounds; // 0x48 - 0x54
   Vector m_vMaxBounds; // 0x54 - 0x60
   std::float_t m_flGridSize; // 0x60 - 0x64
   std::uint32_t m_nSkyVisibilityCluster; // 0x64 - 0x68
   std::uint32_t m_nSunVisibilityCluster; // 0x68 - 0x6C
...
public:
   ...
   CAnimNodeConnection m_inputConnection; // 0x38 - 0x40
   std::float_t m_flStartCycle; // 0x40 - 0x44
   std::float_t m_flEndCycle; // 0x44 - 0x48
...
public:
   ...
   std::float_t m_flStartCycle; // 0x6C - 0x70
   std::float_t m_flEndCycle; // 0x70 - 0x74
...
public:
   ...
   std::int32_t m_GearSlotPosition; // 0xBEC - 0xBF0
   loadout_positions_t m_DefaultLoadoutPosition; // 0xBF0 - 0xBF4
   CUtlString m_sWrongTeamMsg; // 0xBF8 - 0xC00
   std::int32_t m_nPrice; // 0xC00 - 0xC04
   std::int32_t m_nKillAward; // 0xC04 - 0xC08
   std::int32_t m_nPrimaryReserveAmmoMax; // 0xC08 - 0xC0C
   std::int32_t m_nSecondaryReserveAmmoMax; // 0xC0C - 0xC10
   ...
   std::int32_t m_nCrosshairMinDistance; // 0xC2C - 0xC30
   std::int32_t m_nCrosshairDeltaDistance; // 0xC30 - 0xC34
   ...
   std::float_t m_flInaccuracyJumpInitial; // 0xCAC - 0xCB0
   std::float_t m_flInaccuracyJumpApex; // 0xCB0 - 0xCB4
   std::float_t m_flInaccuracyReload; // 0xCB4 - 0xCB8
   std::int32_t m_nRecoilSeed; // 0xCB8 - 0xCBC
   std::int32_t m_nSpreadSeed; // 0xCBC - 0xCC0
   std::float_t m_flTimeToIdleAfterFire; // 0xCC0 - 0xCC4
   std::float_t m_flIdleInterval; // 0xCC4 - 0xCC8
   std::float_t m_flAttackMovespeedFactor; // 0xCC8 - 0xCCC
   std::float_t m_flHeatPerShot; // 0xCCC - 0xCD0
   std::float_t m_flInaccuracyPitchShift; // 0xCD0 - 0xCD4
   std::float_t m_flInaccuracyAltSoundThreshold; // 0xCD4 - 0xCD8
   std::float_t m_flBotAudibleRange; // 0xCD8 - 0xCDC
   ...
   std::int32_t m_nZoomLevels; // 0xCEC - 0xCF0
   std::int32_t m_nZoomFOV1; // 0xCF0 - 0xCF4
   std::int32_t m_nZoomFOV2; // 0xCF4 - 0xCF8
   std::float_t m_flZoomTime0; // 0xCF8 - 0xCFC
   std::float_t m_flZoomTime1; // 0xCFC - 0xD00
   std::float_t m_flZoomTime2; // 0xD00 - 0xD04
   std::float_t m_flIronSightPullUpSpeed; // 0xD04 - 0xD08
   std::float_t m_flIronSightPutDownSpeed; // 0xD08 - 0xD0C
   std::float_t m_flIronSightFOV; // 0xD0C - 0xD10
   std::float_t m_flIronSightPivotForward; // 0xD10 - 0xD14
   std::float_t m_flIronSightLooseness; // 0xD14 - 0xD18
   QAngle m_angPivotAngle; // 0xD18 - 0xD24
   Vector m_vecIronSightEyePos; // 0xD24 - 0xD30
   std::int32_t m_nDamage; // 0xD30 - 0xD34
   std::float_t m_flHeadshotMultiplier; // 0xD34 - 0xD38
   std::float_t m_flArmorRatio; // 0xD38 - 0xD3C
   std::float_t m_flPenetration; // 0xD3C - 0xD40
   std::float_t m_flRange; // 0xD40 - 0xD44
   std::float_t m_flRangeModifier; // 0xD44 - 0xD48
   std::float_t m_flFlinchVelocityModifierLarge; // 0xD48 - 0xD4C
   std::float_t m_flFlinchVelocityModifierSmall; // 0xD4C - 0xD50
   std::float_t m_flRecoveryTimeCrouch; // 0xD50 - 0xD54
   std::float_t m_flRecoveryTimeStand; // 0xD54 - 0xD58
   std::float_t m_flRecoveryTimeCrouchFinal; // 0xD58 - 0xD5C
   std::float_t m_flRecoveryTimeStandFinal; // 0xD5C - 0xD60
   std::int32_t m_nRecoveryTransitionStartBullet; // 0xD60 - 0xD64
   std::int32_t m_nRecoveryTransitionEndBullet; // 0xD64 - 0xD68
   std::float_t m_flThrowVelocity; // 0xD68 - 0xD6C
...
public:
   ...
   std::float_t m_flBulletDamageAbsorbed; // 0xD70 - 0xD74
   GameTime_t m_flLastBulletHitSoundTime; // 0xD74 - 0xD78
   std::float_t m_flDisplayHealth; // 0xD78 - 0xD7C
...
public:
   ...
   std::int32_t m_iExternalItemProviderRegisteredToken; // 0x498 - 0x49C
   std::uint64_t m_ullRegisteredAsItemID; // 0x4A0 - 0x4A8
...
public:
   ...
   std::float_t m_flRadius; // 0x9A4 - 0x9A8
...
public:
   ...
   std::float_t m_flFrameRate; // 0x838 - 0x83C
   std::float_t m_flHDRColorScale; // 0x83C - 0x840
   GameTime_t m_flFireTime; // 0x840 - 0x844
   std::float_t m_flDamage; // 0x844 - 0x848
   std::uint8_t m_nNumBeamEnts; // 0x848 - 0x849
   std::int32_t m_queryHandleHalo; // 0x84C - 0x850
   ...
   std::uint32_t m_nBeamFlags; // 0x884 - 0x888
   CHandle< C_BaseEntity > m_hAttachEntity[10]; // 0x888 - 0x8B0
   AttachmentHandle_t m_nAttachIndex[10]; // 0x8B0 - 0x8BA
   std::float_t m_fWidth; // 0x8BC - 0x8C0
   std::float_t m_fEndWidth; // 0x8C0 - 0x8C4
   std::float_t m_fFadeLength; // 0x8C4 - 0x8C8
   std::float_t m_fHaloScale; // 0x8C8 - 0x8CC
   std::float_t m_fAmplitude; // 0x8CC - 0x8D0
   std::float_t m_fStartFrame; // 0x8D0 - 0x8D4
   std::float_t m_fSpeed; // 0x8D4 - 0x8D8
   std::float_t m_flFrame; // 0x8D8 - 0x8DC
...
public:
   ...
   std::int32_t m_nParentBoneIndex; // 0xB80 - 0xB84
...
public:
   ...
   std::int32_t m_iBoneIndex; // 0x9C8 - 0x9CC
   CHandle< C_BaseEntity > m_hPlayerParent; // 0x9CC - 0x9D0
   bool m_bIsHit; // 0x9D0 - 0x9D1
   std::float_t m_flTimeCreated; // 0x9D4 - 0x9D8
...
public:
   ...
   bool m_bShouldExplode; // 0xB78 - 0xB79
   std::int32_t m_nParentBoneIndex; // 0xB7C - 0xB80
...
public:
   ...
   std::int32_t m_nSpotRules; // 0x1418 - 0x141C
...
public:
   ...
   std::float_t m_flCamDriverAppliedTime; // 0xA44 - 0xA48
   std::float_t m_flCamDriverWeight; // 0xA48 - 0xA4C
   std::uint32_t m_nWeaponParity; // 0xA4C - 0xA50
   std::uint32_t m_nOldWeaponParity; // 0xA50 - 0xA54
...
public:
   ...
   std::int32_t m_nPathIndex; // 0x540 - 0x544
   Vector m_vInTangentLocal; // 0x544 - 0x550
   Vector m_vOutTangentLocal; // 0x550 - 0x55C
   std::float_t m_flFOV; // 0x55C - 0x560
   std::float_t m_flSpeed; // 0x560 - 0x564
   std::float_t m_flEaseIn; // 0x564 - 0x568
   std::float_t m_flEaseOut; // 0x568 - 0x56C
...
public:
   ...
   std::float_t m_flTerroristTimeOutRemaining; // 0x40 - 0x44
   std::float_t m_flCTTimeOutRemaining; // 0x44 - 0x48
   std::int32_t m_nTerroristTimeOuts; // 0x48 - 0x4C
   std::int32_t m_nCTTimeOuts; // 0x4C - 0x50
   bool m_bTechnicalTimeOut; // 0x50 - 0x51
   bool m_bMatchWaitingForResume; // 0x51 - 0x52
   std::int32_t m_iRoundTime; // 0x54 - 0x58
   std::float_t m_fMatchStartTime; // 0x58 - 0x5C
   GameTime_t m_fRoundStartTime; // 0x5C - 0x60
   GameTime_t m_flRestartRoundTime; // 0x60 - 0x64
   bool m_bGameRestart; // 0x64 - 0x65
   std::float_t m_flGameStartTime; // 0x68 - 0x6C
   std::float_t m_timeUntilNextPhaseStarts; // 0x6C - 0x70
   std::int32_t m_gamePhase; // 0x70 - 0x74
   std::int32_t m_totalRoundsPlayed; // 0x74 - 0x78
   std::int32_t m_nRoundsPlayedThisPhase; // 0x78 - 0x7C
   std::int32_t m_nOvertimePlaying; // 0x7C - 0x80
   std::int32_t m_iHostagesRemaining; // 0x80 - 0x84
   ...
   std::int32_t m_nQueuedMatchmakingMode; // 0x8C - 0x90
   bool m_bIsValveDS; // 0x90 - 0x91
   bool m_bLogoMap; // 0x91 - 0x92
   bool m_bPlayAllStepSoundsOnServer; // 0x92 - 0x93
   std::int32_t m_iNumGunGameProgressiveWeaponsCT; // 0x94 - 0x98
   std::int32_t m_iNumGunGameProgressiveWeaponsT; // 0x98 - 0x9C
   std::int32_t m_iSpectatorSlotCount; // 0x9C - 0xA0
   ...
   std::int32_t m_MatchDevice; // 0x460 - 0x464
   bool m_bHasMatchStarted; // 0x464 - 0x465
   std::float_t m_flDMBonusStartTime; // 0x468 - 0x46C
   std::float_t m_flDMBonusTimeLength; // 0x46C - 0x470
   std::uint16_t m_unDMBonusWeaponLoadoutSlot; // 0x470 - 0x472
   bool m_bDMBonusActive; // 0x472 - 0x473
   std::int32_t m_nNextMapInMapgroup; // 0x474 - 0x478
   ...
   std::int32_t m_nTournamentPredictionsPct; // 0xC78 - 0xC7C
   ...
   std::int32_t m_nGuardianModeWaveNumber; // 0xC88 - 0xC8C
   std::int32_t m_nGuardianModeSpecialKillsRemaining; // 0xC8C - 0xC90
   std::int32_t m_nGuardianModeSpecialWeaponNeeded; // 0xC90 - 0xC94
   std::int32_t m_nGuardianGrenadesToGiveBots; // 0xC94 - 0xC98
   std::int32_t m_nNumHeaviesToSpawn; // 0xC98 - 0xC9C
   std::uint32_t m_numGlobalGiftsGiven; // 0xC9C - 0xCA0
   std::uint32_t m_numGlobalGifters; // 0xCA0 - 0xCA4
   std::uint32_t m_numGlobalGiftsPeriodSeconds; // 0xCA4 - 0xCA8
   ...
   std::int32_t m_numBestOfMaps; // 0xDA0 - 0xDA4
   std::int32_t m_nHalloweenMaskListSeed; // 0xDA4 - 0xDA8
   bool m_bBombDropped; // 0xDA8 - 0xDA9
   bool m_bBombPlanted; // 0xDA9 - 0xDAA
   std::int32_t m_iRoundWinStatus; // 0xDAC - 0xDB0
   std::int32_t m_eRoundWinReason; // 0xDB0 - 0xDB4
   ...
   std::int32_t m_nServerQuestID; // 0x1024 - 0x1028
   ...
   std::int32_t m_nEndMatchMapVoteWinner; // 0x107C - 0x1080
   std::int32_t m_iNumConsecutiveCTLoses; // 0x1080 - 0x1084
   std::int32_t m_iNumConsecutiveTerroristLoses; // 0x1084 - 0x1088
   ...
   std::int32_t m_iMaxGunGameProgressiveWeaponIndex; // 0x10FC - 0x1100
   C_SurvivalGameRules m_SurvivalRules; // 0x1118 - 0x17D8
   C_RetakeGameRules m_RetakeRules; // 0x17D8 - 0x18F0
   std::uint8_t m_nMatchEndCount; // 0x18F0 - 0x18F1
...
public:
   ...
   std::float_t m_flOverrideAlpha; // 0xAF0 - 0xAF4
...
public:
   ...
   std::int32_t m_numMapVictories; // 0x7F0 - 0x7F4
   bool m_bSurrendered; // 0x7F4 - 0x7F5
   std::int32_t m_scoreFirstHalf; // 0x7F8 - 0x7FC
   std::int32_t m_scoreSecondHalf; // 0x7FC - 0x800
   std::int32_t m_scoreOvertime; // 0x800 - 0x804
   char m_szClanTeamname[129]; // 0x804 - 0x885
   std::uint32_t m_iClanID; // 0x888 - 0x88C
...
public:
   ...
   std::uint32_t m_OriginalOwnerXuidLow; // 0x10C0 - 0x10C4
   std::uint32_t m_OriginalOwnerXuidHigh; // 0x10C4 - 0x10C8
...
public:
   ...
   std::int32_t m_iCurrentFriction; // 0x9A4 - 0x9A8
   std::int32_t m_iMinFriction; // 0x9A8 - 0x9AC
   std::int32_t m_iMaxFriction; // 0x9AC - 0x9B0
   std::int32_t m_iFrictionAnimState; // 0x9B0 - 0x9B4
...
public:
   ...
   std::float_t m_MinFalloff; // 0x544 - 0x548
   std::float_t m_MaxFalloff; // 0x548 - 0x54C
   std::float_t m_flFadeInDuration; // 0x54C - 0x550
   std::float_t m_flFadeOutDuration; // 0x550 - 0x554
   std::float_t m_flMaxWeight; // 0x554 - 0x558
   std::float_t m_flCurWeight; // 0x558 - 0x55C
...
public:
   ...
   std::float_t m_LastEnterWeight; // 0x840 - 0x844
   std::float_t m_LastEnterTime; // 0x844 - 0x848
   std::float_t m_LastExitWeight; // 0x848 - 0x84C
   std::float_t m_LastExitTime; // 0x84C - 0x850
   bool m_bEnabled; // 0x850 - 0x851
   std::float_t m_MaxWeight; // 0x854 - 0x858
   std::float_t m_FadeDuration; // 0x858 - 0x85C
   std::float_t m_Weight; // 0x85C - 0x860
...
public:
   ...
   std::int32_t command_number; // 0x78 - 0x7C
...
public:
   ...
   std::float_t m_flExtraRadius; // 0x548 - 0x54C
   GameTime_t m_flExtraRadiusStartTime; // 0x54C - 0x550
   std::float_t m_flExtraRadiusTotalLerpTime; // 0x550 - 0x554
   std::int32_t m_nDropOrder; // 0x554 - 0x558
   std::int32_t m_iWave; // 0x558 - 0x55C
...
public:
   ...
   std::float_t m_flFinalExpansionTime; // 0x558 - 0x55C
...
public:
   ...
   std::float_t m_flJammedEffectAmount; // 0xD08 - 0xD0C
...
public:
   ...
   std::int32_t m_nPoseParamPitch; // 0x9C8 - 0x9CC
   std::int32_t m_nPoseParamYaw; // 0x9CC - 0x9D0
   ...
   std::int32_t m_nBoneOverrideIndex; // 0x9DC - 0x9E0
...
public:
   ...
   std::uint8_t m_Flags; // 0x838 - 0x839
   std::uint8_t m_LightStyle; // 0x839 - 0x83A
   std::float_t m_Radius; // 0x83C - 0x840
   std::int32_t m_Exponent; // 0x840 - 0x844
   std::float_t m_InnerAngle; // 0x844 - 0x848
   std::float_t m_OuterAngle; // 0x848 - 0x84C
   std::float_t m_SpotRadius; // 0x84C - 0x850
...
public:
   ...
   std::int32_t m_nInventoryImageRgbaWidth; // 0x80 - 0x84
   std::int32_t m_nInventoryImageRgbaHeight; // 0x84 - 0x88
   char m_szCurrentLoadCachedFileName[260]; // 0x88 - 0x18C
   bool m_bRestoreCustomMaterialAfterPrecache; // 0x1B8 - 0x1B9
   std::uint16_t m_iItemDefinitionIndex; // 0x1BA - 0x1BC
   std::int32_t m_iEntityQuality; // 0x1BC - 0x1C0
   std::uint32_t m_iEntityLevel; // 0x1C0 - 0x1C4
   std::uint64_t m_iItemID; // 0x1C8 - 0x1D0
   std::uint32_t m_iItemIDHigh; // 0x1D0 - 0x1D4
   std::uint32_t m_iItemIDLow; // 0x1D4 - 0x1D8
   std::uint32_t m_iAccountID; // 0x1D8 - 0x1DC
   std::uint32_t m_iInventoryPosition; // 0x1DC - 0x1E0
   bool m_bInitialized; // 0x1E8 - 0x1E9
   bool m_bIsStoreItem; // 0x1E9 - 0x1EA
   bool m_bIsTradeItem; // 0x1EA - 0x1EB
   std::int32_t m_iEntityQuantity; // 0x1EC - 0x1F0
   std::int32_t m_iRarityOverride; // 0x1F0 - 0x1F4
   std::int32_t m_iQualityOverride; // 0x1F4 - 0x1F8
   std::uint8_t m_unClientFlags; // 0x1F8 - 0x1F9
   std::uint8_t m_unOverrideStyle; // 0x1F9 - 0x1FA
...
public:
   ...
   std::int32_t m_nForceSkin; // 0x1070 - 0x1074
...
public:
   ...
   std::float_t m_flFadeInStart; // 0x844 - 0x848
   std::float_t m_flFadeInLength; // 0x848 - 0x84C
   std::float_t m_flFadeOutModelStart; // 0x84C - 0x850
   std::float_t m_flFadeOutModelLength; // 0x850 - 0x854
   std::float_t m_flFadeOutStart; // 0x854 - 0x858
   std::float_t m_flFadeOutLength; // 0x858 - 0x85C
   ...
   std::uint32_t m_nMagnitude; // 0x870 - 0x874
...
public:
   ...
   std::float_t m_flBrightness; // 0x160C - 0x1610
   ...
   std::int32_t m_nHandshake; // 0x1664 - 0x1668
   std::int32_t m_nEnvCubeMapArrayIndex; // 0x1668 - 0x166C
   std::int32_t m_nPriority; // 0x166C - 0x1670
   bool m_bStartDisabled; // 0x1670 - 0x1671
   std::float_t m_flEdgeFadeDist; // 0x1674 - 0x1678
   Vector m_vEdgeFadeDists; // 0x1678 - 0x1684
   std::int32_t m_nLightProbeSizeX; // 0x1684 - 0x1688
   std::int32_t m_nLightProbeSizeY; // 0x1688 - 0x168C
   std::int32_t m_nLightProbeSizeZ; // 0x168C - 0x1690
   std::int32_t m_nLightProbeAtlasX; // 0x1690 - 0x1694
   std::int32_t m_nLightProbeAtlasY; // 0x1694 - 0x1698
   std::int32_t m_nLightProbeAtlasZ; // 0x1698 - 0x169C
...
public:
   ...
   std::float_t m_flEndDistance; // 0x538 - 0x53C
   std::float_t m_flStartDistance; // 0x53C - 0x540
   std::float_t m_flFogFalloffExponent; // 0x540 - 0x544
   bool m_bHeightFogEnabled; // 0x544 - 0x545
   std::float_t m_flFogHeightWidth; // 0x548 - 0x54C
   std::float_t m_flFogHeightEnd; // 0x54C - 0x550
   std::float_t m_flFogHeightStart; // 0x550 - 0x554
   std::float_t m_flFogHeightExponent; // 0x554 - 0x558
   std::float_t m_flLODBias; // 0x558 - 0x55C
   bool m_bActive; // 0x55C - 0x55D
   bool m_bStartDisabled; // 0x55D - 0x55E
   std::float_t m_flFogMaxOpacity; // 0x560 - 0x564
   std::int32_t m_nCubemapSourceType; // 0x564 - 0x568
...
public:
   ...
   std::float_t m_flWidth; // 0x840 - 0x844
   std::float_t m_flHeight; // 0x844 - 0x848
   std::float_t m_flDepth; // 0x848 - 0x84C
   std::uint32_t m_nRenderOrder; // 0x84C - 0x850
   bool m_bProjectOnWorld; // 0x850 - 0x851
   bool m_bProjectOnCharacters; // 0x851 - 0x852
   bool m_bProjectOnWater; // 0x852 - 0x853
   std::float_t m_flDepthSortBias; // 0x854 - 0x858
...
public:
   ...
   std::float_t m_flFadeStartDist; // 0x538 - 0x53C
   std::float_t m_flFadeEndDist; // 0x53C - 0x540
...
public:
   ...
   std::float_t m_flFlightTime; // 0xA44 - 0xA48
   std::float_t m_flFlightSpeed; // 0xA48 - 0xA4C
   GameTime_t m_flLaunchTime; // 0xA4C - 0xA50
   std::float_t m_flInitialZSpeed; // 0xA50 - 0xA54
   std::float_t m_flZAcceleration; // 0xA54 - 0xA58
   std::float_t m_flHorizSpeed; // 0xA58 - 0xA5C
   bool m_bLaunchedFromWithinWorld; // 0xA5C - 0xA5D
   Vector m_vecParabolaDirection; // 0xA60 - 0xA6C
   std::float_t m_flWorldEnterTime; // 0xA6C - 0xA70
   Vector m_vecSkyboxOrigin; // 0xA70 - 0xA7C
   std::float_t m_flSkyboxScale; // 0xA7C - 0xA80
   bool m_bInSkybox; // 0xA80 - 0xA81
   bool m_bDoImpactEffects; // 0xA81 - 0xA82
   std::int32_t m_nMyZoneIndex; // 0xA84 - 0xA88
   CHandle< C_BaseEntity > m_hSkyboxCopy; // 0xA88 - 0xA8C
   std::float_t m_flLaunchHeight; // 0xA8C - 0xA90
...
public:
   ...
   std::int32_t m_nHandshake; // 0x155C - 0x1560
   std::int32_t m_nPriority; // 0x1560 - 0x1564
   bool m_bStartDisabled; // 0x1564 - 0x1565
   std::int32_t m_nLightProbeSizeX; // 0x1568 - 0x156C
   std::int32_t m_nLightProbeSizeY; // 0x156C - 0x1570
   std::int32_t m_nLightProbeSizeZ; // 0x1570 - 0x1574
   std::int32_t m_nLightProbeAtlasX; // 0x1574 - 0x1578
   std::int32_t m_nLightProbeAtlasY; // 0x1578 - 0x157C
   std::int32_t m_nLightProbeAtlasZ; // 0x157C - 0x1580
...
public:
   ...
   std::float_t m_flAlphaScale; // 0xDE8 - 0xDEC
   std::float_t m_flRadiusScale; // 0xDEC - 0xDF0
   std::float_t m_flSelfIllumScale; // 0xDF0 - 0xDF4
...
public:
   ...
   std::int32_t m_iDesiredOverlay; // 0x5B4 - 0x5B8
   bool m_bIsActive; // 0x5B8 - 0x5B9
   bool m_bWasActive; // 0x5B9 - 0x5BA
   std::int32_t m_iCachedDesiredOverlay; // 0x5BC - 0x5C0
   std::int32_t m_iCurrentOverlay; // 0x5C0 - 0x5C4
...
public:
   ...
   std::float_t m_flBrightnessScale; // 0x848 - 0x84C
   std::int32_t m_nFogType; // 0x84C - 0x850
   std::float_t m_flFogMinStart; // 0x850 - 0x854
   std::float_t m_flFogMinEnd; // 0x854 - 0x858
   std::float_t m_flFogMaxStart; // 0x858 - 0x85C
   std::float_t m_flFogMaxEnd; // 0x85C - 0x860
...
public:
   ...
   std::float_t m_flScattering; // 0x538 - 0x53C
   std::float_t m_flAnisotropy; // 0x53C - 0x540
   std::float_t m_flFadeSpeed; // 0x540 - 0x544
   std::float_t m_flDrawDistance; // 0x544 - 0x548
   std::float_t m_flFadeInStart; // 0x548 - 0x54C
   std::float_t m_flFadeInEnd; // 0x54C - 0x550
   std::float_t m_flIndirectStrength; // 0x550 - 0x554
   std::int32_t m_nIndirectTextureDimX; // 0x554 - 0x558
   std::int32_t m_nIndirectTextureDimY; // 0x558 - 0x55C
   std::int32_t m_nIndirectTextureDimZ; // 0x55C - 0x560
   ...
   std::float_t m_flStartAnisotropy; // 0x588 - 0x58C
   std::float_t m_flStartScattering; // 0x58C - 0x590
   std::float_t m_flStartDrawDistance; // 0x590 - 0x594
   std::float_t m_flDefaultAnisotropy; // 0x594 - 0x598
   std::float_t m_flDefaultScattering; // 0x598 - 0x59C
   std::float_t m_flDefaultDrawDistance; // 0x59C - 0x5A0
   ...
   std::int32_t m_nForceRefreshCount; // 0x5B0 - 0x5B4
...
public:
   ...
   std::float_t m_flStrength; // 0x558 - 0x55C
   std::int32_t m_nFalloffShape; // 0x55C - 0x560
   std::float_t m_flFalloffExponent; // 0x560 - 0x564
...
public:
   ...
   std::float_t m_flAveWindSpeed; // 0x80 - 0x84
   bool m_bGusting; // 0x84 - 0x85
   std::float_t m_flWindAngleVariation; // 0x88 - 0x8C
   std::float_t m_flWindSpeedVariation; // 0x8C - 0x90
...
public:
   ...
   std::int32_t m_nFlameModelIndex; // 0x548 - 0x54C
   std::int32_t m_nFlameFromAboveModelIndex; // 0x54C - 0x550
   std::float_t m_flScaleRegister; // 0x550 - 0x554
   std::float_t m_flScaleStart; // 0x554 - 0x558
   std::float_t m_flScaleEnd; // 0x558 - 0x55C
   GameTime_t m_flScaleTimeStart; // 0x55C - 0x560
   GameTime_t m_flScaleTimeEnd; // 0x560 - 0x564
   std::float_t m_flChildFlameSpread; // 0x564 - 0x568
   std::float_t m_flClipPerc; // 0x578 - 0x57C
...
public:
   ...
   std::int32_t m_localLifeState; // 0x9BC - 0x9C0
   std::float_t m_deathDepth; // 0x9C0 - 0x9C4
   std::float_t m_deathAngle; // 0x9C4 - 0x9C8
   std::float_t m_buoyancy; // 0x9C8 - 0x9CC
   CountdownTimer m_wiggleTimer; // 0x9D0 - 0x9E8
   std::float_t m_wigglePhase; // 0x9E8 - 0x9EC
   std::float_t m_wiggleRate; // 0x9EC - 0x9F0
   Vector m_actualPos; // 0x9F0 - 0x9FC
   QAngle m_actualAngles; // 0x9FC - 0xA08
   Vector m_poolOrigin; // 0xA08 - 0xA14
   std::float_t m_waterLevel; // 0xA14 - 0xA18
   bool m_gotUpdate; // 0xA18 - 0xA19
   std::float_t m_x; // 0xA1C - 0xA20
   std::float_t m_y; // 0xA20 - 0xA24
   std::float_t m_z; // 0xA24 - 0xA28
   std::float_t m_angle; // 0xA28 - 0xA2C
   float32 m_errorHistory[20]; // 0xA2C - 0xA7C
   std::int32_t m_errorHistoryIndex; // 0xA7C - 0xA80
   std::int32_t m_errorHistoryCount; // 0xA80 - 0xA84
   std::float_t m_averageError; // 0xA84 - 0xA88
...
public:
   ...
   std::int32_t m_iChangedVariables; // 0x5A4 - 0x5A8
...
public:
   ...
   std::float_t m_flTargetSpeed; // 0x84C - 0x850
   GameTick_t m_nTransitionStartTick; // 0x850 - 0x854
   std::int32_t m_nTransitionDurationTicks; // 0x854 - 0x858
   std::float_t m_flTransitionStartSpeed; // 0x858 - 0x85C
   C_NetworkUtlVectorBase< CHandle< C_BaseEntity > > m_hConveyorModels; // 0x860 - 0x878
   std::float_t m_flCurrentConveyorOffset; // 0x878 - 0x87C
   std::float_t m_flCurrentConveyorSpeed; // 0x87C - 0x880
...
public:
   ...
   std::float_t m_flAutoRideSpeed; // 0x884 - 0x888
...
public:
   ...
   std::int32_t m_nResolutionEnum; // 0x840 - 0x844
...
public:
   ...
   std::int32_t m_nLongAxis; // 0x838 - 0x83C
   std::float_t m_flRadius; // 0x83C - 0x840
   std::float_t m_flLineLength; // 0x840 - 0x844
...
public:
   ...
   std::uint16_t m_WindClothForceHandle; // 0xA00 - 0xA02
...
public:
   ...
   std::float_t m_flFogStartDistance; // 0x540 - 0x544
   std::float_t m_flFogEndDistance; // 0x544 - 0x548
   bool m_bHeightFogEnabled; // 0x548 - 0x549
   std::float_t m_flFogStartHeight; // 0x54C - 0x550
   std::float_t m_flFogEndHeight; // 0x550 - 0x554
   std::float_t m_flFarZ; // 0x554 - 0x558
   std::float_t m_flFogMaxOpacity; // 0x558 - 0x55C
   std::float_t m_flFogFalloffExponent; // 0x55C - 0x560
   std::float_t m_flFogVerticalExponent; // 0x560 - 0x564
   Color m_fogColor; // 0x564 - 0x568
   std::float_t m_flFogStrength; // 0x568 - 0x56C
   std::float_t m_flFadeTime; // 0x56C - 0x570
...
public:
   ...
   std::float_t m_flGrassBurnClearTime; // 0x538 - 0x53C
   std::float_t m_bClientPendingClear; // 0x53C - 0x540
   std::float_t m_flGrassBurnClearTimeLocal; // 0x540 - 0x544
...
public:
   ...
   std::int32_t m_nHostageState; // 0xBE4 - 0xBE8
...
public:
   ...
   std::float_t m_flOffset; // 0x1F4 - 0x1F8
   std::float_t m_flAgeMin; // 0x1F8 - 0x1FC
   std::float_t m_flAgeMax; // 0x1FC - 0x200
   std::float_t m_flNoiseScale; // 0x200 - 0x204
   std::float_t m_flNoiseScaleLoc; // 0x204 - 0x208
...
public:
   ...
   std::float_t m_flAParm; // 0x1F0 - 0x1F4
   std::float_t m_flBParm; // 0x1F4 - 0x1F8
   std::float_t m_flCParm; // 0x1F8 - 0x1FC
   std::float_t m_flDParm; // 0x1FC - 0x200
   std::float_t m_flScale; // 0x200 - 0x204
   std::float_t m_flSpeedMin; // 0x204 - 0x208
   std::float_t m_flSpeedMax; // 0x208 - 0x20C
   std::int32_t m_nBaseCP; // 0x20C - 0x210
...
public:
   ...
   std::float_t m_flTintPerc; // 0x218 - 0x21C
   ParticleColorBlendMode_t m_nTintBlendMode; // 0x21C - 0x220
   std::float_t m_flLightAmplification; // 0x220 - 0x224
...
public:
   ...
   std::float_t m_fMaxDistance; // 0x1F0 - 0x1F4
...
public:
   ...
   std::int32_t m_nIncrement; // 0x1F0 - 0x1F4
   std::int32_t m_nMinCP; // 0x1F4 - 0x1F8
   std::int32_t m_nMaxCP; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flVelocityScale; // 0x1F0 - 0x1F4
   std::float_t m_flIncrement; // 0x1F4 - 0x1F8
   bool m_bRandomDistribution; // 0x1F8 - 0x1F9
   std::int32_t m_nRandomSeed; // 0x1FC - 0x200
...
public:
   ...
   std::int32_t m_nComponent1; // 0x1F0 - 0x1F4
   std::int32_t m_nComponent2; // 0x1F4 - 0x1F8
   std::int32_t m_nControlPointNumber; // 0x1F8 - 0x1FC
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x940 - 0x944
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::int32_t m_nForceInModel; // 0x1F4 - 0x1F8
   std::int32_t m_nDesiredHitbox; // 0x1F8 - 0x1FC
   std::int32_t m_nHitboxValueFromControlPointIndex; // 0x1FC - 0x200
   CParticleCollectionVecInput m_vecHitBoxScale; // 0x200 - 0x7C8
   std::float_t m_flBoneVelocity; // 0x7C8 - 0x7CC
   std::float_t m_flMaxBoneVelocity; // 0x7CC - 0x7D0
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F4 - 0x1F8
   std::int32_t m_nHeightCP; // 0x1F8 - 0x1FC
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::int32_t m_nScaleCP; // 0x1F4 - 0x1F8
   std::int32_t m_nComponent; // 0x1F8 - 0x1FC
   std::float_t m_fRadCentCore; // 0x1FC - 0x200
   std::float_t m_fRadPerPoint; // 0x200 - 0x204
   std::float_t m_fRadPerPointTo; // 0x204 - 0x208
   std::float_t m_fpointAngle; // 0x208 - 0x20C
   std::float_t m_fsizeOverall; // 0x20C - 0x210
   std::float_t m_fRadBias; // 0x210 - 0x214
   std::float_t m_fMinRad; // 0x214 - 0x218
   std::float_t m_fDistBias; // 0x218 - 0x21C
...
public:
   ...
   std::float_t m_fMaxDistance; // 0x1F0 - 0x1F4
   std::float_t m_flNumToAssign; // 0x1F4 - 0x1F8
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::int32_t m_nOverrideCP; // 0x1F4 - 0x1F8
   std::int32_t m_nDensity; // 0x1F8 - 0x1FC
   std::float_t m_flInitialRadius; // 0x1FC - 0x200
   std::float_t m_flInitialSpeedMin; // 0x200 - 0x204
   std::float_t m_flInitialSpeedMax; // 0x204 - 0x208
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0xD80 - 0xD84
...
public:
   ...
   std::float_t m_fSpeedRandExp; // 0xCF8 - 0xCFC
   bool m_bLocalCoords; // 0xCFC - 0xCFD
   std::float_t m_flEndCPGrowthTime; // 0xD00 - 0xD04
...
public:
   ...
   std::float_t m_flOffset; // 0x1F8 - 0x1FC
   std::float_t m_flOutputMin; // 0x1FC - 0x200
   std::float_t m_flOutputMax; // 0x200 - 0x204
   std::float_t m_flNoiseScale; // 0x204 - 0x208
   std::float_t m_flNoiseScaleLoc; // 0x208 - 0x20C
   Vector m_vecOffsetLoc; // 0x20C - 0x218
   std::float_t m_flWorldTimeScale; // 0x218 - 0x21C
...
public:
   ...
   std::int32_t m_nControlPoint; // 0x1F0 - 0x1F4
...
public:
   ...
   std::int32_t m_nStartCP; // 0x6D8 - 0x6DC
...
public:
   ...
   std::float_t m_flScale; // 0x1F0 - 0x1F4
   std::int32_t m_nScaleControlPointNumber; // 0x1F4 - 0x1F8
   std::int32_t m_nControlPointNumber; // 0x1F8 - 0x1FC
...
public:
   ...
   std::int32_t m_nIncrement; // 0x1F8 - 0x1FC
   bool m_bRandomDistribution; // 0x1FC - 0x1FD
   std::int32_t m_nRandomSeed; // 0x200 - 0x204
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::float_t m_flVelocityScale; // 0x1F4 - 0x1F8
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::int32_t m_nLocalSpaceCP; // 0x1F4 - 0x1F8
   std::int32_t m_nWeightUpdateCP; // 0x1F8 - 0x1FC
...
public:
   ...
   std::int32_t m_nSnapshotControlPointNumber; // 0x1F0 - 0x1F4
   std::int32_t m_nControlPointNumber; // 0x1F4 - 0x1F8
   ...
   std::float_t m_flMinNormalVelocity; // 0x204 - 0x208
   std::float_t m_flMaxNormalVelocity; // 0x208 - 0x20C
   std::float_t m_flIncrement; // 0x20C - 0x210
   std::int32_t m_nFullLoopIncrement; // 0x210 - 0x214
   std::int32_t m_nSnapShotStartPoint; // 0x214 - 0x218
   std::float_t m_flBoneVelocity; // 0x218 - 0x21C
   std::float_t m_flBoneVelocityMax; // 0x21C - 0x220
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x28C - 0x290
   bool m_bPerParticle; // 0x290 - 0x291
   bool m_bTranslate; // 0x291 - 0x292
   bool m_bProportional; // 0x292 - 0x293
   std::float_t m_flTraceLength; // 0x294 - 0x298
   bool m_bPerParticleTR; // 0x298 - 0x299
   bool m_bInherit; // 0x299 - 0x29A
   std::int32_t m_nChildCP; // 0x29C - 0x2A0
   std::int32_t m_nChildGroupID; // 0x2A0 - 0x2A4
...
public:
   ...
   std::float_t m_flInputMin; // 0x1FC - 0x200
   std::float_t m_flInputMax; // 0x200 - 0x204
   std::float_t m_flOutputMin; // 0x204 - 0x208
   std::float_t m_flOutputMax; // 0x208 - 0x20C
   ParticleSetMethod_t m_nSetMethod; // 0x20C - 0x210
...
public:
   ...
   std::float_t m_flVelocityMin; // 0x1F0 - 0x1F4
   std::float_t m_flVelocityMax; // 0x1F4 - 0x1F8
   std::int32_t m_nControlPointNumber; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flTraceOffset; // 0x1FC - 0x200
   std::float_t m_flMaxTraceLength; // 0x200 - 0x204
   std::float_t m_flTraceTolerance; // 0x204 - 0x208
   std::int32_t m_nMaxPlanes; // 0x208 - 0x20C
...
public:
   ...
   std::int32_t m_nEndControlPointNumber; // 0x808 - 0x80C
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x208 - 0x20C
...
public:
   ...
   std::int32_t m_nCP; // 0x1F0 - 0x1F4
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F4 - 0x1F8
   std::float_t m_flRotOffset; // 0x1F8 - 0x1FC
...
public:
   ...
   std::int32_t m_nNumPointsAlongPath; // 0x214 - 0x218
...
public:
   ...
   std::int32_t m_nControlPointNumberStart; // 0x1F0 - 0x1F4
   std::int32_t m_nControlPointNumberEnd; // 0x1F4 - 0x1F8
...
public:
   ...
   std::float_t m_flOffsetByRadiusFactor; // 0x4FC - 0x500
   std::int32_t m_nPreserveOffsetCP; // 0x500 - 0x504
   std::int32_t m_nIgnoreCP; // 0x504 - 0x508
...
public:
   ...
   std::int32_t m_nScaleControlPointNumber; // 0xD80 - 0xD84
   std::int32_t m_nControlPointNumber; // 0xD84 - 0xD88
   std::int32_t m_nRadiusComponent; // 0xD88 - 0xD8C
   std::float_t m_flWarpTime; // 0xD8C - 0xD90
   std::float_t m_flWarpStartTime; // 0xD90 - 0xD94
   std::float_t m_flPrevPosScale; // 0xD94 - 0xD98
...
public:
   ...
   std::float_t m_flPrevPosScale; // 0x340 - 0x344
   std::int32_t m_nScaleControlPointNumber; // 0x344 - 0x348
   std::int32_t m_nControlPointNumber; // 0x348 - 0x34C
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F0 - 0x1F4
   std::int32_t m_nAlphaMin; // 0x1F4 - 0x1F8
   std::int32_t m_nAlphaMax; // 0x1F8 - 0x1FC
   std::float_t m_flAlphaRandExponent; // 0x204 - 0x208
...
public:
   ...
   std::float_t m_flMin; // 0x1F0 - 0x1F4
   std::float_t m_flMax; // 0x1F4 - 0x1F8
   std::float_t m_flExponent; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flTintPerc; // 0x21C - 0x220
   std::float_t m_flUpdateThreshold; // 0x220 - 0x224
   std::int32_t m_nTintCP; // 0x224 - 0x228
   ParticleAttributeIndex_t m_nFieldOutput; // 0x228 - 0x22C
   ParticleColorBlendMode_t m_nTintBlendMode; // 0x22C - 0x230
   std::float_t m_flLightAmplification; // 0x230 - 0x234
...
public:
   ...
   std::float_t m_fLifetimeMin; // 0x1F0 - 0x1F4
   std::float_t m_fLifetimeMax; // 0x1F4 - 0x1F8
   std::float_t m_fLifetimeRandExponent; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flRadiusMin; // 0x1F0 - 0x1F4
   std::float_t m_flRadiusMax; // 0x1F4 - 0x1F8
   std::float_t m_flRadiusRandExponent; // 0x1F8 - 0x1FC
...
public:
   ...
   std::int32_t m_nSequenceMin; // 0x1F0 - 0x1F4
   std::int32_t m_nSequenceMax; // 0x1F4 - 0x1F8
...
public:
   ...
   std::float_t m_flMinLength; // 0x1F0 - 0x1F4
   std::float_t m_flMaxLength; // 0x1F4 - 0x1F8
   std::float_t m_flLengthRandExponent; // 0x1F8 - 0x1FC
...
public:
   ...
   std::int32_t m_nComponent; // 0x1FC - 0x200
...
public:
   ...
   std::float_t m_flPercent; // 0x1F0 - 0x1F4
...
public:
   ...
   std::int32_t m_nCPInput; // 0x1F0 - 0x1F4
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F4 - 0x1F8
   std::int32_t m_nField; // 0x1F8 - 0x1FC
   std::float_t m_flInputMin; // 0x1FC - 0x200
   std::float_t m_flInputMax; // 0x200 - 0x204
   std::float_t m_flOutputMin; // 0x204 - 0x208
   std::float_t m_flOutputMax; // 0x208 - 0x20C
   std::float_t m_flStartTime; // 0x20C - 0x210
   std::float_t m_flEndTime; // 0x210 - 0x214
   ParticleSetMethod_t m_nSetMethod; // 0x214 - 0x218
   std::float_t m_flRemapBias; // 0x218 - 0x21C
...
public:
   ...
   std::float_t m_flScale; // 0x244 - 0x248
   std::float_t m_flOffsetRot; // 0x248 - 0x24C
...
public:
   ...
   CParticleTransformInput m_TransformInput; // 0x1F0 - 0x240
   ParticleAttributeIndex_t m_nFieldOutput; // 0x240 - 0x244
   std::float_t m_flOffsetRot; // 0x244 - 0x248
   std::int32_t m_nComponent; // 0x248 - 0x24C
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F4 - 0x1F8
   std::float_t m_flInputMin; // 0x1F8 - 0x1FC
   std::float_t m_flInputMax; // 0x1FC - 0x200
   std::float_t m_flOutputMin; // 0x200 - 0x204
   std::float_t m_flOutputMax; // 0x204 - 0x208
...
public:
   ...
   std::float_t m_flOutputMin; // 0x200 - 0x204
   std::float_t m_flOutputMax; // 0x204 - 0x208
   std::float_t m_flStartTime; // 0x208 - 0x20C
   std::float_t m_flEndTime; // 0x20C - 0x210
...
public:
   ...
   std::float_t m_flStartTime; // 0x218 - 0x21C
   std::float_t m_flEndTime; // 0x21C - 0x220
   ParticleSetMethod_t m_nSetMethod; // 0x220 - 0x224
   std::int32_t m_nControlPointNumber; // 0x224 - 0x228
   bool m_bLocalCoords; // 0x228 - 0x229
   std::float_t m_flRemapBias; // 0x22C - 0x230
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F0 - 0x1F4
   std::int32_t m_nControlPointNumber; // 0x1F4 - 0x1F8
   std::float_t m_flStartTime; // 0x1F8 - 0x1FC
   std::float_t m_flEndTime; // 0x1FC - 0x200
   std::float_t m_flInputMin; // 0x200 - 0x204
   std::float_t m_flInputMax; // 0x204 - 0x208
   std::float_t m_flOutputMin; // 0x208 - 0x20C
   std::float_t m_flOutputMax; // 0x20C - 0x210
   ParticleSetMethod_t m_nSetMethod; // 0x210 - 0x214
...
public:
   ...
   std::float_t m_flStartTime; // 0x2C8 - 0x2CC
   std::float_t m_flEndTime; // 0x2CC - 0x2D0
   ParticleSetMethod_t m_nSetMethod; // 0x2D0 - 0x2D4
   bool m_bOffset; // 0x2D4 - 0x2D5
   bool m_bAccelerate; // 0x2D5 - 0x2D6
   std::float_t m_flRemapBias; // 0x2D8 - 0x2DC
...
public:
   ...
   std::int32_t m_nRTEnvCP; // 0x28C - 0x290
   std::int32_t m_nComponent; // 0x290 - 0x294
...
public:
   ...
   std::float_t m_flFramerate; // 0x1F0 - 0x1F4
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::int32_t m_nDesiredHitbox; // 0x1F4 - 0x1F8
...
public:
   ...
   std::float_t m_flDetail2Rotation; // 0x1F4 - 0x1F8
   std::float_t m_flDetail2Scale; // 0x1F8 - 0x1FC
   std::float_t m_flDetail2BlendFactor; // 0x1FC - 0x200
   std::float_t m_flColorWarpIntensity; // 0x200 - 0x204
   std::float_t m_flDiffuseWarpBlendToFull; // 0x204 - 0x208
   std::float_t m_flEnvMapIntensity; // 0x208 - 0x20C
   std::float_t m_flAmbientScale; // 0x20C - 0x210
   Color m_specularColor; // 0x210 - 0x214
   std::float_t m_flSpecularScale; // 0x214 - 0x218
   std::float_t m_flSpecularExponent; // 0x218 - 0x21C
   std::float_t m_flSpecularExponentBlendToFull; // 0x21C - 0x220
   std::float_t m_flSpecularBlendToFull; // 0x220 - 0x224
   Color m_rimLightColor; // 0x224 - 0x228
   std::float_t m_flRimLightScale; // 0x228 - 0x22C
   std::float_t m_flReflectionsTintByBaseBlendToNone; // 0x22C - 0x230
   std::float_t m_flMetalnessBlendToFull; // 0x230 - 0x234
   std::float_t m_flSelfIllumBlendToFull; // 0x234 - 0x238
...
public:
   ...
   std::float_t m_flSFXColorWarpAmount; // 0x1F0 - 0x1F4
   std::float_t m_flSFXNormalAmount; // 0x1F4 - 0x1F8
   std::float_t m_flSFXMetalnessAmount; // 0x1F8 - 0x1FC
   std::float_t m_flSFXRoughnessAmount; // 0x1FC - 0x200
   std::float_t m_flSFXSelfIllumAmount; // 0x200 - 0x204
   std::float_t m_flSFXSScale; // 0x204 - 0x208
   std::float_t m_flSFXSScrollX; // 0x208 - 0x20C
   std::float_t m_flSFXSScrollY; // 0x20C - 0x210
   std::float_t m_flSFXSScrollZ; // 0x210 - 0x214
   std::float_t m_flSFXSOffsetX; // 0x214 - 0x218
   std::float_t m_flSFXSOffsetY; // 0x218 - 0x21C
   std::float_t m_flSFXSOffsetZ; // 0x21C - 0x220
   DetailCombo_t m_nDetailCombo; // 0x220 - 0x224
   std::float_t m_flSFXSDetailAmount; // 0x224 - 0x228
   std::float_t m_flSFXSDetailScale; // 0x228 - 0x22C
   std::float_t m_flSFXSDetailScrollX; // 0x22C - 0x230
   std::float_t m_flSFXSDetailScrollY; // 0x230 - 0x234
   std::float_t m_flSFXSDetailScrollZ; // 0x234 - 0x238
   std::float_t m_flSFXSUseModelUVs; // 0x238 - 0x23C
...
public:
   ...
   std::int32_t m_nControlPoint; // 0x1F0 - 0x1F4
   std::int32_t m_nControlPointCompare; // 0x1F4 - 0x1F8
   std::int32_t m_nControlPointLocal; // 0x1F8 - 0x1FC
   std::float_t m_flVelocityScale; // 0x1FC - 0x200
...
public:
   ...
   std::float_t m_fSpeedMin; // 0x1F0 - 0x1F4
   std::float_t m_fSpeedMax; // 0x1F4 - 0x1F8
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::float_t m_fSpeedMin; // 0x1F4 - 0x1F8
   std::float_t m_fSpeedMax; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flRadius; // 0x538 - 0x53C
...
public:
   ...
   std::int32_t m_nMode; // 0x53C - 0x540
...
public:
   ...
   std::float_t m_flIronSightAmount; // 0x14 - 0x18
   std::float_t m_flIronSightAmountGained; // 0x18 - 0x1C
   std::float_t m_flIronSightAmountBiased; // 0x1C - 0x20
   std::float_t m_flIronSightAmount_Interpolated; // 0x20 - 0x24
   std::float_t m_flIronSightAmountGained_Interpolated; // 0x24 - 0x28
   std::float_t m_flIronSightAmountBiased_Interpolated; // 0x28 - 0x2C
   std::float_t m_flInterpolationLastUpdated; // 0x2C - 0x30
   QAngle m_angDeltaAverage[8]; // 0x30 - 0x90
   QAngle m_angViewLast; // 0x90 - 0x9C
   Vector2D m_vecDotCoords; // 0x9C - 0xA4
   std::float_t m_flDotBlur; // 0xA4 - 0xA8
   std::float_t m_flSpeedRatio; // 0xA8 - 0xAC
...
public:
   ...
   std::uint32_t m_nHorizontalSize; // 0x838 - 0x83C
   std::uint32_t m_nVerticalSize; // 0x83C - 0x840
   std::uint32_t m_nMinDist; // 0x840 - 0x844
   std::uint32_t m_nMaxDist; // 0x844 - 0x848
   std::uint32_t m_nOuterMaxDist; // 0x848 - 0x84C
   std::float_t m_flGlowProxySize; // 0x84C - 0x850
   std::float_t m_flHDRColorScale; // 0x850 - 0x854
...
public:
   ...
   std::int32_t m_nMinDist; // 0xE8 - 0xEC
   std::int32_t m_nMaxDist; // 0xEC - 0xF0
   std::int32_t m_nOuterMaxDist; // 0xF0 - 0xF4
...
public:
   ...
   std::int32_t flags; // 0x9B0 - 0x9B4
   GameTime_t die; // 0x9B4 - 0x9B8
   std::float_t m_flFrameMax; // 0x9B8 - 0x9BC
   std::float_t x; // 0x9BC - 0x9C0
   std::float_t y; // 0x9C0 - 0x9C4
   std::float_t fadeSpeed; // 0x9C4 - 0x9C8
   std::float_t bounceFactor; // 0x9C8 - 0x9CC
   std::int32_t hitSound; // 0x9CC - 0x9D0
   std::int32_t priority; // 0x9D0 - 0x9D4
   Vector tentOffset; // 0x9D4 - 0x9E0
   QAngle m_vecTempEntAngVelocity; // 0x9E0 - 0x9EC
   std::int32_t tempent_renderamt; // 0x9EC - 0x9F0
   Vector m_vecNormal; // 0x9F0 - 0x9FC
   std::float_t m_flSpriteScale; // 0x9FC - 0xA00
   std::int32_t m_nFlickerFrame; // 0xA00 - 0xA04
   std::float_t m_flFrameRate; // 0xA04 - 0xA08
   std::float_t m_flFrame; // 0xA08 - 0xA0C
   char* m_pszImpactEffect; // 0xA10 - 0xA18
   char* m_pszParticleEffect; // 0xA18 - 0xA20
   bool m_bParticleCollision; // 0xA20 - 0xA21
   std::int32_t m_iLastCollisionFrame; // 0xA24 - 0xA28
...
public:
   ...
   std::int32_t m_nDraftType; // 0x548 - 0x54C
   std::int32_t m_nTeamWinningCoinToss; // 0x54C - 0x550
   ...
   std::int32_t m_nCurrentPhase; // 0xE6C - 0xE70
   std::int32_t m_nPhaseStartTick; // 0xE70 - 0xE74
   std::int32_t m_nPhaseDurationTicks; // 0xE74 - 0xE78
   std::int32_t m_nPostDataUpdateTick; // 0xE78 - 0xE7C
...
public:
   ...
   std::float_t m_flMinAlpha; // 0x1F0 - 0x1F4
...
public:
   ...
   std::float_t m_fFalloffPower; // 0x338 - 0x33C
...
public:
   ...
   std::float_t m_fDrag; // 0x1FC - 0x200
   std::int32_t m_nMaxConstraintPasses; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_flInputMin; // 0x1F0 - 0x1F4
   std::float_t m_flInputMax; // 0x1F4 - 0x1F8
   std::float_t m_flInputBias; // 0x1F8 - 0x1FC
   std::int32_t m_nStartCP; // 0x1FC - 0x200
   std::int32_t m_nEndCP; // 0x200 - 0x204
   std::int32_t m_nOffsetCP; // 0x204 - 0x208
   std::int32_t m_nOuputCP; // 0x208 - 0x20C
   std::int32_t m_nInputCP; // 0x20C - 0x210
...
public:
   ...
   std::float_t m_flInputScale1; // 0x200 - 0x204
   ParticleAttributeIndex_t m_nFieldInput2; // 0x204 - 0x208
   std::float_t m_flInputScale2; // 0x208 - 0x20C
   ControlPointReference_t m_nControlPointInput1; // 0x20C - 0x220
   std::float_t m_flControlPointScale1; // 0x220 - 0x224
   ControlPointReference_t m_nControlPointInput2; // 0x224 - 0x238
   std::float_t m_flControlPointScale2; // 0x238 - 0x23C
...
public:
   ...
   std::int32_t m_nLocalSpaceControlPoint; // 0x126C - 0x1270
...
public:
   ...
   std::int32_t m_nChildGroupID; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_flFadeStartTime; // 0x200 - 0x204
   std::float_t m_flFadeEndTime; // 0x204 - 0x208
   ParticleAttributeIndex_t m_nFieldOutput; // 0x208 - 0x20C
...
public:
   ...
   std::float_t m_flFadeStartTime; // 0x21C - 0x220
   std::float_t m_flFadeEndTime; // 0x220 - 0x224
...
public:
   ...
   std::int32_t m_nFirstControlPoint; // 0x1F0 - 0x1F4
   std::int32_t m_nSecondControlPoint; // 0x1F4 - 0x1F8
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x460 - 0x464
...
public:
   ...
   std::float_t m_fMinDistance; // 0x1F0 - 0x1F4
   std::float_t m_flMaxDistance0; // 0x1F4 - 0x1F8
   std::float_t m_flMaxDistanceMid; // 0x1F8 - 0x1FC
   std::float_t m_flMaxDistance1; // 0x1FC - 0x200
   CPathParameters m_PathParameters; // 0x200 - 0x240
   std::float_t m_flTravelTime; // 0x240 - 0x244
...
public:
   ...
   std::float_t m_fMinDistance; // 0x1F0 - 0x1F4
   std::float_t m_flMaxDistance; // 0x1F4 - 0x1F8
   std::float_t m_flTimeScale; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flMinDistance; // 0x1F0 - 0x1F4
   std::float_t m_flMaxDistance; // 0x1F4 - 0x1F8
...
public:
   ...
   std::float_t m_flEmissionScale; // 0x598 - 0x59C
   std::float_t m_flScalePerParentParticle; // 0x59C - 0x5A0
   bool m_bInitFromKilledParentParticles; // 0x5A0 - 0x5A1
   std::int32_t m_nLimitPerUpdate; // 0x5A4 - 0x5A8
...
public:
   ...
   std::int32_t m_nCPIn; // 0x200 - 0x204
   Vector m_vecCP1Pos; // 0x204 - 0x210
   std::int32_t m_nCPOut; // 0x210 - 0x214
   std::int32_t m_nCPOutField; // 0x214 - 0x218
   std::int32_t m_nCPSSPosOut; // 0x218 - 0x21C
...
public:
   ...
   std::float_t m_flScale; // 0x1F0 - 0x1F4
   std::int32_t m_nControlPoint1; // 0x6C0 - 0x6C4
   std::int32_t m_nControlPoint2; // 0x6C4 - 0x6C8
   std::int32_t m_nControlPoint3; // 0x6C8 - 0x6CC
   std::int32_t m_nControlPoint4; // 0x6CC - 0x6D0
   ...
   std::float_t m_LightFiftyDist1; // 0x700 - 0x704
   std::float_t m_LightZeroDist1; // 0x704 - 0x708
   std::float_t m_LightFiftyDist2; // 0x708 - 0x70C
   std::float_t m_LightZeroDist2; // 0x70C - 0x710
   std::float_t m_LightFiftyDist3; // 0x710 - 0x714
   std::float_t m_LightZeroDist3; // 0x714 - 0x718
   std::float_t m_LightFiftyDist4; // 0x718 - 0x71C
   std::float_t m_LightZeroDist4; // 0x71C - 0x720
...
public:
   ...
   std::float_t m_flCullPerc; // 0x1F0 - 0x1F4
   std::float_t m_flCullStart; // 0x1F4 - 0x1F8
   std::float_t m_flCullEnd; // 0x1F8 - 0x1FC
   std::float_t m_flCullExp; // 0x1FC - 0x200
...
public:
   ...
   std::float_t m_flStartValue; // 0x1F4 - 0x1F8
   std::float_t m_flEndValue; // 0x1F8 - 0x1FC
   std::float_t m_flCycleTime; // 0x1FC - 0x200
   bool m_bDoNotRepeatCycle; // 0x200 - 0x201
   bool m_bSynchronizeParticles; // 0x201 - 0x202
   std::int32_t m_nCPScale; // 0x204 - 0x208
   std::int32_t m_nCPFieldMin; // 0x208 - 0x20C
   std::int32_t m_nCPFieldMax; // 0x20C - 0x210
   ParticleSetMethod_t m_nSetMethod; // 0x210 - 0x214
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::float_t m_flRange; // 0x1F4 - 0x1F8
   std::float_t m_flScale; // 0x1F8 - 0x1FC
...
public:
   ...
   std::int32_t m_nParticlesToMaintain; // 0x1F0 - 0x1F4
   std::float_t m_flDecayDelay; // 0x1F4 - 0x1F8
   std::int32_t m_nSnapshotControlPoint; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flRadiusScale; // 0x1F0 - 0x1F4
   std::float_t m_flForceScale; // 0x1F4 - 0x1F8
...
public:
   ...
   std::int32_t m_nStartCP; // 0x200 - 0x204
   std::int32_t m_nEndCP; // 0x204 - 0x208
   std::int32_t m_nOutputCP; // 0x208 - 0x20C
   std::int32_t m_nOutputCPField; // 0x20C - 0x210
   bool m_bSetOnce; // 0x210 - 0x211
   std::float_t m_flInputMin; // 0x214 - 0x218
   std::float_t m_flInputMax; // 0x218 - 0x21C
   std::float_t m_flOutputMin; // 0x21C - 0x220
   std::float_t m_flOutputMax; // 0x220 - 0x224
   std::float_t m_flMaxTraceLength; // 0x224 - 0x228
   std::float_t m_flLOSScale; // 0x228 - 0x22C
...
public:
   ...
   std::float_t m_flMaxTraceLength; // 0x778 - 0x77C
   std::float_t m_flLOSScale; // 0x77C - 0x780
...
public:
   ...
   std::float_t m_flDistance; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_flMaxTraceLength; // 0x7B0 - 0x7B4
   std::float_t m_flLOSScale; // 0x7B4 - 0x7B8
...
public:
   ...
   std::int32_t m_nOutputControlPoint; // 0x200 - 0x204
   std::int32_t m_nOutputField; // 0x204 - 0x208
   std::float_t m_flInputMin; // 0x208 - 0x20C
   std::float_t m_flInputMax; // 0x20C - 0x210
   std::float_t m_flOutputMin; // 0x210 - 0x214
   std::float_t m_flOutputMax; // 0x214 - 0x218
...
public:
   ...
   std::int32_t m_nChildGroupID; // 0x200 - 0x204
   std::int32_t m_nFirstChild; // 0x204 - 0x208
...
public:
   ...
   std::float_t m_flDecayTime; // 0x1F0 - 0x1F4
...
public:
   ...
   std::float_t m_flStrength; // 0x1F0 - 0x1F4
   std::float_t m_flCurlStrength; // 0x1F4 - 0x1F8
   std::float_t m_flLinearStrength; // 0x1F8 - 0x1FC
   std::float_t m_flRadialStrength; // 0x1FC - 0x200
   std::float_t m_flRotationStrength; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_flStartFadeInTime; // 0x1F0 - 0x1F4
   std::float_t m_flEndFadeInTime; // 0x1F4 - 0x1F8
   std::float_t m_flStartFadeOutTime; // 0x1F8 - 0x1FC
   std::float_t m_flEndFadeOutTime; // 0x1FC - 0x200
   std::float_t m_flStartAlpha; // 0x200 - 0x204
   std::float_t m_flEndAlpha; // 0x204 - 0x208
...
public:
   ...
   std::float_t m_flFadeInTimeMin; // 0x1F0 - 0x1F4
   std::float_t m_flFadeInTimeMax; // 0x1F4 - 0x1F8
   std::float_t m_flFadeInTimeExp; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flFadeInTime; // 0x1F0 - 0x1F4
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F4 - 0x1F8
...
public:
   ...
   std::float_t m_flFadeOutTimeMin; // 0x1F0 - 0x1F4
   std::float_t m_flFadeOutTimeMax; // 0x1F4 - 0x1F8
   std::float_t m_flFadeOutTimeExp; // 0x1F8 - 0x1FC
   std::float_t m_flFadeBias; // 0x1FC - 0x200
...
public:
   ...
   std::float_t m_flFadeOutTime; // 0x1F0 - 0x1F4
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F4 - 0x1F8
...
public:
   ...
   std::float_t m_flMinDist; // 0x1F0 - 0x1F4
   Vector m_vecForceAtMinDist; // 0x1F4 - 0x200
   std::float_t m_flMaxDist; // 0x200 - 0x204
   Vector m_vecForceAtMaxDist; // 0x204 - 0x210
   Vector m_vecPlaneNormal; // 0x210 - 0x21C
   std::int32_t m_nControlPointNumber; // 0x21C - 0x220
   std::float_t m_flExponent; // 0x220 - 0x224
...
public:
   ...
   std::int32_t m_ControlPoint; // 0x200 - 0x204
...
public:
   ...
   std::int32_t m_nColorCP; // 0x200 - 0x204
   std::int32_t m_nColorGemEnableCP; // 0x204 - 0x208
   std::int32_t m_nOutputCP; // 0x208 - 0x20C
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldInput; // 0x1F4 - 0x1F8
   std::int32_t m_nIncrement; // 0x1F8 - 0x1FC
   std::int32_t m_nGroupID; // 0x1FC - 0x200
...
public:
   ...
   CParticleCollectionFloatInput m_flStartTime; // 0x328 - 0x460
   std::float_t m_flInitFromKilledParentParticles; // 0x460 - 0x464
   std::int32_t m_nMaxEmittedPerFrame; // 0x464 - 0x468
   std::int32_t m_nSnapshotControlPoint; // 0x468 - 0x46C
...
public:
   ...
   std::float_t m_flStartTime; // 0x1F0 - 0x1F4
   std::float_t m_flEndTime; // 0x1F4 - 0x1F8
   std::float_t m_flStartScale; // 0x1F8 - 0x1FC
   std::float_t m_flEndScale; // 0x1FC - 0x200
   bool m_bEaseInAndOut; // 0x200 - 0x201
   std::float_t m_flBias; // 0x204 - 0x208
...
public:
   ...
   std::int32_t m_nDesiredVelocityCP; // 0x1F0 - 0x1F4
   std::int32_t m_nLatencyCP; // 0x1F4 - 0x1F8
   std::int32_t m_nLatencyCPField; // 0x1F8 - 0x1FC
   std::int32_t m_nDesiredVelocityCPField; // 0x1FC - 0x200
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F0 - 0x1F4
   std::float_t m_flOutput; // 0x1F4 - 0x1F8
   std::float_t m_flLerpTime; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flLerpTime; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_flStartTime; // 0x330 - 0x334
   std::float_t m_flEndTime; // 0x334 - 0x338
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F0 - 0x1F4
   Vector m_vecOutput; // 0x1F4 - 0x200
   std::float_t m_flStartTime; // 0x200 - 0x204
   std::float_t m_flEndTime; // 0x204 - 0x208
   ParticleSetMethod_t m_nSetMethod; // 0x208 - 0x20C
...
public:
   ...
   std::int32_t m_nCPSnapshot; // 0x200 - 0x204
   std::int32_t m_nCPStartPnt; // 0x204 - 0x208
   std::int32_t m_nCPEndPnt; // 0x208 - 0x20C
...
public:
   ...
   std::int32_t m_nMinCol; // 0x1F0 - 0x1F4
   std::int32_t m_nMaxCol; // 0x1F4 - 0x1F8
   std::int32_t m_nMinRow; // 0x1F8 - 0x1FC
   std::int32_t m_nMaxRow; // 0x1FC - 0x200
   std::int32_t m_nControlPoint; // 0x200 - 0x204
   std::float_t m_flBlendValue; // 0x204 - 0x208
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::float_t m_flLifeTimeFadeStart; // 0x1F4 - 0x1F8
   std::float_t m_flLifeTimeFadeEnd; // 0x1F8 - 0x1FC
   std::float_t m_flJumpThreshold; // 0x1FC - 0x200
   std::float_t m_flPrevPosScale; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_flFadeStart; // 0x1F4 - 0x1F8
   std::float_t m_flFadeEnd; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flFadeStart; // 0x1F0 - 0x1F4
   std::float_t m_flFadeEnd; // 0x1F4 - 0x1F8
...
public:
   ...
   std::int32_t m_nParticlesToMaintain; // 0x1F0 - 0x1F4
   std::float_t m_flStartTime; // 0x1F4 - 0x1F8
   CParticleCollectionFloatInput m_flEmissionDuration; // 0x1F8 - 0x330
   std::float_t m_flEmissionRate; // 0x330 - 0x334
   std::int32_t m_nSnapshotControlPoint; // 0x334 - 0x338
...
public:
   ...
   std::float_t m_fMaxDistance; // 0x1F0 - 0x1F4
   std::float_t m_flNumToAssign; // 0x1F4 - 0x1F8
   std::float_t m_flCohesionStrength; // 0x1F8 - 0x1FC
   std::float_t m_flTolerance; // 0x1FC - 0x200
...
public:
   ...
   std::float_t m_flMaxVelocity; // 0x1F0 - 0x1F4
   std::int32_t m_nOverrideCP; // 0x1F4 - 0x1F8
   std::int32_t m_nOverrideCPField; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_fDrag; // 0x840 - 0x844
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::float_t m_flLifeTimeLerpStart; // 0x1F8 - 0x1FC
   std::float_t m_flLifeTimeLerpEnd; // 0x1FC - 0x200
   std::float_t m_flPrevPosScale; // 0x200 - 0x204
   char m_HitboxSetName[128]; // 0x204 - 0x284
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::int32_t m_nSnapshotControlPointNumber; // 0x1F4 - 0x1F8
...
public:
   ...
   CPerParticleFloatInput m_flOffset; // 0x1F0 - 0x328
   std::float_t m_flMaxTraceLength; // 0x328 - 0x32C
   std::float_t m_flTolerance; // 0x32C - 0x330
   std::float_t m_flTraceOffset; // 0x330 - 0x334
   std::float_t m_flLerpRate; // 0x334 - 0x338
   char m_CollisionGroupName[128]; // 0x338 - 0x3B8
   ParticleTraceSet_t m_nTraceSet; // 0x3B8 - 0x3BC
   std::int32_t m_nRefCP1; // 0x3BC - 0x3C0
   std::int32_t m_nRefCP2; // 0x3C0 - 0x3C4
   std::int32_t m_nLerpCP; // 0x3C4 - 0x3C8
   ...
   std::int32_t m_nPreserveOffsetCP; // 0x3DC - 0x3E0
   std::int32_t m_nIgnoreCP; // 0x3E0 - 0x3E4
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x1F0 - 0x1F4
   std::int32_t m_nScaleControlPoint; // 0x1F4 - 0x1F8
   std::int32_t m_nScaleCPField; // 0x1F8 - 0x1FC
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F0 - 0x1F4
   std::float_t m_flOutputMin; // 0x1F4 - 0x1F8
   std::float_t m_flOutputMax; // 0x1F8 - 0x1FC
   std::float_t m_fl4NoiseScale; // 0x1FC - 0x200
   bool m_bAdditive; // 0x200 - 0x201
   std::float_t m_flNoiseAnimationTimeScale; // 0x204 - 0x208
...
public:
   ...
   std::float_t m_flEmissionDuration; // 0x1F0 - 0x1F4
   std::float_t m_flStartTime; // 0x1F4 - 0x1F8
   std::float_t m_flEmissionScale; // 0x1F8 - 0x1FC
   std::int32_t m_nScaleControlPoint; // 0x1FC - 0x200
   std::int32_t m_nScaleControlPointField; // 0x200 - 0x204
   std::int32_t m_nWorldNoisePoint; // 0x204 - 0x208
   bool m_bAbsVal; // 0x208 - 0x209
   bool m_bAbsValInv; // 0x209 - 0x20A
   std::float_t m_flOffset; // 0x20C - 0x210
   std::float_t m_flOutputMin; // 0x210 - 0x214
   std::float_t m_flOutputMax; // 0x214 - 0x218
   std::float_t m_flNoiseScale; // 0x218 - 0x21C
   std::float_t m_flWorldNoiseScale; // 0x21C - 0x220
   Vector m_vecOffsetLoc; // 0x220 - 0x22C
   std::float_t m_flWorldTimeScale; // 0x22C - 0x230
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F0 - 0x1F4
   std::float_t m_flScale; // 0x1F4 - 0x1F8
...
public:
   ...
   std::float_t m_flRotOffset; // 0x1F0 - 0x1F4
   std::float_t m_flSpinStrength; // 0x1F4 - 0x1F8
   std::int32_t m_nCP; // 0x1F8 - 0x1FC
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1FC - 0x200
...
public:
   ...
   std::float_t m_RateMin; // 0x1F0 - 0x1F4
   std::float_t m_RateMax; // 0x1F4 - 0x1F8
   std::float_t m_FrequencyMin; // 0x1F8 - 0x1FC
   std::float_t m_FrequencyMax; // 0x1FC - 0x200
   ParticleAttributeIndex_t m_nField; // 0x200 - 0x204
   bool m_bProportional; // 0x204 - 0x205
   bool m_bProportionalOp; // 0x205 - 0x206
   std::float_t m_flStartTime_min; // 0x208 - 0x20C
   std::float_t m_flStartTime_max; // 0x20C - 0x210
   std::float_t m_flEndTime_min; // 0x210 - 0x214
   std::float_t m_flEndTime_max; // 0x214 - 0x218
   std::float_t m_flOscMult; // 0x218 - 0x21C
   std::float_t m_flOscAdd; // 0x21C - 0x220
...
public:
   ...
   std::float_t m_Rate; // 0x1F0 - 0x1F4
   std::float_t m_Frequency; // 0x1F4 - 0x1F8
   ParticleAttributeIndex_t m_nField; // 0x1F8 - 0x1FC
   std::float_t m_flOscMult; // 0x1FC - 0x200
   std::float_t m_flOscAdd; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_flStartTime_min; // 0x228 - 0x22C
   std::float_t m_flStartTime_max; // 0x22C - 0x230
   std::float_t m_flEndTime_min; // 0x230 - 0x234
   std::float_t m_flEndTime_max; // 0x234 - 0x238
...
public:
   ...
   std::float_t m_flOscMult; // 0x20C - 0x210
   std::float_t m_flOscAdd; // 0x210 - 0x214
...
public:
   ...
   std::float_t m_flForceScale; // 0x1F0 - 0x1F4
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F0 - 0x1F4
   std::float_t m_flInputMin; // 0x1F4 - 0x1F8
   std::float_t m_flInputMax; // 0x1F8 - 0x1FC
   CParticleTransformInput m_TransformStart; // 0x200 - 0x250
   CParticleTransformInput m_TransformEnd; // 0x250 - 0x2A0
   std::int32_t m_nOutputStartCP; // 0x2A0 - 0x2A4
   std::int32_t m_nOutputStartField; // 0x2A4 - 0x2A8
   std::int32_t m_nOutputEndCP; // 0x2A8 - 0x2AC
   std::int32_t m_nOutputEndField; // 0x2AC - 0x2B0
...
public:
   ...
   std::int32_t m_nBreakControlPointNumber; // 0xCB0 - 0xCB4
   std::int32_t m_nBreakControlPointNumber2; // 0xCB4 - 0xCB8
...
public:
   ...
   std::int32_t m_nPlaneControlPoint; // 0x1F0 - 0x1F4
   Vector m_vecPlaneDirection; // 0x1F4 - 0x200
   bool m_bLocalSpace; // 0x200 - 0x201
   std::float_t m_flPlaneOffset; // 0x204 - 0x208
...
public:
   ...
   CParticleTransformInput m_TransformInput; // 0x1F0 - 0x240
   std::float_t m_flStartTime_min; // 0x240 - 0x244
   std::float_t m_flStartTime_max; // 0x244 - 0x248
   std::float_t m_flStartTime_exp; // 0x248 - 0x24C
   std::float_t m_flEndTime_min; // 0x24C - 0x250
   std::float_t m_flEndTime_max; // 0x250 - 0x254
   std::float_t m_flEndTime_exp; // 0x254 - 0x258
   std::float_t m_flRange; // 0x258 - 0x25C
   CParticleCollectionFloatInput m_flRangeBias; // 0x260 - 0x398
   std::float_t m_flJumpThreshold; // 0x398 - 0x39C
   std::float_t m_flPrevPosScale; // 0x39C - 0x3A0
...
public:
   ...
   std::int32_t m_nCPOutput; // 0x338 - 0x33C
   std::int32_t m_nOutVectorField; // 0x33C - 0x340
...
public:
   ...
   std::float_t m_flMinRadius; // 0x1F0 - 0x1F4
...
public:
   ...
   std::int32_t m_nOutControlPointNumber; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_RateMin; // 0x1F0 - 0x1F4
   std::float_t m_RateMax; // 0x1F4 - 0x1F8
   std::float_t m_flStartTime_min; // 0x1F8 - 0x1FC
   std::float_t m_flStartTime_max; // 0x1FC - 0x200
   std::float_t m_flEndTime_min; // 0x200 - 0x204
   std::float_t m_flEndTime_max; // 0x204 - 0x208
...
public:
   ...
   std::float_t m_Rate; // 0x1F0 - 0x1F4
   std::float_t m_flStartTime; // 0x1F4 - 0x1F8
   std::float_t m_flEndTime; // 0x1F8 - 0x1FC
   ParticleAttributeIndex_t m_nField; // 0x220 - 0x224
...
public:
   ...
   std::float_t m_flEndTime_min; // 0x200 - 0x204
   std::float_t m_flEndTime_max; // 0x204 - 0x208
   std::float_t m_flBias; // 0x208 - 0x20C
   ParticleAttributeIndex_t m_nField; // 0x230 - 0x234
   bool m_bProportionalOp; // 0x234 - 0x235
...
public:
   ...
   std::int32_t m_nInControlPointNumber; // 0x200 - 0x204
   std::int32_t m_nOutControlPointNumber; // 0x204 - 0x208
   std::int32_t m_nField; // 0x208 - 0x20C
   ...
   std::int32_t m_nHeightControlPointNumber; // 0x6F0 - 0x6F4
...
public:
   ...
   std::int32_t m_nOutControlPointNumber; // 0x200 - 0x204
   std::int32_t m_nOutVectorField; // 0x204 - 0x208
   ParticleAttributeIndex_t m_nField; // 0x208 - 0x20C
   std::float_t m_flInputMin; // 0x20C - 0x210
   std::float_t m_flInputMax; // 0x210 - 0x214
   std::float_t m_flOutputMin; // 0x214 - 0x218
   std::float_t m_flOutputMax; // 0x218 - 0x21C
...
public:
   ...
   std::int32_t m_nOutControlPointNumber; // 0x200 - 0x204
   std::float_t m_flInputMin; // 0x204 - 0x208
   std::float_t m_flInputMax; // 0x208 - 0x20C
   std::float_t m_flOutputMin; // 0x20C - 0x210
   std::float_t m_flOutputMax; // 0x210 - 0x214
...
public:
   ...
   std::int32_t m_nInputControlPoint; // 0x200 - 0x204
   std::int32_t m_nOutputControlPoint; // 0x204 - 0x208
   std::int32_t m_nInputField; // 0x208 - 0x20C
   std::int32_t m_nOutputField; // 0x20C - 0x210
   std::float_t m_flInputMin; // 0x210 - 0x214
   std::float_t m_flInputMax; // 0x214 - 0x218
   std::float_t m_flOutputMin; // 0x218 - 0x21C
   std::float_t m_flOutputMax; // 0x21C - 0x220
   bool m_bDerivative; // 0x220 - 0x221
   std::float_t m_flInterpRate; // 0x224 - 0x228
...
public:
   ...
   std::float_t m_flStartTime; // 0x20C - 0x210
   std::float_t m_flEndTime; // 0x210 - 0x214
   std::float_t m_flInterpRate; // 0x214 - 0x218
...
public:
   ...
   std::int32_t m_nCPInput; // 0x1F0 - 0x1F4
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F4 - 0x1F8
   std::int32_t m_nLocalSpaceCP; // 0x1F8 - 0x1FC
   ...
   std::float_t m_flStartTime; // 0x22C - 0x230
   std::float_t m_flEndTime; // 0x230 - 0x234
   std::float_t m_flInterpRate; // 0x234 - 0x238
...
public:
   ...
   std::int32_t m_nCP; // 0x1F0 - 0x1F4
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F4 - 0x1F8
   std::float_t m_flOffsetRot; // 0x1F8 - 0x1FC
   std::int32_t m_nComponent; // 0x1FC - 0x200
...
public:
   ...
   std::float_t m_flRadiusScale; // 0x1F0 - 0x1F4
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F4 - 0x1F8
   std::float_t m_flDensityMin; // 0x1F8 - 0x1FC
   std::float_t m_flDensityMax; // 0x1FC - 0x200
   Vector m_vecOutputMin; // 0x200 - 0x20C
   Vector m_vecOutputMax; // 0x20C - 0x218
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F4 - 0x1F8
   std::float_t m_flScale; // 0x1F8 - 0x1FC
   std::float_t m_flOffsetRot; // 0x1FC - 0x200
...
public:
   ...
   std::float_t m_flMinOutputValue; // 0x214 - 0x218
   std::float_t m_flMaxOutputValue; // 0x218 - 0x21C
...
public:
   ...
   std::int32_t m_nInputCP1; // 0x200 - 0x204
   std::int32_t m_nInputCP2; // 0x204 - 0x208
   std::int32_t m_nOutputCP; // 0x208 - 0x20C
   std::int32_t m_nOutVectorField; // 0x20C - 0x210
   CParticleCollectionFloatInput m_flInputMin; // 0x210 - 0x348
   CParticleCollectionFloatInput m_flInputMax; // 0x348 - 0x480
   CParticleCollectionFloatInput m_flOutputMin; // 0x480 - 0x5B8
   CParticleCollectionFloatInput m_flOutputMax; // 0x5B8 - 0x6F0
...
public:
   ...
   std::int32_t m_nInputCP1; // 0x1F0 - 0x1F4
   std::int32_t m_nInputCP2; // 0x1F4 - 0x1F8
   ParticleAttributeIndex_t m_nFieldOutput; // 0x1F8 - 0x1FC
   std::float_t m_flInputMin; // 0x1FC - 0x200
   std::float_t m_flInputMax; // 0x200 - 0x204
   std::float_t m_flOutputMin; // 0x204 - 0x208
...
public:
   ...
   std::int32_t m_nCP; // 0x200 - 0x204
   std::int32_t m_nCPOutput; // 0x204 - 0x208
   CParticleCollectionVecInput m_vecScale; // 0x208 - 0x7D0
   bool m_bSetMagnitude; // 0x7D0 - 0x7D1
   std::int32_t m_nOutVectorField; // 0x7D4 - 0x7D8
...
public:
   ...
   std::float_t m_flOutputMin; // 0x204 - 0x208
   std::float_t m_flOutputMax; // 0x208 - 0x20C
   std::float_t m_flRemapTime; // 0x20C - 0x210
...
public:
   ...
   CParticleTransformInput m_TransformInput; // 0x1F0 - 0x240
   ParticleAttributeIndex_t m_nFieldOutput; // 0x240 - 0x244
   std::float_t m_flRotOffset; // 0x244 - 0x248
   std::float_t m_flSpinStrength; // 0x248 - 0x24C
...
public:
   ...
   ParticleAttributeIndex_t m_nFieldOutput; // 0x248 - 0x24C
   std::float_t m_flInputMin; // 0x24C - 0x250
   std::float_t m_flInputMax; // 0x250 - 0x254
   std::float_t m_flOutputMin; // 0x254 - 0x258
   std::float_t m_flOutputMax; // 0x258 - 0x25C
   std::float_t m_flRadius; // 0x25C - 0x260
...
public:
   ...
   std::float_t m_flRadius; // 0x26C - 0x270
...
public:
   ...
   std::int32_t m_nOutControlPointNumber; // 0x1F0 - 0x1F4
   ParticleAttributeIndex_t m_nFieldInput; // 0x1F4 - 0x1F8
   std::int32_t m_nParticleNumber; // 0x1F8 - 0x1FC
...
public:
   ...
   std::float_t m_flOutputMin; // 0x200 - 0x204
   std::float_t m_flOutputMax; // 0x204 - 0x208
   std::float_t m_flRadiusScale; // 0x208 - 0x20C
...
public:
   ...
   std::float_t m_flModelScale; // 0x24C - 0x250
   ...
   std::int32_t m_nSizeCullBloat; // 0x260 - 0x264
...
public:
   ...
   std::int32_t m_nScaleCP; // 0x5D8 - 0x5DC
...
public:
   ...
   std::float_t m_flCapRoundness; // 0x11D4 - 0x11D8
   std::float_t m_flCapOffsetAmount; // 0x11D8 - 0x11DC
   std::float_t m_flTessScale; // 0x11DC - 0x11E0
   std::int32_t m_nMinTesselation; // 0x11E0 - 0x11E4
   std::int32_t m_nMaxTesselation; // 0x11E4 - 0x11E8
   std::int32_t m_nRoundness; // 0x11E8 - 0x11EC
...
public:
   ...
   std::float_t m_flRadiusScale; // 0x234 - 0x238
   std::float_t m_flAlphaScale; // 0x238 - 0x23C
   ...
   std::float_t m_flLightDistance; // 0x80C - 0x810
   std::float_t m_flStartFalloff; // 0x810 - 0x814
   std::float_t m_flDistanceFalloff; // 0x814 - 0x818
   std::float_t m_flSpotFoV; // 0x818 - 0x81C
   ...
   std::int32_t m_nHSVShiftControlPoint; // 0x830 - 0x834
...
public:
   ...
   std::float_t m_flFlattenStrength; // 0x230 - 0x234
   ParticleAttributeIndex_t m_nStrengthFieldOverride; // 0x234 - 0x238
   std::float_t m_flRadiusScale; // 0x238 - 0x23C
...
public:
   ...
   std::float_t m_flAnimationRate; // 0x240 - 0x244
   AnimationType_t m_nAnimationType; // 0x244 - 0x248
   bool m_bAnimateInFPS; // 0x248 - 0x249
   std::float_t m_flMinSize; // 0x24C - 0x250
   std::float_t m_flMaxSize; // 0x250 - 0x254
   std::float_t m_flStartFadeSize; // 0x254 - 0x258
   std::float_t m_flEndFadeSize; // 0x258 - 0x25C
...
public:
   ...
   std::int32_t m_nMaterialControlPoint; // 0x230 - 0x234
...
public:
   ...
   std::int32_t m_nSkin; // 0x15EC - 0x15F0
   std::int32_t m_nSkinCP; // 0x15F0 - 0x15F4
   CUtlVector< MaterialVariable_t > m_MaterialVars; // 0x15F8 - 0x1610
   std::int32_t m_nLOD; // 0x1610 - 0x1614
   std::int32_t m_nModelCP; // 0x1614 - 0x1618
...
public:
   ...
   std::float_t m_flMinProjectionDepth; // 0x238 - 0x23C
   std::float_t m_flMaxProjectionDepth; // 0x23C - 0x240
   CStrongHandle< InfoForResourceTypeIMaterial2 > m_hProjectedMaterial; // 0x240 - 0x248
   std::float_t m_flAnimationTimeScale; // 0x248 - 0x24C
...
public:
   ...
   std::float_t m_flMinSize; // 0x2054 - 0x2058
   std::float_t m_flMaxSize; // 0x2058 - 0x205C
   std::float_t m_flStartFadeSize; // 0x205C - 0x2060
   std::float_t m_flEndFadeSize; // 0x2060 - 0x2064
   std::float_t m_flStartFadeDot; // 0x2064 - 0x2068
   std::float_t m_flEndFadeDot; // 0x2068 - 0x206C
   std::float_t m_flRadiusTaper; // 0x206C - 0x2070
   std::int32_t m_nMinTesselation; // 0x2070 - 0x2074
   std::int32_t m_nMaxTesselation; // 0x2074 - 0x2078
   std::float_t m_flTessScale; // 0x2078 - 0x207C
   ...
   std::int32_t m_nTextureVParamsCP; // 0x2428 - 0x242C
   bool m_bClampV; // 0x242C - 0x242D
   std::int32_t m_nScaleCP1; // 0x2430 - 0x2434
   std::int32_t m_nScaleCP2; // 0x2434 - 0x2438
   std::float_t m_flScaleVSizeByControlPointDistance; // 0x2438 - 0x243C
   std::float_t m_flScaleVScrollByControlPointDistance; // 0x243C - 0x2440
   std::float_t m_flScaleVOffsetByControlPointDistance; // 0x2440 - 0x2444
   ...
   std::float_t m_flScalarAttributeTextureCoordScale; // 0x244C - 0x2450
...
public:
   ...
   std::float_t m_flDurationScale; // 0x230 - 0x234
   std::float_t m_flRadiusScale; // 0x234 - 0x238
   std::float_t m_flFrequencyScale; // 0x238 - 0x23C
   std::float_t m_flAmplitudeScale; // 0x23C - 0x240
   ...
   std::int32_t m_nFilterCP; // 0x250 - 0x254
...
public:
   ...
   std::float_t m_flRotateRateDegrees; // 0x230 - 0x234
   std::float_t m_flForwardDegrees; // 0x234 - 0x238
...
public:
   ...
   std::float_t m_flDurationScale; // 0x230 - 0x234
   std::float_t m_flSndLvlScale; // 0x234 - 0x238
   std::float_t m_flPitchScale; // 0x238 - 0x23C
   std::float_t m_flVolumeScale; // 0x23C - 0x240
   ...
   std::int32_t m_nChannel; // 0x250 - 0x254
   std::int32_t m_nCPReference; // 0x254 - 0x258
...
public:
   ...
   std::int32_t m_nOrientationControlPoint; // 0x218C - 0x2190
   bool m_bUseYawWithNormalAligned; // 0x2190 - 0x2191
   std::float_t m_flMinSize; // 0x2194 - 0x2198
   std::float_t m_flMaxSize; // 0x2198 - 0x219C
   std::float_t m_flAlphaAdjustWithSizeAdjust; // 0x219C - 0x21A0
   CParticleCollectionFloatInput m_flStartFadeSize; // 0x21A0 - 0x22D8
   CParticleCollectionFloatInput m_flEndFadeSize; // 0x22D8 - 0x2410
   std::float_t m_flStartFadeDot; // 0x2410 - 0x2414
   std::float_t m_flEndFadeDot; // 0x2414 - 0x2418
   bool m_bDistanceAlpha; // 0x2418 - 0x2419
   bool m_bSoftEdges; // 0x2419 - 0x241A
   std::float_t m_flEdgeSoftnessStart; // 0x241C - 0x2420
   std::float_t m_flEdgeSoftnessEnd; // 0x2420 - 0x2424
   bool m_bOutline; // 0x2424 - 0x2425
   Color m_OutlineColor; // 0x2425 - 0x2429
   std::int32_t m_nOutlineAlpha; // 0x242C - 0x2430
   std::float_t m_flOutlineStart0; // 0x2430 - 0x2434
   std::float_t m_flOutlineStart1; // 0x2434 - 0x2438
   std::float_t m_flOutlineEnd0; // 0x2438 - 0x243C
   std::float_t m_flOutlineEnd1; // 0x243C - 0x2440
   ...
   std::float_t m_flShadowDensity; // 0x26BC - 0x26C0
...
public:
   ...
   std::int32_t m_nPriority; // 0x10B0 - 0x10B4
   ...
   std::float_t m_flCapsuleLength; // 0x11F4 - 0x11F8
   ...
   std::float_t m_flMaxLength; // 0x1200 - 0x1204
   std::float_t m_flMinLength; // 0x1204 - 0x1208
   bool m_bIgnoreDT; // 0x1208 - 0x1209
   std::float_t m_flConstrainRadiusToLengthRatio; // 0x120C - 0x1210
   std::float_t m_flLengthScale; // 0x1210 - 0x1214
   std::float_t m_flLengthFadeInTime; // 0x1214 - 0x1218
...
public:
   ...
   std::float_t m_flTonemapLevel; // 0x230 - 0x234
   std::float_t m_flTonemapWeight; // 0x234 - 0x238
...
public:
   ...
   std::float_t m_flStartFadeDot; // 0x22E4 - 0x22E8
   std::float_t m_flEndFadeDot; // 0x22E8 - 0x22EC
   ParticleAttributeIndex_t m_nPrevPntSource; // 0x22EC - 0x22F0
   std::float_t m_flMaxLength; // 0x22F0 - 0x22F4
   std::float_t m_flMinLength; // 0x22F4 - 0x22F8
   bool m_bIgnoreDT; // 0x22F8 - 0x22F9
   std::float_t m_flConstrainRadiusToLengthRatio; // 0x22FC - 0x2300
   std::float_t m_flLengthScale; // 0x2300 - 0x2304
   std::float_t m_flLengthFadeInTime; // 0x2304 - 0x2308
   ...
   std::float_t m_flForwardShift; // 0x3380 - 0x3384
...
public:
   ...
   std::float_t m_flPeakStrength; // 0x230 - 0x234
   ParticleAttributeIndex_t m_nPeakStrengthFieldOverride; // 0x234 - 0x238
   std::float_t m_flRadius; // 0x238 - 0x23C
   ParticleAttributeIndex_t m_nRadiusFieldOverride; // 0x23C - 0x240
   std::float_t m_flShakeDuration; // 0x240 - 0x244
   std::float_t m_flTransitionTime; // 0x244 - 0x248
   std::float_t m_flTwistAmount; // 0x248 - 0x24C
   std::float_t m_flRadialAmount; // 0x24C - 0x250
   std::float_t m_flControlPointOrientationAmount; // 0x250 - 0x254
   std::int32_t m_nControlPointForLinearDirection; // 0x254 - 0x258
...
public:
   ...
   std::int32_t m_nOutputHandCP; // 0x234 - 0x238
   std::int32_t m_nOutputField; // 0x238 - 0x23C
...
public:
   ...
   std::float_t m_flDurationMin; // 0x1F0 - 0x1F4
   std::float_t m_flDurationMax; // 0x1F4 - 0x1F8
   std::int32_t m_nCP; // 0x1F8 - 0x1FC
   std::int32_t m_nCPField; // 0x1FC - 0x200
   std::int32_t m_nChildGroupID; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_flAdjustmentScale; // 0x598 - 0x59C
...
public:
   ...
   std::float_t m_flRotRateMin; // 0x20C - 0x210
   std::float_t m_flRotRateMax; // 0x210 - 0x214
...
public:
   ...
   std::float_t m_flAccel; // 0x1F0 - 0x1F4
...
public:
   ...
   std::int32_t m_nInputControlPoint; // 0x1F0 - 0x1F4
   std::int32_t m_nOutputControlPoint; // 0x1F4 - 0x1F8
...
public:
   ...
   std::float_t m_flInterpRate; // 0x1F0 - 0x1F4
   std::float_t m_flMaxTraceLength; // 0x1F4 - 0x1F8
   std::float_t m_flTolerance; // 0x1F8 - 0x1FC
   std::float_t m_flTraceOffset; // 0x1FC - 0x200
   char m_CollisionGroupName[128]; // 0x200 - 0x280
   ParticleTraceSet_t m_nTraceSet; // 0x280 - 0x284
   std::int32_t m_nInputCP; // 0x284 - 0x288
   std::int32_t m_nOutputCP; // 0x288 - 0x28C
...
public:
   ...
   std::int32_t m_nInputCP; // 0x200 - 0x204
   std::int32_t m_nOutputCP; // 0x204 - 0x208
...
public:
   ...
   std::int32_t m_nChildGroupID; // 0x1F0 - 0x1F4
   std::int32_t m_nFirstControlPoint; // 0x1F4 - 0x1F8
   std::int32_t m_nNumControlPoints; // 0x1F8 - 0x1FC
...
public:
   ...
   std::int32_t m_nOutputCP; // 0xED0 - 0xED4
   std::int32_t m_nOutVectorField; // 0xED4 - 0xED8
...
public:
   ...
   std::int32_t m_nOutputCP; // 0x5B0 - 0x5B4
   std::int32_t m_nOutVectorField; // 0x5B4 - 0x5B8
...
public:
   ...
   std::int32_t m_nSourceCP; // 0x200 - 0x204
   std::int32_t m_nDestCP; // 0x204 - 0x208
   std::int32_t m_nCPField; // 0x208 - 0x20C
...
public:
   ...
   std::int32_t m_nCPInput; // 0x200 - 0x204
   std::int32_t m_nCPOutput; // 0x204 - 0x208
...
public:
   ...
   std::int32_t m_nCP; // 0x204 - 0x208
   std::int32_t m_nHeadLocation; // 0x208 - 0x20C
...
public:
   ...
   std::int32_t m_nCP1; // 0x200 - 0x204
   std::int32_t m_nHeadLocationMin; // 0x204 - 0x208
   std::int32_t m_nHeadLocationMax; // 0x208 - 0x20C
...
public:
   ...
   std::int32_t m_nControlPointNumber; // 0x200 - 0x204
...
public:
   ...
   std::int32_t m_nCP1; // 0x204 - 0x208
   std::int32_t m_nCP2; // 0x208 - 0x20C
   std::int32_t m_nCP3; // 0x20C - 0x210
   std::int32_t m_nCP4; // 0x210 - 0x214
   Vector m_vecCP1Pos; // 0x214 - 0x220
   Vector m_vecCP2Pos; // 0x220 - 0x22C
   Vector m_vecCP3Pos; // 0x22C - 0x238
   Vector m_vecCP4Pos; // 0x238 - 0x244
   std::int32_t m_nHeadLocation; // 0x244 - 0x248
...
public:
   ...
   std::int32_t m_nCP; // 0x900 - 0x904
   std::int32_t m_nLocalCP; // 0x904 - 0x908
...
public:
   ...
   std::int32_t m_nCPInput; // 0x200 - 0x204
   std::int32_t m_nCPOutputVel; // 0x204 - 0x208
   bool m_bNormalize; // 0x208 - 0x209
   std::int32_t m_nCPOutputMag; // 0x20C - 0x210
   std::int32_t m_nCPField; // 0x210 - 0x214
...
public:
   ...
   std::int32_t m_nCP1; // 0x200 - 0x204
   std::int32_t m_nHand; // 0x204 - 0x208
...
public:
   ...
   std::int32_t m_nCPOut; // 0x200 - 0x204
   std::int32_t m_nCPIn; // 0x204 - 0x208
   std::float_t m_flUpdateRate; // 0x208 - 0x20C
   CParticleCollectionFloatInput m_flTraceLength; // 0x210 - 0x348
   std::float_t m_flStartOffset; // 0x348 - 0x34C
   std::float_t m_flOffset; // 0x34C - 0x350
...
public:
   ...
   std::int32_t m_nSourceCP; // 0x200 - 0x204
   std::int32_t m_nDestCP; // 0x204 - 0x208
   std::int32_t m_nFlowCP; // 0x208 - 0x20C
   std::int32_t m_nActiveCP; // 0x20C - 0x210
   std::int32_t m_nActiveCPField; // 0x210 - 0x214
...
public:
   ...
   std::int32_t m_nFirstControlPoint; // 0x2F0 - 0x2F4
   std::int32_t m_nNumControlPoints; // 0x2F4 - 0x2F8
   std::int32_t m_nFirstSourcePoint; // 0x2F8 - 0x2FC
...
public:
   ...
   std::int32_t m_nFirstControlPoint; // 0x1F4 - 0x1F8
   std::int32_t m_nNumControlPoints; // 0x1F8 - 0x1FC
   std::int32_t m_nFirstSourcePoint; // 0x1FC - 0x200
...
public:
   ...
   bool m_bRandom; // 0x200 - 0x201
   bool m_bReverse; // 0x201 - 0x202
   std::int32_t m_nRandomSeed; // 0x204 - 0x208
...
public:
   ...
   std::int32_t m_nChildGroupID; // 0x200 - 0x204
   std::int32_t m_nChildControlPoint; // 0x204 - 0x208
   std::int32_t m_nNumControlPoints; // 0x208 - 0x20C
   std::int32_t m_nFirstSourcePoint; // 0x20C - 0x210
...
public:
   ...
   std::int32_t m_nFirstControlPoint; // 0x1F4 - 0x1F8
   std::int32_t m_nNumControlPoints; // 0x1F8 - 0x1FC
   std::int32_t m_nParticleIncrement; // 0x1FC - 0x200
   std::int32_t m_nFirstSourcePoint; // 0x200 - 0x204
   bool m_bNumBasedOnParticleCount; // 0x204 - 0x205
   ParticleAttributeIndex_t m_nAttributeToRead; // 0x208 - 0x20C
   std::int32_t m_nCPField; // 0x20C - 0x210
...
public:
   ...
   std::int32_t m_nHeadLocation; // 0x7D0 - 0x7D4
...
public:
   ...
   bool m_bTransformRadii; // 0x1F1 - 0x1F2
   std::int32_t m_nControlPointNumber; // 0x1F4 - 0x1F8
   std::float_t m_flLifeTimeFadeStart; // 0x1F8 - 0x1FC
   std::float_t m_flLifeTimeFadeEnd; // 0x1FC - 0x200
   std::float_t m_flJumpThreshold; // 0x200 - 0x204
   std::float_t m_flPrevPosScale; // 0x204 - 0x208
...
public:
   ...
   std::int32_t m_nCPPosition; // 0x1F0 - 0x1F4
   std::int32_t m_nCPVelocity; // 0x1F4 - 0x1F8
   std::int32_t m_nCPMisc; // 0x1F8 - 0x1FC
   std::int32_t m_nCPColor; // 0x1FC - 0x200
   std::int32_t m_nCPInvalidColor; // 0x200 - 0x204
   std::int32_t m_nCPExtraArcData; // 0x204 - 0x208
   Vector m_vGravity; // 0x208 - 0x214
   std::float_t m_flArcMaxDuration; // 0x214 - 0x218
   std::float_t m_flSegmentBreak; // 0x218 - 0x21C
   std::float_t m_flArcSpeed; // 0x21C - 0x220
   std::float_t m_flAlpha; // 0x220 - 0x224
...
public:
   ...
   std::float_t m_flStartLerpTime; // 0x1F0 - 0x1F4
   Vector m_StartingForce; // 0x1F4 - 0x200
   std::float_t m_flEndLerpTime; // 0x200 - 0x204
...
public:
   ...
   std::float_t m_flNoiseCoordScale0; // 0x1F0 - 0x1F4
   std::float_t m_flNoiseCoordScale1; // 0x1F4 - 0x1F8
   std::float_t m_flNoiseCoordScale2; // 0x1F8 - 0x1FC
   std::float_t m_flNoiseCoordScale3; // 0x1FC - 0x200
...
public:
   ...
   std::float_t m_fForceAmount; // 0x1F0 - 0x1F4
   Vector m_TwistAxis; // 0x1F4 - 0x200
   bool m_bLocalSpace; // 0x200 - 0x201
   std::int32_t m_nControlPointNumber; // 0x204 - 0x208
...
public:
   ...
   std::float_t m_flBrightnessScale; // 0x1F4 - 0x1F8
   std::float_t m_flRadiusScale; // 0x1F8 - 0x1FC
   std::float_t m_flMinimumLightingRadius; // 0x1FC - 0x200
   std::float_t m_flMaximumLightingRadius; // 0x200 - 0x204
   std::float_t m_flPositionDampingConstant; // 0x204 - 0x208
...
public:
   ...
   std::float_t m_flBoundaryDampening; // 0x900 - 0x904
   bool m_bSetVelocity; // 0x904 - 0x905
   bool m_bLockToSurface; // 0x905 - 0x906
   std::float_t m_flGridSpacing; // 0x908 - 0x90C
...
public:
   ...
   std::float_t m_fl4NoiseScale; // 0x20C - 0x210
   bool m_bAdditive; // 0x210 - 0x211
   bool m_bOffset; // 0x211 - 0x212
   std::float_t m_flNoiseAnimationTimeScale; // 0x214 - 0x218
...
public:
   ...
   std::float_t m_flMinVelocity; // 0x1F0 - 0x1F4
...
public:
   ...
   std::float_t m_flDirScale; // 0x1F0 - 0x1F4
   std::float_t m_flSpdScale; // 0x1F4 - 0x1F8
   std::int32_t m_nCPBroadcast; // 0x1F8 - 0x1FC
...
public:
   ...
   std::int32_t m_nIgnoreCP; // 0x290 - 0x294
   std::float_t m_flCpMovementTolerance; // 0x294 - 0x298
   std::float_t m_flRetestRate; // 0x298 - 0x29C
   std::float_t m_flTraceTolerance; // 0x29C - 0x2A0
   std::float_t m_flCollisionConfirmationSpeed; // 0x2A0 - 0x2A4
   std::float_t m_nMaxTracesPerFrame; // 0x2A4 - 0x2A8
   ...
   std::float_t m_flMinSpeed; // 0x78C - 0x790
...
public:
   ...
   std::float_t m_flInnerAngle; // 0xA70 - 0xA74
   std::float_t m_flOuterAngle; // 0xA74 - 0xA78
...
public:
   ...
   std::int32_t m_nRappelABone; // 0x9B0 - 0x9B4
   std::int32_t m_nRappelBBone; // 0x9B4 - 0x9B8
...
public:
   ...
   std::float_t m_impactEnergyScale; // 0xAF0 - 0xAF4
   std::float_t m_inertiaScale; // 0xAF4 - 0xAF8
   std::float_t m_flDmgModBullet; // 0xAF8 - 0xAFC
   std::float_t m_flDmgModClub; // 0xAFC - 0xB00
   std::float_t m_flDmgModExplosive; // 0xB00 - 0xB04
   std::float_t m_flDmgModFire; // 0xB04 - 0xB08
   CUtlSymbolLarge m_iszPhysicsDamageTableName; // 0xB08 - 0xB10
   CUtlSymbolLarge m_iszBasePropData; // 0xB10 - 0xB18
   std::int32_t m_iInteractions; // 0xB18 - 0xB1C
...
public:
   ...
   std::int32_t m_iMaxHealth; // 0xAFC - 0xB00
   std::int32_t m_iHealth; // 0xB00 - 0xB04
...
public:
   ...
   std::float_t m_flTimePickedUp; // 0x9A0 - 0x9A4
...
public:
   ...
   std::int32_t m_iType; // 0x570 - 0x574
...
public:
   ...
   std::int32_t m_nUniqueID; // 0x838 - 0x83C
   std::uint32_t m_unAccountID; // 0x83C - 0x840
   std::uint32_t m_unTraceID; // 0x840 - 0x844
   std::uint32_t m_rtGcTime; // 0x844 - 0x848
   Vector m_vecEndPos; // 0x848 - 0x854
   Vector m_vecStart; // 0x854 - 0x860
   Vector m_vecLeft; // 0x860 - 0x86C
   Vector m_vecNormal; // 0x86C - 0x878
   std::int32_t m_nPlayer; // 0x878 - 0x87C
   std::int32_t m_nEntity; // 0x87C - 0x880
   std::int32_t m_nHitbox; // 0x880 - 0x884
   std::float_t m_flCreationTime; // 0x884 - 0x888
   std::int32_t m_nTintID; // 0x888 - 0x88C
   std::uint8_t m_nVersion; // 0x88C - 0x88D
...
public:
   ...
   std::float_t m_flVerticalFOV; // 0x598 - 0x59C
...
public:
   ...
   std::float_t m_flWidth; // 0x9FC - 0xA00
   std::float_t m_flHeight; // 0xA00 - 0xA04
   std::float_t m_flDPI; // 0xA04 - 0xA08
   std::float_t m_flInteractDistance; // 0xA08 - 0xA0C
   std::float_t m_flDepthOffset; // 0xA0C - 0xA10
   std::uint32_t m_unOwnerContext; // 0xA10 - 0xA14
   std::uint32_t m_unHorizontalAlign; // 0xA14 - 0xA18
   std::uint32_t m_unVerticalAlign; // 0xA18 - 0xA1C
   std::uint32_t m_unOrientation; // 0xA1C - 0xA20
...
public:
   ...
   std::float_t m_flStartTimeInCommentary; // 0x9AC - 0x9B0
   ...
   std::int32_t m_iNodeNumber; // 0x9C8 - 0x9CC
   std::int32_t m_iNodeNumberMax; // 0x9CC - 0x9D0
...
public:
   ...
   std::int32_t m_nTrackedDeviceIndex; // 0x9E0 - 0x9E4
...
public:
   ...
   std::int32_t m_nTrackedDeviceIndex; // 0xB08 - 0xB0C
...
public:
   ...
   std::float_t m_flMaximumChangePerSecond; // 0x548 - 0x54C
   std::float_t m_flDisengageDistance; // 0x54C - 0x550
   std::float_t m_flEngageDistance; // 0x550 - 0x554
   ...
   std::float_t m_flMomentumModifier; // 0x580 - 0x584
   std::float_t m_flSnapValue; // 0x584 - 0x588
   std::float_t m_flCurrentMomentum; // 0x588 - 0x58C
   ValueRemapperRatchetType_t m_nRatchetType; // 0x58C - 0x590
   std::float_t m_flRatchetOffset; // 0x590 - 0x594
   std::float_t m_flInputOffset; // 0x594 - 0x598
   bool m_bEngaged; // 0x598 - 0x599
   bool m_bFirstUpdate; // 0x599 - 0x59A
   std::float_t m_flPreviousValue; // 0x59C - 0x5A0
...
public:
   ...
   std::float_t m_flWorldUnitsPerPx; // 0xA94 - 0xA98
   std::float_t m_flFontSize; // 0xA98 - 0xA9C
   std::float_t m_flDepthOffset; // 0xA9C - 0xAA0
...
public:
   ...
   std::float_t m_flFadeDuration; // 0x858 - 0x85C
   std::float_t m_flMinLogExposure; // 0x85C - 0x860
   std::float_t m_flMaxLogExposure; // 0x860 - 0x864
   std::float_t m_flMinExposure; // 0x864 - 0x868
   std::float_t m_flMaxExposure; // 0x868 - 0x86C
   std::float_t m_flExposureCompensation; // 0x86C - 0x870
   std::float_t m_flExposureFadeSpeedUp; // 0x870 - 0x874
   std::float_t m_flExposureFadeSpeedDown; // 0x874 - 0x878
   std::float_t m_flTonemapEVSmoothingRange; // 0x878 - 0x87C
   bool m_bMaster; // 0x87C - 0x87D
   bool m_bExposureControl; // 0x87D - 0x87E
   std::float_t m_flRate; // 0x880 - 0x884
   std::float_t m_flTonemapPercentTarget; // 0x884 - 0x888
   std::float_t m_flTonemapPercentBrightPixels; // 0x888 - 0x88C
   std::float_t m_flTonemapMinAvgLum; // 0x88C - 0x890
...
public:
   ...
   std::float_t m_flDensity; // 0x840 - 0x844
   std::float_t m_flParticleInnerDist; // 0x850 - 0x854
   ...
   std::int32_t m_nAvailableSheetSequencesMaxIndex; // 0x88C - 0x890
...
public:
   ...
   std::float_t m_flDisplayValue; // 0x998 - 0x99C
   std::float_t m_flDisplayValueLocal; // 0x99C - 0x9A0
   std::float_t m_flTimeOfLastValueChange; // 0x9A0 - 0x9A4
   std::float_t m_flPreviousValue; // 0x9A4 - 0x9A8
...
public:
   ...
   std::int8_t m_iCurrentMaxRagdollCount; // 0x538 - 0x539
...
public:
   ...
   std::uint32_t m_boneIndexAttached; // 0xA10 - 0xA14
   std::uint32_t m_ragdollAttachedObjectIndex; // 0xA14 - 0xA18
   ...
   std::float_t m_parentTime; // 0xA3C - 0xA40
...
public:
   ...
   std::int32_t m_nLinksTouchingSomething; // 0x844 - 0x848
   bool m_bApplyWind; // 0x848 - 0x849
   std::int32_t m_fPrevLockedPoints; // 0x84C - 0x850
   std::int32_t m_iForcePointMoveCounter; // 0x850 - 0x854
   bool m_bPrevEndPointPos[2]; // 0x854 - 0x856
   Vector m_vPrevEndPointPos[2]; // 0x858 - 0x870
   std::float_t m_flCurScroll; // 0x870 - 0x874
   std::float_t m_flScrollSpeed; // 0x874 - 0x878
   std::uint16_t m_RopeFlags; // 0x878 - 0x87A
   CStrongHandle< InfoForResourceTypeIMaterial2 > m_iRopeMaterialModelIndex; // 0x880 - 0x888
   Vector m_LightValues[10]; // 0xAF8 - 0xB70
   std::uint8_t m_nSegments; // 0xB70 - 0xB71
   ...
   std::uint8_t m_Subdiv; // 0xB7E - 0xB7F
   std::int16_t m_RopeLength; // 0xB80 - 0xB82
   std::int16_t m_Slack; // 0xB82 - 0xB84
   std::float_t m_TextureScale; // 0xB84 - 0xB88
   std::uint8_t m_fLockedPoints; // 0xB88 - 0xB89
   std::uint8_t m_nChangeCount; // 0xB89 - 0xB8A
   std::float_t m_Width; // 0xB8C - 0xB90
   ...
   std::int32_t m_TextureHeight; // 0xBA8 - 0xBAC
   Vector m_vecImpulse; // 0xBAC - 0xBB8
   Vector m_vecPreviousImpulse; // 0xBB8 - 0xBC4
   std::float_t m_flCurrentGustTimer; // 0xBC4 - 0xBC8
   std::float_t m_flCurrentGustLifetime; // 0xBC8 - 0xBCC
   std::float_t m_flTimeToNextGust; // 0xBCC - 0xBD0
...
public:
   ...
   std::float_t m_flForceClientTime; // 0x544 - 0x548
   std::uint16_t m_nSceneStringIndex; // 0x548 - 0x54A
   ...
   std::float_t m_flCurrentTime; // 0x590 - 0x594
...
public:
   ...
   std::int32_t m_nSmokeEffectTickBegin; // 0xC08 - 0xC0C
   bool m_bDidSmokeEffect; // 0xC0C - 0xC0D
   std::int32_t m_nRandomSeed; // 0xC10 - 0xC14
...
public:
   ...
   std::float_t m_flRadius; // 0x560 - 0x564
...
public:
   ...
   std::float_t m_flLightScale; // 0x838 - 0x83C
   std::float_t m_Radius; // 0x83C - 0x840
...
public:
   ...
   std::float_t m_fdistNormalize; // 0x840 - 0x844
   ...
   std::float_t m_flSize; // 0x878 - 0x87C
   std::float_t m_flHazeScale; // 0x87C - 0x880
   std::float_t m_flRotation; // 0x880 - 0x884
   std::float_t m_flHDRColorScale; // 0x884 - 0x888
   std::float_t m_flAlphaHaze; // 0x888 - 0x88C
   std::float_t m_flAlphaScale; // 0x88C - 0x890
   std::float_t m_flAlphaHdr; // 0x890 - 0x894
   std::float_t m_flFarZScale; // 0x894 - 0x898
...
public:
   ...
   std::float_t m_flSpawnSelectionTimeStartCurrentStage; // 0x200 - 0x204
   std::float_t m_flSpawnSelectionTimeEndCurrentStage; // 0x204 - 0x208
   std::float_t m_flSpawnSelectionTimeEndLastStage; // 0x208 - 0x20C
   SpawnStage_t m_spawnStage; // 0x20C - 0x210
   std::float_t m_flTabletHexOriginX; // 0x210 - 0x214
   std::float_t m_flTabletHexOriginY; // 0x214 - 0x218
   std::float_t m_flTabletHexSize; // 0x218 - 0x21C
   uint64 m_roundData_playerXuids[64]; // 0x220 - 0x420
   int32 m_roundData_playerPositions[64]; // 0x420 - 0x520
   int32 m_roundData_playerTeams[64]; // 0x520 - 0x620
   ESurvivalGameRuleDecision_t m_SurvivalGameRuleDecisionTypes[16]; // 0x620 - 0x660
...
public:
   ...
   std::int32_t m_nContractKillGridIndex; // 0x1490 - 0x1494
   std::int32_t m_nContractKillGridHighResIndex; // 0x1494 - 0x1498
   bool m_bTabletReceptionIsBlocked; // 0x1498 - 0x1499
   std::float_t m_flScanProgress; // 0x149C - 0x14A0
   ...
   std::int32_t m_nLastPurchaseIndex; // 0x14F8 - 0x14FC
   ...
   std::float_t m_flNoiseFadeAlpha; // 0x1B00 - 0x1B04
   Color m_WorkingColor; // 0x1B04 - 0x1B08
   Vector m_vecLastCameraPos; // 0x1B08 - 0x1B14
   QAngle m_angLastCameraAng; // 0x1B14 - 0x1B20
   std::int32_t m_nDrawElementCount; // 0x1B20 - 0x1B24
   std::float_t m_flPrevScanProgress; // 0x1B24 - 0x1B28
   std::int32_t m_nRenderTargetRes; // 0x1B28 - 0x1B2C
   std::float_t m_flLastClosePoseParamVal; // 0x1B2C - 0x1B30
...
public:
   ...
   std::float_t m_flTimeRemaining; // 0x53C - 0x540
   GameTime_t m_flTimerEndTime; // 0x540 - 0x544
   bool m_bIsDisabled; // 0x544 - 0x545
   bool m_bShowInHUD; // 0x545 - 0x546
   std::int32_t m_nTimerLength; // 0x548 - 0x54C
   std::int32_t m_nTimerInitialLength; // 0x54C - 0x550
   std::int32_t m_nTimerMaxLength; // 0x550 - 0x554
   bool m_bAutoCountdown; // 0x554 - 0x555
   std::int32_t m_nSetupTimeLength; // 0x558 - 0x55C
   std::int32_t m_nState; // 0x55C - 0x560
   bool m_bStartPaused; // 0x560 - 0x561
   bool m_bInCaptureWatchState; // 0x561 - 0x562
   std::float_t m_flTotalTime; // 0x564 - 0x568
   ...
   std::int32_t m_nOldTimerLength; // 0x578 - 0x57C
   std::int32_t m_nOldTimerState; // 0x57C - 0x580
...
public:
   ...
   std::float_t m_flFPS; // 0x83C - 0x840
   ...
   std::float_t m_flStartTime; // 0x868 - 0x86C
   std::float_t m_flStartFrame; // 0x86C - 0x870
...
public:
   ...
   std::float_t m_flFluidDensity; // 0x860 - 0x864
...
public:
   ...
   std::int32_t m_nTripWireStartIndex0; // 0xC00 - 0xC04
   std::int32_t m_nTripWireEndIndex0; // 0xC04 - 0xC08
   std::int32_t m_nTripWireCenterIndex0; // 0xC08 - 0xC0C
...
public:
   ...
   std::int32_t m_iActiveIssueIndex; // 0x548 - 0x54C
   std::int32_t m_iOnlyTeamToVote; // 0x54C - 0x550
   int32 m_nVoteOptionCount[5]; // 0x550 - 0x564
   std::int32_t m_nPotentialVotes; // 0x564 - 0x568
...
public:
   ...
   std::float_t m_flDisplayHealth; // 0x13F0 - 0x13F4
...
public:
   ...
   std::float_t m_flPitchLocal; // 0x13F0 - 0x13F4
...
public:
   ...
   std::float_t m_flTransitionTime; // 0xC - 0x10
   Color m_OldColor; // 0x10 - 0x14
   std::float_t m_flOldStart; // 0x14 - 0x18
   std::float_t m_flOldEnd; // 0x18 - 0x1C
   std::float_t m_flOldMaxDensity; // 0x1C - 0x20
   std::float_t m_flOldHDRColorScale; // 0x20 - 0x24
   std::float_t m_flOldFarZ; // 0x24 - 0x28
   Color m_NewColor; // 0x28 - 0x2C
   std::float_t m_flNewStart; // 0x2C - 0x30
   std::float_t m_flNewEnd; // 0x30 - 0x34
   std::float_t m_flNewMaxDensity; // 0x34 - 0x38
   std::float_t m_flNewHDRColorScale; // 0x38 - 0x3C
   std::float_t m_flNewFarZ; // 0x3C - 0x40
...
public:
   ...
   std::float_t m_flRadius; // 0x18 - 0x1C
   std::float_t m_flMaxFraction; // 0x1C - 0x20
   std::float_t m_flScale; // 0x20 - 0x24
...
public:
   ...
   std::int32_t m_nChainIndex; // 0x0 - 0x4
   ...
   std::float_t m_flDebugNormalizedValue; // 0x34 - 0x38
...
public:
   ...
   std::int32_t m_nCollisionGroupNumber; // 0x0 - 0x4
...
public:
   ...
   std::int32_t m_nResolution; // 0x2D0 - 0x2D4
...
public:
   ...
   std::int32_t m_nSequenceIndex; // 0xE0 - 0xE4
   std::float_t m_flCycle; // 0xE4 - 0xE8
...
public:
   ...
   std::int32_t m_nValueIntX; // 0x28 - 0x2C
   std::int32_t m_nValueIntY; // 0x2C - 0x30
   std::int32_t m_nValueIntZ; // 0x30 - 0x34
   std::int32_t m_nValueIntW; // 0x34 - 0x38
   bool m_bHasFloatBounds; // 0x38 - 0x39
   std::float_t m_flValueFloatX; // 0x3C - 0x40
   std::float_t m_flValueFloatX_Min; // 0x40 - 0x44
   std::float_t m_flValueFloatX_Max; // 0x44 - 0x48
   std::float_t m_flValueFloatY; // 0x48 - 0x4C
   std::float_t m_flValueFloatY_Min; // 0x4C - 0x50
   std::float_t m_flValueFloatY_Max; // 0x50 - 0x54
   std::float_t m_flValueFloatZ; // 0x54 - 0x58
   std::float_t m_flValueFloatZ_Min; // 0x58 - 0x5C
   std::float_t m_flValueFloatZ_Max; // 0x5C - 0x60
   std::float_t m_flValueFloatW; // 0x60 - 0x64
   std::float_t m_flValueFloatW_Min; // 0x64 - 0x68
   std::float_t m_flValueFloatW_Max; // 0x68 - 0x6C
...
public:
   ...
   std::float_t timeSpoken; // 0x0 - 0x4
...
public:
   ...
   std::uint16_t m_nGroup; // 0x0 - 0x2
   std::uint16_t m_nConfig; // 0x2 - 0x4
...
public:
   ...
   std::float_t m_flValue; // 0xC - 0x10
...
public:
   ...
   std::int32_t m_controlPointNameString; // 0x0 - 0x4
...
public:
   ...
   std::float_t m_duration; // 0x8 - 0xC
   GameTime_t m_timestamp; // 0xC - 0x10
   std::float_t m_timescale; // 0x10 - 0x14
...
public:
   ...
   std::float_t m_flXY; // 0xC - 0x10
   std::float_t m_flXZ; // 0x10 - 0x14
   std::float_t m_flYZ; // 0x14 - 0x18
...
public:
   ...
   std::float_t m_duration; // 0x8 - 0xC
   std::float_t m_timestamp; // 0xC - 0x10
   std::float_t m_timescale; // 0x10 - 0x14
...
public:
   ...
   std::int32_t m_nPlatWindowWidth; // 0x18 - 0x1C
   std::int32_t m_nPlatWindowHeight; // 0x1C - 0x20
   std::int32_t m_nRenderWidth; // 0x20 - 0x24
   std::int32_t m_nRenderHeight; // 0x24 - 0x28
...
public:
   ...
   std::int32_t m_nRuntimeIndex; // 0x30 - 0x34
   std::uint32_t m_nFlags; // 0x34 - 0x38
...
public:
   ...
   EngineLoopState_t m_LoopState; // 0x0 - 0x28
   std::float_t m_flRealTime; // 0x28 - 0x2C
   std::float_t m_flFrameTime; // 0x2C - 0x30
...
public:
   ...
   EngineLoopState_t m_LoopState; // 0x0 - 0x28
   std::float_t m_flRenderTime; // 0x28 - 0x2C
   std::float_t m_flRealTime; // 0x2C - 0x30
   std::float_t m_flRenderFrameTimeUnbounded; // 0x30 - 0x34
...
public:
   ...
   std::int32_t m_nTickCount; // 0x0 - 0x4
...
public:
   ...
   std::float_t m_flRenderFrameTime; // 0x30 - 0x34
   std::float_t m_flRenderFrameTimeUnbounded; // 0x34 - 0x38
...
public:
   ...
   std::float_t m_flRealTime; // 0x40 - 0x44
...
public:
   ...
   std::int32_t m_nAdditionalClientCommandsToCreate; // 0x4 - 0x8
...
public:
   ...
   std::float_t m_flFrameTime; // 0x0 - 0x4
...
public:
   ...
   EngineLoopState_t m_LoopState; // 0x0 - 0x28
   std::int32_t m_nClientOutputFrames; // 0x28 - 0x2C
...
public:
   ...
   std::uint32_t m_nSubSceneObject; // 0x4 - 0x8
   std::uint32_t m_nDrawCallIndex; // 0x8 - 0xC
...
public:
   ...
   std::float_t flMaxDist; // 0x4 - 0x8
   std::float_t flRelaxationFactor; // 0x8 - 0xC
...
public:
   ...
   std::float_t te; // 0x0 - 0x4
   std::float_t tv; // 0x4 - 0x8
   std::float_t flDist; // 0x8 - 0xC
...
public:
   ...
   std::float_t flDistMin; // 0x0 - 0x4
   std::float_t flDistMax; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_nPriority; // 0x40 - 0x44
   std::uint32_t m_nVertexMapHash; // 0x44 - 0x48
...
public:
   ...
   std::int32_t m_nPriority; // 0x20 - 0x24
   std::uint32_t m_nVertexMapHash; // 0x24 - 0x28
...
public:
   ...
   std::int32_t m_nPriority; // 0x30 - 0x34
   std::uint32_t m_nVertexMapHash; // 0x34 - 0x38
...
public:
   ...
   std::uint16_t nCtrlParent; // 0x0 - 0x2
   std::uint16_t nChildNode; // 0x2 - 0x4
   RnPlane_t m_Plane; // 0x4 - 0x14
   std::float_t flStickiness; // 0x14 - 0x18
   std::float_t flStrength; // 0x18 - 0x1C
...
public:
   ...
   std::uint16_t nCtrlParent; // 0x0 - 0x2
   std::uint16_t nChildNode; // 0x2 - 0x4
   std::float_t m_flRFactor; // 0x4 - 0x8
   Vector m_vOrigin; // 0x8 - 0x14
   std::float_t flStickiness; // 0x14 - 0x18
...
public:
   ...
   std::uint16_t nCtrlParent; // 0xC - 0xE
   std::uint16_t nCtrlChild; // 0xE - 0x10
...
public:
   ...
   std::uint16_t nCtrlParent; // 0x0 - 0x2
   std::uint16_t nCtrlChild; // 0x2 - 0x4
...
public:
   ...
   std::uint32_t nNameHash; // 0x8 - 0xC
   std::int32_t nType; // 0xC - 0x10
...
public:
   ...
   std::uint32_t nVertexNode; // 0x0 - 0x4
   std::float_t flWeight; // 0x4 - 0x8
   std::uint32_t nMatrixNode; // 0x8 - 0xC
...
public:
   ...
   std::uint16_t nEnd; // 0x2C - 0x2E
   std::uint16_t nNode; // 0x2E - 0x30
   std::uint16_t nBeginDynamic; // 0x30 - 0x32
...
public:
   ...
   std::float_t flWeight; // 0x0 - 0x4
   std::uint16_t nNode; // 0x4 - 0x6
   std::uint16_t nDummy; // 0x6 - 0x8
...
public:
   ...
   std::uint16_t nParentNode; // 0x0 - 0x2
   std::uint16_t nChildNode; // 0x2 - 0x4
   std::float_t flWeight; // 0x4 - 0x8
...
public:
   ...
   std::float_t flHeight0; // 0xC - 0x10
   uint16 nNode[3]; // 0x10 - 0x16
   std::uint16_t nReserved; // 0x16 - 0x18
...
public:
   ...
   CUtlVector< float32 > m_GoalStrength; // 0x58 - 0x70
   CUtlVector< float32 > m_GoalDamping; // 0x70 - 0x88
   std::uint32_t m_nFlags; // 0x88 - 0x8C
...
public:
   ...
   std::uint16_t nNode; // 0x0 - 0x2
   uint16 nDummy[3]; // 0x2 - 0x8
   std::uint16_t nNodeX0; // 0x8 - 0xA
   std::uint16_t nNodeX1; // 0xA - 0xC
   std::uint16_t nNodeY0; // 0xC - 0xE
   std::uint16_t nNodeY1; // 0xE - 0x10
...
public:
   ...
   std::float_t flPointDamping; // 0x0 - 0x4
   std::float_t flAnimationForceAttraction; // 0x4 - 0x8
   std::float_t flAnimationVertexAttraction; // 0x8 - 0xC
   std::float_t flGravity; // 0xC - 0x10
...
public:
   ...
   Vector vOffset; // 0x0 - 0xC
   std::uint16_t nBoneCtrl; // 0xC - 0xE
   std::uint16_t nTargetNode; // 0xE - 0x10
...
public:
   ...
   std::uint16_t nNodeX0; // 0x0 - 0x2
   std::uint16_t nNodeX1; // 0x2 - 0x4
   std::uint16_t nNodeY0; // 0x4 - 0x6
   std::uint16_t nNodeY1; // 0x6 - 0x8
...
public:
   ...
   std::uint16_t m_nTaperedCapsuleRigidIndex; // 0x0 - 0x2
   std::uint16_t m_nSphereRigidIndex; // 0x2 - 0x4
   std::uint16_t m_nBoxRigidIndex; // 0x4 - 0x6
   uint16 m_nCollisionSphereIndex[2]; // 0x6 - 0xA
   std::uint16_t m_nCollisionPlaneIndex; // 0xA - 0xC
...
public:
   ...
   uint16 nNode[2]; // 0x0 - 0x4
   std::float_t flMaxDist; // 0x4 - 0x8
   std::float_t flMinDist; // 0x8 - 0xC
   std::float_t flWeight0; // 0xC - 0x10
   std::float_t flRelaxationFactor; // 0x10 - 0x14
...
public:
   ...
   std::int32_t nParent; // 0x0 - 0x4
   std::float_t flAlpha; // 0x4 - 0x8
...
public:
   ...
   uint16 nNode[2]; // 0x0 - 0x4
   std::float_t flSpringRestLength; // 0x4 - 0x8
   std::float_t flSpringConstant; // 0x8 - 0xC
   std::float_t flSpringDamping; // 0xC - 0x10
   std::float_t flNodeWeight0; // 0x10 - 0x14
...
public:
   ...
   std::float_t flMaxAngle; // 0x0 - 0x4
   std::float_t flStrength; // 0x4 - 0x8
...
public:
   ...
   uint16 nNode[2]; // 0x0 - 0x4
   std::uint16_t nCollisionMask; // 0x4 - 0x6
   std::uint16_t nDummy; // 0x6 - 0x8
...
public:
   ...
   std::float_t w1; // 0x8 - 0xC
   std::float_t w2; // 0xC - 0x10
   std::float_t v1x; // 0x10 - 0x14
...
public:
   ...
   std::uint16_t nNodeOrient; // 0x0 - 0x2
   std::uint16_t nNodeEnd; // 0x2 - 0x4
   std::float_t flTwistRelax; // 0x4 - 0x8
   std::float_t flSwingRelax; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_flVolumetricSolveStrength; // 0x10 - 0x14
   std::int32_t m_nScaleSourceNode; // 0x14 - 0x18
...
public:
   ...
   CUtlString sName; // 0x0 - 0x8
   std::uint32_t nNameHash; // 0x8 - 0xC
   std::uint32_t nColor; // 0xC - 0x10
   std::uint32_t nFlags; // 0x10 - 0x14
   std::uint16_t nVertexBase; // 0x14 - 0x16
   std::uint16_t nVertexCount; // 0x16 - 0x18
   std::uint32_t nMapOffset; // 0x18 - 0x1C
   std::uint32_t nNodeListOffset; // 0x1C - 0x20
   Vector vCenterOfMass; // 0x20 - 0x2C
   std::float_t flVolumetricSolveStrength; // 0x2C - 0x30
   std::int16_t nScaleSourceNode; // 0x30 - 0x32
   std::uint16_t nNodeListCount; // 0x32 - 0x34
...
public:
   ...
   std::float_t flWorldFriction; // 0x0 - 0x4
   std::float_t flGroundFriction; // 0x4 - 0x8
   std::uint16_t nListBegin; // 0x8 - 0xA
   std::uint16_t nListEnd; // 0xA - 0xC
...
public:
   ...
   std::int32_t m_iDamageType; // 0x4F8 - 0x4FC
...
public:
   ...
   std::int32_t m_iHealthMin; // 0x4FC - 0x500
   std::int32_t m_iHealthMax; // 0x500 - 0x504
...
public:
   ...
   std::int32_t m_iFilterTeam; // 0x4F8 - 0x4FC
...
public:
   ...
   std::int32_t m_boneIndex; // 0x0 - 0x4
   Vector m_hingeAxis; // 0x4 - 0x10
   Vector m_vCapsulePos1; // 0x10 - 0x1C
   Vector m_vCapsulePos2; // 0x1C - 0x28
   std::float_t m_flMinAngle; // 0x28 - 0x2C
   std::float_t m_flMaxAngle; // 0x2C - 0x30
   std::float_t m_flRadius; // 0x30 - 0x34
...
public:
   ...
   std::int32_t m_tipParentBoneIndex; // 0x48 - 0x4C
   std::int32_t m_metacarpalBoneIndex; // 0x4C - 0x50
   std::float_t m_flSplayMinAngle; // 0x50 - 0x54
   std::float_t m_flSplayMaxAngle; // 0x54 - 0x58
   std::float_t m_flFingerScaleRatio; // 0x58 - 0x5C
...
public:
   ...
   CAnimAttachment m_attachment; // 0x0 - 0xFFFFFFFF
   std::int32_t m_boneIndex; // 0x80 - 0x84
...
public:
   ...
   std::int32_t m_nTargetBoneIndex; // 0x20 - 0x24
   std::int32_t m_nAnkleBoneIndex; // 0x24 - 0x28
   std::int32_t m_nIKAnchorBoneIndex; // 0x28 - 0x2C
   std::int32_t m_ikChainIndex; // 0x2C - 0x30
   std::float_t m_flMaxIKLength; // 0x30 - 0x34
   std::int32_t m_nFootIndex; // 0x34 - 0x38
   std::int32_t m_nTagIndex; // 0x38 - 0x3C
   std::float_t m_flMaxRotationLeft; // 0x3C - 0x40
   std::float_t m_flMaxRotationRight; // 0x40 - 0x44
...
public:
   ...
   std::float_t m_flFootBaseLength; // 0x20 - 0x24
   std::float_t m_flMaxRotationLeft; // 0x24 - 0x28
   std::float_t m_flMaxRotationRight; // 0x28 - 0x2C
   std::int32_t m_footstepLandedTagIndex; // 0x2C - 0x30
   bool m_bEnableTracing; // 0x30 - 0x31
   std::float_t m_flTraceAngleBlend; // 0x34 - 0x38
   std::int32_t m_nDisableTagIndex; // 0x38 - 0x3C
   std::int32_t m_nFootIndex; // 0x3C - 0x40
...
public:
   ...
   std::int32_t m_nHipBoneIndex; // 0x28 - 0x2C
   ...
   std::float_t m_flMaxFootHeight; // 0x38 - 0x3C
   std::float_t m_flExtensionScale; // 0x3C - 0x40
   std::float_t m_flMaxLegTwist; // 0x40 - 0x44
   bool m_bEnableLockBreaking; // 0x44 - 0x45
   std::float_t m_flLockBreakTolerance; // 0x48 - 0x4C
   std::float_t m_flLockBlendTime; // 0x4C - 0x50
   bool m_bEnableStretching; // 0x50 - 0x51
   std::float_t m_flMaxStretchAmount; // 0x54 - 0x58
   std::float_t m_flStretchExtensionScale; // 0x58 - 0x5C
...
public:
   ...
   CUtlVector< FootFixedData_t > m_footInfo; // 0x0 - 0x18
   std::float_t m_flBlendTime; // 0x18 - 0x1C
   std::float_t m_flLockBreakDistance; // 0x1C - 0x20
   std::float_t m_flMaxLegTwist; // 0x20 - 0x24
   std::int32_t m_nHipBoneIndex; // 0x24 - 0x28
...
public:
   ...
   std::int32_t m_nFootIndex; // 0x18 - 0x1C
...
public:
   ...
   std::int32_t m_nParamCount; // 0x14 - 0x18
...
public:
   ...
   std::int32_t m_nBuySize; // 0x38 - 0x3C
   std::int32_t m_nCost; // 0x3C - 0x40
...
public:
   ...
   std::int32_t m_nWeightListIndex; // 0x0 - 0x4
   std::int32_t m_nEffectedBoneCount; // 0x4 - 0x8
   std::float_t m_flMaxImpactForce; // 0x8 - 0xC
   std::float_t m_flMinImpactForce; // 0xC - 0x10
   std::float_t m_flWhipImpactScale; // 0x10 - 0x14
   std::float_t m_flCounterRotationScale; // 0x14 - 0x18
   std::float_t m_flDistanceFadeScale; // 0x18 - 0x1C
   std::float_t m_flPropagationScale; // 0x1C - 0x20
   std::float_t m_flWhipDelay; // 0x20 - 0x24
   std::float_t m_flSpringStrength; // 0x24 - 0x28
   std::float_t m_flWhipSpringStrength; // 0x28 - 0x2C
   std::float_t m_flMaxAngleRadians; // 0x2C - 0x30
   std::int32_t m_nHipBoneIndex; // 0x30 - 0x34
   std::float_t m_flHipBoneTranslationScale; // 0x34 - 0x38
   std::float_t m_flHipDipSpringStrength; // 0x38 - 0x3C
   std::float_t m_flHipDipImpactScale; // 0x3C - 0x40
   std::float_t m_flHipDipDelay; // 0x40 - 0x44
...
public:
   ...
   std::int32_t m_nNumIterations; // 0x4 - 0x8
...
public:
   ...
   std::float_t m_flWidth; // 0x30 - 0x34
   std::float_t m_flHeight; // 0x34 - 0x38
   std::float_t m_flDepth; // 0x38 - 0x3C
   ...
   std::int32_t m_nRenderOrder; // 0x58 - 0x5C
   Vector4D m_vTintColor; // 0x5C - 0x6C
   std::int32_t m_nSequenceOverride; // 0x6C - 0x70
...
public:
   ...
   std::int32_t m_nBoneIndex; // 0x0 - 0x4
   std::float_t m_flSpringStrength; // 0x4 - 0x8
   std::float_t m_flMaxTimeStep; // 0x8 - 0xC
   std::float_t m_flDamping; // 0xC - 0x10
...
public:
   ...
   std::int32_t m_index; // 0x0 - 0x4
   std::float_t m_weight; // 0x4 - 0x8
...
public:
   ...
   std::float_t m_flYawLimit; // 0xA8 - 0xAC
   std::float_t m_flPitchLimit; // 0xAC - 0xB0
   std::float_t m_flHysteresisInnerAngle; // 0xB0 - 0xB4
   std::float_t m_flHysteresisOuterAngle; // 0xB4 - 0xB8
...
public:
   ...
   std::float_t m_flScale; // 0xC - 0x10
...
public:
   ...
   std::uint32_t m_flexControllerToken; // 0x10 - 0x14
   std::float_t m_flMin; // 0x14 - 0x18
   std::float_t m_flMax; // 0x18 - 0x1C
...
public:
   ...
   CUtlString m_boneName; // 0x0 - 0x8
   std::uint32_t m_boneNameToken; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_flRelativeProbabilityOfSpawn; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_flFadeIn; // 0x54 - 0x58
   std::float_t m_flFadeOut; // 0x58 - 0x5C
...
public:
   ...
   std::float_t m_flKeyValue; // 0x8 - 0xC
...
public:
   ...
   std::uint16_t m_nGroup; // 0x0 - 0x2
   std::uint16_t m_nMotion; // 0x2 - 0x4
...
public:
   ...
   std::float_t invA; // 0xC - 0x10
   std::float_t t; // 0x10 - 0x14
   std::float_t flThetaRelaxed; // 0x14 - 0x18
   std::float_t flThetaFactor; // 0x18 - 0x1C
   std::float_t c01; // 0x1C - 0x20
   std::float_t c02; // 0x20 - 0x24
   std::float_t c03; // 0x24 - 0x28
   std::float_t c04; // 0x28 - 0x2C
   std::float_t flAxialModelDist; // 0x2C - 0x30
...
public:
   ...
   std::uint32_t m_nPackedMin; // 0x0 - 0x4
   std::uint32_t m_nPackedMax; // 0x4 - 0x8
...
public:
   ...
   std::float_t m_flCycle; // 0x14 - 0x18
...
public:
   ...
   CAnimParamHandle m_hParam; // 0x18 - 0x1A
   AnimParamType_t m_eParamType; // 0x1A - 0x1B
   std::float_t m_flStartCycle; // 0x1C - 0x20
   std::float_t m_flEndCycle; // 0x20 - 0x24
...
public:
   ...
   std::int32_t m_iControlPoint; // 0x0 - 0x4
...
public:
   ...
   std::uint32_t m_nModSpecificData; // 0x8 - 0xC
   PetGroundType_t m_groundType; // 0xC - 0x10
   CUtlString m_sequenceName; // 0x10 - 0x18
   std::int32_t m_nFireParticleOnSequenceFrame; // 0x18 - 0x1C
   ...
   std::float_t m_flPlaybackSpeed; // 0x48 - 0x4C
   std::float_t m_flParticleSimulationRate; // 0x4C - 0x50
...
public:
   ...
   std::int32_t m_nNumChannels; // 0x8 - 0xC
...
public:
   ...
   std::uint64_t m_nDefaultMeshGroupMask; // 0x180 - 0x188
...
public:
   ...
   CUtlString m_Name; // 0x20 - 0x28
   std::int32_t m_nParent; // 0x28 - 0x2C
...
public:
   ...
   std::float_t m_flMass; // 0x34 - 0x38
   Vector m_vEyePosition; // 0x38 - 0x44
   std::float_t m_flMaxEyeDeflection; // 0x44 - 0x48
...
public:
   ...
   std::uint32_t m_nStaticNodeFlags; // 0x30 - 0x34
   std::uint32_t m_nDynamicNodeFlags; // 0x34 - 0x38
   std::float_t m_flLocalForce; // 0x38 - 0x3C
   std::float_t m_flLocalRotation; // 0x3C - 0x40
   std::uint16_t m_nNodeCount; // 0x40 - 0x42
   std::uint16_t m_nStaticNodes; // 0x42 - 0x44
   std::uint16_t m_nRotLockStaticNodes; // 0x44 - 0x46
   std::uint16_t m_nFirstPositionDrivenNode; // 0x46 - 0x48
   std::uint16_t m_nSimdTriCount1; // 0x48 - 0x4A
   std::uint16_t m_nSimdTriCount2; // 0x4A - 0x4C
   std::uint16_t m_nSimdQuadCount1; // 0x4C - 0x4E
   std::uint16_t m_nSimdQuadCount2; // 0x4E - 0x50
   std::uint16_t m_nQuadCount1; // 0x50 - 0x52
   std::uint16_t m_nQuadCount2; // 0x52 - 0x54
   std::uint16_t m_nCollisionSphereInclusiveCount; // 0x54 - 0x56
   std::uint16_t m_nTreeDepth; // 0x56 - 0x58
   std::uint16_t m_nNodeBaseJiggleboneDependsCount; // 0x58 - 0x5A
   std::uint16_t m_nRopeCount; // 0x5A - 0x5C
   ...
   std::uint16_t m_nTriCount1; // 0x498 - 0x49A
   std::uint16_t m_nTriCount2; // 0x49A - 0x49C
   std::uint8_t m_nReservedUint8; // 0x49C - 0x49D
   std::uint8_t m_nExtraPressureIterations; // 0x49D - 0x49E
   std::uint8_t m_nExtraGoalIterations; // 0x49E - 0x49F
   std::uint8_t m_nExtraIterations; // 0x49F - 0x4A0
   ...
   std::float_t m_flInternalPressure; // 0x5C0 - 0x5C4
   std::float_t m_flDefaultTimeDilation; // 0x5C4 - 0x5C8
   std::float_t m_flWindage; // 0x5C8 - 0x5CC
   std::float_t m_flWindDrag; // 0x5CC - 0x5D0
   std::float_t m_flDefaultSurfaceStretch; // 0x5D0 - 0x5D4
   std::float_t m_flDefaultThreadStretch; // 0x5D4 - 0x5D8
   std::float_t m_flDefaultGravityScale; // 0x5D8 - 0x5DC
   std::float_t m_flDefaultVelAirDrag; // 0x5DC - 0x5E0
   std::float_t m_flDefaultExpAirDrag; // 0x5E0 - 0x5E4
   std::float_t m_flDefaultVelQuadAirDrag; // 0x5E4 - 0x5E8
   std::float_t m_flDefaultExpQuadAirDrag; // 0x5E8 - 0x5EC
   std::float_t m_flRodVelocitySmoothRate; // 0x5EC - 0x5F0
   std::float_t m_flQuadVelocitySmoothRate; // 0x5F0 - 0x5F4
   std::float_t m_flAddWorldCollisionRadius; // 0x5F4 - 0x5F8
   std::float_t m_flDefaultVolumetricSolveAmount; // 0x5F8 - 0x5FC
   std::uint16_t m_nRodVelocitySmoothIterations; // 0x5FC - 0x5FE
   std::uint16_t m_nQuadVelocitySmoothIterations; // 0x5FE - 0x600
...
public:
   ...
   std::float_t m_flTimeDuration; // 0x14 - 0x18
...
public:
   ...
   std::float_t m_flBloomStrength; // 0x4 - 0x8
   std::float_t m_flScreenBloomStrength; // 0x8 - 0xC
   std::float_t m_flBlurBloomStrength; // 0xC - 0x10
   std::float_t m_flBloomThreshold; // 0x10 - 0x14
   std::float_t m_flBloomThresholdWidth; // 0x14 - 0x18
   std::float_t m_flSkyboxBloomStrength; // 0x18 - 0x1C
   std::float_t m_flBloomStartValue; // 0x1C - 0x20
...
public:
   ...
   std::float_t m_flLocalContrastStrength; // 0x0 - 0x4
   std::float_t m_flLocalContrastEdgeStrength; // 0x4 - 0x8
   std::float_t m_flLocalContrastVignetteStart; // 0x8 - 0xC
   std::float_t m_flLocalContrastVignetteEnd; // 0xC - 0x10
   std::float_t m_flLocalContrastVignetteBlur; // 0x10 - 0x14
...
public:
   ...
   std::int32_t m_nColorCorrectionVolumeDim; // 0xF4 - 0xF8
...
public:
   ...
   std::float_t m_flExposureBias; // 0x0 - 0x4
   std::float_t m_flShoulderStrength; // 0x4 - 0x8
   std::float_t m_flLinearStrength; // 0x8 - 0xC
   std::float_t m_flLinearAngle; // 0xC - 0x10
   std::float_t m_flToeStrength; // 0x10 - 0x14
   std::float_t m_flToeNum; // 0x14 - 0x18
   std::float_t m_flToeDenom; // 0x18 - 0x1C
   std::float_t m_flWhitePoint; // 0x1C - 0x20
   std::float_t m_flLuminanceSource; // 0x20 - 0x24
   std::float_t m_flExposureBiasShadows; // 0x24 - 0x28
   std::float_t m_flExposureBiasHighlights; // 0x28 - 0x2C
   std::float_t m_flMinShadowLum; // 0x2C - 0x30
   std::float_t m_flMaxShadowLum; // 0x30 - 0x34
   std::float_t m_flMinHighlightLum; // 0x34 - 0x38
   std::float_t m_flMaxHighlightLum; // 0x38 - 0x3C
...
public:
   ...
   std::float_t m_flVignetteStrength; // 0x0 - 0x4
   Vector2D m_vCenter; // 0x4 - 0xC
   std::float_t m_flRadius; // 0xC - 0x10
   std::float_t m_flRoundness; // 0x10 - 0x14
   std::float_t m_flFeather; // 0x14 - 0x18
...
public:
   ...
   std::int32_t m_nForceBone; // 0xC - 0x10
...
public:
   ...
   std::int32_t m_nSemanticIndex; // 0x20 - 0x24
   std::uint32_t m_Format; // 0x24 - 0x28
   std::int32_t m_nOffset; // 0x28 - 0x2C
   std::int32_t m_nSlot; // 0x2C - 0x30
   RenderSlotType_t m_nSlotType; // 0x30 - 0x34
   std::int32_t m_nInstanceStepRate; // 0x34 - 0x38
...
public:
   ...
   std::float_t m_flSphereRadius; // 0x58 - 0x5C
...
public:
   ...
   std::int16_t odds; // 0x10 - 0x12
   std::int16_t flags; // 0x12 - 0x14
...
public:
   ...
   std::uint16_t m_nWeight0; // 0x0 - 0x2
   std::uint16_t m_nIndex0; // 0x2 - 0x4
   std::uint16_t m_nWeight1; // 0x4 - 0x6
   std::uint16_t m_nIndex1; // 0x6 - 0x8
   std::uint16_t m_nWeight2; // 0x8 - 0xA
   std::uint16_t m_nIndex2; // 0xA - 0xC
   std::uint16_t m_nFlags; // 0xC - 0xE
   std::uint16_t m_nTargetIndex; // 0xE - 0x10
...
public:
   ...
   std::uint8_t m_nNext; // 0x0 - 0x1
   std::uint8_t m_nTwin; // 0x1 - 0x2
   std::uint8_t m_nOrigin; // 0x2 - 0x3
   std::uint8_t m_nFace; // 0x3 - 0x4
...
public:
   ...
   std::uint32_t m_nFlags; // 0xC8 - 0xCC
...
public:
   ...
   Vector m_vMin; // 0x0 - 0xC
   std::uint32_t m_nChildren; // 0xC - 0x10
   Vector m_vMax; // 0x10 - 0x1C
   std::uint32_t m_nTriangleOffset; // 0x1C - 0x20
...
public:
   ...
   std::float_t m_flOffset; // 0xC - 0x10
...
public:
   ...
   std::float_t m_flMassInv; // 0x0 - 0x4
...
public:
   ...
   std::uint32_t m_nObjectID; // 0x0 - 0x4
   Vector4D m_vTransform[3]; // 0x4 - 0x34
   std::float_t m_flFadeStartDistance; // 0x34 - 0x38
   std::float_t m_flFadeEndDistance; // 0x38 - 0x3C
   ...
   std::uint32_t m_nLightGroup; // 0x68 - 0x6C
   std::int16_t m_nOverlayRenderOrder; // 0x6C - 0x6E
   std::int16_t m_nLODOverride; // 0x6E - 0x70
   std::int32_t m_nCubeMapPrecomputedHandshake; // 0x70 - 0x74
   std::int32_t m_nLightProbeVolumePrecomputedHandshake; // 0x74 - 0x78
...
public:
   ...
   std::uint64_t m_nViewId; // 0x0 - 0x8
   std::uint64_t m_nFrameCount; // 0x8 - 0x10
...
public:
   ...
   std::int32_t m_nSequence; // 0x0 - 0x4
   std::float_t m_flRelativeWeight; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_outerKnuckle1; // 0x30 - 0x34
   std::int32_t m_outerKnuckle2; // 0x34 - 0x38
...
public:
   ...
   std::float_t m_flDirection; // 0xC - 0x10
...
public:
   ...
   std::int32_t nSummarisedCount; // 0x0 - 0x4
...
public:
   ...
   std::int32_t m_tagIndex; // 0x0 - 0x4
   std::float_t m_startCycle; // 0x4 - 0x8
   std::float_t m_endCycle; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_TimeBetweenEvents; // 0x0 - 0x4
   std::float_t m_fNextEvent; // 0x4 - 0x8
...
public:
   ...
   std::float_t m_flTraceHeight; // 0x0 - 0x4
   std::float_t m_flTraceRadius; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_targetBoneIndex; // 0x120 - 0x124
   ...
   std::int32_t m_nFixedBoneIndex; // 0x140 - 0x144
   std::int32_t m_nMiddleBoneIndex; // 0x144 - 0x148
   std::int32_t m_nEndBoneIndex; // 0x148 - 0x14C
   bool m_bMatchTargetOrientation; // 0x14C - 0x14D
   bool m_bConstrainTwist; // 0x14D - 0x14E
   std::float_t m_flMaxTwist; // 0x150 - 0x154
...
public:
   ...
   std::float_t m_flEnvelopeAmount; // 0x0 - 0x4
   std::float_t m_flAttackTimeMS; // 0x4 - 0x8
   std::float_t m_flReleaseTimeMS; // 0x8 - 0xC
   VMixFilterDesc_t m_filter; // 0xC - 0x1C
   std::float_t m_flLFOAmount; // 0x1C - 0x20
   std::float_t m_flLFORate; // 0x20 - 0x24
   std::float_t m_flPhase; // 0x24 - 0x28
...
public:
   ...
   std::float_t m_flSizeMax; // 0x0 - 0x4
   std::float_t m_flSizeMin; // 0x4 - 0x8
   std::float_t m_flComplexity; // 0x8 - 0xC
   std::float_t m_flDiffusion; // 0xC - 0x10
   std::float_t m_flModDepth; // 0x10 - 0x14
   std::float_t m_flModRate; // 0x14 - 0x18
   bool m_bParallel; // 0x18 - 0x19
   VMixFilterDesc_t m_filterType; // 0x1C - 0x2C
   std::float_t m_flWidth; // 0x2C - 0x30
   std::float_t m_flHeight; // 0x30 - 0x34
   std::float_t m_flDepth; // 0x34 - 0x38
   std::float_t m_flFeedbackScale; // 0x38 - 0x3C
   std::float_t m_flFeedbackWidth; // 0x3C - 0x40
   std::float_t m_flFeedbackHeight; // 0x40 - 0x44
   std::float_t m_flFeedbackDepth; // 0x44 - 0x48
   std::float_t m_flOutputGain; // 0x48 - 0x4C
   std::float_t m_flTaps; // 0x4C - 0x50
...
public:
   ...
   std::float_t m_fldbGain; // 0x0 - 0x4
   std::float_t m_flPreDelayMS; // 0x4 - 0x8
   std::float_t m_flWetMix; // 0x8 - 0xC
   std::float_t m_fldbLow; // 0xC - 0x10
   std::float_t m_fldbMid; // 0x10 - 0x14
   std::float_t m_fldbHigh; // 0x14 - 0x18
   std::float_t m_flLowCutoffFreq; // 0x18 - 0x1C
   std::float_t m_flHighCutoffFreq; // 0x1C - 0x20
...
public:
   ...
   std::float_t m_flDelay; // 0x14 - 0x18
   std::float_t m_flDirectGain; // 0x18 - 0x1C
   std::float_t m_flDelayGain; // 0x1C - 0x20
   std::float_t m_flFeedbackGain; // 0x20 - 0x24
   std::float_t m_flWidth; // 0x24 - 0x28
...
public:
   ...
   std::float_t m_flSize; // 0x0 - 0x4
   std::float_t m_flComplexity; // 0x4 - 0x8
   std::float_t m_flFeedback; // 0x8 - 0xC
   std::float_t m_flOutputGain; // 0xC - 0x10
...
public:
   ...
   std::float_t m_fldbGainOutput; // 0x0 - 0x4
   std::float_t m_flRMSTimeMS; // 0x4 - 0x8
   std::float_t m_fldbKneeWidth; // 0x8 - 0xC
   std::float_t m_flDepth; // 0xC - 0x10
   std::float_t m_flWetMix; // 0x10 - 0x14
   std::float_t m_flTimeScale; // 0x14 - 0x18
   std::float_t m_flLowCutoffFreq; // 0x18 - 0x1C
   std::float_t m_flHighCutoffFreq; // 0x1C - 0x20
...
public:
   ...
   std::float_t m_fldbGainInput; // 0x0 - 0x4
   std::float_t m_fldbGainOutput; // 0x4 - 0x8
   std::float_t m_fldbThresholdBelow; // 0x8 - 0xC
   std::float_t m_fldbThresholdAbove; // 0xC - 0x10
   std::float_t m_flRatioBelow; // 0x10 - 0x14
   std::float_t m_flRatioAbove; // 0x14 - 0x18
   std::float_t m_flAttackTimeMS; // 0x18 - 0x1C
   std::float_t m_flReleaseTimeMS; // 0x1C - 0x20
...
public:
   ...
   std::float_t m_fldbOutputGain; // 0x0 - 0x4
   std::float_t m_fldbCompressionThreshold; // 0x4 - 0x8
   std::float_t m_fldbKneeWidth; // 0x8 - 0xC
   std::float_t m_flCompressionRatio; // 0xC - 0x10
   std::float_t m_flAttackTimeMS; // 0x10 - 0x14
   std::float_t m_flReleaseTimeMS; // 0x14 - 0x18
   std::float_t m_flRMSTimeMS; // 0x18 - 0x1C
   std::float_t m_flWetMix; // 0x1C - 0x20
   bool m_bPeakMode; // 0x20 - 0x21
...
public:
   ...
   std::float_t m_fldbGain; // 0x0 - 0x4
   std::float_t m_fldbNoiseGateThreshold; // 0x4 - 0x8
   std::float_t m_fldbCompressionThreshold; // 0x8 - 0xC
   std::float_t m_fldbLimiterThreshold; // 0xC - 0x10
   std::float_t m_fldbKneeWidth; // 0x10 - 0x14
   std::float_t m_flRatio; // 0x14 - 0x18
   std::float_t m_flLimiterRatio; // 0x18 - 0x1C
   std::float_t m_flAttackTimeMS; // 0x1C - 0x20
   std::float_t m_flReleaseTimeMS; // 0x20 - 0x24
   std::float_t m_flRMSTimeMS; // 0x24 - 0x28
   std::float_t m_flWetMix; // 0x28 - 0x2C
...
public:
   ...
   std::float_t m_flCrossfadeTime; // 0x0 - 0x4
...
public:
   ...
   std::float_t m_flAttackTimeMS; // 0x0 - 0x4
   std::float_t m_flHoldTimeMS; // 0x4 - 0x8
   std::float_t m_flReleaseTimeMS; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_fldbGain; // 0x4 - 0x8
   std::float_t m_flCutoffFreq; // 0x8 - 0xC
   std::float_t m_flQ; // 0xC - 0x10
...
public:
   ...
   std::float_t m_flRoomSize; // 0x0 - 0x4
   std::float_t m_flDamp; // 0x4 - 0x8
   std::float_t m_flWidth; // 0x8 - 0xC
   std::float_t m_flLateReflections; // 0xC - 0x10
...
public:
   ...
   std::float_t m_flGlideTime; // 0x14 - 0x18
   std::float_t m_flDelay; // 0x18 - 0x1C
   std::float_t m_flOutputGain; // 0x1C - 0x20
   std::float_t m_flFeedbackGain; // 0x20 - 0x24
   std::float_t m_flModRate; // 0x24 - 0x28
   std::float_t m_flModDepth; // 0x28 - 0x2C
...
public:
   ...
   std::float_t m_freq; // 0x4 - 0x8
   std::float_t m_flPhase; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_flStrength; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_nGrainSampleCount; // 0x0 - 0x4
   std::float_t m_flPitchShift; // 0x4 - 0x8
   std::int32_t m_nQuality; // 0x8 - 0xC
   std::int32_t m_nProcType; // 0xC - 0x10
...
public:
   ...
   std::float_t m_flPrefilter; // 0x0 - 0x4
   std::float_t m_flInputDiffusion1; // 0x4 - 0x8
   std::float_t m_flInputDiffusion2; // 0x8 - 0xC
   std::float_t m_flDecay; // 0xC - 0x10
   std::float_t m_flDamp; // 0x10 - 0x14
   std::float_t m_flFeedbackDiffusion1; // 0x14 - 0x18
   std::float_t m_flFeedbackDiffusion2; // 0x18 - 0x1C
...
public:
   ...
   std::int32_t m_nShape; // 0x0 - 0x4
   std::float_t m_fldbDrive; // 0x4 - 0x8
   std::float_t m_fldbOutputGain; // 0x8 - 0xC
   std::float_t m_flWetMix; // 0xC - 0x10
   std::int32_t m_nOversampleFactor; // 0x10 - 0x14
...
public:
   ...
   std::float_t m_flInterpolationTime; // 0x8 - 0xC
...
public:
   ...
   std::float_t m_flInputPan; // 0x4 - 0x8
   std::float_t m_flOutputBalance; // 0x8 - 0xC
   std::float_t m_fldbOutputGain; // 0xC - 0x10
   bool m_bBassMono; // 0x10 - 0x11
   std::float_t m_flBassFreq; // 0x14 - 0x18
...
public:
   ...
   std::int32_t m_nBandCount; // 0x0 - 0x4
   std::float_t m_flBandwidth; // 0x4 - 0x8
   std::float_t m_fldBModGain; // 0x8 - 0xC
   std::float_t m_flFreqRangeStart; // 0xC - 0x10
   std::float_t m_flFreqRangeEnd; // 0x10 - 0x14
   std::float_t m_fldBUnvoicedGain; // 0x14 - 0x18
   std::float_t m_flAttackTimeMS; // 0x18 - 0x1C
   std::float_t m_flReleaseTimeMS; // 0x1C - 0x20
   std::int32_t m_nDebugBand; // 0x20 - 0x24
...
public:
   ...
   std::uint16_t m_nFlags; // 0x0 - 0x2
   std::uint16_t m_nRefCounter; // 0x2 - 0x4
...
public:
   ...
   std::uint32_t m_nFlags; // 0x0 - 0x4
   std::float_t m_flMass; // 0x4 - 0x8
   VPhysics2ShapeDef_t m_rnShape; // 0x8 - 0x80
   std::uint16_t m_nCollisionAttributeIndex; // 0x80 - 0x82
   std::uint16_t m_nReserved; // 0x82 - 0x84
   std::float_t m_flInertiaScale; // 0x84 - 0x88
   std::float_t m_flLinearDamping; // 0x88 - 0x8C
   std::float_t m_flAngularDamping; // 0x8C - 0x90
...
public:
   ...
   std::uint32_t m_CollisionGroup; // 0x0 - 0x4
...
public:
   ...
   std::uint32_t m_nFlags; // 0x0 - 0x4
   std::uint16_t m_nParent; // 0x4 - 0x6
   std::uint16_t m_nChild; // 0x6 - 0x8
...
public:
   ...
   std::int8_t m_nType; // 0x0 - 0x1
   std::int8_t m_nTranslateMotion; // 0x1 - 0x2
   std::int8_t m_nRotateMotion; // 0x2 - 0x3
   std::int8_t m_nFlags; // 0x3 - 0x4
   Vector m_anchor[2]; // 0x4 - 0x1C
   QuaternionStorage m_axes[2]; // 0x1C - 0x3C
   std::float_t m_maxForce; // 0x3C - 0x40
   std::float_t m_maxTorque; // 0x40 - 0x44
   std::float_t m_linearLimitValue; // 0x44 - 0x48
   std::float_t m_linearLimitRestitution; // 0x48 - 0x4C
   std::float_t m_linearLimitSpring; // 0x4C - 0x50
   std::float_t m_linearLimitDamping; // 0x50 - 0x54
   std::float_t m_twistLowLimitValue; // 0x54 - 0x58
   std::float_t m_twistLowLimitRestitution; // 0x58 - 0x5C
   std::float_t m_twistLowLimitSpring; // 0x5C - 0x60
   std::float_t m_twistLowLimitDamping; // 0x60 - 0x64
   std::float_t m_twistHighLimitValue; // 0x64 - 0x68
   std::float_t m_twistHighLimitRestitution; // 0x68 - 0x6C
   std::float_t m_twistHighLimitSpring; // 0x6C - 0x70
   std::float_t m_twistHighLimitDamping; // 0x70 - 0x74
   std::float_t m_swing1LimitValue; // 0x74 - 0x78
   std::float_t m_swing1LimitRestitution; // 0x78 - 0x7C
   std::float_t m_swing1LimitSpring; // 0x7C - 0x80
   std::float_t m_swing1LimitDamping; // 0x80 - 0x84
   std::float_t m_swing2LimitValue; // 0x84 - 0x88
   std::float_t m_swing2LimitRestitution; // 0x88 - 0x8C
   std::float_t m_swing2LimitSpring; // 0x8C - 0x90
   std::float_t m_swing2LimitDamping; // 0x90 - 0x94
   Vector m_goalPosition; // 0x94 - 0xA0
   QuaternionStorage m_goalOrientation; // 0xA0 - 0xB0
   Vector m_goalAngularVelocity; // 0xB0 - 0xBC
   std::float_t m_driveSpringX; // 0xBC - 0xC0
   std::float_t m_driveSpringY; // 0xC0 - 0xC4
   std::float_t m_driveSpringZ; // 0xC4 - 0xC8
   std::float_t m_driveDampingX; // 0xC8 - 0xCC
   std::float_t m_driveDampingY; // 0xCC - 0xD0
   std::float_t m_driveDampingZ; // 0xD0 - 0xD4
   std::float_t m_driveSpringTwist; // 0xD4 - 0xD8
   std::float_t m_driveSpringSwing; // 0xD8 - 0xDC
   std::float_t m_driveSpringSlerp; // 0xDC - 0xE0
   std::float_t m_driveDampingTwist; // 0xE0 - 0xE4
   std::float_t m_driveDampingSwing; // 0xE4 - 0xE8
   std::float_t m_driveDampingSlerp; // 0xE8 - 0xEC
   std::int32_t m_solverIterationCount; // 0xEC - 0xF0
   std::float_t m_projectionLinearTolerance; // 0xF0 - 0xF4
   std::float_t m_projectionAngularTolerance; // 0xF4 - 0xF8
...
public:
   ...
   std::uint16_t m_nType; // 0x0 - 0x2
   std::uint16_t m_nBody1; // 0x2 - 0x4
   std::uint16_t m_nBody2; // 0x4 - 0x6
   std::uint16_t m_nFlags; // 0x6 - 0x8
   ...
   std::float_t m_flMaxForce; // 0x6C - 0x70
   ...
   std::float_t m_flMaxTorque; // 0x98 - 0x9C
   std::float_t m_flLinearFrequency; // 0x9C - 0xA0
   std::float_t m_flLinearDampingRatio; // 0xA0 - 0xA4
   std::float_t m_flAngularFrequency; // 0xA4 - 0xA8
   std::float_t m_flAngularDampingRatio; // 0xA8 - 0xAC
   std::float_t m_flFriction; // 0xAC - 0xB0
...
public:
   ...
   std::float_t m_flMin; // 0x0 - 0x4
   std::float_t m_flMax; // 0x4 - 0x8
...
public:
   ...
   std::uint64_t m_nInteractsAs; // 0x8 - 0x10
   std::uint64_t m_nInteractsWith; // 0x10 - 0x18
   std::uint64_t m_nInteractsExclude; // 0x18 - 0x20
   std::uint32_t m_nEntityId; // 0x20 - 0x24
   std::uint32_t m_nOwnerId; // 0x24 - 0x28
   std::uint16_t m_nHierarchyId; // 0x28 - 0x2A
   std::uint8_t m_nCollisionGroup; // 0x2A - 0x2B
   std::uint8_t m_nCollisionFunctionMask; // 0x2B - 0x2C
...
public:
   ...
   std::uint8_t m_nNumComponents; // 0xE - 0xF
...
public:
   ...
   std::float_t m_fIdealSampleRate; // 0x10 - 0x14
...
public:
   ...
   std::uint32_t m_nOffset; // 0x0 - 0x4
   std::uint32_t m_nElementCount; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_nD3DSemanticIndex; // 0xC0 - 0xC4
...
public:
   ...
   std::float_t m_flMinDrawVolumeSize; // 0x0 - 0x4
   bool m_bBuildBakedLighting; // 0x4 - 0x5
   Vector2D m_vLightmapUvScale; // 0x8 - 0x10
   std::uint64_t m_nCompileTimestamp; // 0x10 - 0x18
   std::uint64_t m_nCompileFingerprint; // 0x18 - 0x20
...
public:
   ...
   std::int32_t m_nElementCount; // 0x0 - 0x4
   std::int32_t m_nElementSizeInBytes; // 0x4 - 0x8
...
public:
   ...
   std::int32_t m_boneIndex; // 0x20 - 0x24
...
public:
   ...
   std::int32_t soundscapeIndex; // 0x68 - 0x6C
   std::uint8_t localBits; // 0x6C - 0x6D
   std::int32_t soundscapeEntityListIndex; // 0x70 - 0x74
   std::uint32_t soundEventHash; // 0x74 - 0x78
...
public:
   ...
   std::float_t flMinRotation; // 0x0 - 0x4
   std::float_t flMaxRotation; // 0x4 - 0x8
   std::float_t flMotorTargetAngSpeed; // 0x8 - 0xC
   std::float_t flMotorMaxTorque; // 0xC - 0x10
...
public:
   ...
   std::float_t strength; // 0x0 - 0x4
   std::float_t forceLimit; // 0x4 - 0x8
   std::float_t torqueLimit; // 0x8 - 0xC
...
public:
   ...
   std::float_t start; // 0x24 - 0x28
   std::float_t end; // 0x28 - 0x2C
   std::float_t farz; // 0x2C - 0x30
   std::float_t maxdensity; // 0x30 - 0x34
   std::float_t exponent; // 0x34 - 0x38
   std::float_t HDRColorScale; // 0x38 - 0x3C
   std::float_t skyboxFogFactor; // 0x3C - 0x40
   std::float_t skyboxFogFactorLerpTo; // 0x40 - 0x44
   std::float_t startLerpTo; // 0x44 - 0x48
   std::float_t endLerpTo; // 0x48 - 0x4C
   std::float_t maxdensityLerpTo; // 0x4C - 0x50
   GameTime_t lerptime; // 0x50 - 0x54
   std::float_t duration; // 0x54 - 0x58
   std::float_t blendtobackground; // 0x58 - 0x5C
   std::float_t scattering; // 0x5C - 0x60
   std::float_t locallightscale; // 0x60 - 0x64
...
public:
   ...
   std::uint8_t effect; // 0x8 - 0x9
   std::uint8_t channel; // 0x9 - 0xA
   std::float_t x; // 0xC - 0x10
   std::float_t y; // 0x10 - 0x14
...
public:
   ...
   std::int32_t parentIndex; // 0x20 - 0x24
   std::float_t m_flRadius; // 0x24 - 0x28
...
public:
   ...
   std::int32_t m_nModelID; // 0x8 - 0xC
   ...
   std::float_t m_flGlassHalfThickness; // 0x50 - 0x54
...
public:
   ...
   std::int16_t scale; // 0x8 - 0xA
   Vector origin; // 0xC - 0x18
   bool bClip3DSkyBoxNearToWorldFar; // 0x18 - 0x19
   std::float_t flClip3DSkyBoxNearToWorldFarOffset; // 0x1C - 0x20
